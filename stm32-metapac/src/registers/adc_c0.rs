        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "chselr",
                    description: Some(
                        "channel selection register CHSELRMOD = 0 in ADC_CFGR1",
                    ),
                    array: None,
                    byte_offset: 0x28,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "chselr_sq",
                    description: Some(
                        "channel selection register CHSELRMOD = 1 (seqencer enabled) in ADC_CFGR1",
                    ),
                    array: None,
                    byte_offset: 0x28,
                    inner: BlockItemInner::Register(
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tovs",
                    description: Some(
                        "oversampling discontinuous mode (triggered mode) for ADC group regular",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
        ...
        FieldSet {
            ...
            extends: None,
            description: Some(
                "channel selection register [alternate]",
            ),
            bit_size: 32,
            fields: &[
                Field {
                    name: "chsel",
                    description: Some(
                        "ADC channel selection for canversion",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,

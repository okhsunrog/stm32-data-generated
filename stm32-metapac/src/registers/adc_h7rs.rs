        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "rdata",
                    description: Some(
                        "Regular data converted These bits are read-only. They contain the conversion result from the last converted regular channel. The data are left- or right-aligned as described in Section 25.4.26: Data management.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "jqovf",
                    description: Some(
                        "Injected context queue overflow This bit is set by hardware when an Overflow of the Injected Queue of Context occurs. It is cleared by software writing 1 to it. Refer to Section 25.4.21: Queue of context for injected conversions for more information.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 10,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "jdata",
                    description: Some(
                        "Injected data These bits are read-only. They contain the conversion result from injected channel y. The data are left -or right-aligned as described in Section 25.4.26: Data management.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "jsq",
                    description: Some(
                        "1st-4th conversions in the injected sequence These bits are written by software with the channel number (0 to 18) assigned as the 1st-4th in the injected conversion sequence. Note: The software is allowed to write these bits only when JADSTART = 0 (which ensures that no injected conversion is ongoing).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sq",
                    description: Some(
                        "1st-4th conversions in regular sequence These bits are written by software with the channel number (0 to 18) assigned as the 1st-4th in the regular conversion sequence. Note: The software is allowed to write these bits only when ADSTART = 0 (which ensures that no regular conversion is ongoing).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sq",
                    description: Some(
                        "5th-9th conversions in regular sequence These bits are written by software with the channel number (0 to 18) assigned as the 5th-9th in the regular conversion sequence. Note: The software is allowed to write these bits only when ADSTART = 0 (which ensures that no regular conversion is ongoing).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sq",
                    description: Some(
                        "10th-14th conversions in regular sequence These bits are written by software with the channel number (0 to 18) assigned as the 10th-14th in the regular conversion sequence. Note: The software is allowed to write these bits only when ADSTART = 0 (which ensures that no regular conversion is ongoing).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sq",
                    description: Some(
                        "15th-16th conversion in regular sequence These bits are written by software with the channel number (0 to 18) assigned as the 15th-16th in the regular conversion sequence. Note: The software is allowed to write these bits only when ADSTART = 0 (which ensures that no regular conversion is ongoing).",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,

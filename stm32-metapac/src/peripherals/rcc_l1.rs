...
fn default () -> Ahbenr { Ahbenr (0) } } impl core :: fmt :: Debug for Ahbenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahbenr") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpioden" , & self . gpioden ()) . field ("gpioeen" , & self . gpioeen ()) . field ("gpiohen" , & self . gpiohen ()) . field ("gpiofen" , & self . gpiofen ()) . field ("gpiogen" , & self . gpiogen ()) . field ("crcen" , & self . crcen ()) . field ("flashen" , & self . flashen ()) . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("fsmcen" , & self . fsmcen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahbenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahbenr {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpioeen: {=bool:?}, gpiohen: {=bool:?}, gpiofen: {=bool:?}, gpiogen: {=bool:?}, crcen: {=bool:?}, flashen: {=bool:?}, dma1en: {=bool:?}, dma2en: {=bool:?}, fsmcen: {=bool:?} }}" , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpioden () , self . gpioeen () , self . gpiohen () , self . gpiofen () , self . gpiogen () , self . crcen () , self . flashen () , self . dma1en () , self . dma2en () , self . fsmcen ()) } } # [doc = "AHB peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahblpenr { Ahblpenr (0) } } impl core :: fmt :: Debug for Ahblpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahblpenr") . field ("gpioalpen" , & self . gpioalpen ()) . field ("gpioblpen" , & self . gpioblpen ()) . field ("gpioclpen" , & self . gpioclpen ()) . field ("gpiodlpen" , & self . gpiodlpen ()) . field ("gpioelpen" , & self . gpioelpen ()) . field ("gpiohlpen" , & self . gpiohlpen ()) . field ("gpioflpen" , & self . gpioflpen ()) . field ("gpioglpen" , & self . gpioglpen ()) . field ("crclpen" , & self . crclpen ()) . field ("flashlpen" , & self . flashlpen ()) . field ("sramlpen" , & self . sramlpen ()) . field ("dma1lpen" , & self . dma1lpen ()) . field ("dma2lpen" , & self . dma2lpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahblpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahblpenr {{ gpioalpen: {=bool:?}, gpioblpen: {=bool:?}, gpioclpen: {=bool:?}, gpiodlpen: {=bool:?}, gpioelpen: {=bool:?}, gpiohlpen: {=bool:?}, gpioflpen: {=bool:?}, gpioglpen: {=bool:?}, crclpen: {=bool:?}, flashlpen: {=bool:?}, sramlpen: {=bool:?}, dma1lpen: {=bool:?}, dma2lpen: {=bool:?} }}" , self . gpioalpen () , self . gpioblpen () , self . gpioclpen () , self . gpiodlpen () , self . gpioelpen () , self . gpiohlpen () , self . gpioflpen () , self . gpioglpen () , self . crclpen () , self . flashlpen () , self . sramlpen () , self . dma1lpen () , self . dma2lpen ()) } } # [doc = "AHB peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr { Apb1enr (0) } } impl core :: fmt :: Debug for Apb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr") . field ("tim2en" , & self . tim2en ()) . field ("tim3en" , & self . tim3en ()) . field ("tim4en" , & self . tim4en ()) . field ("tim5en" , & self . tim5en ()) . field ("tim6en" , & self . tim6en ()) . field ("tim7en" , & self . tim7en ()) . field ("lcden" , & self . lcden ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("spi3en" , & self . spi3en ()) . field ("usart2en" , & self . usart2en ()) . field ("usart3en" , & self . usart3en ()) . field ("usart4en" , & self . usart4en ()) . field ("usart5en" , & self . usart5en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("usben" , & self . usben ()) . field ("pwren" , & self . pwren ()) . field ("dacen" , & self . dacen ()) . field ("compen" , & self . compen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr {{ tim2en: {=bool:?}, tim3en: {=bool:?}, tim4en: {=bool:?}, tim5en: {=bool:?}, tim6en: {=bool:?}, tim7en: {=bool:?}, lcden: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, spi3en: {=bool:?}, usart2en: {=bool:?}, usart3en: {=bool:?}, usart4en: {=bool:?}, usart5en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, usben: {=bool:?}, pwren: {=bool:?}, dacen: {=bool:?}, compen: {=bool:?} }}" , self . tim2en () , self . tim3en () , self . tim4en () , self . tim5en () , self . tim6en () , self . tim7en () , self . lcden () , self . wwdgen () , self . spi2en () , self . spi3en () , self . usart2en () , self . usart3en () , self . usart4en () , self . usart5en () , self . i2c1en () , self . i2c2en () , self . usben () , self . pwren () , self . dacen () , self . compen ()) } } # [doc = "APB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1lpenr { Apb1lpenr (0) } } impl core :: fmt :: Debug for Apb1lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1lpenr") . field ("tim2lpen" , & self . tim2lpen ()) . field ("tim3lpen" , & self . tim3lpen ()) . field ("tim4lpen" , & self . tim4lpen ()) . field ("tim6lpen" , & self . tim6lpen ()) . field ("tim7lpen" , & self . tim7lpen ()) . field ("lcdlpen" , & self . lcdlpen ()) . field ("wwdglpen" , & self . wwdglpen ()) . field ("spi2lpen" , & self . spi2lpen ()) . field ("usart2lpen" , & self . usart2lpen ()) . field ("usart3lpen" , & self . usart3lpen ()) . field ("i2c1lpen" , & self . i2c1lpen ()) . field ("i2c2lpen" , & self . i2c2lpen ()) . field ("usblpen" , & self . usblpen ()) . field ("pwrlpen" , & self . pwrlpen ()) . field ("daclpen" , & self . daclpen ()) . field ("complpen" , & self . complpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1lpenr {{ tim2lpen: {=bool:?}, tim3lpen: {=bool:?}, tim4lpen: {=bool:?}, tim6lpen: {=bool:?}, tim7lpen: {=bool:?}, lcdlpen: {=bool:?}, wwdglpen: {=bool:?}, spi2lpen: {=bool:?}, usart2lpen: {=bool:?}, usart3lpen: {=bool:?}, i2c1lpen: {=bool:?}, i2c2lpen: {=bool:?}, usblpen: {=bool:?}, pwrlpen: {=bool:?}, daclpen: {=bool:?}, complpen: {=bool:?} }}" , self . tim2lpen () , self . tim3lpen () , self . tim4lpen () , self . tim6lpen () , self . tim7lpen () , self . lcdlpen () , self . wwdglpen () , self . spi2lpen () , self . usart2lpen () , self . usart3lpen () , self . i2c1lpen () , self . i2c2lpen () , self . usblpen () , self . pwrlpen () , self . daclpen () , self . complpen ()) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr { Apb1rstr (0) } } impl core :: fmt :: Debug for Apb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr") . field ("tim2rst" , & self . tim2rst ()) . field ("tim3rst" , & self . tim3rst ()) . field ("tim4rst" , & self . tim4rst ()) . field ("tim5rst" , & self . tim5rst ()) . field ("tim6rst" , & self . tim6rst ()) . field ("tim7rst" , & self . tim7rst ()) . field ("lcdrst" , & self . lcdrst ()) . field ("wwdrst" , & self . wwdrst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("spi3rst" , & self . spi3rst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("usart3rst" , & self . usart3rst ()) . field ("uart4rst" , & self . uart4rst ()) . field ("uart5rst" , & self . uart5rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("usbrst" , & self . usbrst ()) . field ("pwrrst" , & self . pwrrst ()) . field ("dacrst" , & self . dacrst ()) . field ("comprst" , & self . comprst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim4rst: {=bool:?}, tim5rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, lcdrst: {=bool:?}, wwdrst: {=bool:?}, spi2rst: {=bool:?}, spi3rst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, uart4rst: {=bool:?}, uart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, usbrst: {=bool:?}, pwrrst: {=bool:?}, dacrst: {=bool:?}, comprst: {=bool:?} }}" , self . tim2rst () , self . tim3rst () , self . tim4rst () , self . tim5rst () , self . tim6rst () , self . tim7rst () , self . lcdrst () , self . wwdrst () , self . spi2rst () , self . spi3rst () , self . usart2rst () , self . usart3rst () , self . uart4rst () , self . uart5rst () , self . i2c1rst () , self . i2c2rst () , self . usbrst () , self . pwrrst () , self . dacrst () , self . comprst ()) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("syscfgen" , & self . syscfgen ()) . field ("tim9en" , & self . tim9en ()) . field ("tim10en" , & self . tim10en ()) . field ("tim11en" , & self . tim11en ()) . field ("adc1en" , & self . adc1en ()) . field ("sdioen" , & self . sdioen ()) . field ("spi1en" , & self . spi1en ()) . field ("usart1en" , & self . usart1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ syscfgen: {=bool:?}, tim9en: {=bool:?}, tim10en: {=bool:?}, tim11en: {=bool:?}, adc1en: {=bool:?}, sdioen: {=bool:?}, spi1en: {=bool:?}, usart1en: {=bool:?} }}" , self . syscfgen () , self . tim9en () , self . tim10en () , self . tim11en () , self . adc1en () , self . sdioen () , self . spi1en () , self . usart1en ()) } } # [doc = "APB2 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2lpenr { Apb2lpenr (0) } } impl core :: fmt :: Debug for Apb2lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2lpenr") . field ("syscfglpen" , & self . syscfglpen ()) . field ("tim9lpen" , & self . tim9lpen ()) . field ("tim10lpen" , & self . tim10lpen ()) . field ("tim11lpen" , & self . tim11lpen ()) . field ("adc1lpen" , & self . adc1lpen ()) . field ("sdiolpen" , & self . sdiolpen ()) . field ("spi1lpen" , & self . spi1lpen ()) . field ("usart1lpen" , & self . usart1lpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2lpenr {{ syscfglpen: {=bool:?}, tim9lpen: {=bool:?}, tim10lpen: {=bool:?}, tim11lpen: {=bool:?}, adc1lpen: {=bool:?}, sdiolpen: {=bool:?}, spi1lpen: {=bool:?}, usart1lpen: {=bool:?} }}" , self . syscfglpen () , self . tim9lpen () , self . tim10lpen () , self . tim11lpen () , self . adc1lpen () , self . sdiolpen () , self . spi1lpen () , self . usart1lpen ()) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("syscfgrst" , & self . syscfgrst ()) . field ("tim9rst" , & self . tim9rst ()) . field ("tm10rst" , & self . tm10rst ()) . field ("tm11rst" , & self . tm11rst ()) . field ("adc1rst" , & self . adc1rst ()) . field ("sdiorst" , & self . sdiorst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("usart1rst" , & self . usart1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ syscfgrst: {=bool:?}, tim9rst: {=bool:?}, tm10rst: {=bool:?}, tm11rst: {=bool:?}, adc1rst: {=bool:?}, sdiorst: {=bool:?}, spi1rst: {=bool:?}, usart1rst: {=bool:?} }}" , self . syscfgrst () , self . tim9rst () , self . tm10rst () , self . tm11rst () , self . adc1rst () , self . sdiorst () , self . spi1rst () , self . usart1rst ()) } } # [doc = "Clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr { Cfgr (0) } } impl core :: fmt :: Debug for Cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr") . field ("sw" , & self . sw ()) . field ("sws" , & self . sws ()) . field ("hpre" , & self . hpre ()) . field ("ppre1" , & self . ppre1 ()) . field ("ppre2" , & self . ppre2 ()) . field ("pllsrc" , & self . pllsrc ()) . field ("pllmul" , & self . pllmul ()) . field ("plldiv" , & self . plldiv ()) . field ("mcosel" , & self . mcosel ()) . field ("mcopre" , & self . mcopre ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr {{ sw: {:?}, sws: {:?}, hpre: {:?}, ppre1: {:?}, ppre2: {:?}, pllsrc: {:?}, pllmul: {:?}, plldiv: {:?}, mcosel: {:?}, mcopre: {:?} }}" , self . sw () , self . sws () , self . hpre () , self . ppre1 () , self . ppre2 () , self . pllsrc () , self . pllmul () , self . plldiv () , self . mcosel () , self . mcopre ()) } } # [doc = "Clock interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("hsion" , & self . hsion ()) . field ("hsirdy" , & self . hsirdy ()) . field ("msion" , & self . msion ()) . field ("msirdy" , & self . msirdy ()) . field ("hseon" , & self . hseon ()) . field ("hserdy" , & self . hserdy ()) . field ("hsebyp" , & self . hsebyp ()) . field ("pllon" , & self . pllon ()) . field ("pllrdy" , & self . pllrdy ()) . field ("csson" , & self . csson ()) . field ("rtcpre" , & self . rtcpre ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ hsion: {=bool:?}, hsirdy: {=bool:?}, msion: {=bool:?}, msirdy: {=bool:?}, hseon: {=bool:?}, hserdy: {=bool:?}, hsebyp: {=bool:?}, pllon: {=bool:?}, pllrdy: {=bool:?}, csson: {=bool:?}, rtcpre: {:?} }}" , self . hsion () , self . hsirdy () , self . msion () , self . msirdy () , self . hseon () , self . hserdy () , self . hsebyp () , self . pllon () , self . pllrdy () , self . csson () , self . rtcpre ()) } } # [doc = "Control and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

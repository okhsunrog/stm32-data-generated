...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("en" , & self . en ()) . field ("inmsel" , & self . inmsel ()) . field ("inpsel" , & self . inpsel ()) . field ("winmode" , & self . winmode ()) . field ("winout" , & self . winout ()) . field ("polarity" , & self . polarity ()) . field ("hyst" , & self . hyst ()) . field ("pwrmode" , & self . pwrmode ()) . field ("blanksel" , & self . blanksel ()) . field ("value" , & self . value ()) . field ("lock" , & self . lock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ en: {=bool:?}, inmsel: {:?}, inpsel: {=u8:?}, winmode: {:?}, winout: {:?}, polarity: {:?}, hyst: {:?}, pwrmode: {:?}, blanksel: {:?}, value: {=bool:?}, lock: {=bool:?} }}" , self . en () , self . inmsel () , self . inpsel () , self . winmode () , self . winout () , self . polarity () , self . hyst () , self . pwrmode () , self . blanksel () , self . value () , self . lock ()) } } } pub mod vals { # [repr (u8)]
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]
pub enum Blanking { # [doc = "No blanking."]
NO_BLANKING = 0x0 , # [doc = "Check data sheet for blanking options"]
BLANK1 = 0x01 , # [doc = "Check data sheet for blanking options"]
BLANK2 = 0x02 , _RESERVED_3 = 0x03 , # [doc = "Check data sheet for blanking options"]
BLANK3 = 0x04 , _RESERVED_5 = 0x05 , _RESERVED_6 = 0x06 , _RESERVED_7 = 0x07 , _RESERVED_8 = 0x08 , _RESERVED_9 = 0x09 , _RESERVED_a = 0x0a , _RESERVED_b = 0x0b , _RESERVED_c = 0x0c , _RESERVED_d = 0x0d , _RESERVED_e = 0x0e , _RESERVED_f = 0x0f , _RESERVED_10 = 0x10 , _RESERVED_11 = 0x11 , _RESERVED_12 = 0x12 , _RESERVED_13 = 0x13 , _RESERVED_14 = 0x14 , _RESERVED_15 = 0x15 , _RESERVED_16 = 0x16 , _RESERVED_17 = 0x17 , _RESERVED_18 = 0x18 , _RESERVED_19 = 0x19 , _RESERVED_1a = 0x1a , _RESERVED_1b = 0x1b , _RESERVED_1c = 0x1c , _RESERVED_1d = 0x1d , _RESERVED_1e = 0x1e , _RESERVED_1f = 0x1f , } impl Blanking { # [inline (always)]
...
QUARTER_VREF = 0x0 , # [doc = "Inverting input set to 1/2 VRef"]
HALF_VREF = 0x01 , # [doc = "Inverting input set to 3/4 VRef"]
THREE_QUARTER_VREF = 0x02 , # [doc = "Inverting input set to VRef"]
...
NOT_INVERTED = 0x0 , # [doc = "Output is inverted."]
...
HIGH_SPEED = 0x0 , # [doc = "Medium speed / medium power."]
MEDIUM_SPEED = 0x01 , _RESERVED_2 = 0x02 , # [doc = "Very-low speed / ultra-low power."]
ULTRA_LOW = 0x03 , } impl PowerMode { # [inline (always)]
...
THIS_INPSEL = 0x0 , # [doc = "Signal selected with INPSEL\\[2:0\\]
bitfield of the other register (required for window mode)."]
OTHER_INPSEL = 0x01 , } impl WindowMode { # [inline (always)]
...
COMP1_VALUE_XOR_COMP2_VALUE = 0x01 , } impl WindowOut { # [inline (always)]

...
fn default () -> Ahb1enr { Ahb1enr (0) } } impl core :: fmt :: Debug for Ahb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1enr") . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("dmamux1en" , & self . dmamux1en ()) . field ("cordicen" , & self . cordicen ()) . field ("fmacen" , & self . fmacen ()) . field ("flashen" , & self . flashen ()) . field ("crcen" , & self . crcen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1enr {{ dma1en: {=bool:?}, dma2en: {=bool:?}, dmamux1en: {=bool:?}, cordicen: {=bool:?}, fmacen: {=bool:?}, flashen: {=bool:?}, crcen: {=bool:?} }}" , self . dma1en () , self . dma2en () , self . dmamux1en () , self . cordicen () , self . fmacen () , self . flashen () , self . crcen ()) } } # [doc = "AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb1rstr { Ahb1rstr (0) } } impl core :: fmt :: Debug for Ahb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1rstr") . field ("dma1rst" , & self . dma1rst ()) . field ("dma2rst" , & self . dma2rst ()) . field ("dmamux1rst" , & self . dmamux1rst ()) . field ("cordicrst" , & self . cordicrst ()) . field ("fmacrst" , & self . fmacrst ()) . field ("flashrst" , & self . flashrst ()) . field ("crcrst" , & self . crcrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1rstr {{ dma1rst: {=bool:?}, dma2rst: {=bool:?}, dmamux1rst: {=bool:?}, cordicrst: {=bool:?}, fmacrst: {=bool:?}, flashrst: {=bool:?}, crcrst: {=bool:?} }}" , self . dma1rst () , self . dma2rst () , self . dmamux1rst () , self . cordicrst () , self . fmacrst () , self . flashrst () , self . crcrst ()) } } # [doc = "AHB1 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb1smenr { Ahb1smenr (0) } } impl core :: fmt :: Debug for Ahb1smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1smenr") . field ("dma1smen" , & self . dma1smen ()) . field ("dma2smen" , & self . dma2smen ()) . field ("dmamux1smen" , & self . dmamux1smen ()) . field ("cordicsmen" , & self . cordicsmen ()) . field ("fmacsmen" , & self . fmacsmen ()) . field ("flashsmen" , & self . flashsmen ()) . field ("sram1smen" , & self . sram1smen ()) . field ("crcsmen" , & self . crcsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1smenr {{ dma1smen: {=bool:?}, dma2smen: {=bool:?}, dmamux1smen: {=bool:?}, cordicsmen: {=bool:?}, fmacsmen: {=bool:?}, flashsmen: {=bool:?}, sram1smen: {=bool:?}, crcsmen: {=bool:?} }}" , self . dma1smen () , self . dma2smen () , self . dmamux1smen () , self . cordicsmen () , self . fmacsmen () , self . flashsmen () , self . sram1smen () , self . crcsmen ()) } } # [doc = "AHB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2enr { Ahb2enr (0) } } impl core :: fmt :: Debug for Ahb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2enr") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpioden" , & self . gpioden ()) . field ("gpioeen" , & self . gpioeen ()) . field ("gpiofen" , & self . gpiofen ()) . field ("gpiogen" , & self . gpiogen ()) . field ("adc12en" , & self . adc12en ()) . field ("adc345en" , & self . adc345en ()) . field ("dac1en" , & self . dac1en ()) . field ("dac2en" , & self . dac2en ()) . field ("dac3en" , & self . dac3en ()) . field ("dac4en" , & self . dac4en ()) . field ("aesen" , & self . aesen ()) . field ("rngen" , & self . rngen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2enr {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpioeen: {=bool:?}, gpiofen: {=bool:?}, gpiogen: {=bool:?}, adc12en: {=bool:?}, adc345en: {=bool:?}, dac1en: {=bool:?}, dac2en: {=bool:?}, dac3en: {=bool:?}, dac4en: {=bool:?}, aesen: {=bool:?}, rngen: {=bool:?} }}" , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpioden () , self . gpioeen () , self . gpiofen () , self . gpiogen () , self . adc12en () , self . adc345en () , self . dac1en () , self . dac2en () , self . dac3en () , self . dac4en () , self . aesen () , self . rngen ()) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2rstr { Ahb2rstr (0) } } impl core :: fmt :: Debug for Ahb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2rstr") . field ("gpioarst" , & self . gpioarst ()) . field ("gpiobrst" , & self . gpiobrst ()) . field ("gpiocrst" , & self . gpiocrst ()) . field ("gpiodrst" , & self . gpiodrst ()) . field ("gpioerst" , & self . gpioerst ()) . field ("gpiofrst" , & self . gpiofrst ()) . field ("gpiogrst" , & self . gpiogrst ()) . field ("adc12rst" , & self . adc12rst ()) . field ("adc345rst" , & self . adc345rst ()) . field ("dac1rst" , & self . dac1rst ()) . field ("dac2rst" , & self . dac2rst ()) . field ("dac3rst" , & self . dac3rst ()) . field ("dac4rst" , & self . dac4rst ()) . field ("aesrst" , & self . aesrst ()) . field ("rngrst" , & self . rngrst ()) . finish () } } # [cfg (feature = "defmt")]
...
fn default () -> Ahb2smenr { Ahb2smenr (0) } } impl core :: fmt :: Debug for Ahb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2smenr") . field ("gpioasmen" , & self . gpioasmen ()) . field ("gpiobsmen" , & self . gpiobsmen ()) . field ("gpiocsmen" , & self . gpiocsmen ()) . field ("gpiodsmen" , & self . gpiodsmen ()) . field ("gpioesmen" , & self . gpioesmen ()) . field ("gpiofsmen" , & self . gpiofsmen ()) . field ("gpiogsmen" , & self . gpiogsmen ()) . field ("ccmsramsmen" , & self . ccmsramsmen ()) . field ("sram2smen" , & self . sram2smen ()) . field ("adc12smen" , & self . adc12smen ()) . field ("adc345smen" , & self . adc345smen ()) . field ("dac1smen" , & self . dac1smen ()) . field ("dac2smen" , & self . dac2smen ()) . field ("dac3smen" , & self . dac3smen ()) . field ("dac4smen" , & self . dac4smen ()) . field ("aesmen" , & self . aesmen ()) . field ("rngen" , & self . rngen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2smenr {{ gpioasmen: {=bool:?}, gpiobsmen: {=bool:?}, gpiocsmen: {=bool:?}, gpiodsmen: {=bool:?}, gpioesmen: {=bool:?}, gpiofsmen: {=bool:?}, gpiogsmen: {=bool:?}, ccmsramsmen: {=bool:?}, sram2smen: {=bool:?}, adc12smen: {=bool:?}, adc345smen: {=bool:?}, dac1smen: {=bool:?}, dac2smen: {=bool:?}, dac3smen: {=bool:?}, dac4smen: {=bool:?}, aesmen: {=bool:?}, rngen: {=bool:?} }}" , self . gpioasmen () , self . gpiobsmen () , self . gpiocsmen () , self . gpiodsmen () , self . gpioesmen () , self . gpiofsmen () , self . gpiogsmen () , self . ccmsramsmen () , self . sram2smen () , self . adc12smen () , self . adc345smen () , self . dac1smen () , self . dac2smen () , self . dac3smen () , self . dac4smen () , self . aesmen () , self . rngen ()) } } # [doc = "AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr1 { Apb1enr1 (0) } } impl core :: fmt :: Debug for Apb1enr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr1") . field ("tim2en" , & self . tim2en ()) . field ("tim3en" , & self . tim3en ()) . field ("tim4en" , & self . tim4en ()) . field ("tim5en" , & self . tim5en ()) . field ("tim6en" , & self . tim6en ()) . field ("tim7en" , & self . tim7en ()) . field ("crsen" , & self . crsen ()) . field ("rtcapben" , & self . rtcapben ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("spi3en" , & self . spi3en ()) . field ("usart2en" , & self . usart2en ()) . field ("usart3en" , & self . usart3en ()) . field ("uart4en" , & self . uart4en ()) . field ("uart5en" , & self . uart5en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("usben" , & self . usben ()) . field ("fdcanen" , & self . fdcanen ()) . field ("pwren" , & self . pwren ()) . field ("i2c3en" , & self . i2c3en ()) . field ("lptim1en" , & self . lptim1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr1 {{ tim2en: {=bool:?}, tim3en: {=bool:?}, tim4en: {=bool:?}, tim5en: {=bool:?}, tim6en: {=bool:?}, tim7en: {=bool:?}, crsen: {=bool:?}, rtcapben: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, spi3en: {=bool:?}, usart2en: {=bool:?}, usart3en: {=bool:?}, uart4en: {=bool:?}, uart5en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, usben: {=bool:?}, fdcanen: {=bool:?}, pwren: {=bool:?}, i2c3en: {=bool:?}, lptim1en: {=bool:?} }}" , self . tim2en () , self . tim3en () , self . tim4en () , self . tim5en () , self . tim6en () , self . tim7en () , self . crsen () , self . rtcapben () , self . wwdgen () , self . spi2en () , self . spi3en () , self . usart2en () , self . usart3en () , self . uart4en () , self . uart5en () , self . i2c1en () , self . i2c2en () , self . usben () , self . fdcanen () , self . pwren () , self . i2c3en () , self . lptim1en ()) } } # [doc = "APB1 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr2 { Apb1enr2 (0) } } impl core :: fmt :: Debug for Apb1enr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr2") . field ("lpuart1en" , & self . lpuart1en ()) . field ("i2c4en" , & self . i2c4en ()) . field ("ucpd1en" , & self . ucpd1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr2 {{ lpuart1en: {=bool:?}, i2c4en: {=bool:?}, ucpd1en: {=bool:?} }}" , self . lpuart1en () , self . i2c4en () , self . ucpd1en ()) } } # [doc = "APB1 peripheral reset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr1 { Apb1rstr1 (0) } } impl core :: fmt :: Debug for Apb1rstr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr1") . field ("tim2rst" , & self . tim2rst ()) . field ("tim3rst" , & self . tim3rst ()) . field ("tim4rst" , & self . tim4rst ()) . field ("tim5rst" , & self . tim5rst ()) . field ("tim6rst" , & self . tim6rst ()) . field ("tim7rst" , & self . tim7rst ()) . field ("crsrst" , & self . crsrst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("spi3rst" , & self . spi3rst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("usart3rst" , & self . usart3rst ()) . field ("uart4rst" , & self . uart4rst ()) . field ("uart5rst" , & self . uart5rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("usbrst" , & self . usbrst ()) . field ("fdcanrst" , & self . fdcanrst ()) . field ("pwrrst" , & self . pwrrst ()) . field ("i2c3rst" , & self . i2c3rst ()) . field ("lptim1rst" , & self . lptim1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr1 {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim4rst: {=bool:?}, tim5rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, crsrst: {=bool:?}, spi2rst: {=bool:?}, spi3rst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, uart4rst: {=bool:?}, uart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, usbrst: {=bool:?}, fdcanrst: {=bool:?}, pwrrst: {=bool:?}, i2c3rst: {=bool:?}, lptim1rst: {=bool:?} }}" , self . tim2rst () , self . tim3rst () , self . tim4rst () , self . tim5rst () , self . tim6rst () , self . tim7rst () , self . crsrst () , self . spi2rst () , self . spi3rst () , self . usart2rst () , self . usart3rst () , self . uart4rst () , self . uart5rst () , self . i2c1rst () , self . i2c2rst () , self . usbrst () , self . fdcanrst () , self . pwrrst () , self . i2c3rst () , self . lptim1rst ()) } } # [doc = "APB1 peripheral reset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr2 { Apb1rstr2 (0) } } impl core :: fmt :: Debug for Apb1rstr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr2") . field ("lpuart1rst" , & self . lpuart1rst ()) . field ("i2c4rst" , & self . i2c4rst ()) . field ("ucpd1rst" , & self . ucpd1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr2 {{ lpuart1rst: {=bool:?}, i2c4rst: {=bool:?}, ucpd1rst: {=bool:?} }}" , self . lpuart1rst () , self . i2c4rst () , self . ucpd1rst ()) } } # [doc = "APB1SMENR1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1smenr1 { Apb1smenr1 (0) } } impl core :: fmt :: Debug for Apb1smenr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1smenr1") . field ("tim2smen" , & self . tim2smen ()) . field ("tim3smen" , & self . tim3smen ()) . field ("tim4smen" , & self . tim4smen ()) . field ("tim5smen" , & self . tim5smen ()) . field ("tim6smen" , & self . tim6smen ()) . field ("tim7smen" , & self . tim7smen ()) . field ("crssmen" , & self . crssmen ()) . field ("rtcapbsmen" , & self . rtcapbsmen ()) . field ("wwdgsmen" , & self . wwdgsmen ()) . field ("spi2smen" , & self . spi2smen ()) . field ("sp3smen" , & self . sp3smen ()) . field ("usart2smen" , & self . usart2smen ()) . field ("usart3smen" , & self . usart3smen ()) . field ("uart4smen" , & self . uart4smen ()) . field ("uart5smen" , & self . uart5smen ()) . field ("i2c1smen" , & self . i2c1smen ()) . field ("i2c2smen" , & self . i2c2smen ()) . field ("usbsmen" , & self . usbsmen ()) . field ("fdcansmen" , & self . fdcansmen ()) . field ("pwrsmen" , & self . pwrsmen ()) . field ("i2c3smen" , & self . i2c3smen ()) . field ("lptim1smen" , & self . lptim1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1smenr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1smenr1 {{ tim2smen: {=bool:?}, tim3smen: {=bool:?}, tim4smen: {=bool:?}, tim5smen: {=bool:?}, tim6smen: {=bool:?}, tim7smen: {=bool:?}, crssmen: {=bool:?}, rtcapbsmen: {=bool:?}, wwdgsmen: {=bool:?}, spi2smen: {=bool:?}, sp3smen: {=bool:?}, usart2smen: {=bool:?}, usart3smen: {=bool:?}, uart4smen: {=bool:?}, uart5smen: {=bool:?}, i2c1smen: {=bool:?}, i2c2smen: {=bool:?}, usbsmen: {=bool:?}, fdcansmen: {=bool:?}, pwrsmen: {=bool:?}, i2c3smen: {=bool:?}, lptim1smen: {=bool:?} }}" , self . tim2smen () , self . tim3smen () , self . tim4smen () , self . tim5smen () , self . tim6smen () , self . tim7smen () , self . crssmen () , self . rtcapbsmen () , self . wwdgsmen () , self . spi2smen () , self . sp3smen () , self . usart2smen () , self . usart3smen () , self . uart4smen () , self . uart5smen () , self . i2c1smen () , self . i2c2smen () , self . usbsmen () , self . fdcansmen () , self . pwrsmen () , self . i2c3smen () , self . lptim1smen ()) } } # [doc = "APB1 peripheral clocks enable in Sleep and Stop modes register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1smenr2 { Apb1smenr2 (0) } } impl core :: fmt :: Debug for Apb1smenr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1smenr2") . field ("lpuart1smen" , & self . lpuart1smen ()) . field ("i2c4smen" , & self . i2c4smen ()) . field ("ucpd1smen" , & self . ucpd1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1smenr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1smenr2 {{ lpuart1smen: {=bool:?}, i2c4smen: {=bool:?}, ucpd1smen: {=bool:?} }}" , self . lpuart1smen () , self . i2c4smen () , self . ucpd1smen ()) } } # [doc = "APB2ENR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("syscfgen" , & self . syscfgen ()) . field ("tim1en" , & self . tim1en ()) . field ("spi1en" , & self . spi1en ()) . field ("tim8en" , & self . tim8en ()) . field ("usart1en" , & self . usart1en ()) . field ("spi4en" , & self . spi4en ()) . field ("tim15en" , & self . tim15en ()) . field ("tim16en" , & self . tim16en ()) . field ("tim17en" , & self . tim17en ()) . field ("tim20en" , & self . tim20en ()) . field ("sai1en" , & self . sai1en ()) . field ("hrtim1en" , & self . hrtim1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ syscfgen: {=bool:?}, tim1en: {=bool:?}, spi1en: {=bool:?}, tim8en: {=bool:?}, usart1en: {=bool:?}, spi4en: {=bool:?}, tim15en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?}, tim20en: {=bool:?}, sai1en: {=bool:?}, hrtim1en: {=bool:?} }}" , self . syscfgen () , self . tim1en () , self . spi1en () , self . tim8en () , self . usart1en () , self . spi4en () , self . tim15en () , self . tim16en () , self . tim17en () , self . tim20en () , self . sai1en () , self . hrtim1en ()) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("syscfgrst" , & self . syscfgrst ()) . field ("tim1rst" , & self . tim1rst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("tim8rst" , & self . tim8rst ()) . field ("usart1rst" , & self . usart1rst ()) . field ("spi4rst" , & self . spi4rst ()) . field ("tim15rst" , & self . tim15rst ()) . field ("tim16rst" , & self . tim16rst ()) . field ("tim17rst" , & self . tim17rst ()) . field ("tim20rst" , & self . tim20rst ()) . field ("sai1rst" , & self . sai1rst ()) . field ("hrtim1rst" , & self . hrtim1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ syscfgrst: {=bool:?}, tim1rst: {=bool:?}, spi1rst: {=bool:?}, tim8rst: {=bool:?}, usart1rst: {=bool:?}, spi4rst: {=bool:?}, tim15rst: {=bool:?}, tim16rst: {=bool:?}, tim17rst: {=bool:?}, tim20rst: {=bool:?}, sai1rst: {=bool:?}, hrtim1rst: {=bool:?} }}" , self . syscfgrst () , self . tim1rst () , self . spi1rst () , self . tim8rst () , self . usart1rst () , self . spi4rst () , self . tim15rst () , self . tim16rst () , self . tim17rst () , self . tim20rst () , self . sai1rst () , self . hrtim1rst ()) } } # [doc = "APB2SMENR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2smenr { Apb2smenr (0) } } impl core :: fmt :: Debug for Apb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2smenr") . field ("syscfgsmen" , & self . syscfgsmen ()) . field ("tim1smen" , & self . tim1smen ()) . field ("spi1smen" , & self . spi1smen ()) . field ("tim8smen" , & self . tim8smen ()) . field ("usart1smen" , & self . usart1smen ()) . field ("spi4smen" , & self . spi4smen ()) . field ("tim15smen" , & self . tim15smen ()) . field ("tim16smen" , & self . tim16smen ()) . field ("tim17smen" , & self . tim17smen ()) . field ("tim20smen" , & self . tim20smen ()) . field ("sai1smen" , & self . sai1smen ()) . field ("hrtim1smen" , & self . hrtim1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2smenr {{ syscfgsmen: {=bool:?}, tim1smen: {=bool:?}, spi1smen: {=bool:?}, tim8smen: {=bool:?}, usart1smen: {=bool:?}, spi4smen: {=bool:?}, tim15smen: {=bool:?}, tim16smen: {=bool:?}, tim17smen: {=bool:?}, tim20smen: {=bool:?}, sai1smen: {=bool:?}, hrtim1smen: {=bool:?} }}" , self . syscfgsmen () , self . tim1smen () , self . spi1smen () , self . tim8smen () , self . usart1smen () , self . spi4smen () , self . tim15smen () , self . tim16smen () , self . tim17smen () , self . tim20smen () , self . sai1smen () , self . hrtim1smen ()) } } # [doc = "BDCR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccipr2 { Ccipr2 (0) } } impl core :: fmt :: Debug for Ccipr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccipr2") . field ("i2c4sel" , & self . i2c4sel ()) . field ("quadspisel" , & self . quadspisel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccipr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccipr2 {{ i2c4sel: {=u8:?}, quadspisel: {=u8:?} }}" , self . i2c4sel () , self . quadspisel ()) } } # [doc = "Clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr { Cfgr (0) } } impl core :: fmt :: Debug for Cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr") . field ("sw" , & self . sw ()) . field ("sws" , & self . sws ()) . field ("hpre" , & self . hpre ()) . field ("ppre1" , & self . ppre1 ()) . field ("ppre2" , & self . ppre2 ()) . field ("mcosel" , & self . mcosel ()) . field ("mcopre" , & self . mcopre ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr {{ sw: {:?}, sws: {:?}, hpre: {:?}, ppre1: {:?}, ppre2: {:?}, mcosel: {:?}, mcopre: {:?} }}" , self . sw () , self . sws () , self . hpre () , self . ppre1 () , self . ppre2 () , self . mcosel () , self . mcopre ()) } } # [doc = "Clock interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cicr { Cicr (0) } } impl core :: fmt :: Debug for Cicr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cicr") . field ("lsirdyc" , & self . lsirdyc ()) . field ("lserdyc" , & self . lserdyc ()) . field ("hsirdyc" , & self . hsirdyc ()) . field ("hserdyc" , & self . hserdyc ()) . field ("pllrdyc" , & self . pllrdyc ()) . field ("cssc" , & self . cssc ()) . field ("lsecssc" , & self . lsecssc ()) . field ("hsi48rdyc" , & self . hsi48rdyc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cicr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cicr {{ lsirdyc: {=bool:?}, lserdyc: {=bool:?}, hsirdyc: {=bool:?}, hserdyc: {=bool:?}, pllrdyc: {=bool:?}, cssc: {=bool:?}, lsecssc: {=bool:?}, hsi48rdyc: {=bool:?} }}" , self . lsirdyc () , self . lserdyc () , self . hsirdyc () , self . hserdyc () , self . pllrdyc () , self . cssc () , self . lsecssc () , self . hsi48rdyc ()) } } # [doc = "Clock interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cier { Cier (0) } } impl core :: fmt :: Debug for Cier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cier") . field ("lsirdyie" , & self . lsirdyie ()) . field ("lserdyie" , & self . lserdyie ()) . field ("hsirdyie" , & self . hsirdyie ()) . field ("hserdyie" , & self . hserdyie ()) . field ("pllrdyie" , & self . pllrdyie ()) . field ("lsecssie" , & self . lsecssie ()) . field ("hsi48rdyie" , & self . hsi48rdyie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cier {{ lsirdyie: {=bool:?}, lserdyie: {=bool:?}, hsirdyie: {=bool:?}, hserdyie: {=bool:?}, pllrdyie: {=bool:?}, lsecssie: {=bool:?}, hsi48rdyie: {=bool:?} }}" , self . lsirdyie () , self . lserdyie () , self . hsirdyie () , self . hserdyie () , self . pllrdyie () , self . lsecssie () , self . hsi48rdyie ()) } } # [doc = "Clock interrupt flag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("hsion" , & self . hsion ()) . field ("hsikeron" , & self . hsikeron ()) . field ("hsirdy" , & self . hsirdy ()) . field ("hseon" , & self . hseon ()) . field ("hserdy" , & self . hserdy ()) . field ("hsebyp" , & self . hsebyp ()) . field ("csson" , & self . csson ()) . field ("pllon" , & self . pllon ()) . field ("pllrdy" , & self . pllrdy ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ hsion: {=bool:?}, hsikeron: {=bool:?}, hsirdy: {=bool:?}, hseon: {=bool:?}, hserdy: {=bool:?}, hsebyp: {=bool:?}, csson: {=bool:?}, pllon: {=bool:?}, pllrdy: {=bool:?} }}" , self . hsion () , self . hsikeron () , self . hsirdy () , self . hseon () , self . hserdy () , self . hsebyp () , self . csson () , self . pllon () , self . pllrdy ()) } } # [doc = "Clock recovery RC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("lsion" , & self . lsion ()) . field ("lsirdy" , & self . lsirdy ()) . field ("rmvf" , & self . rmvf ()) . field ("oblrstf" , & self . oblrstf ()) . field ("pinrstf" , & self . pinrstf ()) . field ("borrstf" , & self . borrstf ()) . field ("sftrstf" , & self . sftrstf ()) . field ("iwdgrstf" , & self . iwdgrstf ()) . field ("wwdgrstf" , & self . wwdgrstf ()) . field ("lpwrrstf" , & self . lpwrrstf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ lsion: {=bool:?}, lsirdy: {=bool:?}, rmvf: {=bool:?}, oblrstf: {=bool:?}, pinrstf: {=bool:?}, borrstf: {=bool:?}, sftrstf: {=bool:?}, iwdgrstf: {=bool:?}, wwdgrstf: {=bool:?}, lpwrrstf: {=bool:?} }}" , self . lsion () , self . lsirdy () , self . rmvf () , self . oblrstf () , self . pinrstf () , self . borrstf () , self . sftrstf () , self . iwdgrstf () , self . wwdgrstf () , self . lpwrrstf ()) } } # [doc = "Internal clock sources calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icscr { Icscr (0) } } impl core :: fmt :: Debug for Icscr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icscr") . field ("hsical0" , & self . hsical0 ()) . field ("hsitrim" , & self . hsitrim ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icscr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icscr {{ hsical0: {=u8:?}, hsitrim: {=u8:?} }}" , self . hsical0 () , self . hsitrim ()) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pllcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pllcfgr {{ pllsrc: {:?}, pllm: {:?}, plln: {:?}, pllpen: {=bool:?}, pllpbit: {:?}, pllqen: {=bool:?}, pllq: {:?}, pllren: {=bool:?}, pllr: {:?}, pllp: {:?} }}" , self . pllsrc () , self . pllm () , self . plln () , self . pllpen () , self . pllpbit () , self . pllqen () , self . pllq () , self . pllren () , self . pllr () , self . pllp ()) } } } pub mod vals { # [repr (u8)]
...
HSE_DIV_32 = 0x03 , } impl Rtcsel { # [inline (always)]

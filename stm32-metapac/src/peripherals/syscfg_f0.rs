...
fn default () -> Cfgr1 { Cfgr1 (0) } } impl core :: fmt :: Debug for Cfgr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr1") . field ("mem_mode" , & self . mem_mode ()) . field ("pa11_pa12_rmp" , & self . pa11_pa12_rmp ()) . field ("ir_mod" , & self . ir_mod ()) . field ("adc_dma_rmp" , & self . adc_dma_rmp ()) . field ("usart1_tx_dma_rmp" , & self . usart1_tx_dma_rmp ()) . field ("usart1_rx_dma_rmp" , & self . usart1_rx_dma_rmp ()) . field ("tim16_dma_rmp" , & self . tim16_dma_rmp ()) . field ("tim17_dma_rmp" , & self . tim17_dma_rmp ()) . field ("tim16_dma_rmp2" , & self . tim16_dma_rmp2 ()) . field ("tim17_dma_rmp2" , & self . tim17_dma_rmp2 ()) . field ("i2c_pb6_fmp" , & self . i2c_pb6_fmp ()) . field ("i2c_pb7_fmp" , & self . i2c_pb7_fmp ()) . field ("i2c_pb8_fmp" , & self . i2c_pb8_fmp ()) . field ("i2c_pb9_fmp" , & self . i2c_pb9_fmp ()) . field ("i2c1_fmp" , & self . i2c1_fmp ()) . field ("i2c2_fmp" , & self . i2c2_fmp ()) . field ("i2c_pa9_fmp" , & self . i2c_pa9_fmp ()) . field ("i2c_pa10_fmp" , & self . i2c_pa10_fmp ()) . field ("spi2_dma_rmp" , & self . spi2_dma_rmp ()) . field ("usart2_dma_rmp" , & self . usart2_dma_rmp ()) . field ("usart3_dma_rmp" , & self . usart3_dma_rmp ()) . field ("i2c1_dma_rmp" , & self . i2c1_dma_rmp ()) . field ("tim1_dma_rmp" , & self . tim1_dma_rmp ()) . field ("tim2_dma_rmp" , & self . tim2_dma_rmp ()) . field ("tim3_dma_rmp" , & self . tim3_dma_rmp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr1 {{ mem_mode: {:?}, pa11_pa12_rmp: {=bool:?}, ir_mod: {:?}, adc_dma_rmp: {=bool:?}, usart1_tx_dma_rmp: {=bool:?}, usart1_rx_dma_rmp: {=bool:?}, tim16_dma_rmp: {=bool:?}, tim17_dma_rmp: {=bool:?}, tim16_dma_rmp2: {=bool:?}, tim17_dma_rmp2: {=bool:?}, i2c_pb6_fmp: {:?}, i2c_pb7_fmp: {:?}, i2c_pb8_fmp: {:?}, i2c_pb9_fmp: {:?}, i2c1_fmp: {:?}, i2c2_fmp: {:?}, i2c_pa9_fmp: {:?}, i2c_pa10_fmp: {:?}, spi2_dma_rmp: {=bool:?}, usart2_dma_rmp: {=bool:?}, usart3_dma_rmp: {=bool:?}, i2c1_dma_rmp: {=bool:?}, tim1_dma_rmp: {=bool:?}, tim2_dma_rmp: {=bool:?}, tim3_dma_rmp: {=bool:?} }}" , self . mem_mode () , self . pa11_pa12_rmp () , self . ir_mod () , self . adc_dma_rmp () , self . usart1_tx_dma_rmp () , self . usart1_rx_dma_rmp () , self . tim16_dma_rmp () , self . tim17_dma_rmp () , self . tim16_dma_rmp2 () , self . tim17_dma_rmp2 () , self . i2c_pb6_fmp () , self . i2c_pb7_fmp () , self . i2c_pb8_fmp () , self . i2c_pb9_fmp () , self . i2c1_fmp () , self . i2c2_fmp () , self . i2c_pa9_fmp () , self . i2c_pa10_fmp () , self . spi2_dma_rmp () , self . usart2_dma_rmp () , self . usart3_dma_rmp () , self . i2c1_dma_rmp () , self . tim1_dma_rmp () , self . tim2_dma_rmp () , self . tim3_dma_rmp ()) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("lockup_lock" , & self . lockup_lock ()) . field ("sram_parity_lock" , & self . sram_parity_lock ()) . field ("pvd_lock" , & self . pvd_lock ()) . field ("sram_pef" , & self . sram_pef ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ lockup_lock: {=bool:?}, sram_parity_lock: {=bool:?}, pvd_lock: {=bool:?}, sram_pef: {=bool:?} }}" , self . lockup_lock () , self . sram_parity_lock () , self . pvd_lock () , self . sram_pef ()) } } # [doc = "external interrupt configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Exticr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Exticr {{ exti[0]: {=u8:?}, exti[1]: {=u8:?}, exti[2]: {=u8:?}, exti[3]: {=u8:?} }}" , self . exti (0usize) , self . exti (1usize) , self . exti (2usize) , self . exti (3usize)) } } } pub mod vals { # [repr (u8)]

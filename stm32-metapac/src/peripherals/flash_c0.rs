...
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ pg: {=bool:?}, per: {=bool:?}, mer: {=bool:?}, pnb: {=u8:?}, strt: {=bool:?}, optstrt: {=bool:?}, fstpg: {=bool:?}, eopie: {=bool:?}, errie: {=bool:?}, rderrie: {=bool:?}, obl_launch: {=bool:?}, sec_prot: {=bool:?}, optlock: {=bool:?}, lock: {=bool:?} }}" , self . pg () , self . per () , self . mer () , self . pnb () , self . strt () , self . optstrt () , self . fstpg () , self . eopie () , self . errie () , self . rderrie () , self . obl_launch () , self . sec_prot () , self . optlock () , self . lock ()) } } # [doc = "Flash option register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pcrop1aer { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pcrop1aer {{ pcrop1a_end: {=u8:?}, pcrop_rdp: {=bool:?} }}" , self . pcrop1a_end () , self . pcrop_rdp ()) } } # [doc = "Flash PCROP zone A Start address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pcrop1asr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pcrop1asr {{ pcrop1a_strt: {=u8:?} }}" , self . pcrop1a_strt ()) } } # [doc = "Flash PCROP zone B End address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pcrop1ber { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pcrop1ber {{ pcrop1b_end: {=u8:?} }}" , self . pcrop1b_end ()) } } # [doc = "Flash PCROP zone B Start address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pcrop1bsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pcrop1bsr {{ pcrop1b_strt: {=u8:?} }}" , self . pcrop1b_strt ()) } } # [doc = "Flash Security register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Secr { Secr (0) } } impl core :: fmt :: Debug for Secr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Secr") . field ("sec_size" , & self . sec_size ()) . field ("boot_lock" , & self . boot_lock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Secr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Secr {{ sec_size: {=u8:?}, boot_lock: {=bool:?} }}" , self . sec_size () , self . boot_lock ()) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Wrp1br { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Wrp1br {{ wrp1b_strt: {=u8:?}, wrp1b_end: {=u8:?} }}" , self . wrp1b_strt () , self . wrp1b_end ()) } } } pub mod vals { # [repr (u8)]

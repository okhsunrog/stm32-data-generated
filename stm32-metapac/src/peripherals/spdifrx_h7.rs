...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("spdifen" , & self . spdifen ()) . field ("rxdmaen" , & self . rxdmaen ()) . field ("rxsteo" , & self . rxsteo ()) . field ("drfmt" , & self . drfmt ()) . field ("pmsk" , & self . pmsk ()) . field ("vmsk" , & self . vmsk ()) . field ("cumsk" , & self . cumsk ()) . field ("ptmsk" , & self . ptmsk ()) . field ("cbdmaen" , & self . cbdmaen ()) . field ("chsel" , & self . chsel ()) . field ("nbtr" , & self . nbtr ()) . field ("wfa" , & self . wfa ()) . field ("insel" , & self . insel ()) . field ("cksen" , & self . cksen ()) . field ("cksbkpen" , & self . cksbkpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ spdifen: {=u8:?}, rxdmaen: {=bool:?}, rxsteo: {=bool:?}, drfmt: {=u8:?}, pmsk: {=bool:?}, vmsk: {=bool:?}, cumsk: {=bool:?}, ptmsk: {=bool:?}, cbdmaen: {=bool:?}, chsel: {=bool:?}, nbtr: {=u8:?}, wfa: {=bool:?}, insel: {=u8:?}, cksen: {=bool:?}, cksbkpen: {=bool:?} }}" , self . spdifen () , self . rxdmaen () , self . rxsteo () , self . drfmt () , self . pmsk () , self . vmsk () , self . cumsk () , self . ptmsk () , self . cbdmaen () , self . chsel () , self . nbtr () , self . wfa () , self . insel () , self . cksen () , self . cksbkpen ()) } } # [doc = "Channel Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("usr" , & self . usr ()) . field ("cs" , & self . cs ()) . field ("sob" , & self . sob ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ usr: {=u16:?}, cs: {=u8:?}, sob: {=bool:?} }}" , self . usr () , self . cs () , self . sob ()) } } # [doc = "Debug Information register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dir { Dir (0) } } impl core :: fmt :: Debug for Dir { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dir") . field ("thi" , & self . thi ()) . field ("tlo" , & self . tlo ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dir { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dir {{ thi: {=u16:?}, tlo: {=u16:?} }}" , self . thi () , self . tlo ()) } } # [doc = "FMT0 data input register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fmt0Dr { Fmt0Dr (0) } } impl core :: fmt :: Debug for Fmt0Dr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fmt0Dr") . field ("dr" , & self . dr ()) . field ("pe" , & self . pe ()) . field ("v" , & self . v ()) . field ("u" , & self . u ()) . field ("c" , & self . c ()) . field ("pt" , & self . pt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fmt0Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fmt0Dr {{ dr: {=u32:?}, pe: {=bool:?}, v: {=bool:?}, u: {=bool:?}, c: {=bool:?}, pt: {=u8:?} }}" , self . dr () , self . pe () , self . v () , self . u () , self . c () , self . pt ()) } } # [doc = "FMT1 data input register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fmt1Dr { Fmt1Dr (0) } } impl core :: fmt :: Debug for Fmt1Dr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fmt1Dr") . field ("pe" , & self . pe ()) . field ("v" , & self . v ()) . field ("u" , & self . u ()) . field ("c" , & self . c ()) . field ("pt" , & self . pt ()) . field ("dr" , & self . dr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fmt1Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fmt1Dr {{ pe: {=bool:?}, v: {=bool:?}, u: {=bool:?}, c: {=bool:?}, pt: {=u8:?}, dr: {=u32:?} }}" , self . pe () , self . v () , self . u () , self . c () , self . pt () , self . dr ()) } } # [doc = "FMT2 data input register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fmt2Dr { Fmt2Dr (0) } } impl core :: fmt :: Debug for Fmt2Dr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fmt2Dr") . field ("drnl1" , & self . drnl1 ()) . field ("drnl2" , & self . drnl2 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fmt2Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fmt2Dr {{ drnl1: {=u16:?}, drnl2: {=u16:?} }}" , self . drnl1 () , self . drnl2 ()) } } # [doc = "Interrupt Flag Clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ifcr { Ifcr (0) } } impl core :: fmt :: Debug for Ifcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ifcr") . field ("perrcf" , & self . perrcf ()) . field ("ovrcf" , & self . ovrcf ()) . field ("sbdcf" , & self . sbdcf ()) . field ("syncdcf" , & self . syncdcf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ifcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ifcr {{ perrcf: {=bool:?}, ovrcf: {=bool:?}, sbdcf: {=bool:?}, syncdcf: {=bool:?} }}" , self . perrcf () , self . ovrcf () , self . sbdcf () , self . syncdcf ()) } } # [doc = "Interrupt mask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Imr { Imr (0) } } impl core :: fmt :: Debug for Imr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Imr") . field ("rxneie" , & self . rxneie ()) . field ("csrneie" , & self . csrneie ()) . field ("perrie" , & self . perrie ()) . field ("ovrie" , & self . ovrie ()) . field ("sblkie" , & self . sblkie ()) . field ("syncdie" , & self . syncdie ()) . field ("ifeie" , & self . ifeie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Imr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Imr {{ rxneie: {=bool:?}, csrneie: {=bool:?}, perrie: {=bool:?}, ovrie: {=bool:?}, sblkie: {=bool:?}, syncdie: {=bool:?}, ifeie: {=bool:?} }}" , self . rxneie () , self . csrneie () , self . perrie () , self . ovrie () , self . sblkie () , self . syncdie () , self . ifeie ()) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("rxne" , & self . rxne ()) . field ("csrne" , & self . csrne ()) . field ("perr" , & self . perr ()) . field ("ovr" , & self . ovr ()) . field ("sbd" , & self . sbd ()) . field ("syncd" , & self . syncd ()) . field ("ferr" , & self . ferr ()) . field ("serr" , & self . serr ()) . field ("terr" , & self . terr ()) . field ("width" , & self . width ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ rxne: {=bool:?}, csrne: {=bool:?}, perr: {=bool:?}, ovr: {=bool:?}, sbd: {=bool:?}, syncd: {=bool:?}, ferr: {=bool:?}, serr: {=bool:?}, terr: {=bool:?}, width: {=u16:?} }}" , self . rxne () , self . csrne () , self . perr () , self . ovr () , self . sbd () , self . syncd () , self . ferr () , self . serr () , self . terr () , self . width ()) } } }
...
# [inline (always)]
pub const fn privcr (self) -> crate :: common :: Reg < regs :: Privcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1cusize) as _) } } # [inline (always)]
pub const fn smcr (self) -> crate :: common :: Reg < regs :: Smcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x20usize) as _) } } # [doc = "Write protection register"]
# [inline (always)]
...
# [inline (always)]
pub const fn scr (self) -> crate :: common :: Reg < regs :: Scr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x5cusize) as _) } } } pub mod regs { # [doc = "Alarm register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Alrmr { Alrmr (0) } } impl core :: fmt :: Debug for Alrmr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Alrmr") . field ("su" , & self . su ()) . field ("st" , & self . st ()) . field ("msk1" , & self . msk1 ()) . field ("mnu" , & self . mnu ()) . field ("mnt" , & self . mnt ()) . field ("msk2" , & self . msk2 ()) . field ("hu" , & self . hu ()) . field ("ht" , & self . ht ()) . field ("pm" , & self . pm ()) . field ("msk3" , & self . msk3 ()) . field ("du" , & self . du ()) . field ("dt" , & self . dt ()) . field ("wdsel" , & self . wdsel ()) . field ("msk4" , & self . msk4 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Alrmr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Alrmr {{ su: {=u8:?}, st: {=u8:?}, msk1: {:?}, mnu: {=u8:?}, mnt: {=u8:?}, msk2: {:?}, hu: {=u8:?}, ht: {=u8:?}, pm: {:?}, msk3: {:?}, du: {=u8:?}, dt: {=u8:?}, wdsel: {:?}, msk4: {:?} }}" , self . su () , self . st () , self . msk1 () , self . mnu () , self . mnt () , self . msk2 () , self . hu () , self . ht () , self . pm () , self . msk3 () , self . du () , self . dt () , self . wdsel () , self . msk4 ()) } } # [doc = "Alarm sub second register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Alrmssr { Alrmssr (0) } } impl core :: fmt :: Debug for Alrmssr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Alrmssr") . field ("ss" , & self . ss ()) . field ("maskss" , & self . maskss ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Alrmssr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Alrmssr {{ ss: {=u16:?}, maskss: {=u8:?} }}" , self . ss () , self . maskss ()) } } # [doc = "Calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Calr { Calr (0) } } impl core :: fmt :: Debug for Calr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Calr") . field ("calm" , & self . calm ()) . field ("lpcal" , & self . lpcal ()) . field ("calw16" , & self . calw16 ()) . field ("calw8" , & self . calw8 ()) . field ("calp" , & self . calp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Calr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Calr {{ calm: {=u16:?}, lpcal: {:?}, calw16: {:?}, calw8: {:?}, calp: {:?} }}" , self . calm () , self . lpcal () , self . calw16 () , self . calw8 () , self . calp ()) } } # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("wucksel" , & self . wucksel ()) . field ("tsedge" , & self . tsedge ()) . field ("refckon" , & self . refckon ()) . field ("bypshad" , & self . bypshad ()) . field ("fmt" , & self . fmt ()) . field ("alre[0]" , & self . alre (0usize)) . field ("alre[1]" , & self . alre (1usize)) . field ("wute" , & self . wute ()) . field ("tse" , & self . tse ()) . field ("alrie[0]" , & self . alrie (0usize)) . field ("alrie[1]" , & self . alrie (1usize)) . field ("wutie" , & self . wutie ()) . field ("tsie" , & self . tsie ()) . field ("add1h" , & self . add1h ()) . field ("sub1h" , & self . sub1h ()) . field ("bkp" , & self . bkp ()) . field ("cosel" , & self . cosel ()) . field ("pol" , & self . pol ()) . field ("osel" , & self . osel ()) . field ("coe" , & self . coe ()) . field ("itse" , & self . itse ()) . field ("tampts" , & self . tampts ()) . field ("tampoe" , & self . tampoe ()) . field ("tampalrm_pu" , & self . tampalrm_pu ()) . field ("tampalrm_type" , & self . tampalrm_type ()) . field ("out2en" , & self . out2en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ wucksel: {:?}, tsedge: {:?}, refckon: {=bool:?}, bypshad: {=bool:?}, fmt: {:?}, alre[0]: {=bool:?}, alre[1]: {=bool:?}, wute: {=bool:?}, tse: {=bool:?}, alrie[0]: {=bool:?}, alrie[1]: {=bool:?}, wutie: {=bool:?}, tsie: {=bool:?}, add1h: {=bool:?}, sub1h: {=bool:?}, bkp: {=bool:?}, cosel: {:?}, pol: {:?}, osel: {:?}, coe: {=bool:?}, itse: {=bool:?}, tampts: {=bool:?}, tampoe: {=bool:?}, tampalrm_pu: {=bool:?}, tampalrm_type: {:?}, out2en: {=bool:?} }}" , self . wucksel () , self . tsedge () , self . refckon () , self . bypshad () , self . fmt () , self . alre (0usize) , self . alre (1usize) , self . wute () , self . tse () , self . alrie (0usize) , self . alrie (1usize) , self . wutie () , self . tsie () , self . add1h () , self . sub1h () , self . bkp () , self . cosel () , self . pol () , self . osel () , self . coe () , self . itse () , self . tampts () , self . tampoe () , self . tampalrm_pu () , self . tampalrm_type () , self . out2en ()) } } # [doc = "Date register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dr { Dr (0) } } impl core :: fmt :: Debug for Dr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dr") . field ("du" , & self . du ()) . field ("dt" , & self . dt ()) . field ("mu" , & self . mu ()) . field ("mt" , & self . mt ()) . field ("wdu" , & self . wdu ()) . field ("yu" , & self . yu ()) . field ("yt" , & self . yt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ du: {=u8:?}, dt: {=u8:?}, mu: {=u8:?}, mt: {=bool:?}, wdu: {=u8:?}, yu: {=u8:?}, yt: {=u8:?} }}" , self . du () , self . dt () , self . mu () , self . mt () , self . wdu () , self . yu () , self . yt ()) } } # [doc = "Initialization control and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Icsr (pub u32) ; impl Icsr { # [doc = "Alarm write enabled"]
# [inline (always)]
...
# [inline (always)]
pub fn set_alrwf (& mut self , n : usize , val : bool) { assert ! (n < 2usize) ; let offs = 0usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Wakeup timer write flag"]
# [inline (always)]
...
# [inline (always)]
pub fn set_init (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "Recalibration pending Flag"]
# [inline (always)]
...
fn default () -> Icsr { Icsr (0) } } impl core :: fmt :: Debug for Icsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icsr") . field ("alrwf[0]" , & self . alrwf (0usize)) . field ("alrwf[1]" , & self . alrwf (1usize)) . field ("wutwf" , & self . wutwf ()) . field ("shpf" , & self . shpf ()) . field ("inits" , & self . inits ()) . field ("rsf" , & self . rsf ()) . field ("initf" , & self . initf ()) . field ("init" , & self . init ()) . field ("recalpf" , & self . recalpf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icsr {{ alrwf[0]: {=bool:?}, alrwf[1]: {=bool:?}, wutwf: {=bool:?}, shpf: {=bool:?}, inits: {=bool:?}, rsf: {=bool:?}, initf: {=bool:?}, init: {=bool:?}, recalpf: {:?} }}" , self . alrwf (0usize) , self . alrwf (1usize) , self . wutwf () , self . shpf () , self . inits () , self . rsf () , self . initf () , self . init () , self . recalpf ()) } } # [doc = "Masked interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_itsmf (& mut self , val : super :: vals :: Itsmf) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val . to_bits () as u32) & 0x01) << 5usize) ; } } impl Default for Misr { # [inline (always)]
fn default () -> Misr { Misr (0) } } impl core :: fmt :: Debug for Misr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Misr") . field ("alrmf[0]" , & self . alrmf (0usize)) . field ("alrmf[1]" , & self . alrmf (1usize)) . field ("wutmf" , & self . wutmf ()) . field ("tsmf" , & self . tsmf ()) . field ("tsovmf" , & self . tsovmf ()) . field ("itsmf" , & self . itsmf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Misr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Misr {{ alrmf[0]: {:?}, alrmf[1]: {:?}, wutmf: {:?}, tsmf: {:?}, tsovmf: {:?}, itsmf: {:?} }}" , self . alrmf (0usize) , self . alrmf (1usize) , self . wutmf () , self . tsmf () , self . tsovmf () , self . itsmf ()) } } # [doc = "Prescaler register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Prer { Prer (0) } } impl core :: fmt :: Debug for Prer { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Prer") . field ("prediv_s" , & self . prediv_s ()) . field ("prediv_a" , & self . prediv_a ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Prer { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Prer {{ prediv_s: {=u16:?}, prediv_a: {=u8:?} }}" , self . prediv_s () , self . prediv_a ()) } } # [doc = "Privilege mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Privcr (pub u32) ; impl Privcr { # [doc = "ALRAPRIV"]
# [inline (always)]
pub const fn alrpriv (& self , n : usize) -> bool { assert ! (n < 2usize) ; let offs = 0usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "ALRAPRIV"]
# [inline (always)]
...
fn default () -> Privcr { Privcr (0) } } impl core :: fmt :: Debug for Privcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Privcr") . field ("alrpriv[0]" , & self . alrpriv (0usize)) . field ("alrpriv[1]" , & self . alrpriv (1usize)) . field ("wutpriv" , & self . wutpriv ()) . field ("tspriv" , & self . tspriv ()) . field ("calpriv" , & self . calpriv ()) . field ("initpriv" , & self . initpriv ()) . field ("priv_" , & self . priv_ ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Privcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Privcr {{ alrpriv[0]: {=bool:?}, alrpriv[1]: {=bool:?}, wutpriv: {=bool:?}, tspriv: {=bool:?}, calpriv: {=bool:?}, initpriv: {=bool:?}, priv_: {=bool:?} }}" , self . alrpriv (0usize) , self . alrpriv (1usize) , self . wutpriv () , self . tspriv () , self . calpriv () , self . initpriv () , self . priv_ ()) } } # [doc = "Status clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_citsf (& mut self , val : super :: vals :: Calrf) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val . to_bits () as u32) & 0x01) << 5usize) ; } } impl Default for Scr { # [inline (always)]
fn default () -> Scr { Scr (0) } } impl core :: fmt :: Debug for Scr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Scr") . field ("calrf[0]" , & self . calrf (0usize)) . field ("calrf[1]" , & self . calrf (1usize)) . field ("cwutf" , & self . cwutf ()) . field ("ctsf" , & self . ctsf ()) . field ("ctsovf" , & self . ctsovf ()) . field ("citsf" , & self . citsf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Scr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Scr {{ calrf[0]: {:?}, calrf[1]: {:?}, cwutf: {:?}, ctsf: {:?}, ctsovf: {:?}, citsf: {:?} }}" , self . calrf (0usize) , self . calrf (1usize) , self . cwutf () , self . ctsf () , self . ctsovf () , self . citsf ()) } } # [doc = "Shift control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Shiftr { Shiftr (0) } } impl core :: fmt :: Debug for Shiftr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Shiftr") . field ("subfs" , & self . subfs ()) . field ("add1s" , & self . add1s ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Shiftr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Shiftr {{ subfs: {=u16:?}, add1s: {=bool:?} }}" , self . subfs () , self . add1s ()) } } # [doc = "RTC secure mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Smcr (pub u32) ; impl Smcr { # [doc = "Alarm x protection"]
# [inline (always)]
pub const fn alrdprot (& self , n : usize) -> bool { assert ! (n < 2usize) ; let offs = 0usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Alarm x protection"]
# [inline (always)]
pub fn set_alrdprot (& mut self , n : usize , val : bool) { assert ! (n < 2usize) ; let offs = 0usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Wakeup timer protection"]
# [inline (always)]
pub const fn wutdprot (& self) -> bool { let val = (self . 0 >> 2usize) & 0x01 ; val != 0 } # [doc = "Wakeup timer protection"]
# [inline (always)]
pub fn set_wutdprot (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize) ; } # [doc = "Timestamp protection"]
# [inline (always)]
pub const fn tsdprot (& self) -> bool { let val = (self . 0 >> 3usize) & 0x01 ; val != 0 } # [doc = "Timestamp protection"]
# [inline (always)]
pub fn set_tsdprot (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize) ; } # [doc = "Shift register, daylight saving, calibration and reference clock protection"]
# [inline (always)]
pub const fn caldprot (& self) -> bool { let val = (self . 0 >> 13usize) & 0x01 ; val != 0 } # [doc = "Shift register, daylight saving, calibration and reference clock protection"]
# [inline (always)]
pub fn set_caldprot (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize) ; } # [doc = "Initialization protection"]
# [inline (always)]
pub const fn initdprot (& self) -> bool { let val = (self . 0 >> 14usize) & 0x01 ; val != 0 } # [doc = "Initialization protection"]
# [inline (always)]
pub fn set_initdprot (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize) ; } # [doc = "RTC global protection"]
# [inline (always)]
pub const fn decprot (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "RTC global protection"]
# [inline (always)]
pub fn set_decprot (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } } impl Default for Smcr { # [inline (always)]
fn default () -> Smcr { Smcr (0) } } impl core :: fmt :: Debug for Smcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smcr") . field ("alrdprot[0]" , & self . alrdprot (0usize)) . field ("alrdprot[1]" , & self . alrdprot (1usize)) . field ("wutdprot" , & self . wutdprot ()) . field ("tsdprot" , & self . tsdprot ()) . field ("caldprot" , & self . caldprot ()) . field ("initdprot" , & self . initdprot ()) . field ("decprot" , & self . decprot ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smcr {{ alrdprot[0]: {=bool:?}, alrdprot[1]: {=bool:?}, wutdprot: {=bool:?}, tsdprot: {=bool:?}, caldprot: {=bool:?}, initdprot: {=bool:?}, decprot: {=bool:?} }}" , self . alrdprot (0usize) , self . alrdprot (1usize) , self . wutdprot () , self . tsdprot () , self . caldprot () , self . initdprot () , self . decprot ()) } } # [doc = "Secure masked interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_itsmf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize) ; } } impl Default for Smisr { # [inline (always)]
fn default () -> Smisr { Smisr (0) } } impl core :: fmt :: Debug for Smisr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smisr") . field ("alrmf[0]" , & self . alrmf (0usize)) . field ("alrmf[1]" , & self . alrmf (1usize)) . field ("wutmf" , & self . wutmf ()) . field ("tsmf" , & self . tsmf ()) . field ("tsovmf" , & self . tsovmf ()) . field ("itsmf" , & self . itsmf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smisr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smisr {{ alrmf[0]: {=bool:?}, alrmf[1]: {=bool:?}, wutmf: {=bool:?}, tsmf: {=bool:?}, tsovmf: {=bool:?}, itsmf: {=bool:?} }}" , self . alrmf (0usize) , self . alrmf (1usize) , self . wutmf () , self . tsmf () , self . tsovmf () , self . itsmf ()) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_itsf (& mut self , val : super :: vals :: Itsf) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val . to_bits () as u32) & 0x01) << 5usize) ; } } impl Default for Sr { # [inline (always)]
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("alrf[0]" , & self . alrf (0usize)) . field ("alrf[1]" , & self . alrf (1usize)) . field ("wutf" , & self . wutf ()) . field ("tsf" , & self . tsf ()) . field ("tsovf" , & self . tsovf ()) . field ("itsf" , & self . itsf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ alrf[0]: {:?}, alrf[1]: {:?}, wutf: {:?}, tsf: {:?}, tsovf: {:?}, itsf: {:?} }}" , self . alrf (0usize) , self . alrf (1usize) , self . wutf () , self . tsf () , self . tsovf () , self . itsf ()) } } # [doc = "Sub second register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Ssr (pub u32) ; impl Ssr { # [doc = "Synchronous binary counter"]
# [inline (always)]
pub const fn ss (& self) -> u16 { let val = (self . 0 >> 0usize) & 0xffff ; val as u16 } # [doc = "Synchronous binary counter"]
# [inline (always)]
pub fn set_ss (& mut self , val : u16) { self . 0 = (self . 0 & ! (0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize) ; } } impl Default for Ssr { # [inline (always)]
fn default () -> Ssr { Ssr (0) } } impl core :: fmt :: Debug for Ssr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ssr") . field ("ss" , & self . ss ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ssr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ssr {{ ss: {=u16:?} }}" , self . ss ()) } } # [doc = "Time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tr { Tr (0) } } impl core :: fmt :: Debug for Tr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tr") . field ("su" , & self . su ()) . field ("st" , & self . st ()) . field ("mnu" , & self . mnu ()) . field ("mnt" , & self . mnt ()) . field ("hu" , & self . hu ()) . field ("ht" , & self . ht ()) . field ("pm" , & self . pm ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Tr {{ su: {=u8:?}, st: {=u8:?}, mnu: {=u8:?}, mnt: {=u8:?}, hu: {=u8:?}, ht: {=u8:?}, pm: {:?} }}" , self . su () , self . st () , self . mnu () , self . mnt () , self . hu () , self . ht () , self . pm ()) } } # [doc = "Timestamp date register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tsdr { Tsdr (0) } } impl core :: fmt :: Debug for Tsdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tsdr") . field ("du" , & self . du ()) . field ("dt" , & self . dt ()) . field ("mu" , & self . mu ()) . field ("mt" , & self . mt ()) . field ("wdu" , & self . wdu ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tsdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Tsdr {{ du: {=u8:?}, dt: {=u8:?}, mu: {=u8:?}, mt: {=bool:?}, wdu: {=u8:?} }}" , self . du () , self . dt () , self . mu () , self . mt () , self . wdu ()) } } # [doc = "Timestamp sub second register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tsssr { Tsssr (0) } } impl core :: fmt :: Debug for Tsssr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tsssr") . field ("ss" , & self . ss ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tsssr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Tsssr {{ ss: {=u16:?} }}" , self . ss ()) } } # [doc = "Timestamp time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tstr { Tstr (0) } } impl core :: fmt :: Debug for Tstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tstr") . field ("su" , & self . su ()) . field ("st" , & self . st ()) . field ("mnu" , & self . mnu ()) . field ("mnt" , & self . mnt ()) . field ("hu" , & self . hu ()) . field ("ht" , & self . ht ()) . field ("pm" , & self . pm ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Tstr {{ su: {=u8:?}, st: {=u8:?}, mnu: {=u8:?}, mnt: {=u8:?}, hu: {=u8:?}, ht: {=u8:?}, pm: {=bool:?} }}" , self . su () , self . st () , self . mnu () , self . mnt () , self . hu () , self . ht () , self . pm ()) } } # [doc = "Write protection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Wpr { Wpr (0) } } impl core :: fmt :: Debug for Wpr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Wpr") . field ("key" , & self . key ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Wpr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Wpr {{ key: {:?} }}" , self . key ()) } } # [doc = "Wakeup timer register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Wutr { Wutr (0) } } impl core :: fmt :: Debug for Wutr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Wutr") . field ("wut" , & self . wut ()) . field ("wutoclr" , & self . wutoclr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Wutr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Wutr {{ wut: {=u16:?}, wutoclr: {=u16:?} }}" , self . wut () , self . wutoclr ()) } } } pub mod vals { # [repr (u8)]
...
TO_MATCH = 0x0 , # [doc = "Date/day don’t care in Alarm comparison"]
NOT_MATCH = 0x01 , } impl AlrmrMsk { # [inline (always)]
...
DATE_UNITS = 0x0 , # [doc = "DU\\[3:0\\]
represents the week day. DT\\[1:0\\]
is don’t care."]
WEEK_DAY = 0x01 , } impl AlrmrWdsel { # [inline (always)]
...
NO_CHANGE = 0x0 , # [doc = "One RTCCLK pulse is effectively inserted every 2^11 pulses (frequency increased by 488.5 ppm)"]
INCREASE_FREQ = 0x01 , } impl Calp { # [inline (always)]
...
SIXTEEN_SECONDS = 0x01 , } impl Calw16 { # [inline (always)]
...
EIGHT_SECONDS = 0x01 , } impl Calw8 { # [inline (always)]
...
CAL_FREQ_512HZ = 0x0 , # [doc = "Calibration output is 1 Hz (with default prescaler setting)"]
CAL_FREQ_1HZ = 0x01 , } impl Cosel { # [inline (always)]
...
TIMESTAMP_EVENT = 0x01 , } impl Itsf { # [inline (always)]
...
TIMESTAMP_EVENT = 0x01 , } impl Itsmf { # [inline (always)]
...
pub struct Key (u8) ; impl Key { # [doc = "Activate write protection (any value that is not the keys)"]
pub const ACTIVATE : Self = Self (0x0) ; # [doc = "Key 2"]
pub const DEACTIVATE2 : Self = Self (0x53) ; # [doc = "Key 1"]
pub const DEACTIVATE1 : Self = Self (0xca) ; } impl Key { pub const fn from_bits (val : u8) -> Key { Self (val & 0xff) } pub const fn to_bits (self) -> u8 { self . 0 } } impl core :: fmt :: Debug for Key { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { match self . 0 { 0x0 => f . write_str ("ACTIVATE") , 0x53 => f . write_str ("DEACTIVATE2") , 0xca => f . write_str ("DEACTIVATE1") , other => core :: write ! (f , "0x{:02X}" , other) , } } } # [cfg (feature = "defmt")]
impl defmt :: Format for Key { fn format (& self , f : defmt :: Formatter) { match self . 0 { 0x0 => defmt :: write ! (f , "ACTIVATE") , 0x53 => defmt :: write ! (f , "DEACTIVATE2") , 0xca => defmt :: write ! (f , "DEACTIVATE1") , other => defmt :: write ! (f , "0x{:02X}" , other) , } } } impl From < u8 > for Key { # [inline (always)]
...
CK_APRE = 0x01 , } impl Lpcal { # [inline (always)]
...
ALARM_A = 0x01 , # [doc = "Alarm B output enabled"]
ALARM_B = 0x02 , # [doc = "Wakeup output enabled"]
...
PUSH_PULL = 0x0 , # [doc = "TAMPALRM is open-drain output"]
OPEN_DRAIN = 0x01 , } impl TampalrmType { # [inline (always)]
...
RISING_EDGE = 0x0 , # [doc = "RTC_TS input falling edge generates a time-stamp event"]
FALLING_EDGE = 0x01 , } impl Tsedge { # [inline (always)]
...
TIMESTAMP_EVENT = 0x01 , } impl Tsf { # [inline (always)]
...
TIMESTAMP_EVENT = 0x01 , } impl Tsmf { # [inline (always)]
...
CLOCK_SPARE = 0x04 , _RESERVED_5 = 0x05 , # [doc = "ck_spre (usually 1 Hz) clock is selected and 2^16 is added to the WUT counter value"]
CLOCK_SPARE_WITH_OFFSET = 0x06 , _RESERVED_7 = 0x07 , } impl Wucksel { # [inline (always)]

...
fn default () -> Cfgr { Cfgr (0) } } impl core :: fmt :: Debug for Cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr") . field ("dmaen" , & self . dmaen ()) . field ("dmacfg" , & self . dmacfg ()) . field ("res" , & self . res ()) . field ("align" , & self . align ()) . field ("extsel" , & self . extsel ()) . field ("exten" , & self . exten ()) . field ("ovrmod" , & self . ovrmod ()) . field ("cont" , & self . cont ()) . field ("autdly" , & self . autdly ()) . field ("autoff" , & self . autoff ()) . field ("discen" , & self . discen ()) . field ("discnum" , & self . discnum ()) . field ("jdiscen" , & self . jdiscen ()) . field ("jqm" , & self . jqm ()) . field ("awd1sgl" , & self . awd1sgl ()) . field ("awd1en" , & self . awd1en ()) . field ("jawd1en" , & self . jawd1en ()) . field ("jauto" , & self . jauto ()) . field ("awdch1ch" , & self . awdch1ch ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr {{ dmaen: {=bool:?}, dmacfg: {:?}, res: {:?}, align: {=bool:?}, extsel: {=u8:?}, exten: {=u8:?}, ovrmod: {=bool:?}, cont: {=bool:?}, autdly: {=bool:?}, autoff: {=bool:?}, discen: {=bool:?}, discnum: {=u8:?}, jdiscen: {=bool:?}, jqm: {=bool:?}, awd1sgl: {=bool:?}, awd1en: {=bool:?}, jawd1en: {=bool:?}, jauto: {=bool:?}, awdch1ch: {=u8:?} }}" , self . dmaen () , self . dmacfg () , self . res () , self . align () , self . extsel () , self . exten () , self . ovrmod () , self . cont () , self . autdly () , self . autoff () , self . discen () , self . discnum () , self . jdiscen () , self . jqm () , self . awd1sgl () , self . awd1en () , self . jawd1en () , self . jauto () , self . awdch1ch ()) } } # [doc = "configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("rovse" , & self . rovse ()) . field ("jovse" , & self . jovse ()) . field ("ovsr" , & self . ovsr ()) . field ("ovss" , & self . ovss ()) . field ("tovs" , & self . tovs ()) . field ("rovsm" , & self . rovsm ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ rovse: {=bool:?}, jovse: {=bool:?}, ovsr: {=u8:?}, ovss: {=u8:?}, tovs: {=bool:?}, rovsm: {=bool:?} }}" , self . rovse () , self . jovse () , self . ovsr () , self . ovss () , self . tovs () , self . rovsm ()) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Difsel { Difsel (0) } } impl core :: fmt :: Debug for Difsel { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Difsel") . field ("difsel_1_15" , & self . difsel_1_15 ()) . field ("difsel_16_18" , & self . difsel_16_18 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Difsel { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Difsel {{ difsel_1_15: {=u16:?}, difsel_16_18: {=u8:?} }}" , self . difsel_1_15 () , self . difsel_16_18 ()) } } # [doc = "regular Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ regular_data: {=u16:?} }}" , self . regular_data ()) } } # [doc = "interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_jexten (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 6usize)) | (((val as u32) & 0x03) << 6usize) ; } # [doc = "JSQ"]
# [inline (always)]
pub const fn jsq (& self , n : usize) -> u8 { assert ! (n < 4usize) ; let offs = 8usize + n * 6usize ; let val = (self . 0 >> offs) & 0x1f ; val as u8 } # [doc = "JSQ"]
# [inline (always)]
...
impl defmt :: Format for Jsqr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jsqr {{ jl: {=u8:?}, jextsel: {=u8:?}, jexten: {=u8:?}, jsq[0]: {=u8:?}, jsq[1]: {=u8:?}, jsq[2]: {=u8:?}, jsq[3]: {=u8:?} }}" , self . jl () , self . jextsel () , self . jexten () , self . jsq (0usize) , self . jsq (1usize) , self . jsq (2usize) , self . jsq (3usize)) } } # [doc = "offset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ofr { Ofr (0) } } impl core :: fmt :: Debug for Ofr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ofr") . field ("offset" , & self . offset ()) . field ("offset_ch" , & self . offset_ch ()) . field ("offset_en" , & self . offset_en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ofr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ofr {{ offset: {=u16:?}, offset_ch: {=u8:?}, offset_en: {=bool:?} }}" , self . offset () , self . offset_ch () , self . offset_en ()) } } # [doc = "sample time register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Sqr4 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sqr4 {{ sq[0]: {=u8:?}, sq[1]: {=u8:?} }}" , self . sq (0usize) , self . sq (1usize)) } } # [doc = "watchdog threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tr { Tr (0) } } impl core :: fmt :: Debug for Tr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tr") . field ("lt" , & self . lt ()) . field ("ht" , & self . ht ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Tr {{ lt: {=u16:?}, ht: {=u16:?} }}" , self . lt () , self . ht ()) } } } pub mod vals { # [repr (u8)]

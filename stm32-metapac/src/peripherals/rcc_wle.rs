...
fn default () -> Ahb3enr { Ahb3enr (0) } } impl core :: fmt :: Debug for Ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3enr") . field ("pkaen" , & self . pkaen ()) . field ("aesen" , & self . aesen ()) . field ("rngen" , & self . rngen ()) . field ("hsemen" , & self . hsemen ()) . field ("flashen" , & self . flashen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3enr {{ pkaen: {=bool:?}, aesen: {=bool:?}, rngen: {=bool:?}, hsemen: {=bool:?}, flashen: {=bool:?} }}" , self . pkaen () , self . aesen () , self . rngen () , self . hsemen () , self . flashen ()) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3rstr { Ahb3rstr (0) } } impl core :: fmt :: Debug for Ahb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3rstr") . field ("pkarst" , & self . pkarst ()) . field ("aesrst" , & self . aesrst ()) . field ("rngrst" , & self . rngrst ()) . field ("hsemrst" , & self . hsemrst ()) . field ("flashrst" , & self . flashrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3rstr {{ pkarst: {=bool:?}, aesrst: {=bool:?}, rngrst: {=bool:?}, hsemrst: {=bool:?}, flashrst: {=bool:?} }}" , self . pkarst () , self . aesrst () , self . rngrst () , self . hsemrst () , self . flashrst ()) } } # [doc = "AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Extcfgr { Extcfgr (0) } } impl core :: fmt :: Debug for Extcfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Extcfgr") . field ("shdhpre" , & self . shdhpre ()) . field ("shdhpref" , & self . shdhpref ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Extcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Extcfgr {{ shdhpre: {:?}, shdhpref: {=bool:?} }}" , self . shdhpre () , self . shdhpref ()) } } # [doc = "Internal clock sources calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

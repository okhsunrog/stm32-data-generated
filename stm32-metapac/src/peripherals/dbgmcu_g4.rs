...
fn default () -> Apb1hfzr { Apb1hfzr (0) } } impl core :: fmt :: Debug for Apb1hfzr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1hfzr") . field ("i2c4" , & self . i2c4 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1hfzr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1hfzr {{ i2c4: {=bool:?} }}" , self . i2c4 ()) } } # [doc = "APB Low Freeze Register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1lfzr { Apb1lfzr (0) } } impl core :: fmt :: Debug for Apb1lfzr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1lfzr") . field ("tim2" , & self . tim2 ()) . field ("tim3" , & self . tim3 ()) . field ("tim4" , & self . tim4 ()) . field ("tim5" , & self . tim5 ()) . field ("tim6" , & self . tim6 ()) . field ("tim7" , & self . tim7 ()) . field ("rtc" , & self . rtc ()) . field ("wwdg" , & self . wwdg ()) . field ("iwdg" , & self . iwdg ()) . field ("i2c1" , & self . i2c1 ()) . field ("i2c2" , & self . i2c2 ()) . field ("i2c3" , & self . i2c3 ()) . field ("lptimer" , & self . lptimer ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1lfzr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1lfzr {{ tim2: {=bool:?}, tim3: {=bool:?}, tim4: {=bool:?}, tim5: {=bool:?}, tim6: {=bool:?}, tim7: {=bool:?}, rtc: {=bool:?}, wwdg: {=bool:?}, iwdg: {=bool:?}, i2c1: {=bool:?}, i2c2: {=bool:?}, i2c3: {=bool:?}, lptimer: {=bool:?} }}" , self . tim2 () , self . tim3 () , self . tim4 () , self . tim5 () , self . tim6 () , self . tim7 () , self . rtc () , self . wwdg () , self . iwdg () , self . i2c1 () , self . i2c2 () , self . i2c3 () , self . lptimer ()) } } # [doc = "APB High Freeze Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2fzr { Apb2fzr (0) } } impl core :: fmt :: Debug for Apb2fzr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2fzr") . field ("tim1" , & self . tim1 ()) . field ("tim8" , & self . tim8 ()) . field ("tim15" , & self . tim15 ()) . field ("tim16" , & self . tim16 ()) . field ("tim17" , & self . tim17 ()) . field ("tim20" , & self . tim20 ()) . field ("hrtim0" , & self . hrtim0 ()) . field ("hrtim1" , & self . hrtim1 ()) . field ("hrtim2" , & self . hrtim2 ()) . field ("hrtim3" , & self . hrtim3 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2fzr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2fzr {{ tim1: {=bool:?}, tim8: {=bool:?}, tim15: {=bool:?}, tim16: {=bool:?}, tim17: {=bool:?}, tim20: {=bool:?}, hrtim0: {=bool:?}, hrtim1: {=bool:?}, hrtim2: {=bool:?}, hrtim3: {=bool:?} }}" , self . tim1 () , self . tim8 () , self . tim15 () , self . tim16 () , self . tim17 () , self . tim20 () , self . hrtim0 () , self . hrtim1 () , self . hrtim2 () , self . hrtim3 ()) } } # [doc = "Debug MCU Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ dbg_sleep: {=bool:?}, dbg_stop: {=bool:?}, dbg_standby: {=bool:?}, trace_ioen: {=bool:?}, trace_mode: {=u8:?} }}" , self . dbg_sleep () , self . dbg_stop () , self . dbg_standby () , self . trace_ioen () , self . trace_mode ()) } } # [doc = "MCU Device ID Code Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
fn default () -> C2imr1 { C2imr1 (0) } } impl core :: fmt :: Debug for C2imr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2imr1") . field ("rtcstamptamplsecssim" , & self . rtcstamptamplsecssim ()) . field ("rtcalarmim" , & self . rtcalarmim ()) . field ("rtcssruim" , & self . rtcssruim ()) . field ("rtcwkupim" , & self . rtcwkupim ()) . field ("rccim" , & self . rccim ()) . field ("flashim" , & self . flashim ()) . field ("pkaim" , & self . pkaim ()) . field ("aesim" , & self . aesim ()) . field ("compim" , & self . compim ()) . field ("adcim" , & self . adcim ()) . field ("dacim" , & self . dacim ()) . field ("exti0im" , & self . exti0im ()) . field ("exti1im" , & self . exti1im ()) . field ("exti2im" , & self . exti2im ()) . field ("exti3im" , & self . exti3im ()) . field ("exti4im" , & self . exti4im ()) . field ("exti5im" , & self . exti5im ()) . field ("exti6im" , & self . exti6im ()) . field ("exti7im" , & self . exti7im ()) . field ("exti8im" , & self . exti8im ()) . field ("exti9im" , & self . exti9im ()) . field ("exti10im" , & self . exti10im ()) . field ("exti11im" , & self . exti11im ()) . field ("exti12im" , & self . exti12im ()) . field ("exti13im" , & self . exti13im ()) . field ("exti14im" , & self . exti14im ()) . field ("exti15im" , & self . exti15im ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2imr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2imr1 {{ rtcstamptamplsecssim: {=bool:?}, rtcalarmim: {=bool:?}, rtcssruim: {=bool:?}, rtcwkupim: {=bool:?}, rccim: {=bool:?}, flashim: {=bool:?}, pkaim: {=bool:?}, aesim: {=bool:?}, compim: {=bool:?}, adcim: {=bool:?}, dacim: {=bool:?}, exti0im: {=bool:?}, exti1im: {=bool:?}, exti2im: {=bool:?}, exti3im: {=bool:?}, exti4im: {=bool:?}, exti5im: {=bool:?}, exti6im: {=bool:?}, exti7im: {=bool:?}, exti8im: {=bool:?}, exti9im: {=bool:?}, exti10im: {=bool:?}, exti11im: {=bool:?}, exti12im: {=bool:?}, exti13im: {=bool:?}, exti14im: {=bool:?}, exti15im: {=bool:?} }}" , self . rtcstamptamplsecssim () , self . rtcalarmim () , self . rtcssruim () , self . rtcwkupim () , self . rccim () , self . flashim () , self . pkaim () , self . aesim () , self . compim () , self . adcim () , self . dacim () , self . exti0im () , self . exti1im () , self . exti2im () , self . exti3im () , self . exti4im () , self . exti5im () , self . exti6im () , self . exti7im () , self . exti8im () , self . exti9im () , self . exti10im () , self . exti11im () , self . exti12im () , self . exti13im () , self . exti14im () , self . exti15im ()) } } # [doc = "SYSCFG CPU2 interrupt mask register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2imr2 { C2imr2 (0) } } impl core :: fmt :: Debug for C2imr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2imr2") . field ("dma1ch1im" , & self . dma1ch1im ()) . field ("dma1ch2im" , & self . dma1ch2im ()) . field ("dma1ch3im" , & self . dma1ch3im ()) . field ("dma1ch4im" , & self . dma1ch4im ()) . field ("dma1ch5im" , & self . dma1ch5im ()) . field ("dma1ch6im" , & self . dma1ch6im ()) . field ("dma1ch7im" , & self . dma1ch7im ()) . field ("dma2ch1im" , & self . dma2ch1im ()) . field ("dma2ch2im" , & self . dma2ch2im ()) . field ("dma2ch3im" , & self . dma2ch3im ()) . field ("dma2ch4im" , & self . dma2ch4im ()) . field ("dma2ch5im" , & self . dma2ch5im ()) . field ("dma2ch6im" , & self . dma2ch6im ()) . field ("dma2ch7im" , & self . dma2ch7im ()) . field ("dmamux1im" , & self . dmamux1im ()) . field ("pvm3im" , & self . pvm3im ()) . field ("pvdim" , & self . pvdim ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2imr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2imr2 {{ dma1ch1im: {=bool:?}, dma1ch2im: {=bool:?}, dma1ch3im: {=bool:?}, dma1ch4im: {=bool:?}, dma1ch5im: {=bool:?}, dma1ch6im: {=bool:?}, dma1ch7im: {=bool:?}, dma2ch1im: {=bool:?}, dma2ch2im: {=bool:?}, dma2ch3im: {=bool:?}, dma2ch4im: {=bool:?}, dma2ch5im: {=bool:?}, dma2ch6im: {=bool:?}, dma2ch7im: {=bool:?}, dmamux1im: {=bool:?}, pvm3im: {=bool:?}, pvdim: {=bool:?} }}" , self . dma1ch1im () , self . dma1ch2im () , self . dma1ch3im () , self . dma1ch4im () , self . dma1ch5im () , self . dma1ch6im () , self . dma1ch7im () , self . dma2ch1im () , self . dma2ch2im () , self . dma2ch3im () , self . dma2ch4im () , self . dma2ch5im () , self . dma2ch6im () , self . dma2ch7im () , self . dmamux1im () , self . pvm3im () , self . pvdim ()) } } # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ cll: {=bool:?}, spl: {=bool:?}, pvdl: {=bool:?}, eccl: {=bool:?}, spf: {=bool:?} }}" , self . cll () , self . spl () , self . pvdl () , self . eccl () , self . spf ()) } } # [doc = "external interrupt configuration register 4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Exticr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Exticr {{ exti[0]: {=u8:?}, exti[1]: {=u8:?}, exti[2]: {=u8:?}, exti[3]: {=u8:?} }}" , self . exti (0usize) , self . exti (1usize) , self . exti (2usize) , self . exti (3usize)) } } # [doc = "SYSCFG CPU1 interrupt mask register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Imr1 { Imr1 (0) } } impl core :: fmt :: Debug for Imr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Imr1") . field ("rtcstamptamplsecssim" , & self . rtcstamptamplsecssim ()) . field ("rtcssruim" , & self . rtcssruim ()) . field ("exti5im" , & self . exti5im ()) . field ("exti6im" , & self . exti6im ()) . field ("exti7im" , & self . exti7im ()) . field ("exti8im" , & self . exti8im ()) . field ("exti9im" , & self . exti9im ()) . field ("exti10im" , & self . exti10im ()) . field ("exti11im" , & self . exti11im ()) . field ("exti12im" , & self . exti12im ()) . field ("exti13im" , & self . exti13im ()) . field ("exti14im" , & self . exti14im ()) . field ("exti15im" , & self . exti15im ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Imr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Imr1 {{ rtcstamptamplsecssim: {=bool:?}, rtcssruim: {=bool:?}, exti5im: {=bool:?}, exti6im: {=bool:?}, exti7im: {=bool:?}, exti8im: {=bool:?}, exti9im: {=bool:?}, exti10im: {=bool:?}, exti11im: {=bool:?}, exti12im: {=bool:?}, exti13im: {=bool:?}, exti14im: {=bool:?}, exti15im: {=bool:?} }}" , self . rtcstamptamplsecssim () , self . rtcssruim () , self . exti5im () , self . exti6im () , self . exti7im () , self . exti8im () , self . exti9im () , self . exti10im () , self . exti11im () , self . exti12im () , self . exti13im () , self . exti14im () , self . exti15im ()) } } # [doc = "SYSCFG CPU1 interrupt mask register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Imr2 { Imr2 (0) } } impl core :: fmt :: Debug for Imr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Imr2") . field ("pvm3im" , & self . pvm3im ()) . field ("pvdim" , & self . pvdim ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Imr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Imr2 {{ pvm3im: {=bool:?}, pvdim: {=bool:?} }}" , self . pvm3im () , self . pvdim ()) } } # [doc = "memory remap register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Memrmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Memrmp {{ mem_mode: {=u8:?} }}" , self . mem_mode ()) } } # [doc = "radio debug control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Rfdcr { Rfdcr (0) } } impl core :: fmt :: Debug for Rfdcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Rfdcr") . field ("rftbsel" , & self . rftbsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Rfdcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Rfdcr {{ rftbsel: {=bool:?} }}" , self . rftbsel ()) } } # [doc = "SCSR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Scsr { Scsr (0) } } impl core :: fmt :: Debug for Scsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Scsr") . field ("sram2er" , & self . sram2er ()) . field ("srambsy" , & self . srambsy ()) . field ("pkasrambsy" , & self . pkasrambsy ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Scsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Scsr {{ sram2er: {=bool:?}, srambsy: {=bool:?}, pkasrambsy: {=bool:?} }}" , self . sram2er () , self . srambsy () , self . pkasrambsy ()) } } # [doc = "SKR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Skr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Skr {{ key: {=u8:?} }}" , self . key ()) } } # [doc = "SWPR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

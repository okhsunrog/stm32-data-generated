...
fn default () -> Cfgr1 { Cfgr1 (0) } } impl core :: fmt :: Debug for Cfgr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr1") . field ("mem_mode" , & self . mem_mode ()) . field ("ufb" , & self . ufb ()) . field ("boot_mode" , & self . boot_mode ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr1 {{ mem_mode: {=u8:?}, ufb: {=bool:?}, boot_mode: {=u8:?} }}" , self . mem_mode () , self . ufb () , self . boot_mode ()) } } # [doc = "CFGR2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("fwdis" , & self . fwdis ()) . field ("i2c_pb6_fmp" , & self . i2c_pb6_fmp ()) . field ("i2c_pb7_fmp" , & self . i2c_pb7_fmp ()) . field ("i2c_pb8_fmp" , & self . i2c_pb8_fmp ()) . field ("i2c_pb9_fmp" , & self . i2c_pb9_fmp ()) . field ("i2c1_fmp" , & self . i2c1_fmp ()) . field ("i2c2_fmp" , & self . i2c2_fmp ()) . field ("i2c3_fmp" , & self . i2c3_fmp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ fwdis: {=bool:?}, i2c_pb6_fmp: {=bool:?}, i2c_pb7_fmp: {=bool:?}, i2c_pb8_fmp: {=bool:?}, i2c_pb9_fmp: {=bool:?}, i2c1_fmp: {=bool:?}, i2c2_fmp: {=bool:?}, i2c3_fmp: {=bool:?} }}" , self . fwdis () , self . i2c_pb6_fmp () , self . i2c_pb7_fmp () , self . i2c_pb8_fmp () , self . i2c_pb9_fmp () , self . i2c1_fmp () , self . i2c2_fmp () , self . i2c3_fmp ()) } } # [doc = "CFGR3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr3 { Cfgr3 (0) } } impl core :: fmt :: Debug for Cfgr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr3") . field ("en_vrefint" , & self . en_vrefint ()) . field ("sel_vref_out" , & self . sel_vref_out ()) . field ("enbuf_vrefint_adc" , & self . enbuf_vrefint_adc ()) . field ("enbuf_sensor_adc" , & self . enbuf_sensor_adc ()) . field ("enbuf_vrefint_comp2" , & self . enbuf_vrefint_comp2 ()) . field ("enref_hsi48" , & self . enref_hsi48 ()) . field ("vrefint_rdyf" , & self . vrefint_rdyf ()) . field ("ref_lock" , & self . ref_lock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr3 {{ en_vrefint: {=bool:?}, sel_vref_out: {=u8:?}, enbuf_vrefint_adc: {=bool:?}, enbuf_sensor_adc: {=bool:?}, enbuf_vrefint_comp2: {=bool:?}, enref_hsi48: {=bool:?}, vrefint_rdyf: {=bool:?}, ref_lock: {=bool:?} }}" , self . en_vrefint () , self . sel_vref_out () , self . enbuf_vrefint_adc () , self . enbuf_sensor_adc () , self . enbuf_vrefint_comp2 () , self . enref_hsi48 () , self . vrefint_rdyf () , self . ref_lock ()) } } # [doc = "external interrupt configuration register 1-4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Exticr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Exticr {{ exti[0]: {=u8:?}, exti[1]: {=u8:?}, exti[2]: {=u8:?}, exti[3]: {=u8:?} }}" , self . exti (0usize) , self . exti (1usize) , self . exti (2usize) , self . exti (3usize)) } } }
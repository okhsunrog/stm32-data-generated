...
impl defmt :: Format for Calfact { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Calfact {{ calfact: {=u8:?} }}" , self . calfact ()) } } # [doc = "common configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccr { Ccr (0) } } impl core :: fmt :: Debug for Ccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr") . field ("presc" , & self . presc ()) . field ("vrefen" , & self . vrefen ()) . field ("tsen" , & self . tsen ()) . field ("lfmen" , & self . lfmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr {{ presc: {:?}, vrefen: {=bool:?}, tsen: {=bool:?}, lfmen: {=bool:?} }}" , self . presc () , self . vrefen () , self . tsen () , self . lfmen ()) } } # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("ovse" , & self . ovse ()) . field ("ovsr" , & self . ovsr ()) . field ("ovss" , & self . ovss ()) . field ("tovs" , & self . tovs ()) . field ("ckmode" , & self . ckmode ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ ovse: {=bool:?}, ovsr: {=u8:?}, ovss: {=u8:?}, tovs: {=bool:?}, ckmode: {:?} }}" , self . ovse () , self . ovsr () , self . ovss () , self . tovs () , self . ckmode ()) } } # [doc = "channel selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Chselr (pub u32) ; impl Chselr { # [doc = "Channel-x selection"]
# [inline (always)]
pub const fn chsel_x (& self , n : usize) -> bool { assert ! (n < 19usize) ; let offs = 0usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Channel-x selection"]
# [inline (always)]
pub fn set_chsel_x (& mut self , n : usize , val : bool) { assert ! (n < 19usize) ; let offs = 0usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Chselr { # [inline (always)]
fn default () -> Chselr { Chselr (0) } } impl core :: fmt :: Debug for Chselr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Chselr") . field ("chsel_x[0]" , & self . chsel_x (0usize)) . field ("chsel_x[1]" , & self . chsel_x (1usize)) . field ("chsel_x[2]" , & self . chsel_x (2usize)) . field ("chsel_x[3]" , & self . chsel_x (3usize)) . field ("chsel_x[4]" , & self . chsel_x (4usize)) . field ("chsel_x[5]" , & self . chsel_x (5usize)) . field ("chsel_x[6]" , & self . chsel_x (6usize)) . field ("chsel_x[7]" , & self . chsel_x (7usize)) . field ("chsel_x[8]" , & self . chsel_x (8usize)) . field ("chsel_x[9]" , & self . chsel_x (9usize)) . field ("chsel_x[10]" , & self . chsel_x (10usize)) . field ("chsel_x[11]" , & self . chsel_x (11usize)) . field ("chsel_x[12]" , & self . chsel_x (12usize)) . field ("chsel_x[13]" , & self . chsel_x (13usize)) . field ("chsel_x[14]" , & self . chsel_x (14usize)) . field ("chsel_x[15]" , & self . chsel_x (15usize)) . field ("chsel_x[16]" , & self . chsel_x (16usize)) . field ("chsel_x[17]" , & self . chsel_x (17usize)) . field ("chsel_x[18]" , & self . chsel_x (18usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Chselr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Chselr {{ chsel_x[0]: {=bool:?}, chsel_x[1]: {=bool:?}, chsel_x[2]: {=bool:?}, chsel_x[3]: {=bool:?}, chsel_x[4]: {=bool:?}, chsel_x[5]: {=bool:?}, chsel_x[6]: {=bool:?}, chsel_x[7]: {=bool:?}, chsel_x[8]: {=bool:?}, chsel_x[9]: {=bool:?}, chsel_x[10]: {=bool:?}, chsel_x[11]: {=bool:?}, chsel_x[12]: {=bool:?}, chsel_x[13]: {=bool:?}, chsel_x[14]: {=bool:?}, chsel_x[15]: {=bool:?}, chsel_x[16]: {=bool:?}, chsel_x[17]: {=bool:?}, chsel_x[18]: {=bool:?} }}" , self . chsel_x (0usize) , self . chsel_x (1usize) , self . chsel_x (2usize) , self . chsel_x (3usize) , self . chsel_x (4usize) , self . chsel_x (5usize) , self . chsel_x (6usize) , self . chsel_x (7usize) , self . chsel_x (8usize) , self . chsel_x (9usize) , self . chsel_x (10usize) , self . chsel_x (11usize) , self . chsel_x (12usize) , self . chsel_x (13usize) , self . chsel_x (14usize) , self . chsel_x (15usize) , self . chsel_x (16usize) , self . chsel_x (17usize) , self . chsel_x (18usize)) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ aden: {=bool:?}, addis: {=bool:?}, adstart: {=bool:?}, adstp: {=bool:?}, advregen: {=bool:?}, adcal: {=bool:?} }}" , self . aden () , self . addis () , self . adstart () , self . adstp () , self . advregen () , self . adcal ()) } } # [doc = "data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ data: {=u16:?} }}" , self . data ()) } } # [doc = "interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ier { Ier (0) } } impl core :: fmt :: Debug for Ier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ier") . field ("adrdyie" , & self . adrdyie ()) . field ("eosmpie" , & self . eosmpie ()) . field ("eocie" , & self . eocie ()) . field ("eosie" , & self . eosie ()) . field ("ovrie" , & self . ovrie ()) . field ("awdie" , & self . awdie ()) . field ("eocalie" , & self . eocalie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ier {{ adrdyie: {=bool:?}, eosmpie: {=bool:?}, eocie: {=bool:?}, eosie: {=bool:?}, ovrie: {=bool:?}, awdie: {=bool:?}, eocalie: {=bool:?} }}" , self . adrdyie () , self . eosmpie () , self . eocie () , self . eosie () , self . ovrie () , self . awdie () , self . eocalie ()) } } # [doc = "interrupt and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Isr { Isr (0) } } impl core :: fmt :: Debug for Isr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Isr") . field ("adrdy" , & self . adrdy ()) . field ("eosmp" , & self . eosmp ()) . field ("eoc" , & self . eoc ()) . field ("eos" , & self . eos ()) . field ("ovr" , & self . ovr ()) . field ("awd" , & self . awd ()) . field ("eocal" , & self . eocal ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Isr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Isr {{ adrdy: {=bool:?}, eosmp: {=bool:?}, eoc: {=bool:?}, eos: {=bool:?}, ovr: {=bool:?}, awd: {=bool:?}, eocal: {=bool:?} }}" , self . adrdy () , self . eosmp () , self . eoc () , self . eos () , self . ovr () , self . awd () , self . eocal ()) } } # [doc = "sampling time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr { Smpr (0) } } impl core :: fmt :: Debug for Smpr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr") . field ("smp" , & self . smp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smpr {{ smp: {:?} }}" , self . smp ()) } } # [doc = "watchdog threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

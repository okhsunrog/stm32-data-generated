...
fn default () -> Ahb2enr { Ahb2enr (0) } } impl core :: fmt :: Debug for Ahb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2enr") . field ("dcmien" , & self . dcmien ()) . field ("jpegen" , & self . jpegen ()) . field ("aesen" , & self . aesen ()) . field ("crypen" , & self . crypen ()) . field ("hashen" , & self . hashen ()) . field ("rngen" , & self . rngen ()) . field ("usb_otg_fsen" , & self . usb_otg_fsen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2enr {{ dcmien: {=bool:?}, jpegen: {=bool:?}, aesen: {=bool:?}, crypen: {=bool:?}, hashen: {=bool:?}, rngen: {=bool:?}, usb_otg_fsen: {=bool:?} }}" , self . dcmien () , self . jpegen () , self . aesen () , self . crypen () , self . hashen () , self . rngen () , self . usb_otg_fsen ()) } } # [doc = "AHB2 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2lpenr { Ahb2lpenr (0) } } impl core :: fmt :: Debug for Ahb2lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2lpenr") . field ("dcmilpen" , & self . dcmilpen ()) . field ("jpeglpen" , & self . jpeglpen ()) . field ("aeslpen" , & self . aeslpen ()) . field ("cryplpen" , & self . cryplpen ()) . field ("hashlpen" , & self . hashlpen ()) . field ("rnglpen" , & self . rnglpen ()) . field ("usb_otg_fslpen" , & self . usb_otg_fslpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2lpenr {{ dcmilpen: {=bool:?}, jpeglpen: {=bool:?}, aeslpen: {=bool:?}, cryplpen: {=bool:?}, hashlpen: {=bool:?}, rnglpen: {=bool:?}, usb_otg_fslpen: {=bool:?} }}" , self . dcmilpen () , self . jpeglpen () , self . aeslpen () , self . cryplpen () , self . hashlpen () , self . rnglpen () , self . usb_otg_fslpen ()) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2rstr { Ahb2rstr (0) } } impl core :: fmt :: Debug for Ahb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2rstr") . field ("dcmirst" , & self . dcmirst ()) . field ("aesrst" , & self . aesrst ()) . field ("cryprst" , & self . cryprst ()) . field ("hsahrst" , & self . hsahrst ()) . field ("rngrst" , & self . rngrst ()) . field ("usb_otg_fsrst" , & self . usb_otg_fsrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2rstr {{ dcmirst: {=bool:?}, aesrst: {=bool:?}, cryprst: {=bool:?}, hsahrst: {=bool:?}, rngrst: {=bool:?}, usb_otg_fsrst: {=bool:?} }}" , self . dcmirst () , self . aesrst () , self . cryprst () , self . hsahrst () , self . rngrst () , self . usb_otg_fsrst ()) } } # [doc = "AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3enr { Ahb3enr (0) } } impl core :: fmt :: Debug for Ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3enr") . field ("fmcen" , & self . fmcen ()) . field ("quadspien" , & self . quadspien ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3enr {{ fmcen: {=bool:?}, quadspien: {=bool:?} }}" , self . fmcen () , self . quadspien ()) } } # [doc = "AHB3 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3lpenr { Ahb3lpenr (0) } } impl core :: fmt :: Debug for Ahb3lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3lpenr") . field ("fmclpen" , & self . fmclpen ()) . field ("quadspilpen" , & self . quadspilpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3lpenr {{ fmclpen: {=bool:?}, quadspilpen: {=bool:?} }}" , self . fmclpen () , self . quadspilpen ()) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3rstr { Ahb3rstr (0) } } impl core :: fmt :: Debug for Ahb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3rstr") . field ("fmcrst" , & self . fmcrst ()) . field ("quadspirst" , & self . quadspirst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3rstr {{ fmcrst: {=bool:?}, quadspirst: {=bool:?} }}" , self . fmcrst () , self . quadspirst ()) } } # [doc = "APB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1lpenr { Apb1lpenr (0) } } impl core :: fmt :: Debug for Apb1lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1lpenr") . field ("tim2lpen" , & self . tim2lpen ()) . field ("tim3lpen" , & self . tim3lpen ()) . field ("tim4lpen" , & self . tim4lpen ()) . field ("tim5lpen" , & self . tim5lpen ()) . field ("tim6lpen" , & self . tim6lpen ()) . field ("tim7lpen" , & self . tim7lpen ()) . field ("tim12lpen" , & self . tim12lpen ()) . field ("tim13lpen" , & self . tim13lpen ()) . field ("tim14lpen" , & self . tim14lpen ()) . field ("lptim1lpen" , & self . lptim1lpen ()) . field ("rtclpen" , & self . rtclpen ()) . field ("wwdglpen" , & self . wwdglpen ()) . field ("can3lpen" , & self . can3lpen ()) . field ("spi2lpen" , & self . spi2lpen ()) . field ("spi3lpen" , & self . spi3lpen ()) . field ("spdifrxlpen" , & self . spdifrxlpen ()) . field ("usart2lpen" , & self . usart2lpen ()) . field ("usart3lpen" , & self . usart3lpen ()) . field ("uart4lpen" , & self . uart4lpen ()) . field ("uart5lpen" , & self . uart5lpen ()) . field ("i2c1lpen" , & self . i2c1lpen ()) . field ("i2c2lpen" , & self . i2c2lpen ()) . field ("i2c3lpen" , & self . i2c3lpen ()) . field ("i2c4lpen" , & self . i2c4lpen ()) . field ("can1lpen" , & self . can1lpen ()) . field ("can2lpen" , & self . can2lpen ()) . field ("ceclpen" , & self . ceclpen ()) . field ("pwrlpen" , & self . pwrlpen ()) . field ("daclpen" , & self . daclpen ()) . field ("uart7lpen" , & self . uart7lpen ()) . field ("uart8lpen" , & self . uart8lpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1lpenr {{ tim2lpen: {=bool:?}, tim3lpen: {=bool:?}, tim4lpen: {=bool:?}, tim5lpen: {=bool:?}, tim6lpen: {=bool:?}, tim7lpen: {=bool:?}, tim12lpen: {=bool:?}, tim13lpen: {=bool:?}, tim14lpen: {=bool:?}, lptim1lpen: {=bool:?}, rtclpen: {=bool:?}, wwdglpen: {=bool:?}, can3lpen: {=bool:?}, spi2lpen: {=bool:?}, spi3lpen: {=bool:?}, spdifrxlpen: {=bool:?}, usart2lpen: {=bool:?}, usart3lpen: {=bool:?}, uart4lpen: {=bool:?}, uart5lpen: {=bool:?}, i2c1lpen: {=bool:?}, i2c2lpen: {=bool:?}, i2c3lpen: {=bool:?}, i2c4lpen: {=bool:?}, can1lpen: {=bool:?}, can2lpen: {=bool:?}, ceclpen: {=bool:?}, pwrlpen: {=bool:?}, daclpen: {=bool:?}, uart7lpen: {=bool:?}, uart8lpen: {=bool:?} }}" , self . tim2lpen () , self . tim3lpen () , self . tim4lpen () , self . tim5lpen () , self . tim6lpen () , self . tim7lpen () , self . tim12lpen () , self . tim13lpen () , self . tim14lpen () , self . lptim1lpen () , self . rtclpen () , self . wwdglpen () , self . can3lpen () , self . spi2lpen () , self . spi3lpen () , self . spdifrxlpen () , self . usart2lpen () , self . usart3lpen () , self . uart4lpen () , self . uart5lpen () , self . i2c1lpen () , self . i2c2lpen () , self . i2c3lpen () , self . i2c4lpen () , self . can1lpen () , self . can2lpen () , self . ceclpen () , self . pwrlpen () , self . daclpen () , self . uart7lpen () , self . uart8lpen ()) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr { Apb1rstr (0) } } impl core :: fmt :: Debug for Apb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr") . field ("tim2rst" , & self . tim2rst ()) . field ("tim3rst" , & self . tim3rst ()) . field ("tim4rst" , & self . tim4rst ()) . field ("tim5rst" , & self . tim5rst ()) . field ("tim6rst" , & self . tim6rst ()) . field ("tim7rst" , & self . tim7rst ()) . field ("tim12rst" , & self . tim12rst ()) . field ("tim13rst" , & self . tim13rst ()) . field ("tim14rst" , & self . tim14rst ()) . field ("lptim1rst" , & self . lptim1rst ()) . field ("wwdgrst" , & self . wwdgrst ()) . field ("can3rst" , & self . can3rst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("spi3rst" , & self . spi3rst ()) . field ("spdifrxrst" , & self . spdifrxrst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("usart3rst" , & self . usart3rst ()) . field ("uart4rst" , & self . uart4rst ()) . field ("uart5rst" , & self . uart5rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("i2c3rst" , & self . i2c3rst ()) . field ("i2c4rst" , & self . i2c4rst ()) . field ("can1rst" , & self . can1rst ()) . field ("can2rst" , & self . can2rst ()) . field ("cecrst" , & self . cecrst ()) . field ("pwrrst" , & self . pwrrst ()) . field ("dacrst" , & self . dacrst ()) . field ("uart7rst" , & self . uart7rst ()) . field ("uart8rst" , & self . uart8rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim4rst: {=bool:?}, tim5rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, tim12rst: {=bool:?}, tim13rst: {=bool:?}, tim14rst: {=bool:?}, lptim1rst: {=bool:?}, wwdgrst: {=bool:?}, can3rst: {=bool:?}, spi2rst: {=bool:?}, spi3rst: {=bool:?}, spdifrxrst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, uart4rst: {=bool:?}, uart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, i2c3rst: {=bool:?}, i2c4rst: {=bool:?}, can1rst: {=bool:?}, can2rst: {=bool:?}, cecrst: {=bool:?}, pwrrst: {=bool:?}, dacrst: {=bool:?}, uart7rst: {=bool:?}, uart8rst: {=bool:?} }}" , self . tim2rst () , self . tim3rst () , self . tim4rst () , self . tim5rst () , self . tim6rst () , self . tim7rst () , self . tim12rst () , self . tim13rst () , self . tim14rst () , self . lptim1rst () , self . wwdgrst () , self . can3rst () , self . spi2rst () , self . spi3rst () , self . spdifrxrst () , self . usart2rst () , self . usart3rst () , self . uart4rst () , self . uart5rst () , self . i2c1rst () , self . i2c2rst () , self . i2c3rst () , self . i2c4rst () , self . can1rst () , self . can2rst () , self . cecrst () , self . pwrrst () , self . dacrst () , self . uart7rst () , self . uart8rst ()) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("tim1en" , & self . tim1en ()) . field ("tim8en" , & self . tim8en ()) . field ("usart1en" , & self . usart1en ()) . field ("usart6en" , & self . usart6en ()) . field ("sdmmc2en" , & self . sdmmc2en ()) . field ("adc1en" , & self . adc1en ()) . field ("adc2en" , & self . adc2en ()) . field ("adc3en" , & self . adc3en ()) . field ("sdmmc1en" , & self . sdmmc1en ()) . field ("spi1en" , & self . spi1en ()) . field ("spi4en" , & self . spi4en ()) . field ("syscfgen" , & self . syscfgen ()) . field ("tim9en" , & self . tim9en ()) . field ("tim10en" , & self . tim10en ()) . field ("tim11en" , & self . tim11en ()) . field ("spi5en" , & self . spi5en ()) . field ("spi6en" , & self . spi6en ()) . field ("sai1en" , & self . sai1en ()) . field ("sai2en" , & self . sai2en ()) . field ("ltdcen" , & self . ltdcen ()) . field ("dsien" , & self . dsien ()) . field ("dfsdm1en" , & self . dfsdm1en ()) . field ("mdiosen" , & self . mdiosen ()) . field ("usbphycen" , & self . usbphycen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ tim1en: {=bool:?}, tim8en: {=bool:?}, usart1en: {=bool:?}, usart6en: {=bool:?}, sdmmc2en: {=bool:?}, adc1en: {=bool:?}, adc2en: {=bool:?}, adc3en: {=bool:?}, sdmmc1en: {=bool:?}, spi1en: {=bool:?}, spi4en: {=bool:?}, syscfgen: {=bool:?}, tim9en: {=bool:?}, tim10en: {=bool:?}, tim11en: {=bool:?}, spi5en: {=bool:?}, spi6en: {=bool:?}, sai1en: {=bool:?}, sai2en: {=bool:?}, ltdcen: {=bool:?}, dsien: {=bool:?}, dfsdm1en: {=bool:?}, mdiosen: {=bool:?}, usbphycen: {=bool:?} }}" , self . tim1en () , self . tim8en () , self . usart1en () , self . usart6en () , self . sdmmc2en () , self . adc1en () , self . adc2en () , self . adc3en () , self . sdmmc1en () , self . spi1en () , self . spi4en () , self . syscfgen () , self . tim9en () , self . tim10en () , self . tim11en () , self . spi5en () , self . spi6en () , self . sai1en () , self . sai2en () , self . ltdcen () , self . dsien () , self . dfsdm1en () , self . mdiosen () , self . usbphycen ()) } } # [doc = "APB2 peripheral clock enabled in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2lpenr { Apb2lpenr (0) } } impl core :: fmt :: Debug for Apb2lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2lpenr") . field ("tim1lpen" , & self . tim1lpen ()) . field ("tim8lpen" , & self . tim8lpen ()) . field ("usart1lpen" , & self . usart1lpen ()) . field ("usart6lpen" , & self . usart6lpen ()) . field ("sdmmc2lpen" , & self . sdmmc2lpen ()) . field ("adc1lpen" , & self . adc1lpen ()) . field ("adc2lpen" , & self . adc2lpen ()) . field ("adc3lpen" , & self . adc3lpen ()) . field ("sdmmc1lpen" , & self . sdmmc1lpen ()) . field ("spi1lpen" , & self . spi1lpen ()) . field ("spi4lpen" , & self . spi4lpen ()) . field ("syscfglpen" , & self . syscfglpen ()) . field ("tim9lpen" , & self . tim9lpen ()) . field ("tim10lpen" , & self . tim10lpen ()) . field ("tim11lpen" , & self . tim11lpen ()) . field ("spi5lpen" , & self . spi5lpen ()) . field ("spi6lpen" , & self . spi6lpen ()) . field ("sai1lpen" , & self . sai1lpen ()) . field ("sai2lpen" , & self . sai2lpen ()) . field ("ltdclpen" , & self . ltdclpen ()) . field ("dsilpen" , & self . dsilpen ()) . field ("dfsdm1lpen" , & self . dfsdm1lpen ()) . field ("mdioslpen" , & self . mdioslpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2lpenr {{ tim1lpen: {=bool:?}, tim8lpen: {=bool:?}, usart1lpen: {=bool:?}, usart6lpen: {=bool:?}, sdmmc2lpen: {=bool:?}, adc1lpen: {=bool:?}, adc2lpen: {=bool:?}, adc3lpen: {=bool:?}, sdmmc1lpen: {=bool:?}, spi1lpen: {=bool:?}, spi4lpen: {=bool:?}, syscfglpen: {=bool:?}, tim9lpen: {=bool:?}, tim10lpen: {=bool:?}, tim11lpen: {=bool:?}, spi5lpen: {=bool:?}, spi6lpen: {=bool:?}, sai1lpen: {=bool:?}, sai2lpen: {=bool:?}, ltdclpen: {=bool:?}, dsilpen: {=bool:?}, dfsdm1lpen: {=bool:?}, mdioslpen: {=bool:?} }}" , self . tim1lpen () , self . tim8lpen () , self . usart1lpen () , self . usart6lpen () , self . sdmmc2lpen () , self . adc1lpen () , self . adc2lpen () , self . adc3lpen () , self . sdmmc1lpen () , self . spi1lpen () , self . spi4lpen () , self . syscfglpen () , self . tim9lpen () , self . tim10lpen () , self . tim11lpen () , self . spi5lpen () , self . spi6lpen () , self . sai1lpen () , self . sai2lpen () , self . ltdclpen () , self . dsilpen () , self . dfsdm1lpen () , self . mdioslpen ()) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("tim1rst" , & self . tim1rst ()) . field ("tim8rst" , & self . tim8rst ()) . field ("usart1rst" , & self . usart1rst ()) . field ("usart6rst" , & self . usart6rst ()) . field ("sdmmc2rst" , & self . sdmmc2rst ()) . field ("adcrst" , & self . adcrst ()) . field ("sdmmc1rst" , & self . sdmmc1rst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("spi4rst" , & self . spi4rst ()) . field ("syscfgrst" , & self . syscfgrst ()) . field ("tim9rst" , & self . tim9rst ()) . field ("tim10rst" , & self . tim10rst ()) . field ("tim11rst" , & self . tim11rst ()) . field ("spi5rst" , & self . spi5rst ()) . field ("spi6rst" , & self . spi6rst ()) . field ("sai1rst" , & self . sai1rst ()) . field ("sai2rst" , & self . sai2rst ()) . field ("ltdcrst" , & self . ltdcrst ()) . field ("dsirst" , & self . dsirst ()) . field ("dfsdm1rst" , & self . dfsdm1rst ()) . field ("mdiosrst" , & self . mdiosrst ()) . field ("usbphycrst" , & self . usbphycrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ tim1rst: {=bool:?}, tim8rst: {=bool:?}, usart1rst: {=bool:?}, usart6rst: {=bool:?}, sdmmc2rst: {=bool:?}, adcrst: {=bool:?}, sdmmc1rst: {=bool:?}, spi1rst: {=bool:?}, spi4rst: {=bool:?}, syscfgrst: {=bool:?}, tim9rst: {=bool:?}, tim10rst: {=bool:?}, tim11rst: {=bool:?}, spi5rst: {=bool:?}, spi6rst: {=bool:?}, sai1rst: {=bool:?}, sai2rst: {=bool:?}, ltdcrst: {=bool:?}, dsirst: {=bool:?}, dfsdm1rst: {=bool:?}, mdiosrst: {=bool:?}, usbphycrst: {=bool:?} }}" , self . tim1rst () , self . tim8rst () , self . usart1rst () , self . usart6rst () , self . sdmmc2rst () , self . adcrst () , self . sdmmc1rst () , self . spi1rst () , self . spi4rst () , self . syscfgrst () , self . tim9rst () , self . tim10rst () , self . tim11rst () , self . spi5rst () , self . spi6rst () , self . sai1rst () , self . sai2rst () , self . ltdcrst () , self . dsirst () , self . dfsdm1rst () , self . mdiosrst () , self . usbphycrst ()) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bdcr { Bdcr (0) } } impl core :: fmt :: Debug for Bdcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bdcr") . field ("lseon" , & self . lseon ()) . field ("lserdy" , & self . lserdy ()) . field ("lsebyp" , & self . lsebyp ()) . field ("lsedrv" , & self . lsedrv ()) . field ("rtcsel" , & self . rtcsel ()) . field ("rtcen" , & self . rtcen ()) . field ("bdrst" , & self . bdrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bdcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bdcr {{ lseon: {=bool:?}, lserdy: {=bool:?}, lsebyp: {=bool:?}, lsedrv: {:?}, rtcsel: {:?}, rtcen: {=bool:?}, bdrst: {=bool:?} }}" , self . lseon () , self . lserdy () , self . lsebyp () , self . lsedrv () , self . rtcsel () , self . rtcen () , self . bdrst ()) } } # [doc = "clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dckcfgr1 { Dckcfgr1 (0) } } impl core :: fmt :: Debug for Dckcfgr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dckcfgr1") . field ("plli2sdivq" , & self . plli2sdivq ()) . field ("pllsaidivq" , & self . pllsaidivq ()) . field ("pllsaidivr" , & self . pllsaidivr ()) . field ("sai1sel" , & self . sai1sel ()) . field ("sai2sel" , & self . sai2sel ()) . field ("timpre" , & self . timpre ()) . field ("dfsdm1sel" , & self . dfsdm1sel ()) . field ("adfsdm1sel" , & self . adfsdm1sel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dckcfgr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dckcfgr1 {{ plli2sdivq: {:?}, pllsaidivq: {:?}, pllsaidivr: {:?}, sai1sel: {:?}, sai2sel: {:?}, timpre: {:?}, dfsdm1sel: {:?}, adfsdm1sel: {:?} }}" , self . plli2sdivq () , self . pllsaidivq () , self . pllsaidivr () , self . sai1sel () , self . sai2sel () , self . timpre () , self . dfsdm1sel () , self . adfsdm1sel ()) } } # [doc = "dedicated clocks configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dckcfgr2 { Dckcfgr2 (0) } } impl core :: fmt :: Debug for Dckcfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dckcfgr2") . field ("usart1sel" , & self . usart1sel ()) . field ("usart2sel" , & self . usart2sel ()) . field ("usart3sel" , & self . usart3sel ()) . field ("uart4sel" , & self . uart4sel ()) . field ("uart5sel" , & self . uart5sel ()) . field ("usart6sel" , & self . usart6sel ()) . field ("uart7sel" , & self . uart7sel ()) . field ("uart8sel" , & self . uart8sel ()) . field ("i2c1sel" , & self . i2c1sel ()) . field ("i2c2sel" , & self . i2c2sel ()) . field ("i2c3sel" , & self . i2c3sel ()) . field ("i2c4sel" , & self . i2c4sel ()) . field ("lptim1sel" , & self . lptim1sel ()) . field ("cecsel" , & self . cecsel ()) . field ("clk48sel" , & self . clk48sel ()) . field ("sdmmc1sel" , & self . sdmmc1sel ()) . field ("sdmmc2sel" , & self . sdmmc2sel ()) . field ("dsisel" , & self . dsisel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dckcfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dckcfgr2 {{ usart1sel: {:?}, usart2sel: {:?}, usart3sel: {:?}, uart4sel: {:?}, uart5sel: {:?}, usart6sel: {:?}, uart7sel: {:?}, uart8sel: {:?}, i2c1sel: {:?}, i2c2sel: {:?}, i2c3sel: {:?}, i2c4sel: {:?}, lptim1sel: {:?}, cecsel: {:?}, clk48sel: {:?}, sdmmc1sel: {:?}, sdmmc2sel: {:?}, dsisel: {:?} }}" , self . usart1sel () , self . usart2sel () , self . usart3sel () , self . uart4sel () , self . uart5sel () , self . usart6sel () , self . uart7sel () , self . uart8sel () , self . i2c1sel () , self . i2c2sel () , self . i2c3sel () , self . i2c4sel () , self . lptim1sel () , self . cecsel () , self . clk48sel () , self . sdmmc1sel () , self . sdmmc2sel () , self . dsisel ()) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Plli2scfgr { Plli2scfgr (0) } } impl core :: fmt :: Debug for Plli2scfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Plli2scfgr") . field ("plln" , & self . plln ()) . field ("pllp" , & self . pllp ()) . field ("pllq" , & self . pllq ()) . field ("pllr" , & self . pllr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Plli2scfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Plli2scfgr {{ plln: {:?}, pllp: {:?}, pllq: {:?}, pllr: {:?} }}" , self . plln () , self . pllp () , self . pllq () , self . pllr ()) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pllsaicfgr { Pllsaicfgr (0) } } impl core :: fmt :: Debug for Pllsaicfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pllsaicfgr") . field ("plln" , & self . plln ()) . field ("pllp" , & self . pllp ()) . field ("pllq" , & self . pllq ()) . field ("pllr" , & self . pllr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pllsaicfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pllsaicfgr {{ plln: {:?}, pllp: {:?}, pllq: {:?}, pllr: {:?} }}" , self . plln () , self . pllp () , self . pllq () , self . pllr ()) } } # [doc = "spread spectrum clock generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

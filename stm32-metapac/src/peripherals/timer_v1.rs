...
fn default () -> Af11chCmp { Af11chCmp (0) } } impl core :: fmt :: Debug for Af11chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af11chCmp") . field ("bkine" , & self . bkine ()) . field ("bkcmpe[0]" , & self . bkcmpe (0usize)) . field ("bkcmpe[1]" , & self . bkcmpe (1usize)) . field ("bkdf1bke" , & self . bkdf1bke ()) . field ("bkinp" , & self . bkinp ()) . field ("bkcmpp[0]" , & self . bkcmpp (0usize)) . field ("bkcmpp[1]" , & self . bkcmpp (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af11chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Af11chCmp {{ bkine: {=bool:?}, bkcmpe[0]: {=bool:?}, bkcmpe[1]: {=bool:?}, bkdf1bke: {=bool:?}, bkinp: {:?}, bkcmpp[0]: {:?}, bkcmpp[1]: {:?} }}" , self . bkine () , self . bkcmpe (0usize) , self . bkcmpe (1usize) , self . bkdf1bke () , self . bkinp () , self . bkcmpp (0usize) , self . bkcmpp (1usize)) } } # [doc = "alternate function register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Af1Adv { Af1Adv (0) } } impl core :: fmt :: Debug for Af1Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af1Adv") . field ("bkine" , & self . bkine ()) . field ("bkcmpe[0]" , & self . bkcmpe (0usize)) . field ("bkcmpe[1]" , & self . bkcmpe (1usize)) . field ("bkdf1bke" , & self . bkdf1bke ()) . field ("bkinp" , & self . bkinp ()) . field ("bkcmpp[0]" , & self . bkcmpp (0usize)) . field ("bkcmpp[1]" , & self . bkcmpp (1usize)) . field ("etrsel" , & self . etrsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af1Adv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Af1Adv {{ bkine: {=bool:?}, bkcmpe[0]: {=bool:?}, bkcmpe[1]: {=bool:?}, bkdf1bke: {=bool:?}, bkinp: {:?}, bkcmpp[0]: {:?}, bkcmpp[1]: {:?}, etrsel: {=u8:?} }}" , self . bkine () , self . bkcmpe (0usize) , self . bkcmpe (1usize) , self . bkdf1bke () , self . bkinp () , self . bkcmpp (0usize) , self . bkcmpp (1usize) , self . etrsel ()) } } # [doc = "alternate function register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Af2Adv { Af2Adv (0) } } impl core :: fmt :: Debug for Af2Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af2Adv") . field ("bk2ine" , & self . bk2ine ()) . field ("bk2cmpe[0]" , & self . bk2cmpe (0usize)) . field ("bk2df1bk1e" , & self . bk2df1bk1e ()) . field ("bk2inp" , & self . bk2inp ()) . field ("bk2cmpp[0]" , & self . bk2cmpp (0usize)) . field ("bk2cmpp[1]" , & self . bk2cmpp (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af2Adv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Af2Adv {{ bk2ine: {=bool:?}, bk2cmpe[0]: {=bool:?}, bk2df1bk1e: {=bool:?}, bk2inp: {:?}, bk2cmpp[0]: {:?}, bk2cmpp[1]: {:?} }}" , self . bk2ine () , self . bk2cmpe (0usize) , self . bk2df1bk1e () , self . bk2inp () , self . bk2cmpp (0usize) , self . bk2cmpp (1usize)) } } # [doc = "auto-reload register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for ArrCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "ArrCore {{ arr: {=u16:?} }}" , self . arr ()) } } # [doc = "break and dead-time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bdtr1chCmp { Bdtr1chCmp (0) } } impl core :: fmt :: Debug for Bdtr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bdtr1chCmp") . field ("dtg" , & self . dtg ()) . field ("lock" , & self . lock ()) . field ("ossi" , & self . ossi ()) . field ("ossr" , & self . ossr ()) . field ("bke[0]" , & self . bke (0usize)) . field ("bkp[0]" , & self . bkp (0usize)) . field ("aoe" , & self . aoe ()) . field ("moe" , & self . moe ()) . field ("bkf[0]" , & self . bkf (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bdtr1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bdtr1chCmp {{ dtg: {=u8:?}, lock: {:?}, ossi: {:?}, ossr: {:?}, bke[0]: {=bool:?}, bkp[0]: {:?}, aoe: {=bool:?}, moe: {=bool:?}, bkf[0]: {:?} }}" , self . dtg () , self . lock () , self . ossi () , self . ossr () , self . bke (0usize) , self . bkp (0usize) , self . aoe () , self . moe () , self . bkf (0usize)) } } # [doc = "break and dead-time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for CcmrOutputGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcmrOutputGp16 {{ ccs[0]: {:?}, ccs[1]: {:?}, ocfe[0]: {=bool:?}, ocfe[1]: {=bool:?}, ocpe[0]: {=bool:?}, ocpe[1]: {=bool:?}, ocm[0]: {:?}, ocm[1]: {:?}, occe[0]: {=bool:?}, occe[1]: {=bool:?} }}" , self . ccs (0usize) , self . ccs (1usize) , self . ocfe (0usize) , self . ocfe (1usize) , self . ocpe (0usize) , self . ocpe (1usize) , self . ocm (0usize) , self . ocm (1usize) , self . occe (0usize) , self . occe (1usize)) } } # [doc = "capture/compare register x (x=1-4,6)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ccr1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr1ch {{ ccr: {=u16:?} }}" , self . ccr ()) } } # [doc = "capture/compare register 5"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ccr5Adv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr5Adv {{ ccr: {=u16:?}, gc5c[0]: {:?}, gc5c[1]: {:?}, gc5c[2]: {:?} }}" , self . ccr () , self . gc5c (0usize) , self . gc5c (1usize) , self . gc5c (2usize)) } } # [doc = "counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for CntCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CntCore {{ cnt: {=u16:?}, uifcpy: {=bool:?} }}" , self . cnt () , self . uifcpy ()) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr11ch { Cr11ch (0) } } impl core :: fmt :: Debug for Cr11ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr11ch") . field ("cen" , & self . cen ()) . field ("udis" , & self . udis ()) . field ("urs" , & self . urs ()) . field ("opm" , & self . opm ()) . field ("arpe" , & self . arpe ()) . field ("ckd" , & self . ckd ()) . field ("uifremap" , & self . uifremap ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr11ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr11ch {{ cen: {=bool:?}, udis: {=bool:?}, urs: {:?}, opm: {=bool:?}, arpe: {=bool:?}, ckd: {:?}, uifremap: {=bool:?} }}" , self . cen () , self . udis () , self . urs () , self . opm () , self . arpe () , self . ckd () , self . uifremap ()) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr1Core { Cr1Core (0) } } impl core :: fmt :: Debug for Cr1Core { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr1Core") . field ("cen" , & self . cen ()) . field ("udis" , & self . udis ()) . field ("urs" , & self . urs ()) . field ("opm" , & self . opm ()) . field ("arpe" , & self . arpe ()) . field ("uifremap" , & self . uifremap ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr1Core { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr1Core {{ cen: {=bool:?}, udis: {=bool:?}, urs: {:?}, opm: {=bool:?}, arpe: {=bool:?}, uifremap: {=bool:?} }}" , self . cen () , self . udis () , self . urs () , self . opm () , self . arpe () , self . uifremap ()) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr1Gp16 { Cr1Gp16 (0) } } impl core :: fmt :: Debug for Cr1Gp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr1Gp16") . field ("cen" , & self . cen ()) . field ("udis" , & self . udis ()) . field ("urs" , & self . urs ()) . field ("opm" , & self . opm ()) . field ("dir" , & self . dir ()) . field ("cms" , & self . cms ()) . field ("arpe" , & self . arpe ()) . field ("ckd" , & self . ckd ()) . field ("uifremap" , & self . uifremap ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr1Gp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr1Gp16 {{ cen: {=bool:?}, udis: {=bool:?}, urs: {:?}, opm: {=bool:?}, dir: {:?}, cms: {:?}, arpe: {=bool:?}, ckd: {:?}, uifremap: {=bool:?} }}" , self . cen () , self . udis () , self . urs () , self . opm () , self . dir () , self . cms () , self . arpe () , self . ckd () , self . uifremap ()) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dcr1chCmp { Dcr1chCmp (0) } } impl core :: fmt :: Debug for Dcr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dcr1chCmp") . field ("dba" , & self . dba ()) . field ("dbl" , & self . dbl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dcr1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dcr1chCmp {{ dba: {=u8:?}, dbl: {=u8:?} }}" , self . dba () , self . dbl ()) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DmarGp16 { DmarGp16 (0) } } impl core :: fmt :: Debug for DmarGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DmarGp16") . field ("dmab" , & self . dmab ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for DmarGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "DmarGp16 {{ dmab: {=u16:?} }}" , self . dmab ()) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> SmcrGp16 { SmcrGp16 (0) } } impl core :: fmt :: Debug for SmcrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SmcrGp16") . field ("sms" , & self . sms ()) . field ("ts" , & self . ts ()) . field ("msm" , & self . msm ()) . field ("etf" , & self . etf ()) . field ("etps" , & self . etps ()) . field ("ece" , & self . ece ()) . field ("etp" , & self . etp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for SmcrGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "SmcrGp16 {{ sms: {:?}, ts: {:?}, msm: {:?}, etf: {:?}, etps: {:?}, ece: {=bool:?}, etp: {:?} }}" , self . sms () , self . ts () , self . msm () , self . etf () , self . etps () , self . ece () , self . etp ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
COMPARE_OC4 = 0x07 , } impl Mms { # [inline (always)]
...
PWM_MODE2 = 0x07 , } impl Ocm { # [inline (always)]

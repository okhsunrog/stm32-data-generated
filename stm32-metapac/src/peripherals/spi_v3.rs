...
fn default () -> Cfg1 { Cfg1 (0) } } impl core :: fmt :: Debug for Cfg1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfg1") . field ("dsize" , & self . dsize ()) . field ("fthlv" , & self . fthlv ()) . field ("udrcfg" , & self . udrcfg ()) . field ("udrdet" , & self . udrdet ()) . field ("rxdmaen" , & self . rxdmaen ()) . field ("txdmaen" , & self . txdmaen ()) . field ("crcsize" , & self . crcsize ()) . field ("crcen" , & self . crcen ()) . field ("mbr" , & self . mbr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfg1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfg1 {{ dsize: {=u8:?}, fthlv: {:?}, udrcfg: {:?}, udrdet: {:?}, rxdmaen: {=bool:?}, txdmaen: {=bool:?}, crcsize: {=u8:?}, crcen: {=bool:?}, mbr: {:?} }}" , self . dsize () , self . fthlv () , self . udrcfg () , self . udrdet () , self . rxdmaen () , self . txdmaen () , self . crcsize () , self . crcen () , self . mbr ()) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfg2 { Cfg2 (0) } } impl core :: fmt :: Debug for Cfg2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfg2") . field ("mssi" , & self . mssi ()) . field ("midi" , & self . midi ()) . field ("ioswp" , & self . ioswp ()) . field ("comm" , & self . comm ()) . field ("sp" , & self . sp ()) . field ("master" , & self . master ()) . field ("lsbfirst" , & self . lsbfirst ()) . field ("cpha" , & self . cpha ()) . field ("cpol" , & self . cpol ()) . field ("ssm" , & self . ssm ()) . field ("ssiop" , & self . ssiop ()) . field ("ssoe" , & self . ssoe ()) . field ("ssom" , & self . ssom ()) . field ("afcntr" , & self . afcntr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfg2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfg2 {{ mssi: {=u8:?}, midi: {=u8:?}, ioswp: {=bool:?}, comm: {:?}, sp: {:?}, master: {:?}, lsbfirst: {:?}, cpha: {:?}, cpol: {:?}, ssm: {=bool:?}, ssiop: {:?}, ssoe: {=bool:?}, ssom: {:?}, afcntr: {=bool:?} }}" , self . mssi () , self . midi () , self . ioswp () , self . comm () , self . sp () , self . master () , self . lsbfirst () , self . cpha () , self . cpol () , self . ssm () , self . ssiop () , self . ssoe () , self . ssom () , self . afcntr ()) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr1 { Cr1 (0) } } impl core :: fmt :: Debug for Cr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr1") . field ("spe" , & self . spe ()) . field ("masrx" , & self . masrx ()) . field ("cstart" , & self . cstart ()) . field ("csusp" , & self . csusp ()) . field ("hddir" , & self . hddir ()) . field ("ssi" , & self . ssi ()) . field ("crc33_17" , & self . crc33_17 ()) . field ("rcrcini" , & self . rcrcini ()) . field ("tcrcini" , & self . tcrcini ()) . field ("iolock" , & self . iolock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr1 {{ spe: {=bool:?}, masrx: {=bool:?}, cstart: {=bool:?}, csusp: {=bool:?}, hddir: {:?}, ssi: {=bool:?}, crc33_17: {=bool:?}, rcrcini: {:?}, tcrcini: {:?}, iolock: {=bool:?} }}" , self . spe () , self . masrx () , self . cstart () , self . csusp () , self . hddir () , self . ssi () , self . crc33_17 () , self . rcrcini () , self . tcrcini () , self . iolock ()) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr2 { Cr2 (0) } } impl core :: fmt :: Debug for Cr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2") . field ("tsize" , & self . tsize ()) . field ("tser" , & self . tser ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2 {{ tsize: {=u16:?}, tser: {=u16:?} }}" , self . tsize () , self . tser ()) } } # [doc = "Polynomial Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Crcpoly { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Crcpoly {{ crcpoly: {=u32:?} }}" , self . crcpoly ()) } } # [doc = "I2S Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> I2scfgr { I2scfgr (0) } } impl core :: fmt :: Debug for I2scfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("I2scfgr") . field ("i2smod" , & self . i2smod ()) . field ("i2scfg" , & self . i2scfg ()) . field ("i2sstd" , & self . i2sstd ()) . field ("pcmsync" , & self . pcmsync ()) . field ("datlen" , & self . datlen ()) . field ("chlen" , & self . chlen ()) . field ("ckpol" , & self . ckpol ()) . field ("fixch" , & self . fixch ()) . field ("wsinv" , & self . wsinv ()) . field ("datfmt" , & self . datfmt ()) . field ("i2sdiv" , & self . i2sdiv ()) . field ("odd" , & self . odd ()) . field ("mckoe" , & self . mckoe ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for I2scfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "I2scfgr {{ i2smod: {=bool:?}, i2scfg: {:?}, i2sstd: {:?}, pcmsync: {:?}, datlen: {:?}, chlen: {:?}, ckpol: {:?}, fixch: {:?}, wsinv: {=bool:?}, datfmt: {:?}, i2sdiv: {=u8:?}, odd: {:?}, mckoe: {=bool:?} }}" , self . i2smod () , self . i2scfg () , self . i2sstd () , self . pcmsync () , self . datlen () , self . chlen () , self . ckpol () , self . fixch () , self . wsinv () , self . datfmt () , self . i2sdiv () , self . odd () , self . mckoe ()) } } # [doc = "Interrupt Enable Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ier { Ier (0) } } impl core :: fmt :: Debug for Ier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ier") . field ("rxpie" , & self . rxpie ()) . field ("txpie" , & self . txpie ()) . field ("dxpie" , & self . dxpie ()) . field ("eotie" , & self . eotie ()) . field ("txtfie" , & self . txtfie ()) . field ("udrie" , & self . udrie ()) . field ("ovrie" , & self . ovrie ()) . field ("crceie" , & self . crceie ()) . field ("tifreie" , & self . tifreie ()) . field ("modfie" , & self . modfie ()) . field ("tserfie" , & self . tserfie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ier {{ rxpie: {=bool:?}, txpie: {=bool:?}, dxpie: {=bool:?}, eotie: {=bool:?}, txtfie: {=bool:?}, udrie: {=bool:?}, ovrie: {=bool:?}, crceie: {=bool:?}, tifreie: {=bool:?}, modfie: {=bool:?}, tserfie: {=bool:?} }}" , self . rxpie () , self . txpie () , self . dxpie () , self . eotie () , self . txtfie () , self . udrie () , self . ovrie () , self . crceie () , self . tifreie () , self . modfie () , self . tserfie ()) } } # [doc = "Interrupt/Status Flags Clear Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ifcr { Ifcr (0) } } impl core :: fmt :: Debug for Ifcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ifcr") . field ("eotc" , & self . eotc ()) . field ("txtfc" , & self . txtfc ()) . field ("udrc" , & self . udrc ()) . field ("ovrc" , & self . ovrc ()) . field ("crcec" , & self . crcec ()) . field ("tifrec" , & self . tifrec ()) . field ("modfc" , & self . modfc ()) . field ("tserfc" , & self . tserfc ()) . field ("suspc" , & self . suspc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ifcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ifcr {{ eotc: {=bool:?}, txtfc: {=bool:?}, udrc: {=bool:?}, ovrc: {=bool:?}, crcec: {=bool:?}, tifrec: {=bool:?}, modfc: {=bool:?}, tserfc: {=bool:?}, suspc: {=bool:?} }}" , self . eotc () , self . txtfc () , self . udrc () , self . ovrc () , self . crcec () , self . tifrec () , self . modfc () , self . tserfc () , self . suspc ()) } } # [doc = "Receiver CRC Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Rxcrc { Rxcrc (0) } } impl core :: fmt :: Debug for Rxcrc { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Rxcrc") . field ("rxcrc" , & self . rxcrc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Rxcrc { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Rxcrc {{ rxcrc: {=u32:?} }}" , self . rxcrc ()) } } # [doc = "Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("rxp" , & self . rxp ()) . field ("txp" , & self . txp ()) . field ("dxp" , & self . dxp ()) . field ("eot" , & self . eot ()) . field ("txtf" , & self . txtf ()) . field ("udr" , & self . udr ()) . field ("ovr" , & self . ovr ()) . field ("crce" , & self . crce ()) . field ("tifre" , & self . tifre ()) . field ("modf" , & self . modf ()) . field ("tserf" , & self . tserf ()) . field ("susp" , & self . susp ()) . field ("txc" , & self . txc ()) . field ("rxplvl" , & self . rxplvl ()) . field ("rxwne" , & self . rxwne ()) . field ("ctsize" , & self . ctsize ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ rxp: {=bool:?}, txp: {=bool:?}, dxp: {=bool:?}, eot: {=bool:?}, txtf: {=bool:?}, udr: {=bool:?}, ovr: {=bool:?}, crce: {=bool:?}, tifre: {=bool:?}, modf: {=bool:?}, tserf: {=bool:?}, susp: {=bool:?}, txc: {=bool:?}, rxplvl: {:?}, rxwne: {:?}, ctsize: {=u16:?} }}" , self . rxp () , self . txp () , self . dxp () , self . eot () , self . txtf () , self . udr () , self . ovr () , self . crce () , self . tifre () , self . modf () , self . tserf () , self . susp () , self . txc () , self . rxplvl () , self . rxwne () , self . ctsize ()) } } # [doc = "Transmitter CRC Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Txcrc { Txcrc (0) } } impl core :: fmt :: Debug for Txcrc { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Txcrc") . field ("txcrc" , & self . txcrc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Txcrc { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Txcrc {{ txcrc: {=u32:?} }}" , self . txcrc ()) } } # [doc = "Underrun Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Udrdr { Udrdr (0) } } impl core :: fmt :: Debug for Udrdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Udrdr") . field ("udrdr" , & self . udrdr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Udrdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Udrdr {{ udrdr: {=u32:?} }}" , self . udrdr ()) } } } pub mod vals { # [repr (u8)]
...
IDLE_LOW = 0x0 , # [doc = "CK idle level is High. Signals are sampled on falling and changed on rising clock edges"]
IDLE_HIGH = 0x01 , } impl Ckpol { # [inline (always)]
...
FULL_DUPLEX = 0x0 , # [doc = "Simplex transmitter only"]
TRANSMITTER = 0x01 , # [doc = "Simplex receiver only"]
RECEIVER = 0x02 , # [doc = "Half duplex"]
HALF_DUPLEX = 0x03 , } impl Comm { # [inline (always)]
...
FIRST_EDGE = 0x0 , # [doc = "The second clock transition is the first data capture edge"]
SECOND_EDGE = 0x01 , } impl Cpha { # [inline (always)]
...
IDLE_LOW = 0x0 , # [doc = "SCK to 1 when idle"]
IDLE_HIGH = 0x01 , } impl Cpol { # [inline (always)]
...
RIGHT_ALIGNED = 0x0 , # [doc = "The data inside RXDR and TXDR are left aligned"]
LEFT_ALIGNED = 0x01 , } impl Datfmt { # [inline (always)]
...
NOT_FIXED = 0x0 , # [doc = "The channel length in slave mode is supposed to be 16 or 32 bits (according to CHLEN)"]
...
ONE_FRAME = 0x0 , # [doc = "2 frames"]
TWO_FRAMES = 0x01 , # [doc = "3 frames"]
THREE_FRAMES = 0x02 , # [doc = "4 frames"]
FOUR_FRAMES = 0x03 , # [doc = "5 frames"]
FIVE_FRAMES = 0x04 , # [doc = "6 frames"]
SIX_FRAMES = 0x05 , # [doc = "7 frames"]
SEVEN_FRAMES = 0x06 , # [doc = "8 frames"]
EIGHT_FRAMES = 0x07 , # [doc = "9 frames"]
NINE_FRAMES = 0x08 , # [doc = "10 frames"]
TEN_FRAMES = 0x09 , # [doc = "11 frames"]
ELEVEN_FRAMES = 0x0a , # [doc = "12 frames"]
TWELVE_FRAMES = 0x0b , # [doc = "13 frames"]
THIRTEEN_FRAMES = 0x0c , # [doc = "14 frames"]
FOURTEEN_FRAMES = 0x0d , # [doc = "15 frames"]
FIFTEEN_FRAMES = 0x0e , # [doc = "16 frames"]
SIXTEEN_FRAMES = 0x0f , } impl Fthlv { # [inline (always)]
...
SLAVE_TX = 0x0 , # [doc = "Slave, receive"]
SLAVE_RX = 0x01 , # [doc = "Master, transmit"]
MASTER_TX = 0x02 , # [doc = "Master, receive"]
MASTER_RX = 0x03 , # [doc = "Slave, full duplex"]
SLAVE_FULL_DUPLEX = 0x04 , # [doc = "Master, full duplex"]
MASTER_FULL_DUPLEX = 0x05 , _RESERVED_6 = 0x06 , _RESERVED_7 = 0x07 , } impl I2scfg { # [inline (always)]
...
ALL_ZEROS = 0x0 , # [doc = "All ones RX CRC initialization pattern"]
ALL_ONES = 0x01 , } impl Rcrcini { # [inline (always)]
...
ZERO_FRAMES = 0x0 , # [doc = "One frame beyond packing ratio available"]
ONE_FRAME = 0x01 , # [doc = "Two frame beyond packing ratio available"]
TWO_FRAMES = 0x02 , # [doc = "Three frame beyond packing ratio available"]
THREE_FRAMES = 0x03 , } impl Rxplvl { # [inline (always)]
...
LESS_THAN32 = 0x0 , # [doc = "At least 32-bit data frame received"]
AT_LEAST32 = 0x01 , } impl Rxwne { # [inline (always)]
...
ACTIVE_LOW = 0x0 , # [doc = "High level is active for SS signal"]
ACTIVE_HIGH = 0x01 , } impl Ssiop { # [inline (always)]
...
NOT_ASSERTED = 0x01 , } impl Ssom { # [inline (always)]
...
ALL_ZEROS = 0x0 , # [doc = "All ones TX CRC initialization pattern"]
ALL_ONES = 0x01 , } impl Tcrcini { # [inline (always)]
...
REPEAT_RECEIVED = 0x01 , # [doc = "Slave repeats last transmitted data frame"]
REPEAT_TRANSMITTED = 0x02 , _RESERVED_3 = 0x03 , } impl Udrcfg { # [inline (always)]
...
START_OF_FRAME = 0x0 , # [doc = "Underrun is detected at end of last data frame"]
END_OF_FRAME = 0x01 , # [doc = "Underrun is detected at begin of active SS signal"]
START_OF_SLAVE_SELECT = 0x02 , _RESERVED_3 = 0x03 , } impl Udrdet { # [inline (always)]

...
fn default () -> Dmabmr { Dmabmr (0) } } impl core :: fmt :: Debug for Dmabmr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmabmr") . field ("sr" , & self . sr ()) . field ("da" , & self . da ()) . field ("dsl" , & self . dsl ()) . field ("pbl" , & self . pbl ()) . field ("pm" , & self . pm ()) . field ("fb" , & self . fb ()) . field ("rdp" , & self . rdp ()) . field ("usp" , & self . usp ()) . field ("fpm" , & self . fpm ()) . field ("aab" , & self . aab ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmabmr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmabmr {{ sr: {=bool:?}, da: {:?}, dsl: {=u8:?}, pbl: {:?}, pm: {:?}, fb: {:?}, rdp: {:?}, usp: {:?}, fpm: {:?}, aab: {=bool:?} }}" , self . sr () , self . da () , self . dsl () , self . pbl () , self . pm () , self . fb () , self . rdp () , self . usp () , self . fpm () , self . aab ()) } } # [doc = "Ethernet DMA current host receive buffer address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmarpdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmarpdr {{ rpd: {:?} }}" , self . rpd ()) } } # [doc = "Ethernet DMA status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Maccr { Maccr (0) } } impl core :: fmt :: Debug for Maccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Maccr") . field ("re" , & self . re ()) . field ("te" , & self . te ()) . field ("dc" , & self . dc ()) . field ("bl" , & self . bl ()) . field ("apcs" , & self . apcs ()) . field ("rd" , & self . rd ()) . field ("ipco" , & self . ipco ()) . field ("dm" , & self . dm ()) . field ("lm" , & self . lm ()) . field ("rod" , & self . rod ()) . field ("fes" , & self . fes ()) . field ("csd" , & self . csd ()) . field ("ifg" , & self . ifg ()) . field ("jd" , & self . jd ()) . field ("wd" , & self . wd ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Maccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Maccr {{ re: {=bool:?}, te: {=bool:?}, dc: {=bool:?}, bl: {:?}, apcs: {:?}, rd: {:?}, ipco: {:?}, dm: {:?}, lm: {:?}, rod: {:?}, fes: {:?}, csd: {:?}, ifg: {:?}, jd: {:?}, wd: {:?} }}" , self . re () , self . te () , self . dc () , self . bl () , self . apcs () , self . rd () , self . ipco () , self . dm () , self . lm () , self . rod () , self . fes () , self . csd () , self . ifg () , self . jd () , self . wd ()) } } # [doc = "Ethernet MAC debug register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmccr { Mmccr (0) } } impl core :: fmt :: Debug for Mmccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmccr") . field ("cr" , & self . cr ()) . field ("csr" , & self . csr ()) . field ("ror" , & self . ror ()) . field ("mcf" , & self . mcf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmccr {{ cr: {:?}, csr: {:?}, ror: {=bool:?}, mcf: {=bool:?} }}" , self . cr () , self . csr () , self . ror () , self . mcf ()) } } # [doc = "Ethernet MMC received frames with alignment error counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("tpe" , & self . tpe ()) . field ("tpal" , & self . tpal ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ tpe: {=bool:?}, tpal: {:?} }}" , self . tpe () , self . tpal ()) } } # [doc = "Control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("cte" , & self . cte ()) . field ("cti" , & self . cti ()) . field ("tpie" , & self . tpie ()) . field ("tef" , & self . tef ()) . field ("tif" , & self . tif ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ cte: {=bool:?}, cti: {=bool:?}, tpie: {=bool:?}, tef: {=bool:?}, tif: {=bool:?} }}" , self . cte () , self . cti () , self . tpie () , self . tef () , self . tif ()) } } # [doc = "Data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dr { Dr (0) } } impl core :: fmt :: Debug for Dr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dr") . field ("d" , & self . d ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ d: {=u16:?} }}" , self . d ()) } } # [doc = "RTC clock calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Rtccr { Rtccr (0) } } impl core :: fmt :: Debug for Rtccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Rtccr") . field ("cal" , & self . cal ()) . field ("cco" , & self . cco ()) . field ("asoe" , & self . asoe ()) . field ("asos" , & self . asos ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Rtccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Rtccr {{ cal: {=u8:?}, cco: {=bool:?}, asoe: {=bool:?}, asos: {:?} }}" , self . cal () , self . cco () , self . asoe () , self . asos ()) } } } pub mod vals { # [repr (u8)]

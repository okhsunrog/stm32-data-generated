...
fn default () -> Acr { Acr (0) } } impl core :: fmt :: Debug for Acr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Acr") . field ("latency" , & self . latency ()) . field ("hlfcya" , & self . hlfcya ()) . field ("prftbe" , & self . prftbe ()) . field ("prftbs" , & self . prftbs ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Acr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Acr {{ latency: {:?}, hlfcya: {=bool:?}, prftbe: {=bool:?}, prftbs: {=bool:?} }}" , self . latency () , self . hlfcya () , self . prftbe () , self . prftbs ()) } } # [doc = "Flash address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ar { Ar (0) } } impl core :: fmt :: Debug for Ar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ar") . field ("far" , & self . far ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ar {{ far: {=u32:?} }}" , self . far ()) } } # [doc = "Flash control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("pg" , & self . pg ()) . field ("per" , & self . per ()) . field ("mer" , & self . mer ()) . field ("optpg" , & self . optpg ()) . field ("opter" , & self . opter ()) . field ("strt" , & self . strt ()) . field ("lock" , & self . lock ()) . field ("optwre" , & self . optwre ()) . field ("errie" , & self . errie ()) . field ("eopie" , & self . eopie ()) . field ("obl_launch" , & self . obl_launch ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ pg: {=bool:?}, per: {=bool:?}, mer: {=bool:?}, optpg: {=bool:?}, opter: {=bool:?}, strt: {=bool:?}, lock: {=bool:?}, optwre: {=bool:?}, errie: {=bool:?}, eopie: {=bool:?}, obl_launch: {=bool:?} }}" , self . pg () , self . per () , self . mer () , self . optpg () , self . opter () , self . strt () , self . lock () , self . optwre () , self . errie () , self . eopie () , self . obl_launch ()) } } # [doc = "Option byte register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Obr { Obr (0) } } impl core :: fmt :: Debug for Obr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Obr") . field ("opterr" , & self . opterr ()) . field ("rdprt" , & self . rdprt ()) . field ("wdg_sw" , & self . wdg_sw ()) . field ("n_rst_stop" , & self . n_rst_stop ()) . field ("n_rst_stdby" , & self . n_rst_stdby ()) . field ("n_boot1" , & self . n_boot1 ()) . field ("vdda_monitor" , & self . vdda_monitor ()) . field ("sram_parity_check" , & self . sram_parity_check ()) . field ("sdadc12_vdd_monitor" , & self . sdadc12_vdd_monitor ()) . field ("data0" , & self . data0 ()) . field ("data1" , & self . data1 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Obr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Obr {{ opterr: {=bool:?}, rdprt: {:?}, wdg_sw: {:?}, n_rst_stop: {:?}, n_rst_stdby: {:?}, n_boot1: {=bool:?}, vdda_monitor: {=bool:?}, sram_parity_check: {=bool:?}, sdadc12_vdd_monitor: {=bool:?}, data0: {=u8:?}, data1: {=u8:?} }}" , self . opterr () , self . rdprt () , self . wdg_sw () , self . n_rst_stop () , self . n_rst_stdby () , self . n_boot1 () , self . vdda_monitor () , self . sram_parity_check () , self . sdadc12_vdd_monitor () , self . data0 () , self . data1 ()) } } # [doc = "Flash status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("bsy" , & self . bsy ()) . field ("pgerr" , & self . pgerr ()) . field ("wrprterr" , & self . wrprterr ()) . field ("eop" , & self . eop ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ bsy: {=bool:?}, pgerr: {=bool:?}, wrprterr: {=bool:?}, eop: {=bool:?} }}" , self . bsy () , self . pgerr () , self . wrprterr () , self . eop ()) } } # [doc = "Write protection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Wrpr { Wrpr (0) } } impl core :: fmt :: Debug for Wrpr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Wrpr") . field ("wrp" , & self . wrp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Wrpr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Wrpr {{ wrp: {=u32:?} }}" , self . wrp ()) } } } pub mod vals { # [repr (u8)]
...
NO_RESET = 0x01 , } impl NRstStdby { # [inline (always)]
...
RESET = 0x0 , # [doc = "No reset generated"]
NO_RESET = 0x01 , } impl NRstStop { # [inline (always)]

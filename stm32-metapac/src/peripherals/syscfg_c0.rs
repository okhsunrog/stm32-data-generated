...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("lockup_lock" , & self . lockup_lock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ lockup_lock: {=bool:?} }}" , self . lockup_lock ()) } } # [doc = "configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr3 { Cfgr3 (0) } } impl core :: fmt :: Debug for Cfgr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr3") . field ("pinmux0" , & self . pinmux0 ()) . field ("pinmux1" , & self . pinmux1 ()) . field ("pinmux2" , & self . pinmux2 ()) . field ("pinmux3" , & self . pinmux3 ()) . field ("pinmux4" , & self . pinmux4 ()) . field ("pinmux5" , & self . pinmux5 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr3 {{ pinmux0: {:?}, pinmux1: {:?}, pinmux2: {:?}, pinmux3: {:?}, pinmux4: {:?}, pinmux5: {:?} }}" , self . pinmux0 () , self . pinmux1 () , self . pinmux2 () , self . pinmux3 () , self . pinmux4 () , self . pinmux5 ()) } } # [doc = "interrupt line 0 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Itline0 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline0 {{ wwdg: {=bool:?} }}" , self . wwdg ()) } } # [doc = "interrupt line 10 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline11 { Itline11 (0) } } impl core :: fmt :: Debug for Itline11 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline11") . field ("dmamux" , & self . dmamux ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline11 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline11 {{ dmamux: {=bool:?} }}" , self . dmamux ()) } } # [doc = "interrupt line 12 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline12 { Itline12 (0) } } impl core :: fmt :: Debug for Itline12 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline12") . field ("adc" , & self . adc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline12 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline12 {{ adc: {=bool:?} }}" , self . adc ()) } } # [doc = "interrupt line 13 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Itline14 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline14 {{ tim1_cc: {=bool:?} }}" , self . tim1_cc ()) } } # [doc = "interrupt line 16 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Itline16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline16 {{ tim3: {=bool:?} }}" , self . tim3 ()) } } # [doc = "interrupt line 19 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline2 { Itline2 (0) } } impl core :: fmt :: Debug for Itline2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline2") . field ("rtc" , & self . rtc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline2 {{ rtc: {=bool:?} }}" , self . rtc ()) } } # [doc = "interrupt line 21 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Itline23 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline23 {{ i2c1: {=bool:?} }}" , self . i2c1 ()) } } # [doc = "interrupt line 25 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Itline25 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline25 {{ spi1: {=bool:?} }}" , self . spi1 ()) } } # [doc = "interrupt line 27 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Itline28 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline28 {{ usart2: {=bool:?} }}" , self . usart2 ()) } } # [doc = "interrupt line 3 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline3 { Itline3 (0) } } impl core :: fmt :: Debug for Itline3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline3") . field ("flash_itf" , & self . flash_itf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline3 {{ flash_itf: {=bool:?} }}" , self . flash_itf ()) } } # [doc = "interrupt line 4 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline5 { Itline5 (0) } } impl core :: fmt :: Debug for Itline5 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline5") . field ("exti[0]" , & self . exti (0usize)) . field ("exti[1]" , & self . exti (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline5 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline5 {{ exti[0]: {=bool:?}, exti[1]: {=bool:?} }}" , self . exti (0usize) , self . exti (1usize)) } } # [doc = "interrupt line 6 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline6 { Itline6 (0) } } impl core :: fmt :: Debug for Itline6 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline6") . field ("exti[0]" , & self . exti (0usize)) . field ("exti[1]" , & self . exti (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline6 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline6 {{ exti[0]: {=bool:?}, exti[1]: {=bool:?} }}" , self . exti (0usize) , self . exti (1usize)) } } # [doc = "interrupt line 7 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline7 { Itline7 (0) } } impl core :: fmt :: Debug for Itline7 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline7") . field ("exti[0]" , & self . exti (0usize)) . field ("exti[1]" , & self . exti (1usize)) . field ("exti[2]" , & self . exti (2usize)) . field ("exti[3]" , & self . exti (3usize)) . field ("exti[4]" , & self . exti (4usize)) . field ("exti[5]" , & self . exti (5usize)) . field ("exti[6]" , & self . exti (6usize)) . field ("exti[7]" , & self . exti (7usize)) . field ("exti[8]" , & self . exti (8usize)) . field ("exti[9]" , & self . exti (9usize)) . field ("exti[10]" , & self . exti (10usize)) . field ("exti[11]" , & self . exti (11usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline7 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline7 {{ exti[0]: {=bool:?}, exti[1]: {=bool:?}, exti[2]: {=bool:?}, exti[3]: {=bool:?}, exti[4]: {=bool:?}, exti[5]: {=bool:?}, exti[6]: {=bool:?}, exti[7]: {=bool:?}, exti[8]: {=bool:?}, exti[9]: {=bool:?}, exti[10]: {=bool:?}, exti[11]: {=bool:?} }}" , self . exti (0usize) , self . exti (1usize) , self . exti (2usize) , self . exti (3usize) , self . exti (4usize) , self . exti (5usize) , self . exti (6usize) , self . exti (7usize) , self . exti (8usize) , self . exti (9usize) , self . exti (10usize) , self . exti (11usize)) } } # [doc = "interrupt line 9 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Itline9 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Itline9 {{ dma1_ch1: {=bool:?} }}" , self . dma1_ch1 ()) } } } pub mod vals { # [repr (u8)]

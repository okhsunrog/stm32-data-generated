...
fn default () -> Dmabmr { Dmabmr (0) } } impl core :: fmt :: Debug for Dmabmr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmabmr") . field ("sr" , & self . sr ()) . field ("da" , & self . da ()) . field ("dsl" , & self . dsl ()) . field ("edfe" , & self . edfe ()) . field ("pbl" , & self . pbl ()) . field ("pm" , & self . pm ()) . field ("fb" , & self . fb ()) . field ("rdp" , & self . rdp ()) . field ("usp" , & self . usp ()) . field ("fpm" , & self . fpm ()) . field ("aab" , & self . aab ()) . field ("mb" , & self . mb ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmabmr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmabmr {{ sr: {=bool:?}, da: {:?}, dsl: {=u8:?}, edfe: {=bool:?}, pbl: {:?}, pm: {:?}, fb: {:?}, rdp: {:?}, usp: {:?}, fpm: {:?}, aab: {=bool:?}, mb: {:?} }}" , self . sr () , self . da () , self . dsl () , self . edfe () , self . pbl () , self . pm () , self . fb () , self . rdp () , self . usp () , self . fpm () , self . aab () , self . mb ()) } } # [doc = "Ethernet DMA current host receive buffer address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmachrbar { Dmachrbar (0) } } impl core :: fmt :: Debug for Dmachrbar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmachrbar") . field ("hrbap" , & self . hrbap ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmachrbar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmachrbar {{ hrbap: {=u32:?} }}" , self . hrbap ()) } } # [doc = "Ethernet DMA current host receive descriptor register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmachrdr { Dmachrdr (0) } } impl core :: fmt :: Debug for Dmachrdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmachrdr") . field ("hrdap" , & self . hrdap ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmachrdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmachrdr {{ hrdap: {=u32:?} }}" , self . hrdap ()) } } # [doc = "Ethernet DMA current host transmit buffer address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmachtbar { Dmachtbar (0) } } impl core :: fmt :: Debug for Dmachtbar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmachtbar") . field ("htbap" , & self . htbap ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmachtbar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmachtbar {{ htbap: {=u32:?} }}" , self . htbap ()) } } # [doc = "Ethernet DMA current host transmit descriptor register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmachtdr { Dmachtdr (0) } } impl core :: fmt :: Debug for Dmachtdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmachtdr") . field ("htdap" , & self . htdap ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmachtdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmachtdr {{ htdap: {=u32:?} }}" , self . htdap ()) } } # [doc = "Ethernet DMA interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmaier { Dmaier (0) } } impl core :: fmt :: Debug for Dmaier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmaier") . field ("tie" , & self . tie ()) . field ("tpsie" , & self . tpsie ()) . field ("tbuie" , & self . tbuie ()) . field ("tjtie" , & self . tjtie ()) . field ("roie" , & self . roie ()) . field ("tuie" , & self . tuie ()) . field ("rie" , & self . rie ()) . field ("rbuie" , & self . rbuie ()) . field ("rpsie" , & self . rpsie ()) . field ("rwtie" , & self . rwtie ()) . field ("etie" , & self . etie ()) . field ("fbeie" , & self . fbeie ()) . field ("erie" , & self . erie ()) . field ("aise" , & self . aise ()) . field ("nise" , & self . nise ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmaier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmaier {{ tie: {=bool:?}, tpsie: {=bool:?}, tbuie: {=bool:?}, tjtie: {=bool:?}, roie: {=bool:?}, tuie: {=bool:?}, rie: {=bool:?}, rbuie: {=bool:?}, rpsie: {=bool:?}, rwtie: {=bool:?}, etie: {=bool:?}, fbeie: {=bool:?}, erie: {=bool:?}, aise: {=bool:?}, nise: {=bool:?} }}" , self . tie () , self . tpsie () , self . tbuie () , self . tjtie () , self . roie () , self . tuie () , self . rie () , self . rbuie () , self . rpsie () , self . rwtie () , self . etie () , self . fbeie () , self . erie () , self . aise () , self . nise ()) } } # [doc = "Ethernet DMA missed frame and buffer overflow counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmamfbocr { Dmamfbocr (0) } } impl core :: fmt :: Debug for Dmamfbocr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmamfbocr") . field ("mfc" , & self . mfc ()) . field ("omfc" , & self . omfc ()) . field ("mfa" , & self . mfa ()) . field ("ofoc" , & self . ofoc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmamfbocr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmamfbocr {{ mfc: {=u16:?}, omfc: {=bool:?}, mfa: {=u16:?}, ofoc: {=bool:?} }}" , self . mfc () , self . omfc () , self . mfa () , self . ofoc ()) } } # [doc = "Ethernet DMA operation mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmaomr { Dmaomr (0) } } impl core :: fmt :: Debug for Dmaomr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmaomr") . field ("sr" , & self . sr ()) . field ("osf" , & self . osf ()) . field ("rtc" , & self . rtc ()) . field ("fugf" , & self . fugf ()) . field ("fef" , & self . fef ()) . field ("st" , & self . st ()) . field ("ttc" , & self . ttc ()) . field ("ftf" , & self . ftf ()) . field ("tsf" , & self . tsf ()) . field ("dfrf" , & self . dfrf ()) . field ("rsf" , & self . rsf ()) . field ("dtcefd" , & self . dtcefd ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmaomr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmaomr {{ sr: {:?}, osf: {=bool:?}, rtc: {:?}, fugf: {:?}, fef: {:?}, st: {:?}, ttc: {:?}, ftf: {:?}, tsf: {:?}, dfrf: {=bool:?}, rsf: {:?}, dtcefd: {:?} }}" , self . sr () , self . osf () , self . rtc () , self . fugf () , self . fef () , self . st () , self . ttc () , self . ftf () , self . tsf () , self . dfrf () , self . rsf () , self . dtcefd ()) } } # [doc = "Ethernet DMA receive descriptor list address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmardlar { Dmardlar (0) } } impl core :: fmt :: Debug for Dmardlar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmardlar") . field ("srl" , & self . srl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmardlar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmardlar {{ srl: {=u32:?} }}" , self . srl ()) } } # [doc = "EHERNET DMA receive poll demand register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmarpdr { Dmarpdr (0) } } impl core :: fmt :: Debug for Dmarpdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmarpdr") . field ("rpd" , & self . rpd ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmarpdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmarpdr {{ rpd: {:?} }}" , self . rpd ()) } } # [doc = "Ethernet DMA receive status watchdog timer register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmarswtr { Dmarswtr (0) } } impl core :: fmt :: Debug for Dmarswtr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmarswtr") . field ("rswtc" , & self . rswtc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmarswtr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmarswtr {{ rswtc: {=u8:?} }}" , self . rswtc ()) } } # [doc = "Ethernet DMA status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmasr { Dmasr (0) } } impl core :: fmt :: Debug for Dmasr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmasr") . field ("ts" , & self . ts ()) . field ("tpss" , & self . tpss ()) . field ("tbus" , & self . tbus ()) . field ("tjts" , & self . tjts ()) . field ("ros" , & self . ros ()) . field ("tus" , & self . tus ()) . field ("rs" , & self . rs ()) . field ("rbus" , & self . rbus ()) . field ("rpss" , & self . rpss ()) . field ("pwts" , & self . pwts ()) . field ("ets" , & self . ets ()) . field ("fbes" , & self . fbes ()) . field ("ers" , & self . ers ()) . field ("ais" , & self . ais ()) . field ("nis" , & self . nis ()) . field ("rps" , & self . rps ()) . field ("tps" , & self . tps ()) . field ("ebs" , & self . ebs ()) . field ("mmcs" , & self . mmcs ()) . field ("pmts" , & self . pmts ()) . field ("tsts" , & self . tsts ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmasr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmasr {{ ts: {=bool:?}, tpss: {=bool:?}, tbus: {=bool:?}, tjts: {=bool:?}, ros: {=bool:?}, tus: {=bool:?}, rs: {=bool:?}, rbus: {=bool:?}, rpss: {=bool:?}, pwts: {=bool:?}, ets: {=bool:?}, fbes: {=bool:?}, ers: {=bool:?}, ais: {=bool:?}, nis: {=bool:?}, rps: {:?}, tps: {:?}, ebs: {=u8:?}, mmcs: {=bool:?}, pmts: {=bool:?}, tsts: {=bool:?} }}" , self . ts () , self . tpss () , self . tbus () , self . tjts () , self . ros () , self . tus () , self . rs () , self . rbus () , self . rpss () , self . pwts () , self . ets () , self . fbes () , self . ers () , self . ais () , self . nis () , self . rps () , self . tps () , self . ebs () , self . mmcs () , self . pmts () , self . tsts ()) } } # [doc = "Ethernet DMA transmit descriptor list address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmatdlar { Dmatdlar (0) } } impl core :: fmt :: Debug for Dmatdlar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmatdlar") . field ("stl" , & self . stl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmatdlar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmatdlar {{ stl: {=u32:?} }}" , self . stl ()) } } # [doc = "Ethernet DMA transmit poll demand register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dmatpdr { Dmatpdr (0) } } impl core :: fmt :: Debug for Dmatpdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dmatpdr") . field ("tpd" , & self . tpd ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dmatpdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dmatpdr {{ tpd: {:?} }}" , self . tpd ()) } } # [doc = "Ethernet MAC address 0 high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Maca0hr { Maca0hr (0) } } impl core :: fmt :: Debug for Maca0hr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Maca0hr") . field ("maca0h" , & self . maca0h ()) . field ("mo" , & self . mo ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Maca0hr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Maca0hr {{ maca0h: {=u16:?}, mo: {=bool:?} }}" , self . maca0h () , self . mo ()) } } # [doc = "Ethernet MAC address 0 low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Maca0lr { Maca0lr (0) } } impl core :: fmt :: Debug for Maca0lr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Maca0lr") . field ("maca0l" , & self . maca0l ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Maca0lr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Maca0lr {{ maca0l: {=u32:?} }}" , self . maca0l ()) } } # [doc = "Ethernet MAC address 1/2/3 high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macahr { Macahr (0) } } impl core :: fmt :: Debug for Macahr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macahr") . field ("macah" , & self . macah ()) . field ("mbc" , & self . mbc ()) . field ("sa" , & self . sa ()) . field ("ae" , & self . ae ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macahr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macahr {{ macah: {=u16:?}, mbc: {=u8:?}, sa: {:?}, ae: {=bool:?} }}" , self . macah () , self . mbc () , self . sa () , self . ae ()) } } # [doc = "Ethernet MAC address 1/2/3 low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macalr { Macalr (0) } } impl core :: fmt :: Debug for Macalr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macalr") . field ("macal" , & self . macal ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macalr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macalr {{ macal: {=u32:?} }}" , self . macal ()) } } # [doc = "Ethernet MAC configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Maccr { Maccr (0) } } impl core :: fmt :: Debug for Maccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Maccr") . field ("re" , & self . re ()) . field ("te" , & self . te ()) . field ("dc" , & self . dc ()) . field ("bl" , & self . bl ()) . field ("apcs" , & self . apcs ()) . field ("rd" , & self . rd ()) . field ("ipco" , & self . ipco ()) . field ("dm" , & self . dm ()) . field ("lm" , & self . lm ()) . field ("rod" , & self . rod ()) . field ("fes" , & self . fes ()) . field ("csd" , & self . csd ()) . field ("ifg" , & self . ifg ()) . field ("jd" , & self . jd ()) . field ("wd" , & self . wd ()) . field ("cstf" , & self . cstf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Maccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Maccr {{ re: {=bool:?}, te: {=bool:?}, dc: {=bool:?}, bl: {:?}, apcs: {:?}, rd: {:?}, ipco: {:?}, dm: {:?}, lm: {:?}, rod: {:?}, fes: {:?}, csd: {:?}, ifg: {:?}, jd: {:?}, wd: {:?}, cstf: {=bool:?} }}" , self . re () , self . te () , self . dc () , self . bl () , self . apcs () , self . rd () , self . ipco () , self . dm () , self . lm () , self . rod () , self . fes () , self . csd () , self . ifg () , self . jd () , self . wd () , self . cstf ()) } } # [doc = "Ethernet MAC debug register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macdbgr { Macdbgr (0) } } impl core :: fmt :: Debug for Macdbgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macdbgr") . field ("mmrpea" , & self . mmrpea ()) . field ("msfrwcs" , & self . msfrwcs ()) . field ("rfwra" , & self . rfwra ()) . field ("rfrcs" , & self . rfrcs ()) . field ("rffl" , & self . rffl ()) . field ("mmtea" , & self . mmtea ()) . field ("mtfcs" , & self . mtfcs ()) . field ("mtp" , & self . mtp ()) . field ("tfrs" , & self . tfrs ()) . field ("tfwa" , & self . tfwa ()) . field ("tfne" , & self . tfne ()) . field ("tff" , & self . tff ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macdbgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macdbgr {{ mmrpea: {=bool:?}, msfrwcs: {=u8:?}, rfwra: {=bool:?}, rfrcs: {=u8:?}, rffl: {=u8:?}, mmtea: {=bool:?}, mtfcs: {=u8:?}, mtp: {=bool:?}, tfrs: {=u8:?}, tfwa: {=bool:?}, tfne: {=bool:?}, tff: {=bool:?} }}" , self . mmrpea () , self . msfrwcs () , self . rfwra () , self . rfrcs () , self . rffl () , self . mmtea () , self . mtfcs () , self . mtp () , self . tfrs () , self . tfwa () , self . tfne () , self . tff ()) } } # [doc = "Ethernet MAC flow control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macfcr { Macfcr (0) } } impl core :: fmt :: Debug for Macfcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macfcr") . field ("fcb" , & self . fcb ()) . field ("tfce" , & self . tfce ()) . field ("rfce" , & self . rfce ()) . field ("upfd" , & self . upfd ()) . field ("plt" , & self . plt ()) . field ("zqpd" , & self . zqpd ()) . field ("pt" , & self . pt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macfcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macfcr {{ fcb: {:?}, tfce: {=bool:?}, rfce: {=bool:?}, upfd: {=bool:?}, plt: {:?}, zqpd: {:?}, pt: {=u16:?} }}" , self . fcb () , self . tfce () , self . rfce () , self . upfd () , self . plt () , self . zqpd () , self . pt ()) } } # [doc = "Ethernet MAC frame filter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macffr { Macffr (0) } } impl core :: fmt :: Debug for Macffr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macffr") . field ("pm" , & self . pm ()) . field ("hu" , & self . hu ()) . field ("hm" , & self . hm ()) . field ("daif" , & self . daif ()) . field ("pam" , & self . pam ()) . field ("bfd" , & self . bfd ()) . field ("pcf" , & self . pcf ()) . field ("saif" , & self . saif ()) . field ("saf" , & self . saf ()) . field ("hpf" , & self . hpf ()) . field ("ra" , & self . ra ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macffr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macffr {{ pm: {=bool:?}, hu: {:?}, hm: {:?}, daif: {:?}, pam: {=bool:?}, bfd: {:?}, pcf: {:?}, saif: {:?}, saf: {=bool:?}, hpf: {:?}, ra: {=bool:?} }}" , self . pm () , self . hu () , self . hm () , self . daif () , self . pam () , self . bfd () , self . pcf () , self . saif () , self . saf () , self . hpf () , self . ra ()) } } # [doc = "Ethernet MAC hash table high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Machthr { Machthr (0) } } impl core :: fmt :: Debug for Machthr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Machthr") . field ("hth" , & self . hth ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Machthr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Machthr {{ hth: {=u32:?} }}" , self . hth ()) } } # [doc = "Ethernet MAC hash table low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Machtlr { Machtlr (0) } } impl core :: fmt :: Debug for Machtlr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Machtlr") . field ("htl" , & self . htl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Machtlr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Machtlr {{ htl: {=u32:?} }}" , self . htl ()) } } # [doc = "Ethernet MAC interrupt mask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macimr { Macimr (0) } } impl core :: fmt :: Debug for Macimr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macimr") . field ("pmtim" , & self . pmtim ()) . field ("tstim" , & self . tstim ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macimr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macimr {{ pmtim: {:?}, tstim: {:?} }}" , self . pmtim () , self . tstim ()) } } # [doc = "Ethernet MAC MII address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macmiiar { Macmiiar (0) } } impl core :: fmt :: Debug for Macmiiar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macmiiar") . field ("mb" , & self . mb ()) . field ("mw" , & self . mw ()) . field ("cr" , & self . cr ()) . field ("mr" , & self . mr ()) . field ("pa" , & self . pa ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macmiiar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macmiiar {{ mb: {:?}, mw: {:?}, cr: {:?}, mr: {=u8:?}, pa: {=u8:?} }}" , self . mb () , self . mw () , self . cr () , self . mr () , self . pa ()) } } # [doc = "Ethernet MAC MII data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macmiidr { Macmiidr (0) } } impl core :: fmt :: Debug for Macmiidr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macmiidr") . field ("md" , & self . md ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macmiidr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macmiidr {{ md: {=u16:?} }}" , self . md ()) } } # [doc = "Ethernet MAC PMT control and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macpmtcsr { Macpmtcsr (0) } } impl core :: fmt :: Debug for Macpmtcsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macpmtcsr") . field ("pd" , & self . pd ()) . field ("mpe" , & self . mpe ()) . field ("wfe" , & self . wfe ()) . field ("mpr" , & self . mpr ()) . field ("wfr" , & self . wfr ()) . field ("gu" , & self . gu ()) . field ("wffrpr" , & self . wffrpr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macpmtcsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macpmtcsr {{ pd: {:?}, mpe: {=bool:?}, wfe: {=bool:?}, mpr: {=bool:?}, wfr: {=bool:?}, gu: {=bool:?}, wffrpr: {:?} }}" , self . pd () , self . mpe () , self . wfe () , self . mpr () , self . wfr () , self . gu () , self . wffrpr ()) } } # [doc = "Ethernet MAC interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macsr { Macsr (0) } } impl core :: fmt :: Debug for Macsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macsr") . field ("pmts" , & self . pmts ()) . field ("mmcs" , & self . mmcs ()) . field ("mmcrs" , & self . mmcrs ()) . field ("mmcts" , & self . mmcts ()) . field ("tsts" , & self . tsts ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macsr {{ pmts: {=bool:?}, mmcs: {=bool:?}, mmcrs: {=bool:?}, mmcts: {=bool:?}, tsts: {=bool:?} }}" , self . pmts () , self . mmcs () , self . mmcrs () , self . mmcts () , self . tsts ()) } } # [doc = "Ethernet MAC VLAN tag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Macvlantr { Macvlantr (0) } } impl core :: fmt :: Debug for Macvlantr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Macvlantr") . field ("vlanti" , & self . vlanti ()) . field ("vlantc" , & self . vlantc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Macvlantr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Macvlantr {{ vlanti: {=u16:?}, vlantc: {:?} }}" , self . vlanti () , self . vlantc ()) } } # [doc = "Ethernet MMC control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmccr { Mmccr (0) } } impl core :: fmt :: Debug for Mmccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmccr") . field ("cr" , & self . cr ()) . field ("csr" , & self . csr ()) . field ("ror" , & self . ror ()) . field ("mcf" , & self . mcf ()) . field ("mcp" , & self . mcp ()) . field ("mcfhp" , & self . mcfhp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmccr {{ cr: {:?}, csr: {:?}, ror: {=bool:?}, mcf: {=bool:?}, mcp: {:?}, mcfhp: {:?} }}" , self . cr () , self . csr () , self . ror () , self . mcf () , self . mcp () , self . mcfhp ()) } } # [doc = "Ethernet MMC received frames with alignment error counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmcrfaecr { Mmcrfaecr (0) } } impl core :: fmt :: Debug for Mmcrfaecr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmcrfaecr") . field ("rfaec" , & self . rfaec ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmcrfaecr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmcrfaecr {{ rfaec: {=u32:?} }}" , self . rfaec ()) } } # [doc = "Ethernet MMC received frames with CRC error counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmcrfcecr { Mmcrfcecr (0) } } impl core :: fmt :: Debug for Mmcrfcecr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmcrfcecr") . field ("rfcfc" , & self . rfcfc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmcrfcecr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmcrfcecr {{ rfcfc: {=u32:?} }}" , self . rfcfc ()) } } # [doc = "MMC received good unicast frames counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmcrgufcr { Mmcrgufcr (0) } } impl core :: fmt :: Debug for Mmcrgufcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmcrgufcr") . field ("rgufc" , & self . rgufc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmcrgufcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmcrgufcr {{ rgufc: {=u32:?} }}" , self . rgufc ()) } } # [doc = "Ethernet MMC receive interrupt mask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmcrimr { Mmcrimr (0) } } impl core :: fmt :: Debug for Mmcrimr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmcrimr") . field ("rfcem" , & self . rfcem ()) . field ("rfaem" , & self . rfaem ()) . field ("rgufm" , & self . rgufm ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmcrimr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmcrimr {{ rfcem: {:?}, rfaem: {:?}, rgufm: {:?} }}" , self . rfcem () , self . rfaem () , self . rgufm ()) } } # [doc = "Ethernet MMC receive interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmcrir { Mmcrir (0) } } impl core :: fmt :: Debug for Mmcrir { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmcrir") . field ("rfces" , & self . rfces ()) . field ("rfaes" , & self . rfaes ()) . field ("rgufs" , & self . rgufs ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmcrir { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmcrir {{ rfces: {=bool:?}, rfaes: {=bool:?}, rgufs: {=bool:?} }}" , self . rfces () , self . rfaes () , self . rgufs ()) } } # [doc = "Ethernet MMC transmitted good frames counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmctgfcr { Mmctgfcr (0) } } impl core :: fmt :: Debug for Mmctgfcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmctgfcr") . field ("tgfc" , & self . tgfc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmctgfcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmctgfcr {{ tgfc: {=u32:?} }}" , self . tgfc ()) } } # [doc = "Ethernet MMC transmitted good frames after more than a single collision"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmctgfmsccr { Mmctgfmsccr (0) } } impl core :: fmt :: Debug for Mmctgfmsccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmctgfmsccr") . field ("tgfmscc" , & self . tgfmscc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmctgfmsccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmctgfmsccr {{ tgfmscc: {=u32:?} }}" , self . tgfmscc ()) } } # [doc = "Ethernet MMC transmitted good frames after a single collision counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmctgfsccr { Mmctgfsccr (0) } } impl core :: fmt :: Debug for Mmctgfsccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmctgfsccr") . field ("tgfscc" , & self . tgfscc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmctgfsccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmctgfsccr {{ tgfscc: {=u32:?} }}" , self . tgfscc ()) } } # [doc = "Ethernet MMC transmit interrupt mask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmctimr { Mmctimr (0) } } impl core :: fmt :: Debug for Mmctimr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmctimr") . field ("tgfscm" , & self . tgfscm ()) . field ("tgfmscm" , & self . tgfmscm ()) . field ("tgfm" , & self . tgfm ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmctimr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmctimr {{ tgfscm: {:?}, tgfmscm: {:?}, tgfm: {:?} }}" , self . tgfscm () , self . tgfmscm () , self . tgfm ()) } } # [doc = "Ethernet MMC transmit interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmctir { Mmctir (0) } } impl core :: fmt :: Debug for Mmctir { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmctir") . field ("tgfscs" , & self . tgfscs ()) . field ("tgfmscs" , & self . tgfmscs ()) . field ("tgfs" , & self . tgfs ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmctir { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmctir {{ tgfscs: {=bool:?}, tgfmscs: {=bool:?}, tgfs: {=bool:?} }}" , self . tgfscs () , self . tgfmscs () , self . tgfs ()) } } # [doc = "Ethernet PTP PPS control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptpppscr { Ptpppscr (0) } } impl core :: fmt :: Debug for Ptpppscr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptpppscr") . field ("tsso" , & self . tsso ()) . field ("tsttr" , & self . tsttr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptpppscr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptpppscr {{ tsso: {=bool:?}, tsttr: {=bool:?} }}" , self . tsso () , self . tsttr ()) } } # [doc = "Ethernet PTP subsecond increment register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptpssir { Ptpssir (0) } } impl core :: fmt :: Debug for Ptpssir { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptpssir") . field ("stssi" , & self . stssi ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptpssir { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptpssir {{ stssi: {=u8:?} }}" , self . stssi ()) } } # [doc = "Ethernet PTP time stamp addend register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptptsar { Ptptsar (0) } } impl core :: fmt :: Debug for Ptptsar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptptsar") . field ("tsa" , & self . tsa ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptptsar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptptsar {{ tsa: {=u32:?} }}" , self . tsa ()) } } # [doc = "Ethernet PTP time stamp control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptptscr { Ptptscr (0) } } impl core :: fmt :: Debug for Ptptscr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptptscr") . field ("tse" , & self . tse ()) . field ("tsfcu" , & self . tsfcu ()) . field ("tssti" , & self . tssti ()) . field ("tsstu" , & self . tsstu ()) . field ("tsite" , & self . tsite ()) . field ("ttsaru" , & self . ttsaru ()) . field ("tssarfe" , & self . tssarfe ()) . field ("tsssr" , & self . tsssr ()) . field ("tsptppsv2e" , & self . tsptppsv2e ()) . field ("tssptpoefe" , & self . tssptpoefe ()) . field ("tssipv6fe" , & self . tssipv6fe ()) . field ("tssipv4fe" , & self . tssipv4fe ()) . field ("tsseme" , & self . tsseme ()) . field ("tssmrme" , & self . tssmrme ()) . field ("tscnt" , & self . tscnt ()) . field ("tspffmae" , & self . tspffmae ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptptscr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptptscr {{ tse: {=bool:?}, tsfcu: {=bool:?}, tssti: {=bool:?}, tsstu: {=bool:?}, tsite: {=bool:?}, ttsaru: {=bool:?}, tssarfe: {=bool:?}, tsssr: {=bool:?}, tsptppsv2e: {=bool:?}, tssptpoefe: {=bool:?}, tssipv6fe: {=bool:?}, tssipv4fe: {=bool:?}, tsseme: {=bool:?}, tssmrme: {=bool:?}, tscnt: {=u8:?}, tspffmae: {=bool:?} }}" , self . tse () , self . tsfcu () , self . tssti () , self . tsstu () , self . tsite () , self . ttsaru () , self . tssarfe () , self . tsssr () , self . tsptppsv2e () , self . tssptpoefe () , self . tssipv6fe () , self . tssipv4fe () , self . tsseme () , self . tssmrme () , self . tscnt () , self . tspffmae ()) } } # [doc = "Ethernet PTP time stamp high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptptshr { Ptptshr (0) } } impl core :: fmt :: Debug for Ptptshr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptptshr") . field ("sts" , & self . sts ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptptshr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptptshr {{ sts: {=u32:?} }}" , self . sts ()) } } # [doc = "Ethernet PTP time stamp high update register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptptshur { Ptptshur (0) } } impl core :: fmt :: Debug for Ptptshur { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptptshur") . field ("tsus" , & self . tsus ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptptshur { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptptshur {{ tsus: {=u32:?} }}" , self . tsus ()) } } # [doc = "Ethernet PTP time stamp low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptptslr { Ptptslr (0) } } impl core :: fmt :: Debug for Ptptslr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptptslr") . field ("stss" , & self . stss ()) . field ("stpns" , & self . stpns ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptptslr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptptslr {{ stss: {=u32:?}, stpns: {=bool:?} }}" , self . stss () , self . stpns ()) } } # [doc = "Ethernet PTP time stamp low update register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptptslur { Ptptslur (0) } } impl core :: fmt :: Debug for Ptptslur { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptptslur") . field ("tsuss" , & self . tsuss ()) . field ("tsupns" , & self . tsupns ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptptslur { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptptslur {{ tsuss: {=u32:?}, tsupns: {=bool:?} }}" , self . tsuss () , self . tsupns ()) } } # [doc = "Ethernet PTP time stamp status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptptssr { Ptptssr (0) } } impl core :: fmt :: Debug for Ptptssr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptptssr") . field ("tsso" , & self . tsso ()) . field ("tsttr" , & self . tsttr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptptssr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptptssr {{ tsso: {=bool:?}, tsttr: {=bool:?} }}" , self . tsso () , self . tsttr ()) } } # [doc = "Ethernet PTP target time high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptptthr { Ptptthr (0) } } impl core :: fmt :: Debug for Ptptthr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptptthr") . field ("ttsh" , & self . ttsh ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptptthr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptptthr {{ ttsh: {=u32:?} }}" , self . ttsh ()) } } # [doc = "Ethernet PTP target time low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ptpttlr { Ptpttlr (0) } } impl core :: fmt :: Debug for Ptpttlr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ptpttlr") . field ("ttsl" , & self . ttsl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ptpttlr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ptpttlr {{ ttsl: {=u32:?} }}" , self . ttsl ()) } } } pub mod vals { # [repr (u8)]
...
NOT_ROLLOVER = 0x01 , } impl Csr { # [inline (always)]
...
ROUND_ROBIN = 0x0 , # [doc = "Rx has priority over Tx"]
RX_PRIORITY = 0x01 , } impl Da { # [inline (always)]
...
HALF_DUPLEX = 0x0 , # [doc = "MAC operates in full-duplex mode"]
FULL_DUPLEX = 0x01 , } impl Dm { # [inline (always)]
...
DISABLE_BACK_PRESSURE = 0x0 , # [doc = "In full duplex, initiate a Pause control frame. In half duplex, assert back pressure"]
PAUSE_OR_BACK_PRESSURE = 0x01 , } impl Fcb { # [inline (always)]
...
HASH_ONLY = 0x0 , # [doc = "If HM or HU is set, frames that match either the perfect filter or the hash filter are passed"]
HASH_OR_PERFECT = 0x01 , } impl Hpf { # [inline (always)]
...
ALMOST_HALF = 0x0 , # [doc = "When MCP is set, MMC counters are preset to almost-full value 0xFFFF_FFF0"]
ALMOST_FULL = 0x01 , } impl Mcfhp { # [inline (always)]
...
PREVENT_ALL = 0x0 , # [doc = "MAC forwards all control frames to application except Pause"]
FORWARD_ALL_EXCEPT_PAUSE = 0x01 , # [doc = "MAC forwards all control frames to application even if they fail the address filter"]
FORWARD_ALL = 0x02 , # [doc = "MAC forwards control frames that pass the address filter"]
FORWARD_ALL_FILTERED = 0x03 , } impl Pcf { # [inline (always)]
...
ONE_TO_ONE = 0x0 , # [doc = "RxDMA priority over TxDMA is 2:1"]
TWO_TO_ONE = 0x01 , # [doc = "RxDMA priority over TxDMA is 3:1"]
THREE_TO_ONE = 0x02 , # [doc = "RxDMA priority over TxDMA is 4:1"]
FOUR_TO_ONE = 0x03 , } impl PriorityRxOverTx { # [inline (always)]
...
pub struct Rpd (u32) ; impl Rpd { # [doc = "Poll the receive descriptor list"]
pub const POLL : Self = Self (0x0) ; } impl Rpd { pub const fn from_bits (val : u32) -> Rpd { Self (val & 0xffff_ffff) } pub const fn to_bits (self) -> u32 { self . 0 } } impl core :: fmt :: Debug for Rpd { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { match self . 0 { 0x0 => f . write_str ("POLL") , other => core :: write ! (f , "0x{:02X}" , other) , } } } # [cfg (feature = "defmt")]
impl defmt :: Format for Rpd { fn format (& self , f : defmt :: Formatter) { match self . 0 { 0x0 => defmt :: write ! (f , "POLL") , other => defmt :: write ! (f , "0x{:02X}" , other) , } } } impl From < u32 > for Rpd { # [inline (always)]
...
RUNNING_FETCHING = 0x01 , _RESERVED_2 = 0x02 , # [doc = "Running, waiting for receive packet"]
RUNNING_WAITING = 0x03 , # [doc = "Suspended, receive descriptor unavailable"]
SUSPENDED = 0x04 , _RESERVED_5 = 0x05 , _RESERVED_6 = 0x06 , # [doc = "Running, writing data to host memory buffer"]
RUNNING_WRITING = 0x07 , } impl Rps { # [inline (always)]
...
CUT_THROUGH = 0x0 , # [doc = "Frames are read from Rx FIFO after complete frame has been written"]
STORE_FORWARD = 0x01 , } impl Rsf { # [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub struct Tpd (u32) ; impl Tpd { # [doc = "Poll the transmit descriptor list"]
pub const POLL : Self = Self (0x0) ; } impl Tpd { pub const fn from_bits (val : u32) -> Tpd { Self (val & 0xffff_ffff) } pub const fn to_bits (self) -> u32 { self . 0 } } impl core :: fmt :: Debug for Tpd { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { match self . 0 { 0x0 => f . write_str ("POLL") , other => core :: write ! (f , "0x{:02X}" , other) , } } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tpd { fn format (& self , f : defmt :: Formatter) { match self . 0 { 0x0 => defmt :: write ! (f , "POLL") , other => defmt :: write ! (f , "0x{:02X}" , other) , } } } impl From < u32 > for Tpd { # [inline (always)]
...
RUNNING_FETCHING = 0x01 , # [doc = "Running, waiting for status"]
RUNNING_WAITING = 0x02 , # [doc = "Running, reading data from host memory buffer"]
RUNNING_READING = 0x03 , _RESERVED_4 = 0x04 , _RESERVED_5 = 0x05 , # [doc = "Suspended, transmit descriptor unavailable or transmit buffer underflow"]
...
CUT_THROUGH = 0x0 , # [doc = "Transmission starts when a full frame is in the Tx FIFO"]
STORE_FORWARD = 0x01 , } impl Tsf { # [inline (always)]

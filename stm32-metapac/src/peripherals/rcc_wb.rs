...
fn default () -> Ahb1enr { Ahb1enr (0) } } impl core :: fmt :: Debug for Ahb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1enr") . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("dmamux1en" , & self . dmamux1en ()) . field ("crcen" , & self . crcen ()) . field ("tscen" , & self . tscen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1enr {{ dma1en: {=bool:?}, dma2en: {=bool:?}, dmamux1en: {=bool:?}, crcen: {=bool:?}, tscen: {=bool:?} }}" , self . dma1en () , self . dma2en () , self . dmamux1en () , self . crcen () , self . tscen ()) } } # [doc = "AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb1rstr { Ahb1rstr (0) } } impl core :: fmt :: Debug for Ahb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1rstr") . field ("dma1rst" , & self . dma1rst ()) . field ("dma2rst" , & self . dma2rst ()) . field ("dmamux1rst" , & self . dmamux1rst ()) . field ("crcrst" , & self . crcrst ()) . field ("tscrst" , & self . tscrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1rstr {{ dma1rst: {=bool:?}, dma2rst: {=bool:?}, dmamux1rst: {=bool:?}, crcrst: {=bool:?}, tscrst: {=bool:?} }}" , self . dma1rst () , self . dma2rst () , self . dmamux1rst () , self . crcrst () , self . tscrst ()) } } # [doc = "AHB1 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb1smenr { Ahb1smenr (0) } } impl core :: fmt :: Debug for Ahb1smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1smenr") . field ("dma1smen" , & self . dma1smen ()) . field ("dma2smen" , & self . dma2smen ()) . field ("dmamux1smen" , & self . dmamux1smen ()) . field ("sram1smen" , & self . sram1smen ()) . field ("crcsmen" , & self . crcsmen ()) . field ("tscsmen" , & self . tscsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1smenr {{ dma1smen: {=bool:?}, dma2smen: {=bool:?}, dmamux1smen: {=bool:?}, sram1smen: {=bool:?}, crcsmen: {=bool:?}, tscsmen: {=bool:?} }}" , self . dma1smen () , self . dma2smen () , self . dmamux1smen () , self . sram1smen () , self . crcsmen () , self . tscsmen ()) } } # [doc = "AHB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2enr { Ahb2enr (0) } } impl core :: fmt :: Debug for Ahb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2enr") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpioden" , & self . gpioden ()) . field ("gpioeen" , & self . gpioeen ()) . field ("gpiohen" , & self . gpiohen ()) . field ("adcen" , & self . adcen ()) . field ("aes1en" , & self . aes1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2enr {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpioeen: {=bool:?}, gpiohen: {=bool:?}, adcen: {=bool:?}, aes1en: {=bool:?} }}" , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpioden () , self . gpioeen () , self . gpiohen () , self . adcen () , self . aes1en ()) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2rstr { Ahb2rstr (0) } } impl core :: fmt :: Debug for Ahb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2rstr") . field ("gpioarst" , & self . gpioarst ()) . field ("gpiobrst" , & self . gpiobrst ()) . field ("gpiocrst" , & self . gpiocrst ()) . field ("gpiodrst" , & self . gpiodrst ()) . field ("gpioerst" , & self . gpioerst ()) . field ("gpiohrst" , & self . gpiohrst ()) . field ("adcrst" , & self . adcrst ()) . field ("aes1rst" , & self . aes1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2rstr {{ gpioarst: {=bool:?}, gpiobrst: {=bool:?}, gpiocrst: {=bool:?}, gpiodrst: {=bool:?}, gpioerst: {=bool:?}, gpiohrst: {=bool:?}, adcrst: {=bool:?}, aes1rst: {=bool:?} }}" , self . gpioarst () , self . gpiobrst () , self . gpiocrst () , self . gpiodrst () , self . gpioerst () , self . gpiohrst () , self . adcrst () , self . aes1rst ()) } } # [doc = "AHB2 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2smenr { Ahb2smenr (0) } } impl core :: fmt :: Debug for Ahb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2smenr") . field ("gpioasmen" , & self . gpioasmen ()) . field ("gpiobsmen" , & self . gpiobsmen ()) . field ("gpiocsmen" , & self . gpiocsmen ()) . field ("gpiodsmen" , & self . gpiodsmen ()) . field ("gpioesmen" , & self . gpioesmen ()) . field ("gpiohsmen" , & self . gpiohsmen ()) . field ("adcfssmen" , & self . adcfssmen ()) . field ("aes1smen" , & self . aes1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2smenr {{ gpioasmen: {=bool:?}, gpiobsmen: {=bool:?}, gpiocsmen: {=bool:?}, gpiodsmen: {=bool:?}, gpioesmen: {=bool:?}, gpiohsmen: {=bool:?}, adcfssmen: {=bool:?}, aes1smen: {=bool:?} }}" , self . gpioasmen () , self . gpiobsmen () , self . gpiocsmen () , self . gpiodsmen () , self . gpioesmen () , self . gpiohsmen () , self . adcfssmen () , self . aes1smen ()) } } # [doc = "AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3enr { Ahb3enr (0) } } impl core :: fmt :: Debug for Ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3enr") . field ("quadspien" , & self . quadspien ()) . field ("pkaen" , & self . pkaen ()) . field ("aes2en" , & self . aes2en ()) . field ("rngen" , & self . rngen ()) . field ("hsemen" , & self . hsemen ()) . field ("ipccen" , & self . ipccen ()) . field ("flashen" , & self . flashen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3enr {{ quadspien: {=bool:?}, pkaen: {=bool:?}, aes2en: {=bool:?}, rngen: {=bool:?}, hsemen: {=bool:?}, ipccen: {=bool:?}, flashen: {=bool:?} }}" , self . quadspien () , self . pkaen () , self . aes2en () , self . rngen () , self . hsemen () , self . ipccen () , self . flashen ()) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3rstr { Ahb3rstr (0) } } impl core :: fmt :: Debug for Ahb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3rstr") . field ("quadspirst" , & self . quadspirst ()) . field ("pkarst" , & self . pkarst ()) . field ("aes2rst" , & self . aes2rst ()) . field ("rngrst" , & self . rngrst ()) . field ("hsemrst" , & self . hsemrst ()) . field ("ipccrst" , & self . ipccrst ()) . field ("flashrst" , & self . flashrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3rstr {{ quadspirst: {=bool:?}, pkarst: {=bool:?}, aes2rst: {=bool:?}, rngrst: {=bool:?}, hsemrst: {=bool:?}, ipccrst: {=bool:?}, flashrst: {=bool:?} }}" , self . quadspirst () , self . pkarst () , self . aes2rst () , self . rngrst () , self . hsemrst () , self . ipccrst () , self . flashrst ()) } } # [doc = "AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3smenr { Ahb3smenr (0) } } impl core :: fmt :: Debug for Ahb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3smenr") . field ("quadspismen" , & self . quadspismen ()) . field ("pkasmen" , & self . pkasmen ()) . field ("aes2smen" , & self . aes2smen ()) . field ("rngsmen" , & self . rngsmen ()) . field ("sram2smen" , & self . sram2smen ()) . field ("flashsmen" , & self . flashsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3smenr {{ quadspismen: {=bool:?}, pkasmen: {=bool:?}, aes2smen: {=bool:?}, rngsmen: {=bool:?}, sram2smen: {=bool:?}, flashsmen: {=bool:?} }}" , self . quadspismen () , self . pkasmen () , self . aes2smen () , self . rngsmen () , self . sram2smen () , self . flashsmen ()) } } # [doc = "APB1ENR1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr1 { Apb1enr1 (0) } } impl core :: fmt :: Debug for Apb1enr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr1") . field ("tim2en" , & self . tim2en ()) . field ("lcden" , & self . lcden ()) . field ("rtcapben" , & self . rtcapben ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c3en" , & self . i2c3en ()) . field ("crsen" , & self . crsen ()) . field ("usben" , & self . usben ()) . field ("lptim1en" , & self . lptim1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr1 {{ tim2en: {=bool:?}, lcden: {=bool:?}, rtcapben: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, i2c1en: {=bool:?}, i2c3en: {=bool:?}, crsen: {=bool:?}, usben: {=bool:?}, lptim1en: {=bool:?} }}" , self . tim2en () , self . lcden () , self . rtcapben () , self . wwdgen () , self . spi2en () , self . i2c1en () , self . i2c3en () , self . crsen () , self . usben () , self . lptim1en ()) } } # [doc = "APB1 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr2 { Apb1enr2 (0) } } impl core :: fmt :: Debug for Apb1enr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr2") . field ("lpuart1en" , & self . lpuart1en ()) . field ("lptim2en" , & self . lptim2en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr2 {{ lpuart1en: {=bool:?}, lptim2en: {=bool:?} }}" , self . lpuart1en () , self . lptim2en ()) } } # [doc = "APB1 peripheral reset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr1 { Apb1rstr1 (0) } } impl core :: fmt :: Debug for Apb1rstr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr1") . field ("tim2rst" , & self . tim2rst ()) . field ("lcdrst" , & self . lcdrst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c3rst" , & self . i2c3rst ()) . field ("crsrst" , & self . crsrst ()) . field ("usbrst" , & self . usbrst ()) . field ("lptim1rst" , & self . lptim1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr1 {{ tim2rst: {=bool:?}, lcdrst: {=bool:?}, spi2rst: {=bool:?}, i2c1rst: {=bool:?}, i2c3rst: {=bool:?}, crsrst: {=bool:?}, usbrst: {=bool:?}, lptim1rst: {=bool:?} }}" , self . tim2rst () , self . lcdrst () , self . spi2rst () , self . i2c1rst () , self . i2c3rst () , self . crsrst () , self . usbrst () , self . lptim1rst ()) } } # [doc = "APB1 peripheral reset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr2 { Apb1rstr2 (0) } } impl core :: fmt :: Debug for Apb1rstr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr2") . field ("lpuart1rst" , & self . lpuart1rst ()) . field ("lptim2rst" , & self . lptim2rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr2 {{ lpuart1rst: {=bool:?}, lptim2rst: {=bool:?} }}" , self . lpuart1rst () , self . lptim2rst ()) } } # [doc = "APB1SMENR1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1smenr1 { Apb1smenr1 (0) } } impl core :: fmt :: Debug for Apb1smenr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1smenr1") . field ("tim2smen" , & self . tim2smen ()) . field ("lcdsmen" , & self . lcdsmen ()) . field ("rtcapbsmen" , & self . rtcapbsmen ()) . field ("wwdgsmen" , & self . wwdgsmen ()) . field ("spi2smen" , & self . spi2smen ()) . field ("i2c1smen" , & self . i2c1smen ()) . field ("i2c3smen" , & self . i2c3smen ()) . field ("crsmen" , & self . crsmen ()) . field ("usbsmen" , & self . usbsmen ()) . field ("lptim1smen" , & self . lptim1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1smenr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1smenr1 {{ tim2smen: {=bool:?}, lcdsmen: {=bool:?}, rtcapbsmen: {=bool:?}, wwdgsmen: {=bool:?}, spi2smen: {=bool:?}, i2c1smen: {=bool:?}, i2c3smen: {=bool:?}, crsmen: {=bool:?}, usbsmen: {=bool:?}, lptim1smen: {=bool:?} }}" , self . tim2smen () , self . lcdsmen () , self . rtcapbsmen () , self . wwdgsmen () , self . spi2smen () , self . i2c1smen () , self . i2c3smen () , self . crsmen () , self . usbsmen () , self . lptim1smen ()) } } # [doc = "APB1 peripheral clocks enable in Sleep and Stop modes register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1smenr2 { Apb1smenr2 (0) } } impl core :: fmt :: Debug for Apb1smenr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1smenr2") . field ("lpuart1smen" , & self . lpuart1smen ()) . field ("lptim2smen" , & self . lptim2smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1smenr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1smenr2 {{ lpuart1smen: {=bool:?}, lptim2smen: {=bool:?} }}" , self . lpuart1smen () , self . lptim2smen ()) } } # [doc = "APB2ENR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("tim1en" , & self . tim1en ()) . field ("spi1en" , & self . spi1en ()) . field ("usart1en" , & self . usart1en ()) . field ("tim16en" , & self . tim16en ()) . field ("tim17en" , & self . tim17en ()) . field ("sai1en" , & self . sai1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ tim1en: {=bool:?}, spi1en: {=bool:?}, usart1en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?}, sai1en: {=bool:?} }}" , self . tim1en () , self . spi1en () , self . usart1en () , self . tim16en () , self . tim17en () , self . sai1en ()) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("tim1rst" , & self . tim1rst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("usart1rst" , & self . usart1rst ()) . field ("tim16rst" , & self . tim16rst ()) . field ("tim17rst" , & self . tim17rst ()) . field ("sai1rst" , & self . sai1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ tim1rst: {=bool:?}, spi1rst: {=bool:?}, usart1rst: {=bool:?}, tim16rst: {=bool:?}, tim17rst: {=bool:?}, sai1rst: {=bool:?} }}" , self . tim1rst () , self . spi1rst () , self . usart1rst () , self . tim16rst () , self . tim17rst () , self . sai1rst ()) } } # [doc = "APB2SMENR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2smenr { Apb2smenr (0) } } impl core :: fmt :: Debug for Apb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2smenr") . field ("tim1smen" , & self . tim1smen ()) . field ("spi1smen" , & self . spi1smen ()) . field ("usart1smen" , & self . usart1smen ()) . field ("tim16smen" , & self . tim16smen ()) . field ("tim17smen" , & self . tim17smen ()) . field ("sai1smen" , & self . sai1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2smenr {{ tim1smen: {=bool:?}, spi1smen: {=bool:?}, usart1smen: {=bool:?}, tim16smen: {=bool:?}, tim17smen: {=bool:?}, sai1smen: {=bool:?} }}" , self . tim1smen () , self . spi1smen () , self . usart1smen () , self . tim16smen () , self . tim17smen () , self . sai1smen ()) } } # [doc = "APB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb3rstr { Apb3rstr (0) } } impl core :: fmt :: Debug for Apb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb3rstr") . field ("rfrst" , & self . rfrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb3rstr {{ rfrst: {=bool:?} }}" , self . rfrst ()) } } # [doc = "BDCR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bdcr { Bdcr (0) } } impl core :: fmt :: Debug for Bdcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bdcr") . field ("lseon" , & self . lseon ()) . field ("lserdy" , & self . lserdy ()) . field ("lsebyp" , & self . lsebyp ()) . field ("lsedrv" , & self . lsedrv ()) . field ("lsecsson" , & self . lsecsson ()) . field ("lsecssd_" , & self . lsecssd_ ()) . field ("rtcsel" , & self . rtcsel ()) . field ("rtcen" , & self . rtcen ()) . field ("bdrst" , & self . bdrst ()) . field ("lscoen" , & self . lscoen ()) . field ("lscosel" , & self . lscosel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bdcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bdcr {{ lseon: {=bool:?}, lserdy: {=bool:?}, lsebyp: {=bool:?}, lsedrv: {:?}, lsecsson: {=bool:?}, lsecssd_: {=bool:?}, rtcsel: {:?}, rtcen: {=bool:?}, bdrst: {=bool:?}, lscoen: {=bool:?}, lscosel: {=u8:?} }}" , self . lseon () , self . lserdy () , self . lsebyp () , self . lsedrv () , self . lsecsson () , self . lsecssd_ () , self . rtcsel () , self . rtcen () , self . bdrst () , self . lscoen () , self . lscosel ()) } } # [doc = "CPU2 AHB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb1enr { C2ahb1enr (0) } } impl core :: fmt :: Debug for C2ahb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb1enr") . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("dmamux1en" , & self . dmamux1en ()) . field ("sram1en" , & self . sram1en ()) . field ("crcen" , & self . crcen ()) . field ("tscen" , & self . tscen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb1enr {{ dma1en: {=bool:?}, dma2en: {=bool:?}, dmamux1en: {=bool:?}, sram1en: {=bool:?}, crcen: {=bool:?}, tscen: {=bool:?} }}" , self . dma1en () , self . dma2en () , self . dmamux1en () , self . sram1en () , self . crcen () , self . tscen ()) } } # [doc = "CPU2 AHB1 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb1smenr { C2ahb1smenr (0) } } impl core :: fmt :: Debug for C2ahb1smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb1smenr") . field ("dma1smen" , & self . dma1smen ()) . field ("dma2smen" , & self . dma2smen ()) . field ("dmamux1smen" , & self . dmamux1smen ()) . field ("sram1smen" , & self . sram1smen ()) . field ("crcsmen" , & self . crcsmen ()) . field ("tscsmen" , & self . tscsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb1smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb1smenr {{ dma1smen: {=bool:?}, dma2smen: {=bool:?}, dmamux1smen: {=bool:?}, sram1smen: {=bool:?}, crcsmen: {=bool:?}, tscsmen: {=bool:?} }}" , self . dma1smen () , self . dma2smen () , self . dmamux1smen () , self . sram1smen () , self . crcsmen () , self . tscsmen ()) } } # [doc = "CPU2 AHB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb2enr { C2ahb2enr (0) } } impl core :: fmt :: Debug for C2ahb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb2enr") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpioden" , & self . gpioden ()) . field ("gpioeen" , & self . gpioeen ()) . field ("gpiohen" , & self . gpiohen ()) . field ("adcen" , & self . adcen ()) . field ("aes1en" , & self . aes1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb2enr {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpioeen: {=bool:?}, gpiohen: {=bool:?}, adcen: {=bool:?}, aes1en: {=bool:?} }}" , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpioden () , self . gpioeen () , self . gpiohen () , self . adcen () , self . aes1en ()) } } # [doc = "CPU2 AHB2 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb2smenr { C2ahb2smenr (0) } } impl core :: fmt :: Debug for C2ahb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb2smenr") . field ("gpioasmen" , & self . gpioasmen ()) . field ("gpiobsmen" , & self . gpiobsmen ()) . field ("gpiocsmen" , & self . gpiocsmen ()) . field ("gpiodsmen" , & self . gpiodsmen ()) . field ("gpioesmen" , & self . gpioesmen ()) . field ("gpiohsmen" , & self . gpiohsmen ()) . field ("adcfssmen" , & self . adcfssmen ()) . field ("aes1smen" , & self . aes1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb2smenr {{ gpioasmen: {=bool:?}, gpiobsmen: {=bool:?}, gpiocsmen: {=bool:?}, gpiodsmen: {=bool:?}, gpioesmen: {=bool:?}, gpiohsmen: {=bool:?}, adcfssmen: {=bool:?}, aes1smen: {=bool:?} }}" , self . gpioasmen () , self . gpiobsmen () , self . gpiocsmen () , self . gpiodsmen () , self . gpioesmen () , self . gpiohsmen () , self . adcfssmen () , self . aes1smen ()) } } # [doc = "CPU2 AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb3enr { C2ahb3enr (0) } } impl core :: fmt :: Debug for C2ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb3enr") . field ("pkaen" , & self . pkaen ()) . field ("aes2en" , & self . aes2en ()) . field ("rngen" , & self . rngen ()) . field ("hsemen" , & self . hsemen ()) . field ("ipccen" , & self . ipccen ()) . field ("flashen" , & self . flashen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb3enr {{ pkaen: {=bool:?}, aes2en: {=bool:?}, rngen: {=bool:?}, hsemen: {=bool:?}, ipccen: {=bool:?}, flashen: {=bool:?} }}" , self . pkaen () , self . aes2en () , self . rngen () , self . hsemen () , self . ipccen () , self . flashen ()) } } # [doc = "CPU2 AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb3smenr { C2ahb3smenr (0) } } impl core :: fmt :: Debug for C2ahb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb3smenr") . field ("pkasmen" , & self . pkasmen ()) . field ("aes2smen" , & self . aes2smen ()) . field ("rngsmen" , & self . rngsmen ()) . field ("sram2smen" , & self . sram2smen ()) . field ("flashsmen" , & self . flashsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb3smenr {{ pkasmen: {=bool:?}, aes2smen: {=bool:?}, rngsmen: {=bool:?}, sram2smen: {=bool:?}, flashsmen: {=bool:?} }}" , self . pkasmen () , self . aes2smen () , self . rngsmen () , self . sram2smen () , self . flashsmen ()) } } # [doc = "CPU2 APB1ENR1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb1enr1 { C2apb1enr1 (0) } } impl core :: fmt :: Debug for C2apb1enr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb1enr1") . field ("tim2en" , & self . tim2en ()) . field ("lcden" , & self . lcden ()) . field ("rtcapben" , & self . rtcapben ()) . field ("spi2en" , & self . spi2en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c3en" , & self . i2c3en ()) . field ("crsen" , & self . crsen ()) . field ("usben" , & self . usben ()) . field ("lptim1en" , & self . lptim1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb1enr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb1enr1 {{ tim2en: {=bool:?}, lcden: {=bool:?}, rtcapben: {=bool:?}, spi2en: {=bool:?}, i2c1en: {=bool:?}, i2c3en: {=bool:?}, crsen: {=bool:?}, usben: {=bool:?}, lptim1en: {=bool:?} }}" , self . tim2en () , self . lcden () , self . rtcapben () , self . spi2en () , self . i2c1en () , self . i2c3en () , self . crsen () , self . usben () , self . lptim1en ()) } } # [doc = "CPU2 APB1 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb1enr2 { C2apb1enr2 (0) } } impl core :: fmt :: Debug for C2apb1enr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb1enr2") . field ("lpuart1en" , & self . lpuart1en ()) . field ("lptim2en" , & self . lptim2en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb1enr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb1enr2 {{ lpuart1en: {=bool:?}, lptim2en: {=bool:?} }}" , self . lpuart1en () , self . lptim2en ()) } } # [doc = "CPU2 APB1SMENR1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb1smenr1 { C2apb1smenr1 (0) } } impl core :: fmt :: Debug for C2apb1smenr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb1smenr1") . field ("tim2smen" , & self . tim2smen ()) . field ("lcdsmen" , & self . lcdsmen ()) . field ("rtcapbsmen" , & self . rtcapbsmen ()) . field ("spi2smen" , & self . spi2smen ()) . field ("i2c1smen" , & self . i2c1smen ()) . field ("i2c3smen" , & self . i2c3smen ()) . field ("crsmen" , & self . crsmen ()) . field ("usbsmen" , & self . usbsmen ()) . field ("lptim1smen" , & self . lptim1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb1smenr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb1smenr1 {{ tim2smen: {=bool:?}, lcdsmen: {=bool:?}, rtcapbsmen: {=bool:?}, spi2smen: {=bool:?}, i2c1smen: {=bool:?}, i2c3smen: {=bool:?}, crsmen: {=bool:?}, usbsmen: {=bool:?}, lptim1smen: {=bool:?} }}" , self . tim2smen () , self . lcdsmen () , self . rtcapbsmen () , self . spi2smen () , self . i2c1smen () , self . i2c3smen () , self . crsmen () , self . usbsmen () , self . lptim1smen ()) } } # [doc = "CPU2 APB1 peripheral clocks enable in Sleep and Stop modes register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb1smenr2 { C2apb1smenr2 (0) } } impl core :: fmt :: Debug for C2apb1smenr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb1smenr2") . field ("lpuart1smen" , & self . lpuart1smen ()) . field ("lptim2smen" , & self . lptim2smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb1smenr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb1smenr2 {{ lpuart1smen: {=bool:?}, lptim2smen: {=bool:?} }}" , self . lpuart1smen () , self . lptim2smen ()) } } # [doc = "CPU2 APB2ENR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb2enr { C2apb2enr (0) } } impl core :: fmt :: Debug for C2apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb2enr") . field ("tim1en" , & self . tim1en ()) . field ("spi1en" , & self . spi1en ()) . field ("usart1en" , & self . usart1en ()) . field ("tim16en" , & self . tim16en ()) . field ("tim17en" , & self . tim17en ()) . field ("sai1en" , & self . sai1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb2enr {{ tim1en: {=bool:?}, spi1en: {=bool:?}, usart1en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?}, sai1en: {=bool:?} }}" , self . tim1en () , self . spi1en () , self . usart1en () , self . tim16en () , self . tim17en () , self . sai1en ()) } } # [doc = "CPU2 APB2SMENR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb2smenr { C2apb2smenr (0) } } impl core :: fmt :: Debug for C2apb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb2smenr") . field ("tim1smen" , & self . tim1smen ()) . field ("spi1smen" , & self . spi1smen ()) . field ("usart1smen" , & self . usart1smen ()) . field ("tim16smen" , & self . tim16smen ()) . field ("tim17smen" , & self . tim17smen ()) . field ("sai1smen" , & self . sai1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb2smenr {{ tim1smen: {=bool:?}, spi1smen: {=bool:?}, usart1smen: {=bool:?}, tim16smen: {=bool:?}, tim17smen: {=bool:?}, sai1smen: {=bool:?} }}" , self . tim1smen () , self . spi1smen () , self . usart1smen () , self . tim16smen () , self . tim17smen () , self . sai1smen ()) } } # [doc = "CPU2 APB3ENR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb3enr { C2apb3enr (0) } } impl core :: fmt :: Debug for C2apb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb3enr") . field ("bleen" , & self . bleen ()) . field ("en802" , & self . en802 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb3enr {{ bleen: {=bool:?}, en802: {=bool:?} }}" , self . bleen () , self . en802 ()) } } # [doc = "CPU2 APB3SMENR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb3smenr { C2apb3smenr (0) } } impl core :: fmt :: Debug for C2apb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb3smenr") . field ("blesmen" , & self . blesmen ()) . field ("smen802" , & self . smen802 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb3smenr {{ blesmen: {=bool:?}, smen802: {=bool:?} }}" , self . blesmen () , self . smen802 ()) } } # [doc = "CCIPR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccipr { Ccipr (0) } } impl core :: fmt :: Debug for Ccipr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccipr") . field ("usart1sel" , & self . usart1sel ()) . field ("lpuart1sel" , & self . lpuart1sel ()) . field ("i2c1sel" , & self . i2c1sel ()) . field ("i2c3sel" , & self . i2c3sel ()) . field ("lptim1sel" , & self . lptim1sel ()) . field ("lptim2sel" , & self . lptim2sel ()) . field ("sai1sel" , & self . sai1sel ()) . field ("clk48sel" , & self . clk48sel ()) . field ("adcsel" , & self . adcsel ()) . field ("rngsel" , & self . rngsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccipr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccipr {{ usart1sel: {:?}, lpuart1sel: {:?}, i2c1sel: {:?}, i2c3sel: {:?}, lptim1sel: {:?}, lptim2sel: {:?}, sai1sel: {:?}, clk48sel: {:?}, adcsel: {:?}, rngsel: {:?} }}" , self . usart1sel () , self . lpuart1sel () , self . i2c1sel () , self . i2c3sel () , self . lptim1sel () , self . lptim2sel () , self . sai1sel () , self . clk48sel () , self . adcsel () , self . rngsel ()) } } # [doc = "Clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr { Cfgr (0) } } impl core :: fmt :: Debug for Cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr") . field ("sw" , & self . sw ()) . field ("sws" , & self . sws ()) . field ("hpre" , & self . hpre ()) . field ("ppre1" , & self . ppre1 ()) . field ("ppre2" , & self . ppre2 ()) . field ("stopwuck" , & self . stopwuck ()) . field ("hpref" , & self . hpref ()) . field ("ppre1f" , & self . ppre1f ()) . field ("ppre2f" , & self . ppre2f ()) . field ("mcosel" , & self . mcosel ()) . field ("mcopre" , & self . mcopre ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr {{ sw: {:?}, sws: {:?}, hpre: {:?}, ppre1: {:?}, ppre2: {:?}, stopwuck: {=bool:?}, hpref: {=bool:?}, ppre1f: {=bool:?}, ppre2f: {=bool:?}, mcosel: {:?}, mcopre: {:?} }}" , self . sw () , self . sws () , self . hpre () , self . ppre1 () , self . ppre2 () , self . stopwuck () , self . hpref () , self . ppre1f () , self . ppre2f () , self . mcosel () , self . mcopre ()) } } # [doc = "Clock interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cicr { Cicr (0) } } impl core :: fmt :: Debug for Cicr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cicr") . field ("lsi1rdyc" , & self . lsi1rdyc ()) . field ("lserdyc" , & self . lserdyc ()) . field ("msirdyc" , & self . msirdyc ()) . field ("hsirdyc" , & self . hsirdyc ()) . field ("hserdyc" , & self . hserdyc ()) . field ("pllrdyc" , & self . pllrdyc ()) . field ("pllsai1rdyc" , & self . pllsai1rdyc ()) . field ("hsecssc" , & self . hsecssc ()) . field ("lsecssc" , & self . lsecssc ()) . field ("hsi48rdyc" , & self . hsi48rdyc ()) . field ("lsi2rdyc" , & self . lsi2rdyc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cicr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cicr {{ lsi1rdyc: {=bool:?}, lserdyc: {=bool:?}, msirdyc: {=bool:?}, hsirdyc: {=bool:?}, hserdyc: {=bool:?}, pllrdyc: {=bool:?}, pllsai1rdyc: {=bool:?}, hsecssc: {=bool:?}, lsecssc: {=bool:?}, hsi48rdyc: {=bool:?}, lsi2rdyc: {=bool:?} }}" , self . lsi1rdyc () , self . lserdyc () , self . msirdyc () , self . hsirdyc () , self . hserdyc () , self . pllrdyc () , self . pllsai1rdyc () , self . hsecssc () , self . lsecssc () , self . hsi48rdyc () , self . lsi2rdyc ()) } } # [doc = "Clock interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cier { Cier (0) } } impl core :: fmt :: Debug for Cier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cier") . field ("lsi1rdyie" , & self . lsi1rdyie ()) . field ("lserdyie" , & self . lserdyie ()) . field ("msirdyie" , & self . msirdyie ()) . field ("hsirdyie" , & self . hsirdyie ()) . field ("hserdyie" , & self . hserdyie ()) . field ("pllrdyie" , & self . pllrdyie ()) . field ("pllsai1rdyie" , & self . pllsai1rdyie ()) . field ("lsecssie" , & self . lsecssie ()) . field ("hsi48rdyie" , & self . hsi48rdyie ()) . field ("lsi2rdyie" , & self . lsi2rdyie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cier {{ lsi1rdyie: {=bool:?}, lserdyie: {=bool:?}, msirdyie: {=bool:?}, hsirdyie: {=bool:?}, hserdyie: {=bool:?}, pllrdyie: {=bool:?}, pllsai1rdyie: {=bool:?}, lsecssie: {=bool:?}, hsi48rdyie: {=bool:?}, lsi2rdyie: {=bool:?} }}" , self . lsi1rdyie () , self . lserdyie () , self . msirdyie () , self . hsirdyie () , self . hserdyie () , self . pllrdyie () , self . pllsai1rdyie () , self . lsecssie () , self . hsi48rdyie () , self . lsi2rdyie ()) } } # [doc = "Clock interrupt flag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cifr { Cifr (0) } } impl core :: fmt :: Debug for Cifr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cifr") . field ("lsi1rdyf" , & self . lsi1rdyf ()) . field ("lserdyf" , & self . lserdyf ()) . field ("msirdyf" , & self . msirdyf ()) . field ("hsirdyf" , & self . hsirdyf ()) . field ("hserdyf" , & self . hserdyf ()) . field ("pllrdyf" , & self . pllrdyf ()) . field ("pllsai1rdyf" , & self . pllsai1rdyf ()) . field ("hsecssf" , & self . hsecssf ()) . field ("lsecssf" , & self . lsecssf ()) . field ("hsi48rdyf" , & self . hsi48rdyf ()) . field ("lsi2rdyf" , & self . lsi2rdyf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cifr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cifr {{ lsi1rdyf: {=bool:?}, lserdyf: {=bool:?}, msirdyf: {=bool:?}, hsirdyf: {=bool:?}, hserdyf: {=bool:?}, pllrdyf: {=bool:?}, pllsai1rdyf: {=bool:?}, hsecssf: {=bool:?}, lsecssf: {=bool:?}, hsi48rdyf: {=bool:?}, lsi2rdyf: {=bool:?} }}" , self . lsi1rdyf () , self . lserdyf () , self . msirdyf () , self . hsirdyf () , self . hserdyf () , self . pllrdyf () , self . pllsai1rdyf () , self . hsecssf () , self . lsecssf () , self . hsi48rdyf () , self . lsi2rdyf ()) } } # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("msion" , & self . msion ()) . field ("msirdy" , & self . msirdy ()) . field ("msipllen" , & self . msipllen ()) . field ("msirange" , & self . msirange ()) . field ("hsion" , & self . hsion ()) . field ("hsikeron" , & self . hsikeron ()) . field ("hsirdy" , & self . hsirdy ()) . field ("hsiasfs" , & self . hsiasfs ()) . field ("hsikerdy" , & self . hsikerdy ()) . field ("hseon" , & self . hseon ()) . field ("hserdy" , & self . hserdy ()) . field ("hsebyp" , & self . hsebyp ()) . field ("csson" , & self . csson ()) . field ("hsepre" , & self . hsepre ()) . field ("pllon" , & self . pllon ()) . field ("pllrdy" , & self . pllrdy ()) . field ("pllsai1on" , & self . pllsai1on ()) . field ("pllsai1rdy" , & self . pllsai1rdy ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ msion: {=bool:?}, msirdy: {=bool:?}, msipllen: {=bool:?}, msirange: {:?}, hsion: {=bool:?}, hsikeron: {=bool:?}, hsirdy: {=bool:?}, hsiasfs: {=bool:?}, hsikerdy: {=bool:?}, hseon: {=bool:?}, hserdy: {=bool:?}, hsebyp: {=bool:?}, csson: {=bool:?}, hsepre: {:?}, pllon: {=bool:?}, pllrdy: {=bool:?}, pllsai1on: {=bool:?}, pllsai1rdy: {=bool:?} }}" , self . msion () , self . msirdy () , self . msipllen () , self . msirange () , self . hsion () , self . hsikeron () , self . hsirdy () , self . hsiasfs () , self . hsikerdy () , self . hseon () , self . hserdy () , self . hsebyp () , self . csson () , self . hsepre () , self . pllon () , self . pllrdy () , self . pllsai1on () , self . pllsai1rdy ()) } } # [doc = "Clock recovery RC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("lsi1on" , & self . lsi1on ()) . field ("lsi1rdy" , & self . lsi1rdy ()) . field ("lsi2on" , & self . lsi2on ()) . field ("lsi2rdy" , & self . lsi2rdy ()) . field ("lsi2trimen" , & self . lsi2trimen ()) . field ("lsi2trimok" , & self . lsi2trimok ()) . field ("lsi2bw" , & self . lsi2bw ()) . field ("rfwkpsel" , & self . rfwkpsel ()) . field ("rfrsts" , & self . rfrsts ()) . field ("rmvf" , & self . rmvf ()) . field ("oblrstf" , & self . oblrstf ()) . field ("pinrstf" , & self . pinrstf ()) . field ("borrstf" , & self . borrstf ()) . field ("sftrstf" , & self . sftrstf ()) . field ("iwdgrstf" , & self . iwdgrstf ()) . field ("wwdgrstf" , & self . wwdgrstf ()) . field ("lpwrrstf" , & self . lpwrrstf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ lsi1on: {=bool:?}, lsi1rdy: {=bool:?}, lsi2on: {=bool:?}, lsi2rdy: {=bool:?}, lsi2trimen: {=bool:?}, lsi2trimok: {=bool:?}, lsi2bw: {=u8:?}, rfwkpsel: {=u8:?}, rfrsts: {=bool:?}, rmvf: {=bool:?}, oblrstf: {=bool:?}, pinrstf: {=bool:?}, borrstf: {=bool:?}, sftrstf: {=bool:?}, iwdgrstf: {=bool:?}, wwdgrstf: {=bool:?}, lpwrrstf: {=bool:?} }}" , self . lsi1on () , self . lsi1rdy () , self . lsi2on () , self . lsi2rdy () , self . lsi2trimen () , self . lsi2trimok () , self . lsi2bw () , self . rfwkpsel () , self . rfrsts () , self . rmvf () , self . oblrstf () , self . pinrstf () , self . borrstf () , self . sftrstf () , self . iwdgrstf () , self . wwdgrstf () , self . lpwrrstf ()) } } # [doc = "Extended clock recovery register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Extcfgr { Extcfgr (0) } } impl core :: fmt :: Debug for Extcfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Extcfgr") . field ("shdhpre" , & self . shdhpre ()) . field ("c2hpre" , & self . c2hpre ()) . field ("shdhpref" , & self . shdhpref ()) . field ("c2hpref" , & self . c2hpref ()) . field ("rfcss" , & self . rfcss ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Extcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Extcfgr {{ shdhpre: {:?}, c2hpre: {:?}, shdhpref: {=bool:?}, c2hpref: {=bool:?}, rfcss: {=bool:?} }}" , self . shdhpre () , self . c2hpre () , self . shdhpref () , self . c2hpref () , self . rfcss ()) } } # [doc = "Clock HSE register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Hsecr { Hsecr (0) } } impl core :: fmt :: Debug for Hsecr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Hsecr") . field ("unlocked" , & self . unlocked ()) . field ("hses" , & self . hses ()) . field ("hsegmc" , & self . hsegmc ()) . field ("hsetune" , & self . hsetune ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Hsecr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Hsecr {{ unlocked: {=bool:?}, hses: {=bool:?}, hsegmc: {=u8:?}, hsetune: {=u8:?} }}" , self . unlocked () , self . hses () , self . hsegmc () , self . hsetune ()) } } # [doc = "Internal clock sources calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Icscr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icscr {{ msical: {=u8:?}, msitrim: {=u8:?}, hsical: {=u8:?}, hsitrim: {=u8:?} }}" , self . msical () , self . msitrim () , self . hsical () , self . hsitrim ()) } } # [doc = "PLLSYS configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pllcfgr { Pllcfgr (0) } } impl core :: fmt :: Debug for Pllcfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pllcfgr") . field ("pllsrc" , & self . pllsrc ()) . field ("pllm" , & self . pllm ()) . field ("plln" , & self . plln ()) . field ("pllpen" , & self . pllpen ()) . field ("pllp" , & self . pllp ()) . field ("pllqen" , & self . pllqen ()) . field ("pllq" , & self . pllq ()) . field ("pllren" , & self . pllren ()) . field ("pllr" , & self . pllr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pllcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pllcfgr {{ pllsrc: {:?}, pllm: {:?}, plln: {:?}, pllpen: {=bool:?}, pllp: {:?}, pllqen: {=bool:?}, pllq: {:?}, pllren: {=bool:?}, pllr: {:?} }}" , self . pllsrc () , self . pllm () , self . plln () , self . pllpen () , self . pllp () , self . pllqen () , self . pllq () , self . pllren () , self . pllr ()) } } # [doc = "PLLSAI1 configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pllsai1cfgr { Pllsai1cfgr (0) } } impl core :: fmt :: Debug for Pllsai1cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pllsai1cfgr") . field ("plln" , & self . plln ()) . field ("pllpen" , & self . pllpen ()) . field ("pllp" , & self . pllp ()) . field ("pllqen" , & self . pllqen ()) . field ("pllq" , & self . pllq ()) . field ("pllren" , & self . pllren ()) . field ("pllr" , & self . pllr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pllsai1cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pllsai1cfgr {{ plln: {:?}, pllpen: {=bool:?}, pllp: {:?}, pllqen: {=bool:?}, pllq: {:?}, pllren: {=bool:?}, pllr: {:?} }}" , self . plln () , self . pllpen () , self . pllp () , self . pllqen () , self . pllq () , self . pllren () , self . pllr ()) } } # [doc = "Step Down converter control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Smpscr (pub u32) ; impl Smpscr { # [doc = "Step Down converter clock selection"]
# [inline (always)]
pub const fn smpssel (& self) -> super :: vals :: Smps { let val = (self . 0 >> 0usize) & 0x03 ; super :: vals :: Smps :: from_bits (val as u8) } # [doc = "Step Down converter clock selection"]
# [inline (always)]
pub fn set_smpssel (& mut self , val : super :: vals :: Smps) { self . 0 = (self . 0 & ! (0x03 << 0usize)) | (((val . to_bits () as u32) & 0x03) << 0usize) ; } # [doc = "Step Down converter clock prescaler"]
# [inline (always)]
...
# [inline (always)]
pub const fn smpssws (& self) -> super :: vals :: Smps { let val = (self . 0 >> 8usize) & 0x03 ; super :: vals :: Smps :: from_bits (val as u8) } # [doc = "Step Down converter clock switch status"]
# [inline (always)]
pub fn set_smpssws (& mut self , val : super :: vals :: Smps) { self . 0 = (self . 0 & ! (0x03 << 8usize)) | (((val . to_bits () as u32) & 0x03) << 8usize) ; } } impl Default for Smpscr { # [inline (always)]
fn default () -> Smpscr { Smpscr (0) } } impl core :: fmt :: Debug for Smpscr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpscr") . field ("smpssel" , & self . smpssel ()) . field ("smpsdiv" , & self . smpsdiv ()) . field ("smpssws" , & self . smpssws ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpscr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smpscr {{ smpssel: {:?}, smpsdiv: {=u8:?}, smpssws: {:?} }}" , self . smpssel () , self . smpsdiv () , self . smpssws ()) } } } pub mod vals { # [repr (u8)]
...
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]
pub enum Smps { HSI = 0x0 , MSI = 0x01 , HSE = 0x02 , _RESERVED_3 = 0x03 , } impl Smps { # [inline (always)]
pub const fn from_bits (val : u8) -> Smps { unsafe { core :: mem :: transmute (val & 0x03) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Smps { # [inline (always)]
fn from (val : u8) -> Smps { Smps :: from_bits (val) } } impl From < Smps > for u8 { # [inline (always)]
fn from (val : Smps) -> u8 { Smps :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]

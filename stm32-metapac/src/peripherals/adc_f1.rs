...
fn default () -> Dr { Dr (0) } } impl core :: fmt :: Debug for Dr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dr") . field ("data" , & self . data ()) . field ("adc2data" , & self . adc2data ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ data: {=u16:?}, adc2data: {=u16:?} }}" , self . data () , self . adc2data ()) } } # [doc = "watchdog higher threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr1 { Smpr1 (0) } } impl core :: fmt :: Debug for Smpr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr1") . field ("smp[0]" , & self . smp (0usize)) . field ("smp[1]" , & self . smp (1usize)) . field ("smp[2]" , & self . smp (2usize)) . field ("smp[3]" , & self . smp (3usize)) . field ("smp[4]" , & self . smp (4usize)) . field ("smp[5]" , & self . smp (5usize)) . field ("smp[6]" , & self . smp (6usize)) . field ("smp[7]" , & self . smp (7usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smpr1 {{ smp[0]: {:?}, smp[1]: {:?}, smp[2]: {:?}, smp[3]: {:?}, smp[4]: {:?}, smp[5]: {:?}, smp[6]: {:?}, smp[7]: {:?} }}" , self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize)) } } # [doc = "sample time register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("awd" , & self . awd ()) . field ("eoc" , & self . eoc ()) . field ("jeoc" , & self . jeoc ()) . field ("jstrt" , & self . jstrt ()) . field ("strt" , & self . strt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ awd: {=bool:?}, eoc: {=bool:?}, jeoc: {=bool:?}, jstrt: {=bool:?}, strt: {=bool:?} }}" , self . awd () , self . eoc () , self . jeoc () , self . jstrt () , self . strt ()) } } } pub mod vals { # [repr (u8)]
...
REGULAR_INJECTED = 0x01 , # [doc = "Combined regular simultaneous + alternate trigger mode"]
REGULAR_ALTERNATE_TRIGGER = 0x02 , # [doc = "Combined injected simultaneous + fast interleaved mode"]
INJECTED_FAST_INTERLEAVED = 0x03 , # [doc = "Combined injected simultaneous + slow Interleaved mode"]
INJECTED_SLOW_INTERLEAVED = 0x04 , # [doc = "Injected simultaneous mode only"]
INJECTED = 0x05 , # [doc = "Regular simultaneous mode only"]
REGULAR = 0x06 , # [doc = "Fast interleaved mode only"]
FAST_INTERLEAVED = 0x07 , # [doc = "Slow interleaved mode only"]
SLOW_INTERLEAVED = 0x08 , # [doc = "Alternate trigger mode only"]
ALTERNATE_TRIGGER = 0x09 , _RESERVED_a = 0x0a , _RESERVED_b = 0x0b , _RESERVED_c = 0x0c , _RESERVED_d = 0x0d , _RESERVED_e = 0x0e , _RESERVED_f = 0x0f , } impl Dualmod { # [inline (always)]

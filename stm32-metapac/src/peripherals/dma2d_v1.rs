...
impl defmt :: Format for Amtcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Amtcr {{ en: {=bool:?}, dt: {=u8:?} }}" , self . en () , self . dt ()) } } # [doc = "BGCLUT"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bgclut { Bgclut (0) } } impl core :: fmt :: Debug for Bgclut { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bgclut") . field ("blue" , & self . blue ()) . field ("green" , & self . green ()) . field ("red" , & self . red ()) . field ("aplha" , & self . aplha ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bgclut { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bgclut {{ blue: {=u8:?}, green: {=u8:?}, red: {=u8:?}, aplha: {=u8:?} }}" , self . blue () , self . green () , self . red () , self . aplha ()) } } # [doc = "background CLUT memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bgcmar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bgcmar {{ ma: {=u32:?} }}" , self . ma ()) } } # [doc = "background color register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bgcolr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bgcolr {{ blue: {=u8:?}, green: {=u8:?}, red: {=u8:?} }}" , self . blue () , self . green () , self . red ()) } } # [doc = "background memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bgmar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bgmar {{ ma: {=u32:?} }}" , self . ma ()) } } # [doc = "background offset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bgor { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bgor {{ lo: {=u16:?} }}" , self . lo ()) } } # [doc = "background PFC control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bgpfccr { Bgpfccr (0) } } impl core :: fmt :: Debug for Bgpfccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bgpfccr") . field ("cm" , & self . cm ()) . field ("ccm" , & self . ccm ()) . field ("start" , & self . start ()) . field ("cs" , & self . cs ()) . field ("am" , & self . am ()) . field ("alpha" , & self . alpha ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bgpfccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bgpfccr {{ cm: {:?}, ccm: {:?}, start: {:?}, cs: {=u8:?}, am: {:?}, alpha: {=u8:?} }}" , self . cm () , self . ccm () , self . start () , self . cs () , self . am () , self . alpha ()) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("start" , & self . start ()) . field ("susp" , & self . susp ()) . field ("abort" , & self . abort ()) . field ("teie" , & self . teie ()) . field ("tcie" , & self . tcie ()) . field ("twie" , & self . twie ()) . field ("caeie" , & self . caeie ()) . field ("ctcie" , & self . ctcie ()) . field ("ceie" , & self . ceie ()) . field ("mode" , & self . mode ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ start: {:?}, susp: {=bool:?}, abort: {:?}, teie: {=bool:?}, tcie: {=bool:?}, twie: {=bool:?}, caeie: {=bool:?}, ctcie: {=bool:?}, ceie: {=bool:?}, mode: {:?} }}" , self . start () , self . susp () , self . abort () , self . teie () , self . tcie () , self . twie () , self . caeie () , self . ctcie () , self . ceie () , self . mode ()) } } # [doc = "FGCLUT"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fgclut { Fgclut (0) } } impl core :: fmt :: Debug for Fgclut { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fgclut") . field ("blue" , & self . blue ()) . field ("green" , & self . green ()) . field ("red" , & self . red ()) . field ("aplha" , & self . aplha ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fgclut { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fgclut {{ blue: {=u8:?}, green: {=u8:?}, red: {=u8:?}, aplha: {=u8:?} }}" , self . blue () , self . green () , self . red () , self . aplha ()) } } # [doc = "foreground CLUT memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fgcmar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fgcmar {{ ma: {=u32:?} }}" , self . ma ()) } } # [doc = "foreground color register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fgcolr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fgcolr {{ blue: {=u8:?}, green: {=u8:?}, red: {=u8:?} }}" , self . blue () , self . green () , self . red ()) } } # [doc = "foreground memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fgmar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fgmar {{ ma: {=u32:?} }}" , self . ma ()) } } # [doc = "foreground offset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fgor { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fgor {{ lo: {=u16:?} }}" , self . lo ()) } } # [doc = "foreground PFC control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fgpfccr { Fgpfccr (0) } } impl core :: fmt :: Debug for Fgpfccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fgpfccr") . field ("cm" , & self . cm ()) . field ("ccm" , & self . ccm ()) . field ("start" , & self . start ()) . field ("cs" , & self . cs ()) . field ("am" , & self . am ()) . field ("alpha" , & self . alpha ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fgpfccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fgpfccr {{ cm: {:?}, ccm: {:?}, start: {:?}, cs: {=u8:?}, am: {:?}, alpha: {=u8:?} }}" , self . cm () , self . ccm () , self . start () , self . cs () , self . am () , self . alpha ()) } } # [doc = "interrupt flag clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ifcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ifcr {{ cteif: {:?}, ctcif: {:?}, ctwif: {:?}, caecif: {:?}, cctcif: {:?}, cceif: {:?} }}" , self . cteif () , self . ctcif () , self . ctwif () , self . caecif () , self . cctcif () , self . cceif ()) } } # [doc = "Interrupt Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Isr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Isr {{ teif: {=bool:?}, tcif: {=bool:?}, twif: {=bool:?}, caeif: {=bool:?}, ctcif: {=bool:?}, ceif: {=bool:?} }}" , self . teif () , self . tcif () , self . twif () , self . caeif () , self . ctcif () , self . ceif ()) } } # [doc = "line watermark register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Lwr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Lwr {{ lw: {=u16:?} }}" , self . lw ()) } } # [doc = "number of line register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Nlr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Nlr {{ nl: {=u16:?}, pl: {=u16:?} }}" , self . nl () , self . pl ()) } } # [doc = "output color register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ocolr { Ocolr (0) } } impl core :: fmt :: Debug for Ocolr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ocolr") . field ("blue" , & self . blue ()) . field ("green" , & self . green ()) . field ("red" , & self . red ()) . field ("aplha" , & self . aplha ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ocolr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ocolr {{ blue: {=u8:?}, green: {=u8:?}, red: {=u8:?}, aplha: {=u8:?} }}" , self . blue () , self . green () , self . red () , self . aplha ()) } } # [doc = "output memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Omar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Omar {{ ma: {=u32:?} }}" , self . ma ()) } } # [doc = "output offset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Oor { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Oor {{ lo: {=u16:?} }}" , self . lo ()) } } # [doc = "output PFC control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Opfccr { Opfccr (0) } } impl core :: fmt :: Debug for Opfccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Opfccr") . field ("cm" , & self . cm ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Opfccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Opfccr {{ cm: {:?} }}" , self . cm ()) } } } pub mod vals { # [repr (u8)]
...
MEMORY_TO_MEMORY = 0x0 , # [doc = "Memory-to-memory with PFC (FG fetch only with FG PFC active)"]
MEMORY_TO_MEMORY_PFC = 0x01 , # [doc = "Memory-to-memory with blending (FG and BG fetch with PFC and blending)"]
MEMORY_TO_MEMORY_PFCBLENDING = 0x02 , # [doc = "Register-to-memory"]
REGISTER_TO_MEMORY = 0x03 , } impl Mode { # [inline (always)]

...
fn default () -> Cr2 { Cr2 (0) } } impl core :: fmt :: Debug for Cr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2") . field ("adon" , & self . adon ()) . field ("cont" , & self . cont ()) . field ("cal" , & self . cal ()) . field ("rstcal" , & self . rstcal ()) . field ("dma" , & self . dma ()) . field ("align" , & self . align ()) . field ("jextsel" , & self . jextsel ()) . field ("jexttrig" , & self . jexttrig ()) . field ("extsel" , & self . extsel ()) . field ("exttrig" , & self . exttrig ()) . field ("jswstart" , & self . jswstart ()) . field ("swstart" , & self . swstart ()) . field ("tsvrefe" , & self . tsvrefe ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2 {{ adon: {=bool:?}, cont: {=bool:?}, cal: {=bool:?}, rstcal: {=bool:?}, dma: {=bool:?}, align: {=bool:?}, jextsel: {=u8:?}, jexttrig: {=bool:?}, extsel: {=u8:?}, exttrig: {=bool:?}, jswstart: {=bool:?}, swstart: {=bool:?}, tsvrefe: {=bool:?} }}" , self . adon () , self . cont () , self . cal () , self . rstcal () , self . dma () , self . align () , self . jextsel () , self . jexttrig () , self . extsel () , self . exttrig () , self . jswstart () , self . swstart () , self . tsvrefe ()) } } # [doc = "regular data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ data: {=u16:?} }}" , self . data ()) } } # [doc = "watchdog higher threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Htr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Htr {{ ht: {=u16:?} }}" , self . ht ()) } } # [doc = "injected data register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Jdr1 { Jdr1 (0) } } impl core :: fmt :: Debug for Jdr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Jdr1") . field ("jdata1" , & self . jdata1 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Jdr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jdr1 {{ jdata1: {=u16:?} }}" , self . jdata1 ()) } } # [doc = "injected data register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Jdr2 { Jdr2 (0) } } impl core :: fmt :: Debug for Jdr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Jdr2") . field ("jdata2" , & self . jdata2 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Jdr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jdr2 {{ jdata2: {=u16:?} }}" , self . jdata2 ()) } } # [doc = "injected data register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Jdr3 { Jdr3 (0) } } impl core :: fmt :: Debug for Jdr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Jdr3") . field ("jdata3" , & self . jdata3 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Jdr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jdr3 {{ jdata3: {=u16:?} }}" , self . jdata3 ()) } } # [doc = "injected data register 4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Jdr4 { Jdr4 (0) } } impl core :: fmt :: Debug for Jdr4 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Jdr4") . field ("jdata4" , & self . jdata4 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Jdr4 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jdr4 {{ jdata4: {=u16:?} }}" , self . jdata4 ()) } } # [doc = "injected channel data offset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Jofr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jofr1 {{ joffset1: {=u16:?} }}" , self . joffset1 ()) } } # [doc = "injected channel data offset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Jofr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jofr2 {{ joffset2: {=u16:?} }}" , self . joffset2 ()) } } # [doc = "injected channel data offset register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Jofr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jofr3 {{ joffset3: {=u16:?} }}" , self . joffset3 ()) } } # [doc = "injected channel data offset register 4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ltr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ltr {{ lt: {=u16:?} }}" , self . lt ()) } } # [doc = "sample time register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr1 { Smpr1 (0) } } impl core :: fmt :: Debug for Smpr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr1") . field ("smp10" , & self . smp10 ()) . field ("smp11" , & self . smp11 ()) . field ("smp12" , & self . smp12 ()) . field ("smp13" , & self . smp13 ()) . field ("smp14" , & self . smp14 ()) . field ("smp15" , & self . smp15 ()) . field ("smp16" , & self . smp16 ()) . field ("smp17" , & self . smp17 ()) . field ("smp18" , & self . smp18 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smpr1 {{ smp10: {:?}, smp11: {:?}, smp12: {:?}, smp13: {:?}, smp14: {:?}, smp15: {:?}, smp16: {:?}, smp17: {:?}, smp18: {:?} }}" , self . smp10 () , self . smp11 () , self . smp12 () , self . smp13 () , self . smp14 () , self . smp15 () , self . smp16 () , self . smp17 () , self . smp18 ()) } } # [doc = "sample time register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr2 { Smpr2 (0) } } impl core :: fmt :: Debug for Smpr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr2") . field ("smp0" , & self . smp0 ()) . field ("smp1" , & self . smp1 ()) . field ("smp2" , & self . smp2 ()) . field ("smp3" , & self . smp3 ()) . field ("smp4" , & self . smp4 ()) . field ("smp5" , & self . smp5 ()) . field ("smp6" , & self . smp6 ()) . field ("smp7" , & self . smp7 ()) . field ("smp8" , & self . smp8 ()) . field ("smp9" , & self . smp9 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smpr2 {{ smp0: {:?}, smp1: {:?}, smp2: {:?}, smp3: {:?}, smp4: {:?}, smp5: {:?}, smp6: {:?}, smp7: {:?}, smp8: {:?}, smp9: {:?} }}" , self . smp0 () , self . smp1 () , self . smp2 () , self . smp3 () , self . smp4 () , self . smp5 () , self . smp6 () , self . smp7 () , self . smp8 () , self . smp9 ()) } } # [doc = "regular sequence register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sqr1 { Sqr1 (0) } } impl core :: fmt :: Debug for Sqr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sqr1") . field ("sq13" , & self . sq13 ()) . field ("sq14" , & self . sq14 ()) . field ("sq15" , & self . sq15 ()) . field ("sq16" , & self . sq16 ()) . field ("l" , & self . l ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sqr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sqr1 {{ sq13: {=u8:?}, sq14: {=u8:?}, sq15: {=u8:?}, sq16: {=u8:?}, l: {=u8:?} }}" , self . sq13 () , self . sq14 () , self . sq15 () , self . sq16 () , self . l ()) } } # [doc = "regular sequence register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sqr2 { Sqr2 (0) } } impl core :: fmt :: Debug for Sqr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sqr2") . field ("sq7" , & self . sq7 ()) . field ("sq8" , & self . sq8 ()) . field ("sq9" , & self . sq9 ()) . field ("sq10" , & self . sq10 ()) . field ("sq11" , & self . sq11 ()) . field ("sq12" , & self . sq12 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sqr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sqr2 {{ sq7: {=u8:?}, sq8: {=u8:?}, sq9: {=u8:?}, sq10: {=u8:?}, sq11: {=u8:?}, sq12: {=u8:?} }}" , self . sq7 () , self . sq8 () , self . sq9 () , self . sq10 () , self . sq11 () , self . sq12 ()) } } # [doc = "regular sequence register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sqr3 { Sqr3 (0) } } impl core :: fmt :: Debug for Sqr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sqr3") . field ("sq1" , & self . sq1 ()) . field ("sq2" , & self . sq2 ()) . field ("sq3" , & self . sq3 ()) . field ("sq4" , & self . sq4 ()) . field ("sq5" , & self . sq5 ()) . field ("sq6" , & self . sq6 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sqr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sqr3 {{ sq1: {=u8:?}, sq2: {=u8:?}, sq3: {=u8:?}, sq4: {=u8:?}, sq5: {=u8:?}, sq6: {=u8:?} }}" , self . sq1 () , self . sq2 () , self . sq3 () , self . sq4 () , self . sq5 () , self . sq6 ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("awd" , & self . awd ()) . field ("eoc" , & self . eoc ()) . field ("jeoc" , & self . jeoc ()) . field ("jstrt" , & self . jstrt ()) . field ("strt" , & self . strt ()) . field ("ovr" , & self . ovr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ awd: {=bool:?}, eoc: {=bool:?}, jeoc: {=bool:?}, jstrt: {=bool:?}, strt: {=bool:?}, ovr: {=bool:?} }}" , self . awd () , self . eoc () , self . jeoc () , self . jstrt () , self . strt () , self . ovr ()) } } } pub mod vals { # [repr (u8)]

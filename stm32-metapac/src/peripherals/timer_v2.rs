...
fn default () -> Af11chCmp { Af11chCmp (0) } } impl core :: fmt :: Debug for Af11chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af11chCmp") . field ("bkine" , & self . bkine ()) . field ("bkcmpe[0]" , & self . bkcmpe (0usize)) . field ("bkcmpe[1]" , & self . bkcmpe (1usize)) . field ("bkcmpe[2]" , & self . bkcmpe (2usize)) . field ("bkcmpe[3]" , & self . bkcmpe (3usize)) . field ("bkcmpe[4]" , & self . bkcmpe (4usize)) . field ("bkcmpe[5]" , & self . bkcmpe (5usize)) . field ("bkcmpe[6]" , & self . bkcmpe (6usize)) . field ("bkcmpe[7]" , & self . bkcmpe (7usize)) . field ("bkinp" , & self . bkinp ()) . field ("bkcmpp[0]" , & self . bkcmpp (0usize)) . field ("bkcmpp[1]" , & self . bkcmpp (1usize)) . field ("bkcmpp[2]" , & self . bkcmpp (2usize)) . field ("bkcmpp[3]" , & self . bkcmpp (3usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af11chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Af11chCmp {{ bkine: {=bool:?}, bkcmpe[0]: {=bool:?}, bkcmpe[1]: {=bool:?}, bkcmpe[2]: {=bool:?}, bkcmpe[3]: {=bool:?}, bkcmpe[4]: {=bool:?}, bkcmpe[5]: {=bool:?}, bkcmpe[6]: {=bool:?}, bkcmpe[7]: {=bool:?}, bkinp: {:?}, bkcmpp[0]: {:?}, bkcmpp[1]: {:?}, bkcmpp[2]: {:?}, bkcmpp[3]: {:?} }}" , self . bkine () , self . bkcmpe (0usize) , self . bkcmpe (1usize) , self . bkcmpe (2usize) , self . bkcmpe (3usize) , self . bkcmpe (4usize) , self . bkcmpe (5usize) , self . bkcmpe (6usize) , self . bkcmpe (7usize) , self . bkinp () , self . bkcmpp (0usize) , self . bkcmpp (1usize) , self . bkcmpp (2usize) , self . bkcmpp (3usize)) } } # [doc = "alternate function register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Af1Adv { Af1Adv (0) } } impl core :: fmt :: Debug for Af1Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af1Adv") . field ("bkine" , & self . bkine ()) . field ("bkcmpe[0]" , & self . bkcmpe (0usize)) . field ("bkcmpe[1]" , & self . bkcmpe (1usize)) . field ("bkcmpe[2]" , & self . bkcmpe (2usize)) . field ("bkcmpe[3]" , & self . bkcmpe (3usize)) . field ("bkcmpe[4]" , & self . bkcmpe (4usize)) . field ("bkcmpe[5]" , & self . bkcmpe (5usize)) . field ("bkcmpe[6]" , & self . bkcmpe (6usize)) . field ("bkcmpe[7]" , & self . bkcmpe (7usize)) . field ("bkinp" , & self . bkinp ()) . field ("bkcmpp[0]" , & self . bkcmpp (0usize)) . field ("bkcmpp[1]" , & self . bkcmpp (1usize)) . field ("bkcmpp[2]" , & self . bkcmpp (2usize)) . field ("bkcmpp[3]" , & self . bkcmpp (3usize)) . field ("etrsel" , & self . etrsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af1Adv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Af1Adv {{ bkine: {=bool:?}, bkcmpe[0]: {=bool:?}, bkcmpe[1]: {=bool:?}, bkcmpe[2]: {=bool:?}, bkcmpe[3]: {=bool:?}, bkcmpe[4]: {=bool:?}, bkcmpe[5]: {=bool:?}, bkcmpe[6]: {=bool:?}, bkcmpe[7]: {=bool:?}, bkinp: {:?}, bkcmpp[0]: {:?}, bkcmpp[1]: {:?}, bkcmpp[2]: {:?}, bkcmpp[3]: {:?}, etrsel: {=u8:?} }}" , self . bkine () , self . bkcmpe (0usize) , self . bkcmpe (1usize) , self . bkcmpe (2usize) , self . bkcmpe (3usize) , self . bkcmpe (4usize) , self . bkcmpe (5usize) , self . bkcmpe (6usize) , self . bkcmpe (7usize) , self . bkinp () , self . bkcmpp (0usize) , self . bkcmpp (1usize) , self . bkcmpp (2usize) , self . bkcmpp (3usize) , self . etrsel ()) } } # [doc = "alternate function register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Af1Gp16 { Af1Gp16 (0) } } impl core :: fmt :: Debug for Af1Gp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af1Gp16") . field ("etrsel" , & self . etrsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af1Gp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Af1Gp16 {{ etrsel: {=u8:?} }}" , self . etrsel ()) } } # [doc = "alternate function register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Af21chCmp { Af21chCmp (0) } } impl core :: fmt :: Debug for Af21chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af21chCmp") . field ("ocrsel" , & self . ocrsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af21chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Af21chCmp {{ ocrsel: {=u8:?} }}" , self . ocrsel ()) } } # [doc = "alternate function register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Af2Adv { Af2Adv (0) } } impl core :: fmt :: Debug for Af2Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af2Adv") . field ("bk2ine" , & self . bk2ine ()) . field ("bk2cmpe[0]" , & self . bk2cmpe (0usize)) . field ("bk2cmpe[1]" , & self . bk2cmpe (1usize)) . field ("bk2cmpe[2]" , & self . bk2cmpe (2usize)) . field ("bk2cmpe[3]" , & self . bk2cmpe (3usize)) . field ("bk2cmpe[4]" , & self . bk2cmpe (4usize)) . field ("bk2cmpe[5]" , & self . bk2cmpe (5usize)) . field ("bk2cmpe[6]" , & self . bk2cmpe (6usize)) . field ("bk2cmpe[7]" , & self . bk2cmpe (7usize)) . field ("bk2inp" , & self . bk2inp ()) . field ("bk2cmpp[0]" , & self . bk2cmpp (0usize)) . field ("bk2cmpp[1]" , & self . bk2cmpp (1usize)) . field ("bk2cmpp[2]" , & self . bk2cmpp (2usize)) . field ("bk2cmpp[3]" , & self . bk2cmpp (3usize)) . field ("ocrsel" , & self . ocrsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af2Adv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Af2Adv {{ bk2ine: {=bool:?}, bk2cmpe[0]: {=bool:?}, bk2cmpe[1]: {=bool:?}, bk2cmpe[2]: {=bool:?}, bk2cmpe[3]: {=bool:?}, bk2cmpe[4]: {=bool:?}, bk2cmpe[5]: {=bool:?}, bk2cmpe[6]: {=bool:?}, bk2cmpe[7]: {=bool:?}, bk2inp: {:?}, bk2cmpp[0]: {:?}, bk2cmpp[1]: {:?}, bk2cmpp[2]: {:?}, bk2cmpp[3]: {:?}, ocrsel: {=u8:?} }}" , self . bk2ine () , self . bk2cmpe (0usize) , self . bk2cmpe (1usize) , self . bk2cmpe (2usize) , self . bk2cmpe (3usize) , self . bk2cmpe (4usize) , self . bk2cmpe (5usize) , self . bk2cmpe (6usize) , self . bk2cmpe (7usize) , self . bk2inp () , self . bk2cmpp (0usize) , self . bk2cmpp (1usize) , self . bk2cmpp (2usize) , self . bk2cmpp (3usize) , self . ocrsel ()) } } # [doc = "auto-reload register (Dither mode disabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> ArrCore { ArrCore (0) } } impl core :: fmt :: Debug for ArrCore { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("ArrCore") . field ("arr" , & self . arr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for ArrCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "ArrCore {{ arr: {=u16:?} }}" , self . arr ()) } } # [doc = "auto-reload register (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> ArrDitherCore { ArrDitherCore (0) } } impl core :: fmt :: Debug for ArrDitherCore { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("ArrDitherCore") . field ("dither" , & self . dither ()) . field ("arr" , & self . arr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for ArrDitherCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "ArrDitherCore {{ dither: {=u8:?}, arr: {=u16:?} }}" , self . dither () , self . arr ()) } } # [doc = "auto-reload register (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> ArrDitherGp32 { ArrDitherGp32 (0) } } impl core :: fmt :: Debug for ArrDitherGp32 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("ArrDitherGp32") . field ("dither" , & self . dither ()) . field ("arr" , & self . arr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for ArrDitherGp32 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "ArrDitherGp32 {{ dither: {=u8:?}, arr: {=u32:?} }}" , self . dither () , self . arr ()) } } # [doc = "break and dead-time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bdtr1chCmp { Bdtr1chCmp (0) } } impl core :: fmt :: Debug for Bdtr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bdtr1chCmp") . field ("dtg" , & self . dtg ()) . field ("lock" , & self . lock ()) . field ("ossi" , & self . ossi ()) . field ("ossr" , & self . ossr ()) . field ("bke[0]" , & self . bke (0usize)) . field ("bkp[0]" , & self . bkp (0usize)) . field ("aoe" , & self . aoe ()) . field ("moe" , & self . moe ()) . field ("bkf[0]" , & self . bkf (0usize)) . field ("bkdsrm[0]" , & self . bkdsrm (0usize)) . field ("bkbid[0]" , & self . bkbid (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bdtr1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bdtr1chCmp {{ dtg: {=u8:?}, lock: {:?}, ossi: {:?}, ossr: {:?}, bke[0]: {=bool:?}, bkp[0]: {:?}, aoe: {=bool:?}, moe: {=bool:?}, bkf[0]: {:?}, bkdsrm[0]: {:?}, bkbid[0]: {:?} }}" , self . dtg () , self . lock () , self . ossi () , self . ossr () , self . bke (0usize) , self . bkp (0usize) , self . aoe () , self . moe () , self . bkf (0usize) , self . bkdsrm (0usize) , self . bkbid (0usize)) } } # [doc = "break and dead-time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> BdtrAdv { BdtrAdv (0) } } impl core :: fmt :: Debug for BdtrAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("BdtrAdv") . field ("dtg" , & self . dtg ()) . field ("lock" , & self . lock ()) . field ("ossi" , & self . ossi ()) . field ("ossr" , & self . ossr ()) . field ("bke[0]" , & self . bke (0usize)) . field ("bke[1]" , & self . bke (1usize)) . field ("bkp[0]" , & self . bkp (0usize)) . field ("bkp[1]" , & self . bkp (1usize)) . field ("aoe" , & self . aoe ()) . field ("moe" , & self . moe ()) . field ("bkf[0]" , & self . bkf (0usize)) . field ("bkf[1]" , & self . bkf (1usize)) . field ("bkdsrm[0]" , & self . bkdsrm (0usize)) . field ("bkdsrm[1]" , & self . bkdsrm (1usize)) . field ("bkbid[0]" , & self . bkbid (0usize)) . field ("bkbid[1]" , & self . bkbid (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for BdtrAdv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "BdtrAdv {{ dtg: {=u8:?}, lock: {:?}, ossi: {:?}, ossr: {:?}, bke[0]: {=bool:?}, bke[1]: {=bool:?}, bkp[0]: {:?}, bkp[1]: {:?}, aoe: {=bool:?}, moe: {=bool:?}, bkf[0]: {:?}, bkf[1]: {:?}, bkdsrm[0]: {:?}, bkdsrm[1]: {:?}, bkbid[0]: {:?}, bkbid[1]: {:?} }}" , self . dtg () , self . lock () , self . ossi () , self . ossr () , self . bke (0usize) , self . bke (1usize) , self . bkp (0usize) , self . bkp (1usize) , self . aoe () , self . moe () , self . bkf (0usize) , self . bkf (1usize) , self . bkdsrm (0usize) , self . bkdsrm (1usize) , self . bkbid (0usize) , self . bkbid (1usize)) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccer1ch { Ccer1ch (0) } } impl core :: fmt :: Debug for Ccer1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccer1ch") . field ("cce[0]" , & self . cce (0usize)) . field ("ccp[0]" , & self . ccp (0usize)) . field ("ccnp[0]" , & self . ccnp (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccer1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccer1ch {{ cce[0]: {=bool:?}, ccp[0]: {=bool:?}, ccnp[0]: {=bool:?} }}" , self . cce (0usize) , self . ccp (0usize) , self . ccnp (0usize)) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccer1chCmp { Ccer1chCmp (0) } } impl core :: fmt :: Debug for Ccer1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccer1chCmp") . field ("cce[0]" , & self . cce (0usize)) . field ("ccp[0]" , & self . ccp (0usize)) . field ("ccne[0]" , & self . ccne (0usize)) . field ("ccnp[0]" , & self . ccnp (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccer1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccer1chCmp {{ cce[0]: {=bool:?}, ccp[0]: {=bool:?}, ccne[0]: {=bool:?}, ccnp[0]: {=bool:?} }}" , self . cce (0usize) , self . ccp (0usize) , self . ccne (0usize) , self . ccnp (0usize)) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccer2ch { Ccer2ch (0) } } impl core :: fmt :: Debug for Ccer2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccer2ch") . field ("cce[0]" , & self . cce (0usize)) . field ("cce[1]" , & self . cce (1usize)) . field ("ccp[0]" , & self . ccp (0usize)) . field ("ccp[1]" , & self . ccp (1usize)) . field ("ccnp[0]" , & self . ccnp (0usize)) . field ("ccnp[1]" , & self . ccnp (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccer2ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccer2ch {{ cce[0]: {=bool:?}, cce[1]: {=bool:?}, ccp[0]: {=bool:?}, ccp[1]: {=bool:?}, ccnp[0]: {=bool:?}, ccnp[1]: {=bool:?} }}" , self . cce (0usize) , self . cce (1usize) , self . ccp (0usize) , self . ccp (1usize) , self . ccnp (0usize) , self . ccnp (1usize)) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccer2chCmp { Ccer2chCmp (0) } } impl core :: fmt :: Debug for Ccer2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccer2chCmp") . field ("cce[0]" , & self . cce (0usize)) . field ("cce[1]" , & self . cce (1usize)) . field ("ccp[0]" , & self . ccp (0usize)) . field ("ccp[1]" , & self . ccp (1usize)) . field ("ccne[0]" , & self . ccne (0usize)) . field ("ccnp[0]" , & self . ccnp (0usize)) . field ("ccnp[1]" , & self . ccnp (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccer2chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccer2chCmp {{ cce[0]: {=bool:?}, cce[1]: {=bool:?}, ccp[0]: {=bool:?}, ccp[1]: {=bool:?}, ccne[0]: {=bool:?}, ccnp[0]: {=bool:?}, ccnp[1]: {=bool:?} }}" , self . cce (0usize) , self . cce (1usize) , self . ccp (0usize) , self . ccp (1usize) , self . ccne (0usize) , self . ccnp (0usize) , self . ccnp (1usize)) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcerAdv { CcerAdv (0) } } impl core :: fmt :: Debug for CcerAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcerAdv") . field ("cce[0]" , & self . cce (0usize)) . field ("cce[1]" , & self . cce (1usize)) . field ("cce[2]" , & self . cce (2usize)) . field ("cce[3]" , & self . cce (3usize)) . field ("cce[4]" , & self . cce (4usize)) . field ("cce[5]" , & self . cce (5usize)) . field ("ccp[0]" , & self . ccp (0usize)) . field ("ccp[1]" , & self . ccp (1usize)) . field ("ccp[2]" , & self . ccp (2usize)) . field ("ccp[3]" , & self . ccp (3usize)) . field ("ccp[4]" , & self . ccp (4usize)) . field ("ccp[5]" , & self . ccp (5usize)) . field ("ccne[0]" , & self . ccne (0usize)) . field ("ccne[1]" , & self . ccne (1usize)) . field ("ccne[2]" , & self . ccne (2usize)) . field ("ccne[3]" , & self . ccne (3usize)) . field ("ccnp[0]" , & self . ccnp (0usize)) . field ("ccnp[1]" , & self . ccnp (1usize)) . field ("ccnp[2]" , & self . ccnp (2usize)) . field ("ccnp[3]" , & self . ccnp (3usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcerAdv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcerAdv {{ cce[0]: {=bool:?}, cce[1]: {=bool:?}, cce[2]: {=bool:?}, cce[3]: {=bool:?}, cce[4]: {=bool:?}, cce[5]: {=bool:?}, ccp[0]: {=bool:?}, ccp[1]: {=bool:?}, ccp[2]: {=bool:?}, ccp[3]: {=bool:?}, ccp[4]: {=bool:?}, ccp[5]: {=bool:?}, ccne[0]: {=bool:?}, ccne[1]: {=bool:?}, ccne[2]: {=bool:?}, ccne[3]: {=bool:?}, ccnp[0]: {=bool:?}, ccnp[1]: {=bool:?}, ccnp[2]: {=bool:?}, ccnp[3]: {=bool:?} }}" , self . cce (0usize) , self . cce (1usize) , self . cce (2usize) , self . cce (3usize) , self . cce (4usize) , self . cce (5usize) , self . ccp (0usize) , self . ccp (1usize) , self . ccp (2usize) , self . ccp (3usize) , self . ccp (4usize) , self . ccp (5usize) , self . ccne (0usize) , self . ccne (1usize) , self . ccne (2usize) , self . ccne (3usize) , self . ccnp (0usize) , self . ccnp (1usize) , self . ccnp (2usize) , self . ccnp (3usize)) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcerGp16 { CcerGp16 (0) } } impl core :: fmt :: Debug for CcerGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcerGp16") . field ("cce[0]" , & self . cce (0usize)) . field ("cce[1]" , & self . cce (1usize)) . field ("cce[2]" , & self . cce (2usize)) . field ("cce[3]" , & self . cce (3usize)) . field ("ccp[0]" , & self . ccp (0usize)) . field ("ccp[1]" , & self . ccp (1usize)) . field ("ccp[2]" , & self . ccp (2usize)) . field ("ccp[3]" , & self . ccp (3usize)) . field ("ccnp[0]" , & self . ccnp (0usize)) . field ("ccnp[1]" , & self . ccnp (1usize)) . field ("ccnp[2]" , & self . ccnp (2usize)) . field ("ccnp[3]" , & self . ccnp (3usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcerGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcerGp16 {{ cce[0]: {=bool:?}, cce[1]: {=bool:?}, cce[2]: {=bool:?}, cce[3]: {=bool:?}, ccp[0]: {=bool:?}, ccp[1]: {=bool:?}, ccp[2]: {=bool:?}, ccp[3]: {=bool:?}, ccnp[0]: {=bool:?}, ccnp[1]: {=bool:?}, ccnp[2]: {=bool:?}, ccnp[3]: {=bool:?} }}" , self . cce (0usize) , self . cce (1usize) , self . cce (2usize) , self . cce (3usize) , self . ccp (0usize) , self . ccp (1usize) , self . ccp (2usize) , self . ccp (3usize) , self . ccnp (0usize) , self . ccnp (1usize) , self . ccnp (2usize) , self . ccnp (3usize)) } } # [doc = "capture/compare mode register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccmr3Adv { Ccmr3Adv (0) } } impl core :: fmt :: Debug for Ccmr3Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccmr3Adv") . field ("ocfe[0]" , & self . ocfe (0usize)) . field ("ocfe[1]" , & self . ocfe (1usize)) . field ("ocpe[0]" , & self . ocpe (0usize)) . field ("ocpe[1]" , & self . ocpe (1usize)) . field ("ocm[0]" , & self . ocm (0usize)) . field ("ocm[1]" , & self . ocm (1usize)) . field ("occe[0]" , & self . occe (0usize)) . field ("occe[1]" , & self . occe (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccmr3Adv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccmr3Adv {{ ocfe[0]: {=bool:?}, ocfe[1]: {=bool:?}, ocpe[0]: {=bool:?}, ocpe[1]: {=bool:?}, ocm[0]: {:?}, ocm[1]: {:?}, occe[0]: {=bool:?}, occe[1]: {=bool:?} }}" , self . ocfe (0usize) , self . ocfe (1usize) , self . ocpe (0usize) , self . ocpe (1usize) , self . ocm (0usize) , self . ocm (1usize) , self . occe (0usize) , self . occe (1usize)) } } # [doc = "capture/compare mode register x (x=1) (input mode)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcmrInput1ch { CcmrInput1ch (0) } } impl core :: fmt :: Debug for CcmrInput1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrInput1ch") . field ("ccs[0]" , & self . ccs (0usize)) . field ("icpsc[0]" , & self . icpsc (0usize)) . field ("icf[0]" , & self . icf (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrInput1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcmrInput1ch {{ ccs[0]: {:?}, icpsc[0]: {=u8:?}, icf[0]: {:?} }}" , self . ccs (0usize) , self . icpsc (0usize) , self . icf (0usize)) } } # [doc = "capture/compare mode register x (x=1) (input mode)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcmrInput2ch { CcmrInput2ch (0) } } impl core :: fmt :: Debug for CcmrInput2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrInput2ch") . field ("ccs[0]" , & self . ccs (0usize)) . field ("ccs[1]" , & self . ccs (1usize)) . field ("icpsc[0]" , & self . icpsc (0usize)) . field ("icpsc[1]" , & self . icpsc (1usize)) . field ("icf[0]" , & self . icf (0usize)) . field ("icf[1]" , & self . icf (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrInput2ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcmrInput2ch {{ ccs[0]: {:?}, ccs[1]: {:?}, icpsc[0]: {=u8:?}, icpsc[1]: {=u8:?}, icf[0]: {:?}, icf[1]: {:?} }}" , self . ccs (0usize) , self . ccs (1usize) , self . icpsc (0usize) , self . icpsc (1usize) , self . icf (0usize) , self . icf (1usize)) } } # [doc = "capture/compare mode register x (x=1) (output mode)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcmrOutput1ch { CcmrOutput1ch (0) } } impl core :: fmt :: Debug for CcmrOutput1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrOutput1ch") . field ("ccs[0]" , & self . ccs (0usize)) . field ("ocfe[0]" , & self . ocfe (0usize)) . field ("ocpe[0]" , & self . ocpe (0usize)) . field ("ocm[0]" , & self . ocm (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrOutput1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcmrOutput1ch {{ ccs[0]: {:?}, ocfe[0]: {=bool:?}, ocpe[0]: {=bool:?}, ocm[0]: {:?} }}" , self . ccs (0usize) , self . ocfe (0usize) , self . ocpe (0usize) , self . ocm (0usize)) } } # [doc = "capture/compare mode register x (x=1) (output mode)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcmrOutput2ch { CcmrOutput2ch (0) } } impl core :: fmt :: Debug for CcmrOutput2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrOutput2ch") . field ("ccs[0]" , & self . ccs (0usize)) . field ("ccs[1]" , & self . ccs (1usize)) . field ("ocfe[0]" , & self . ocfe (0usize)) . field ("ocfe[1]" , & self . ocfe (1usize)) . field ("ocpe[0]" , & self . ocpe (0usize)) . field ("ocpe[1]" , & self . ocpe (1usize)) . field ("ocm[0]" , & self . ocm (0usize)) . field ("ocm[1]" , & self . ocm (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrOutput2ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcmrOutput2ch {{ ccs[0]: {:?}, ccs[1]: {:?}, ocfe[0]: {=bool:?}, ocfe[1]: {=bool:?}, ocpe[0]: {=bool:?}, ocpe[1]: {=bool:?}, ocm[0]: {:?}, ocm[1]: {:?} }}" , self . ccs (0usize) , self . ccs (1usize) , self . ocfe (0usize) , self . ocfe (1usize) , self . ocpe (0usize) , self . ocpe (1usize) , self . ocm (0usize) , self . ocm (1usize)) } } # [doc = "capture/compare mode register x (x=1-2) (output mode)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcmrOutputGp16 { CcmrOutputGp16 (0) } } impl core :: fmt :: Debug for CcmrOutputGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrOutputGp16") . field ("ccs[0]" , & self . ccs (0usize)) . field ("ccs[1]" , & self . ccs (1usize)) . field ("ocfe[0]" , & self . ocfe (0usize)) . field ("ocfe[1]" , & self . ocfe (1usize)) . field ("ocpe[0]" , & self . ocpe (0usize)) . field ("ocpe[1]" , & self . ocpe (1usize)) . field ("ocm[0]" , & self . ocm (0usize)) . field ("ocm[1]" , & self . ocm (1usize)) . field ("occe[0]" , & self . occe (0usize)) . field ("occe[1]" , & self . occe (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrOutputGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcmrOutputGp16 {{ ccs[0]: {:?}, ccs[1]: {:?}, ocfe[0]: {=bool:?}, ocfe[1]: {=bool:?}, ocpe[0]: {=bool:?}, ocpe[1]: {=bool:?}, ocm[0]: {:?}, ocm[1]: {:?}, occe[0]: {=bool:?}, occe[1]: {=bool:?} }}" , self . ccs (0usize) , self . ccs (1usize) , self . ocfe (0usize) , self . ocfe (1usize) , self . ocpe (0usize) , self . ocpe (1usize) , self . ocm (0usize) , self . ocm (1usize) , self . occe (0usize) , self . occe (1usize)) } } # [doc = "capture/compare register x (x=1-4,6) (Dither mode disabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccr1ch { Ccr1ch (0) } } impl core :: fmt :: Debug for Ccr1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr1ch") . field ("ccr" , & self . ccr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr1ch {{ ccr: {=u16:?} }}" , self . ccr ()) } } # [doc = "capture/compare register 5 (Dither mode disabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccr5Adv { Ccr5Adv (0) } } impl core :: fmt :: Debug for Ccr5Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr5Adv") . field ("ccr" , & self . ccr ()) . field ("gc5c[0]" , & self . gc5c (0usize)) . field ("gc5c[1]" , & self . gc5c (1usize)) . field ("gc5c[2]" , & self . gc5c (2usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr5Adv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr5Adv {{ ccr: {=u16:?}, gc5c[0]: {:?}, gc5c[1]: {:?}, gc5c[2]: {:?} }}" , self . ccr () , self . gc5c (0usize) , self . gc5c (1usize) , self . gc5c (2usize)) } } # [doc = "capture/compare register 5 (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccr5DitherAdv { Ccr5DitherAdv (0) } } impl core :: fmt :: Debug for Ccr5DitherAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr5DitherAdv") . field ("dither" , & self . dither ()) . field ("ccr" , & self . ccr ()) . field ("gc5c[0]" , & self . gc5c (0usize)) . field ("gc5c[1]" , & self . gc5c (1usize)) . field ("gc5c[2]" , & self . gc5c (2usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr5DitherAdv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr5DitherAdv {{ dither: {=u8:?}, ccr: {=u16:?}, gc5c[0]: {:?}, gc5c[1]: {:?}, gc5c[2]: {:?} }}" , self . dither () , self . ccr () , self . gc5c (0usize) , self . gc5c (1usize) , self . gc5c (2usize)) } } # [doc = "capture/compare register x (x=1-4,6) (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcrDither1ch { CcrDither1ch (0) } } impl core :: fmt :: Debug for CcrDither1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcrDither1ch") . field ("dither" , & self . dither ()) . field ("ccr" , & self . ccr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcrDither1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcrDither1ch {{ dither: {=u8:?}, ccr: {=u16:?} }}" , self . dither () , self . ccr ()) } } # [doc = "capture/compare register x (x=1-4,6) (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcrDitherGp32 { CcrDitherGp32 (0) } } impl core :: fmt :: Debug for CcrDitherGp32 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcrDitherGp32") . field ("dither" , & self . dither ()) . field ("ccr" , & self . ccr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcrDitherGp32 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CcrDitherGp32 {{ dither: {=u8:?}, ccr: {=u32:?} }}" , self . dither () , self . ccr ()) } } # [doc = "counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CntCore { CntCore (0) } } impl core :: fmt :: Debug for CntCore { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CntCore") . field ("cnt" , & self . cnt ()) . field ("uifcpy" , & self . uifcpy ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CntCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CntCore {{ cnt: {=u16:?}, uifcpy: {=bool:?} }}" , self . cnt () , self . uifcpy ()) } } # [doc = "counter (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CntDitherGp32 { CntDitherGp32 (0) } } impl core :: fmt :: Debug for CntDitherGp32 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CntDitherGp32") . field ("cnt" , & self . cnt ()) . field ("uifcpy" , & self . uifcpy ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CntDitherGp32 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "CntDitherGp32 {{ cnt: {=u32:?}, uifcpy: {=bool:?} }}" , self . cnt () , self . uifcpy ()) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr11ch { Cr11ch (0) } } impl core :: fmt :: Debug for Cr11ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr11ch") . field ("cen" , & self . cen ()) . field ("udis" , & self . udis ()) . field ("urs" , & self . urs ()) . field ("opm" , & self . opm ()) . field ("arpe" , & self . arpe ()) . field ("ckd" , & self . ckd ()) . field ("uifremap" , & self . uifremap ()) . field ("dithen" , & self . dithen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr11ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr11ch {{ cen: {=bool:?}, udis: {=bool:?}, urs: {:?}, opm: {=bool:?}, arpe: {=bool:?}, ckd: {:?}, uifremap: {=bool:?}, dithen: {=bool:?} }}" , self . cen () , self . udis () , self . urs () , self . opm () , self . arpe () , self . ckd () , self . uifremap () , self . dithen ()) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr1Core { Cr1Core (0) } } impl core :: fmt :: Debug for Cr1Core { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr1Core") . field ("cen" , & self . cen ()) . field ("udis" , & self . udis ()) . field ("urs" , & self . urs ()) . field ("opm" , & self . opm ()) . field ("arpe" , & self . arpe ()) . field ("uifremap" , & self . uifremap ()) . field ("dithen" , & self . dithen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr1Core { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr1Core {{ cen: {=bool:?}, udis: {=bool:?}, urs: {:?}, opm: {=bool:?}, arpe: {=bool:?}, uifremap: {=bool:?}, dithen: {=bool:?} }}" , self . cen () , self . udis () , self . urs () , self . opm () , self . arpe () , self . uifremap () , self . dithen ()) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr1Gp16 { Cr1Gp16 (0) } } impl core :: fmt :: Debug for Cr1Gp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr1Gp16") . field ("cen" , & self . cen ()) . field ("udis" , & self . udis ()) . field ("urs" , & self . urs ()) . field ("opm" , & self . opm ()) . field ("dir" , & self . dir ()) . field ("cms" , & self . cms ()) . field ("arpe" , & self . arpe ()) . field ("ckd" , & self . ckd ()) . field ("uifremap" , & self . uifremap ()) . field ("dithen" , & self . dithen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr1Gp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr1Gp16 {{ cen: {=bool:?}, udis: {=bool:?}, urs: {:?}, opm: {=bool:?}, dir: {:?}, cms: {:?}, arpe: {=bool:?}, ckd: {:?}, uifremap: {=bool:?}, dithen: {=bool:?} }}" , self . cen () , self . udis () , self . urs () , self . opm () , self . dir () , self . cms () , self . arpe () , self . ckd () , self . uifremap () , self . dithen ()) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr21chCmp { Cr21chCmp (0) } } impl core :: fmt :: Debug for Cr21chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr21chCmp") . field ("ccpc" , & self . ccpc ()) . field ("ccus" , & self . ccus ()) . field ("ccds" , & self . ccds ()) . field ("ois[0]" , & self . ois (0usize)) . field ("oisn[0]" , & self . oisn (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr21chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr21chCmp {{ ccpc: {=bool:?}, ccus: {=bool:?}, ccds: {:?}, ois[0]: {=bool:?}, oisn[0]: {=bool:?} }}" , self . ccpc () , self . ccus () , self . ccds () , self . ois (0usize) , self . oisn (0usize)) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr22ch { Cr22ch (0) } } impl core :: fmt :: Debug for Cr22ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr22ch") . field ("mms" , & self . mms ()) . field ("ti1s" , & self . ti1s ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr22ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr22ch {{ mms: {:?}, ti1s: {:?} }}" , self . mms () , self . ti1s ()) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr22chCmp { Cr22chCmp (0) } } impl core :: fmt :: Debug for Cr22chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr22chCmp") . field ("ccpc" , & self . ccpc ()) . field ("ccus" , & self . ccus ()) . field ("ccds" , & self . ccds ()) . field ("mms" , & self . mms ()) . field ("ti1s" , & self . ti1s ()) . field ("ois[0]" , & self . ois (0usize)) . field ("ois[1]" , & self . ois (1usize)) . field ("oisn[0]" , & self . oisn (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr22chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr22chCmp {{ ccpc: {=bool:?}, ccus: {=bool:?}, ccds: {:?}, mms: {:?}, ti1s: {:?}, ois[0]: {=bool:?}, ois[1]: {=bool:?}, oisn[0]: {=bool:?} }}" , self . ccpc () , self . ccus () , self . ccds () , self . mms () , self . ti1s () , self . ois (0usize) , self . ois (1usize) , self . oisn (0usize)) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr2Adv { Cr2Adv (0) } } impl core :: fmt :: Debug for Cr2Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2Adv") . field ("ccpc" , & self . ccpc ()) . field ("ccus" , & self . ccus ()) . field ("ccds" , & self . ccds ()) . field ("mms" , & self . mms ()) . field ("ti1s" , & self . ti1s ()) . field ("ois[0]" , & self . ois (0usize)) . field ("ois[1]" , & self . ois (1usize)) . field ("ois[2]" , & self . ois (2usize)) . field ("ois[3]" , & self . ois (3usize)) . field ("ois[4]" , & self . ois (4usize)) . field ("ois[5]" , & self . ois (5usize)) . field ("oisn[0]" , & self . oisn (0usize)) . field ("oisn[1]" , & self . oisn (1usize)) . field ("oisn[2]" , & self . oisn (2usize)) . field ("oisn[3]" , & self . oisn (3usize)) . field ("mms2" , & self . mms2 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2Adv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2Adv {{ ccpc: {=bool:?}, ccus: {=bool:?}, ccds: {:?}, mms: {:?}, ti1s: {:?}, ois[0]: {=bool:?}, ois[1]: {=bool:?}, ois[2]: {=bool:?}, ois[3]: {=bool:?}, ois[4]: {=bool:?}, ois[5]: {=bool:?}, oisn[0]: {=bool:?}, oisn[1]: {=bool:?}, oisn[2]: {=bool:?}, oisn[3]: {=bool:?}, mms2: {:?} }}" , self . ccpc () , self . ccus () , self . ccds () , self . mms () , self . ti1s () , self . ois (0usize) , self . ois (1usize) , self . ois (2usize) , self . ois (3usize) , self . ois (4usize) , self . ois (5usize) , self . oisn (0usize) , self . oisn (1usize) , self . oisn (2usize) , self . oisn (3usize) , self . mms2 ()) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr2Basic { Cr2Basic (0) } } impl core :: fmt :: Debug for Cr2Basic { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2Basic") . field ("mms" , & self . mms ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2Basic { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2Basic {{ mms: {:?} }}" , self . mms ()) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr2Gp16 { Cr2Gp16 (0) } } impl core :: fmt :: Debug for Cr2Gp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2Gp16") . field ("ccds" , & self . ccds ()) . field ("mms" , & self . mms ()) . field ("ti1s" , & self . ti1s ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2Gp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2Gp16 {{ ccds: {:?}, mms: {:?}, ti1s: {:?} }}" , self . ccds () , self . mms () , self . ti1s ()) } } # [doc = "DMA control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dcr1chCmp { Dcr1chCmp (0) } } impl core :: fmt :: Debug for Dcr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dcr1chCmp") . field ("dba" , & self . dba ()) . field ("dbl" , & self . dbl ()) . field ("dbss" , & self . dbss ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dcr1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dcr1chCmp {{ dba: {=u8:?}, dbl: {=u8:?}, dbss: {:?} }}" , self . dba () , self . dbl () , self . dbss ()) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dier1ch { Dier1ch (0) } } impl core :: fmt :: Debug for Dier1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dier1ch") . field ("uie" , & self . uie ()) . field ("ccie[0]" , & self . ccie (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dier1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dier1ch {{ uie: {=bool:?}, ccie[0]: {=bool:?} }}" , self . uie () , self . ccie (0usize)) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dier1chCmp { Dier1chCmp (0) } } impl core :: fmt :: Debug for Dier1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dier1chCmp") . field ("uie" , & self . uie ()) . field ("ccie[0]" , & self . ccie (0usize)) . field ("comie" , & self . comie ()) . field ("bie" , & self . bie ()) . field ("ude" , & self . ude ()) . field ("ccde[0]" , & self . ccde (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dier1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dier1chCmp {{ uie: {=bool:?}, ccie[0]: {=bool:?}, comie: {=bool:?}, bie: {=bool:?}, ude: {=bool:?}, ccde[0]: {=bool:?} }}" , self . uie () , self . ccie (0usize) , self . comie () , self . bie () , self . ude () , self . ccde (0usize)) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dier2ch { Dier2ch (0) } } impl core :: fmt :: Debug for Dier2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dier2ch") . field ("uie" , & self . uie ()) . field ("ccie[0]" , & self . ccie (0usize)) . field ("ccie[1]" , & self . ccie (1usize)) . field ("tie" , & self . tie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dier2ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dier2ch {{ uie: {=bool:?}, ccie[0]: {=bool:?}, ccie[1]: {=bool:?}, tie: {=bool:?} }}" , self . uie () , self . ccie (0usize) , self . ccie (1usize) , self . tie ()) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dier2chCmp { Dier2chCmp (0) } } impl core :: fmt :: Debug for Dier2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dier2chCmp") . field ("uie" , & self . uie ()) . field ("ccie[0]" , & self . ccie (0usize)) . field ("comie" , & self . comie ()) . field ("tie" , & self . tie ()) . field ("bie" , & self . bie ()) . field ("ude" , & self . ude ()) . field ("ccde[0]" , & self . ccde (0usize)) . field ("comde" , & self . comde ()) . field ("tde" , & self . tde ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dier2chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dier2chCmp {{ uie: {=bool:?}, ccie[0]: {=bool:?}, comie: {=bool:?}, tie: {=bool:?}, bie: {=bool:?}, ude: {=bool:?}, ccde[0]: {=bool:?}, comde: {=bool:?}, tde: {=bool:?} }}" , self . uie () , self . ccie (0usize) , self . comie () , self . tie () , self . bie () , self . ude () , self . ccde (0usize) , self . comde () , self . tde ()) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DierAdv { DierAdv (0) } } impl core :: fmt :: Debug for DierAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DierAdv") . field ("uie" , & self . uie ()) . field ("ccie[0]" , & self . ccie (0usize)) . field ("ccie[1]" , & self . ccie (1usize)) . field ("ccie[2]" , & self . ccie (2usize)) . field ("ccie[3]" , & self . ccie (3usize)) . field ("comie" , & self . comie ()) . field ("tie" , & self . tie ()) . field ("bie" , & self . bie ()) . field ("ude" , & self . ude ()) . field ("ccde[0]" , & self . ccde (0usize)) . field ("ccde[1]" , & self . ccde (1usize)) . field ("ccde[2]" , & self . ccde (2usize)) . field ("ccde[3]" , & self . ccde (3usize)) . field ("comde" , & self . comde ()) . field ("tde" , & self . tde ()) . field ("idxie" , & self . idxie ()) . field ("dirie" , & self . dirie ()) . field ("ierrie" , & self . ierrie ()) . field ("terrie" , & self . terrie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for DierAdv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "DierAdv {{ uie: {=bool:?}, ccie[0]: {=bool:?}, ccie[1]: {=bool:?}, ccie[2]: {=bool:?}, ccie[3]: {=bool:?}, comie: {=bool:?}, tie: {=bool:?}, bie: {=bool:?}, ude: {=bool:?}, ccde[0]: {=bool:?}, ccde[1]: {=bool:?}, ccde[2]: {=bool:?}, ccde[3]: {=bool:?}, comde: {=bool:?}, tde: {=bool:?}, idxie: {=bool:?}, dirie: {=bool:?}, ierrie: {=bool:?}, terrie: {=bool:?} }}" , self . uie () , self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) , self . comie () , self . tie () , self . bie () , self . ude () , self . ccde (0usize) , self . ccde (1usize) , self . ccde (2usize) , self . ccde (3usize) , self . comde () , self . tde () , self . idxie () , self . dirie () , self . ierrie () , self . terrie ()) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DierBasicNoCr2 { DierBasicNoCr2 (0) } } impl core :: fmt :: Debug for DierBasicNoCr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DierBasicNoCr2") . field ("uie" , & self . uie ()) . field ("ude" , & self . ude ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for DierBasicNoCr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "DierBasicNoCr2 {{ uie: {=bool:?}, ude: {=bool:?} }}" , self . uie () , self . ude ()) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DierCore { DierCore (0) } } impl core :: fmt :: Debug for DierCore { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DierCore") . field ("uie" , & self . uie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for DierCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "DierCore {{ uie: {=bool:?} }}" , self . uie ()) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DierGp16 { DierGp16 (0) } } impl core :: fmt :: Debug for DierGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DierGp16") . field ("uie" , & self . uie ()) . field ("ccie[0]" , & self . ccie (0usize)) . field ("ccie[1]" , & self . ccie (1usize)) . field ("ccie[2]" , & self . ccie (2usize)) . field ("ccie[3]" , & self . ccie (3usize)) . field ("tie" , & self . tie ()) . field ("ude" , & self . ude ()) . field ("ccde[0]" , & self . ccde (0usize)) . field ("ccde[1]" , & self . ccde (1usize)) . field ("ccde[2]" , & self . ccde (2usize)) . field ("ccde[3]" , & self . ccde (3usize)) . field ("tde" , & self . tde ()) . field ("idxie" , & self . idxie ()) . field ("dirie" , & self . dirie ()) . field ("ierrie" , & self . ierrie ()) . field ("terrie" , & self . terrie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for DierGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "DierGp16 {{ uie: {=bool:?}, ccie[0]: {=bool:?}, ccie[1]: {=bool:?}, ccie[2]: {=bool:?}, ccie[3]: {=bool:?}, tie: {=bool:?}, ude: {=bool:?}, ccde[0]: {=bool:?}, ccde[1]: {=bool:?}, ccde[2]: {=bool:?}, ccde[3]: {=bool:?}, tde: {=bool:?}, idxie: {=bool:?}, dirie: {=bool:?}, ierrie: {=bool:?}, terrie: {=bool:?} }}" , self . uie () , self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) , self . tie () , self . ude () , self . ccde (0usize) , self . ccde (1usize) , self . ccde (2usize) , self . ccde (3usize) , self . tde () , self . idxie () , self . dirie () , self . ierrie () , self . terrie ()) } } # [doc = "deadtime register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dtr21chCmp { Dtr21chCmp (0) } } impl core :: fmt :: Debug for Dtr21chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dtr21chCmp") . field ("dtgf" , & self . dtgf ()) . field ("dtae" , & self . dtae ()) . field ("dtpe" , & self . dtpe ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dtr21chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dtr21chCmp {{ dtgf: {=u8:?}, dtae: {:?}, dtpe: {=bool:?} }}" , self . dtgf () , self . dtae () , self . dtpe ()) } } # [doc = "encoder control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> EcrGp16 { EcrGp16 (0) } } impl core :: fmt :: Debug for EcrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("EcrGp16") . field ("ie" , & self . ie ()) . field ("idir" , & self . idir ()) . field ("iblk" , & self . iblk ()) . field ("fidx" , & self . fidx ()) . field ("ipos" , & self . ipos ()) . field ("pw" , & self . pw ()) . field ("pwprsc" , & self . pwprsc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for EcrGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "EcrGp16 {{ ie: {=bool:?}, idir: {:?}, iblk: {:?}, fidx: {:?}, ipos: {=u8:?}, pw: {=u8:?}, pwprsc: {=u8:?} }}" , self . ie () , self . idir () , self . iblk () , self . fidx () , self . ipos () , self . pw () , self . pwprsc ()) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Egr1ch { Egr1ch (0) } } impl core :: fmt :: Debug for Egr1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Egr1ch") . field ("ug" , & self . ug ()) . field ("ccg[0]" , & self . ccg (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Egr1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Egr1ch {{ ug: {=bool:?}, ccg[0]: {=bool:?} }}" , self . ug () , self . ccg (0usize)) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Egr1chCmp { Egr1chCmp (0) } } impl core :: fmt :: Debug for Egr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Egr1chCmp") . field ("ug" , & self . ug ()) . field ("ccg[0]" , & self . ccg (0usize)) . field ("comg" , & self . comg ()) . field ("bg[0]" , & self . bg (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Egr1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Egr1chCmp {{ ug: {=bool:?}, ccg[0]: {=bool:?}, comg: {=bool:?}, bg[0]: {=bool:?} }}" , self . ug () , self . ccg (0usize) , self . comg () , self . bg (0usize)) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Egr2ch { Egr2ch (0) } } impl core :: fmt :: Debug for Egr2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Egr2ch") . field ("ug" , & self . ug ()) . field ("ccg[0]" , & self . ccg (0usize)) . field ("ccg[1]" , & self . ccg (1usize)) . field ("tg" , & self . tg ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Egr2ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Egr2ch {{ ug: {=bool:?}, ccg[0]: {=bool:?}, ccg[1]: {=bool:?}, tg: {=bool:?} }}" , self . ug () , self . ccg (0usize) , self . ccg (1usize) , self . tg ()) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Egr2chCmp { Egr2chCmp (0) } } impl core :: fmt :: Debug for Egr2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Egr2chCmp") . field ("ug" , & self . ug ()) . field ("ccg[0]" , & self . ccg (0usize)) . field ("ccg[1]" , & self . ccg (1usize)) . field ("comg" , & self . comg ()) . field ("tg" , & self . tg ()) . field ("bg[0]" , & self . bg (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Egr2chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Egr2chCmp {{ ug: {=bool:?}, ccg[0]: {=bool:?}, ccg[1]: {=bool:?}, comg: {=bool:?}, tg: {=bool:?}, bg[0]: {=bool:?} }}" , self . ug () , self . ccg (0usize) , self . ccg (1usize) , self . comg () , self . tg () , self . bg (0usize)) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> EgrAdv { EgrAdv (0) } } impl core :: fmt :: Debug for EgrAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("EgrAdv") . field ("ug" , & self . ug ()) . field ("ccg[0]" , & self . ccg (0usize)) . field ("ccg[1]" , & self . ccg (1usize)) . field ("ccg[2]" , & self . ccg (2usize)) . field ("ccg[3]" , & self . ccg (3usize)) . field ("comg" , & self . comg ()) . field ("tg" , & self . tg ()) . field ("bg[0]" , & self . bg (0usize)) . field ("bg[1]" , & self . bg (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for EgrAdv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "EgrAdv {{ ug: {=bool:?}, ccg[0]: {=bool:?}, ccg[1]: {=bool:?}, ccg[2]: {=bool:?}, ccg[3]: {=bool:?}, comg: {=bool:?}, tg: {=bool:?}, bg[0]: {=bool:?}, bg[1]: {=bool:?} }}" , self . ug () , self . ccg (0usize) , self . ccg (1usize) , self . ccg (2usize) , self . ccg (3usize) , self . comg () , self . tg () , self . bg (0usize) , self . bg (1usize)) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> EgrCore { EgrCore (0) } } impl core :: fmt :: Debug for EgrCore { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("EgrCore") . field ("ug" , & self . ug ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for EgrCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "EgrCore {{ ug: {=bool:?} }}" , self . ug ()) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> EgrGp16 { EgrGp16 (0) } } impl core :: fmt :: Debug for EgrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("EgrGp16") . field ("ug" , & self . ug ()) . field ("ccg[0]" , & self . ccg (0usize)) . field ("ccg[1]" , & self . ccg (1usize)) . field ("ccg[2]" , & self . ccg (2usize)) . field ("ccg[3]" , & self . ccg (3usize)) . field ("tg" , & self . tg ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for EgrGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "EgrGp16 {{ ug: {=bool:?}, ccg[0]: {=bool:?}, ccg[1]: {=bool:?}, ccg[2]: {=bool:?}, ccg[3]: {=bool:?}, tg: {=bool:?} }}" , self . ug () , self . ccg (0usize) , self . ccg (1usize) , self . ccg (2usize) , self . ccg (3usize) , self . tg ()) } } # [doc = "repetition counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Rcr1chCmp { Rcr1chCmp (0) } } impl core :: fmt :: Debug for Rcr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Rcr1chCmp") . field ("rep" , & self . rep ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Rcr1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Rcr1chCmp {{ rep: {=u8:?} }}" , self . rep ()) } } # [doc = "repetition counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> RcrAdv { RcrAdv (0) } } impl core :: fmt :: Debug for RcrAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("RcrAdv") . field ("rep" , & self . rep ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for RcrAdv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "RcrAdv {{ rep: {=u16:?} }}" , self . rep ()) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smcr2ch { Smcr2ch (0) } } impl core :: fmt :: Debug for Smcr2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smcr2ch") . field ("sms" , & self . sms ()) . field ("ts" , & self . ts ()) . field ("msm" , & self . msm ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smcr2ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smcr2ch {{ sms: {:?}, ts: {:?}, msm: {:?} }}" , self . sms () , self . ts () , self . msm ()) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smcr2chCmp { Smcr2chCmp (0) } } impl core :: fmt :: Debug for Smcr2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smcr2chCmp") . field ("sms" , & self . sms ()) . field ("ts" , & self . ts ()) . field ("msm" , & self . msm ()) . field ("smspe" , & self . smspe ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smcr2chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smcr2chCmp {{ sms: {:?}, ts: {:?}, msm: {:?}, smspe: {=bool:?} }}" , self . sms () , self . ts () , self . msm () , self . smspe ()) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> SmcrAdv { SmcrAdv (0) } } impl core :: fmt :: Debug for SmcrAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SmcrAdv") . field ("sms" , & self . sms ()) . field ("occs" , & self . occs ()) . field ("ts" , & self . ts ()) . field ("msm" , & self . msm ()) . field ("etf" , & self . etf ()) . field ("etps" , & self . etps ()) . field ("ece" , & self . ece ()) . field ("etp" , & self . etp ()) . field ("smspe" , & self . smspe ()) . field ("smsps" , & self . smsps ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for SmcrAdv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "SmcrAdv {{ sms: {:?}, occs: {:?}, ts: {:?}, msm: {:?}, etf: {:?}, etps: {:?}, ece: {=bool:?}, etp: {:?}, smspe: {=bool:?}, smsps: {:?} }}" , self . sms () , self . occs () , self . ts () , self . msm () , self . etf () , self . etps () , self . ece () , self . etp () , self . smspe () , self . smsps ()) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> SmcrGp16 { SmcrGp16 (0) } } impl core :: fmt :: Debug for SmcrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SmcrGp16") . field ("sms" , & self . sms ()) . field ("ts" , & self . ts ()) . field ("msm" , & self . msm ()) . field ("etf" , & self . etf ()) . field ("etps" , & self . etps ()) . field ("ece" , & self . ece ()) . field ("etp" , & self . etp ()) . field ("smspe" , & self . smspe ()) . field ("smsps" , & self . smsps ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for SmcrGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "SmcrGp16 {{ sms: {:?}, ts: {:?}, msm: {:?}, etf: {:?}, etps: {:?}, ece: {=bool:?}, etp: {:?}, smspe: {=bool:?}, smsps: {:?} }}" , self . sms () , self . ts () , self . msm () , self . etf () , self . etps () , self . ece () , self . etp () , self . smspe () , self . smsps ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr1ch { Sr1ch (0) } } impl core :: fmt :: Debug for Sr1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr1ch") . field ("uif" , & self . uif ()) . field ("ccif[0]" , & self . ccif (0usize)) . field ("ccof[0]" , & self . ccof (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr1ch {{ uif: {=bool:?}, ccif[0]: {=bool:?}, ccof[0]: {=bool:?} }}" , self . uif () , self . ccif (0usize) , self . ccof (0usize)) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr1chCmp { Sr1chCmp (0) } } impl core :: fmt :: Debug for Sr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr1chCmp") . field ("uif" , & self . uif ()) . field ("ccif[0]" , & self . ccif (0usize)) . field ("comif" , & self . comif ()) . field ("bif[0]" , & self . bif (0usize)) . field ("ccof[0]" , & self . ccof (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr1chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr1chCmp {{ uif: {=bool:?}, ccif[0]: {=bool:?}, comif: {=bool:?}, bif[0]: {=bool:?}, ccof[0]: {=bool:?} }}" , self . uif () , self . ccif (0usize) , self . comif () , self . bif (0usize) , self . ccof (0usize)) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr2ch { Sr2ch (0) } } impl core :: fmt :: Debug for Sr2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr2ch") . field ("uif" , & self . uif ()) . field ("ccif[0]" , & self . ccif (0usize)) . field ("ccif[1]" , & self . ccif (1usize)) . field ("tif" , & self . tif ()) . field ("ccof[0]" , & self . ccof (0usize)) . field ("ccof[1]" , & self . ccof (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr2ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr2ch {{ uif: {=bool:?}, ccif[0]: {=bool:?}, ccif[1]: {=bool:?}, tif: {=bool:?}, ccof[0]: {=bool:?}, ccof[1]: {=bool:?} }}" , self . uif () , self . ccif (0usize) , self . ccif (1usize) , self . tif () , self . ccof (0usize) , self . ccof (1usize)) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr2chCmp { Sr2chCmp (0) } } impl core :: fmt :: Debug for Sr2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr2chCmp") . field ("uif" , & self . uif ()) . field ("ccif[0]" , & self . ccif (0usize)) . field ("ccif[1]" , & self . ccif (1usize)) . field ("comif" , & self . comif ()) . field ("tif" , & self . tif ()) . field ("bif[0]" , & self . bif (0usize)) . field ("ccof[0]" , & self . ccof (0usize)) . field ("ccof[1]" , & self . ccof (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr2chCmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr2chCmp {{ uif: {=bool:?}, ccif[0]: {=bool:?}, ccif[1]: {=bool:?}, comif: {=bool:?}, tif: {=bool:?}, bif[0]: {=bool:?}, ccof[0]: {=bool:?}, ccof[1]: {=bool:?} }}" , self . uif () , self . ccif (0usize) , self . ccif (1usize) , self . comif () , self . tif () , self . bif (0usize) , self . ccof (0usize) , self . ccof (1usize)) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> SrAdv { SrAdv (0) } } impl core :: fmt :: Debug for SrAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SrAdv") . field ("uif" , & self . uif ()) . field ("ccif[0]" , & self . ccif (0usize)) . field ("ccif[1]" , & self . ccif (1usize)) . field ("ccif[2]" , & self . ccif (2usize)) . field ("ccif[3]" , & self . ccif (3usize)) . field ("comif" , & self . comif ()) . field ("tif" , & self . tif ()) . field ("bif[0]" , & self . bif (0usize)) . field ("bif[1]" , & self . bif (1usize)) . field ("ccof[0]" , & self . ccof (0usize)) . field ("ccof[1]" , & self . ccof (1usize)) . field ("ccof[2]" , & self . ccof (2usize)) . field ("ccof[3]" , & self . ccof (3usize)) . field ("sbif" , & self . sbif ()) . field ("ccif5" , & self . ccif5 ()) . field ("ccif6" , & self . ccif6 ()) . field ("idxif" , & self . idxif ()) . field ("dirif" , & self . dirif ()) . field ("ierrif" , & self . ierrif ()) . field ("terrif" , & self . terrif ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for SrAdv { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "SrAdv {{ uif: {=bool:?}, ccif[0]: {=bool:?}, ccif[1]: {=bool:?}, ccif[2]: {=bool:?}, ccif[3]: {=bool:?}, comif: {=bool:?}, tif: {=bool:?}, bif[0]: {=bool:?}, bif[1]: {=bool:?}, ccof[0]: {=bool:?}, ccof[1]: {=bool:?}, ccof[2]: {=bool:?}, ccof[3]: {=bool:?}, sbif: {=bool:?}, ccif5: {=bool:?}, ccif6: {=bool:?}, idxif: {=bool:?}, dirif: {=bool:?}, ierrif: {=bool:?}, terrif: {=bool:?} }}" , self . uif () , self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) , self . comif () , self . tif () , self . bif (0usize) , self . bif (1usize) , self . ccof (0usize) , self . ccof (1usize) , self . ccof (2usize) , self . ccof (3usize) , self . sbif () , self . ccif5 () , self . ccif6 () , self . idxif () , self . dirif () , self . ierrif () , self . terrif ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> SrCore { SrCore (0) } } impl core :: fmt :: Debug for SrCore { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SrCore") . field ("uif" , & self . uif ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for SrCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "SrCore {{ uif: {=bool:?} }}" , self . uif ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> SrGp16 { SrGp16 (0) } } impl core :: fmt :: Debug for SrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SrGp16") . field ("uif" , & self . uif ()) . field ("ccif[0]" , & self . ccif (0usize)) . field ("ccif[1]" , & self . ccif (1usize)) . field ("ccif[2]" , & self . ccif (2usize)) . field ("ccif[3]" , & self . ccif (3usize)) . field ("tif" , & self . tif ()) . field ("ccof[0]" , & self . ccof (0usize)) . field ("ccof[1]" , & self . ccof (1usize)) . field ("ccof[2]" , & self . ccof (2usize)) . field ("ccof[3]" , & self . ccof (3usize)) . field ("idxif" , & self . idxif ()) . field ("dirif" , & self . dirif ()) . field ("ierrif" , & self . ierrif ()) . field ("terrif" , & self . terrif ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for SrGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "SrGp16 {{ uif: {=bool:?}, ccif[0]: {=bool:?}, ccif[1]: {=bool:?}, ccif[2]: {=bool:?}, ccif[3]: {=bool:?}, tif: {=bool:?}, ccof[0]: {=bool:?}, ccof[1]: {=bool:?}, ccof[2]: {=bool:?}, ccof[3]: {=bool:?}, idxif: {=bool:?}, dirif: {=bool:?}, ierrif: {=bool:?}, terrif: {=bool:?} }}" , self . uif () , self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) , self . tif () , self . ccof (0usize) , self . ccof (1usize) , self . ccof (2usize) , self . ccof (3usize) , self . idxif () , self . dirif () , self . ierrif () , self . terrif ()) } } # [doc = "input selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tisel1ch { Tisel1ch (0) } } impl core :: fmt :: Debug for Tisel1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tisel1ch") . field ("tisel[0]" , & self . tisel (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tisel1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Tisel1ch {{ tisel[0]: {=u8:?} }}" , self . tisel (0usize)) } } # [doc = "input selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tisel2ch { Tisel2ch (0) } } impl core :: fmt :: Debug for Tisel2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tisel2ch") . field ("tisel[0]" , & self . tisel (0usize)) . field ("tisel[1]" , & self . tisel (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tisel2ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Tisel2ch {{ tisel[0]: {=u8:?}, tisel[1]: {=u8:?} }}" , self . tisel (0usize) , self . tisel (1usize)) } } # [doc = "input selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> TiselGp16 { TiselGp16 (0) } } impl core :: fmt :: Debug for TiselGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("TiselGp16") . field ("tisel[0]" , & self . tisel (0usize)) . field ("tisel[1]" , & self . tisel (1usize)) . field ("tisel[2]" , & self . tisel (2usize)) . field ("tisel[3]" , & self . tisel (3usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for TiselGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "TiselGp16 {{ tisel[0]: {=u8:?}, tisel[1]: {=u8:?}, tisel[2]: {=u8:?}, tisel[3]: {=u8:?} }}" , self . tisel (0usize) , self . tisel (1usize) , self . tisel (2usize) , self . tisel (3usize)) } } } pub mod vals { # [repr (u8)]
...
NOT_INVERTED = 0x0 , # [doc = "input polarity is inverted (active high if BKxP = 0, active low if BKxP = 1)"]
...
ACTIVE_LOW = 0x0 , # [doc = "Break input tim_brk is active high"]
ACTIVE_HIGH = 0x01 , } impl Bkp { # [inline (always)]
...
ON_COMPARE = 0x0 , # [doc = "CCx DMA request sent when update event occurs"]
ON_UPDATE = 0x01 , } impl Ccds { # [inline (always)]
...
EDGE_ALIGNED = 0x0 , # [doc = "The counter counts up and down alternatively. Output compare interrupt flags are set only when the counter is counting down."]
CENTER_ALIGNED1 = 0x01 , # [doc = "The counter counts up and down alternatively. Output compare interrupt flags are set only when the counter is counting up."]
CENTER_ALIGNED2 = 0x02 , # [doc = "The counter counts up and down alternatively. Output compare interrupt flags are set both when the counter is counting up or down."]
CENTER_ALIGNED3 = 0x03 , } impl Cms { # [inline (always)]
...
NOT_INVERTED = 0x0 , # [doc = "ETR is inverted, active at low level or falling edge"]
...
ALWAYS_ACTIVE = 0x0 , # [doc = "the first Index only resets the counter"]
FIRST_ONLY = 0x01 , } impl Fidx { # [inline (always)]
...
NO_FILTER = 0x0 , # [doc = "fSAMPLING=fCK_INT, N=2"]
...
NO_EFFECT = 0x0 , # [doc = "TIM_OCxREFC is the logical AND of TIM_OCxREF and TIM_OC5REF"]
LOGICAL_AND = 0x01 , } impl Gc5c { # [inline (always)]
...
ALWAYS_ACTIVE = 0x0 , # [doc = "Index disabled when tim_ti3 input is active, as per CC3P bitfield"]
...
COMPARE_PULSE = 0x03 , # [doc = "OC1REF signal is used as trigger output"]
COMPARE_OC1 = 0x04 , # [doc = "OC2REF signal is used as trigger output"]
COMPARE_OC2 = 0x05 , # [doc = "OC3REF signal is used as trigger output"]
COMPARE_OC3 = 0x06 , # [doc = "OC4REF signal is used as trigger output"]
COMPARE_OC4 = 0x07 , # [doc = "The encoder clock signal is used as trigger output"]
ENCODER_CLOCK_OUTPUT = 0x08 , _RESERVED_9 = 0x09 , _RESERVED_a = 0x0a , _RESERVED_b = 0x0b , _RESERVED_c = 0x0c , _RESERVED_d = 0x0d , _RESERVED_e = 0x0e , _RESERVED_f = 0x0f , } impl Mms { # [inline (always)]
...
COMPARE_PULSE = 0x03 , # [doc = "OC1REF signal is used as TRGO2"]
COMPARE_OC1 = 0x04 , # [doc = "OC2REF signal is used as TRGO2"]
COMPARE_OC2 = 0x05 , # [doc = "OC3REF signal is used as TRGO2"]
COMPARE_OC3 = 0x06 , # [doc = "OC4REF signal is used as TRGO2"]
COMPARE_OC4 = 0x07 , # [doc = "OC5REF signal is used as TRGO2"]
COMPARE_OC5 = 0x08 , # [doc = "OC6REF signal is used as TRGO2"]
COMPARE_OC6 = 0x09 , # [doc = "OC4REF rising or falling edges generate pulses on TRGO2"]
COMPARE_PULSE_OC4 = 0x0a , # [doc = "OC6REF rising or falling edges generate pulses on TRGO2"]
COMPARE_PULSE_OC6 = 0x0b , # [doc = "OC4REF or OC6REF rising edges generate pulses on TRGO2"]
COMPARE_PULSE_OC4_OR_OC6_RISING = 0x0c , # [doc = "OC4REF rising or OC6REF falling edges generate pulses on TRGO2"]
COMPARE_PULSE_OC4_RISING_OR_OC6_FALLING = 0x0d , # [doc = "OC5REF or OC6REF rising edges generate pulses on TRGO2"]
COMPARE_PULSE_OC5_OR_OC6_RISING = 0x0e , # [doc = "OC5REF rising or OC6REF falling edges generate pulses on TRGO2"]
COMPARE_PULSE_OC5_RISING_OR_OC6_FALLING = 0x0f , } impl Mms2 { # [inline (always)]
...
NO_SYNC = 0x0 , # [doc = "The effect of an event on the trigger input (TRGI) is delayed to allow a perfect synchronization between the current timer and its slaves (through TRGO). It is useful if we want to synchronize several timers on a single external event."]
...
ACTIVE_ON_MATCH = 0x01 , # [doc = "Set channel to inactive level on match. OCyREF signal is forced low when the counter matches the capture/compare register"]
INACTIVE_ON_MATCH = 0x02 , # [doc = "OCyREF toggles when TIMx_CNT=TIMx_CCRy"]
TOGGLE = 0x03 , # [doc = "OCyREF is forced low"]
FORCE_INACTIVE = 0x04 , # [doc = "OCyREF is forced high"]
FORCE_ACTIVE = 0x05 , # [doc = "In upcounting, channel is active as long as TIMx_CNT<TIMx_CCRy else inactive. In downcounting, channel is inactive as long as TIMx_CNT>TIMx_CCRy else active"]
PWM_MODE1 = 0x06 , # [doc = "Inversely to PwmMode1"]
...
IDLE_LEVEL = 0x01 , } impl Ossi { # [inline (always)]
...
IDLE_LEVEL = 0x01 , } impl Ossr { # [inline (always)]
...
ANY_EVENT = 0x0 , # [doc = "Only counter overflow/underflow generates an update interrupt or DMA request"]
COUNTER_ONLY = 0x01 , } impl Urs { # [inline (always)]

...
fn default () -> Bcdr { Bcdr (0) } } impl core :: fmt :: Debug for Bcdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bcdr") . field ("bcden" , & self . bcden ()) . field ("dcden" , & self . dcden ()) . field ("pden" , & self . pden ()) . field ("sden" , & self . sden ()) . field ("dcdet" , & self . dcdet ()) . field ("pdet" , & self . pdet ()) . field ("sdet" , & self . sdet ()) . field ("ps2det" , & self . ps2det ()) . field ("dppu" , & self . dppu ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bcdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bcdr {{ bcden: {=bool:?}, dcden: {=bool:?}, pden: {=bool:?}, sden: {=bool:?}, dcdet: {=bool:?}, pdet: {=bool:?}, sdet: {:?}, ps2det: {=bool:?}, dppu: {=bool:?} }}" , self . bcden () , self . dcden () , self . pden () , self . sden () , self . dcdet () , self . pdet () , self . sdet () , self . ps2det () , self . dppu ()) } } # [doc = "Buffer table address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Btable { Btable (0) } } impl core :: fmt :: Debug for Btable { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Btable") . field ("btable" , & self . btable ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Btable { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Btable {{ btable: {=u16:?} }}" , self . btable ()) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cntr { Cntr (0) } } impl core :: fmt :: Debug for Cntr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cntr") . field ("fres" , & self . fres ()) . field ("pdwn" , & self . pdwn ()) . field ("lpmode" , & self . lpmode ()) . field ("fsusp" , & self . fsusp ()) . field ("resume" , & self . resume ()) . field ("l1resume" , & self . l1resume ()) . field ("l1reqm" , & self . l1reqm ()) . field ("esofm" , & self . esofm ()) . field ("sofm" , & self . sofm ()) . field ("resetm" , & self . resetm ()) . field ("suspm" , & self . suspm ()) . field ("wkupm" , & self . wkupm ()) . field ("errm" , & self . errm ()) . field ("pmaovrm" , & self . pmaovrm ()) . field ("ctrm" , & self . ctrm ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cntr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cntr {{ fres: {=bool:?}, pdwn: {=bool:?}, lpmode: {=bool:?}, fsusp: {=bool:?}, resume: {=bool:?}, l1resume: {=bool:?}, l1reqm: {=bool:?}, esofm: {=bool:?}, sofm: {=bool:?}, resetm: {=bool:?}, suspm: {=bool:?}, wkupm: {=bool:?}, errm: {=bool:?}, pmaovrm: {=bool:?}, ctrm: {=bool:?} }}" , self . fres () , self . pdwn () , self . lpmode () , self . fsusp () , self . resume () , self . l1resume () , self . l1reqm () , self . esofm () , self . sofm () , self . resetm () , self . suspm () , self . wkupm () , self . errm () , self . pmaovrm () , self . ctrm ()) } } # [doc = "device address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Daddr { Daddr (0) } } impl core :: fmt :: Debug for Daddr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Daddr") . field ("add" , & self . add ()) . field ("ef" , & self . ef ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Daddr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Daddr {{ add: {=u8:?}, ef: {=bool:?} }}" , self . add () , self . ef ()) } } # [doc = "endpoint register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Epr { Epr (0) } } impl core :: fmt :: Debug for Epr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Epr") . field ("ea" , & self . ea ()) . field ("stat_tx" , & self . stat_tx ()) . field ("dtog_tx" , & self . dtog_tx ()) . field ("ctr_tx" , & self . ctr_tx ()) . field ("ep_kind" , & self . ep_kind ()) . field ("ep_type" , & self . ep_type ()) . field ("setup" , & self . setup ()) . field ("stat_rx" , & self . stat_rx ()) . field ("dtog_rx" , & self . dtog_rx ()) . field ("ctr_rx" , & self . ctr_rx ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Epr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Epr {{ ea: {=u8:?}, stat_tx: {:?}, dtog_tx: {=bool:?}, ctr_tx: {=bool:?}, ep_kind: {=bool:?}, ep_type: {:?}, setup: {=bool:?}, stat_rx: {:?}, dtog_rx: {=bool:?}, ctr_rx: {=bool:?} }}" , self . ea () , self . stat_tx () , self . dtog_tx () , self . ctr_tx () , self . ep_kind () , self . ep_type () , self . setup () , self . stat_rx () , self . dtog_rx () , self . ctr_rx ()) } } # [doc = "frame number register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fnr { Fnr (0) } } impl core :: fmt :: Debug for Fnr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fnr") . field ("fn_" , & self . fn_ ()) . field ("lsof" , & self . lsof ()) . field ("lck" , & self . lck ()) . field ("rxdm" , & self . rxdm ()) . field ("rxdp" , & self . rxdp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fnr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fnr {{ fn_: {=u16:?}, lsof: {=u8:?}, lck: {=bool:?}, rxdm: {=bool:?}, rxdp: {=bool:?} }}" , self . fn_ () , self . lsof () , self . lck () , self . rxdm () , self . rxdp ()) } } # [doc = "interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Istr { Istr (0) } } impl core :: fmt :: Debug for Istr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Istr") . field ("ep_id" , & self . ep_id ()) . field ("dir" , & self . dir ()) . field ("l1req" , & self . l1req ()) . field ("esof" , & self . esof ()) . field ("sof" , & self . sof ()) . field ("reset" , & self . reset ()) . field ("susp" , & self . susp ()) . field ("wkup" , & self . wkup ()) . field ("err" , & self . err ()) . field ("pmaovr" , & self . pmaovr ()) . field ("ctr" , & self . ctr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Istr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Istr {{ ep_id: {=u8:?}, dir: {:?}, l1req: {=bool:?}, esof: {=bool:?}, sof: {=bool:?}, reset: {=bool:?}, susp: {=bool:?}, wkup: {=bool:?}, err: {=bool:?}, pmaovr: {=bool:?}, ctr: {=bool:?} }}" , self . ep_id () , self . dir () , self . l1req () , self . esof () , self . sof () , self . reset () , self . susp () , self . wkup () , self . err () , self . pmaovr () , self . ctr ()) } } # [doc = "LPM control and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Lpmcsr { Lpmcsr (0) } } impl core :: fmt :: Debug for Lpmcsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Lpmcsr") . field ("lpmen" , & self . lpmen ()) . field ("lpmack" , & self . lpmack ()) . field ("remwake" , & self . remwake ()) . field ("besl" , & self . besl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Lpmcsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Lpmcsr {{ lpmen: {=bool:?}, lpmack: {:?}, remwake: {=bool:?}, besl: {=u8:?} }}" , self . lpmen () , self . lpmack () , self . remwake () , self . besl ()) } } } pub mod vals { # [repr (u8)]

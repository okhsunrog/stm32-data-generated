...
impl defmt :: Format for Acr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Acr {{ latency: {=u8:?}, wrhighfreq: {=u8:?} }}" , self . latency () , self . wrhighfreq ()) } } # [doc = "FLASH register with boot address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> BootCurr { BootCurr (0) } } impl core :: fmt :: Debug for BootCurr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("BootCurr") . field ("boot_add0" , & self . boot_add0 ()) . field ("boot_add1" , & self . boot_add1 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for BootCurr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "BootCurr {{ boot_add0: {=u16:?}, boot_add1: {=u16:?} }}" , self . boot_add0 () , self . boot_add1 ()) } } # [doc = "FLASH register with boot address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> BootPrgr { BootPrgr (0) } } impl core :: fmt :: Debug for BootPrgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("BootPrgr") . field ("boot_add0" , & self . boot_add0 ()) . field ("boot_add1" , & self . boot_add1 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for BootPrgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "BootPrgr {{ boot_add0: {=u16:?}, boot_add1: {=u16:?} }}" , self . boot_add0 () , self . boot_add1 ()) } } # [doc = "FLASH clear control register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccr { Ccr (0) } } impl core :: fmt :: Debug for Ccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr") . field ("clr_eop" , & self . clr_eop ()) . field ("clr_wrperr" , & self . clr_wrperr ()) . field ("clr_pgserr" , & self . clr_pgserr ()) . field ("clr_strberr" , & self . clr_strberr ()) . field ("clr_incerr" , & self . clr_incerr ()) . field ("clr_operr" , & self . clr_operr ()) . field ("clr_rdperr" , & self . clr_rdperr ()) . field ("clr_rdserr" , & self . clr_rdserr ()) . field ("clr_sneccerr" , & self . clr_sneccerr ()) . field ("clr_dbeccerr" , & self . clr_dbeccerr ()) . field ("clr_crcend" , & self . clr_crcend ()) . field ("clr_crcrderr" , & self . clr_crcrderr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr {{ clr_eop: {=bool:?}, clr_wrperr: {=bool:?}, clr_pgserr: {=bool:?}, clr_strberr: {=bool:?}, clr_incerr: {=bool:?}, clr_operr: {=bool:?}, clr_rdperr: {=bool:?}, clr_rdserr: {=bool:?}, clr_sneccerr: {=bool:?}, clr_dbeccerr: {=bool:?}, clr_crcend: {=bool:?}, clr_crcrderr: {=bool:?} }}" , self . clr_eop () , self . clr_wrperr () , self . clr_pgserr () , self . clr_strberr () , self . clr_incerr () , self . clr_operr () , self . clr_rdperr () , self . clr_rdserr () , self . clr_sneccerr () , self . clr_dbeccerr () , self . clr_crcend () , self . clr_crcrderr ()) } } # [doc = "FLASH control register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("lock" , & self . lock ()) . field ("pg" , & self . pg ()) . field ("ser" , & self . ser ()) . field ("ber" , & self . ber ()) . field ("psize" , & self . psize ()) . field ("fw" , & self . fw ()) . field ("start" , & self . start ()) . field ("snb" , & self . snb ()) . field ("crc_en" , & self . crc_en ()) . field ("eopie" , & self . eopie ()) . field ("wrperrie" , & self . wrperrie ()) . field ("pgserrie" , & self . pgserrie ()) . field ("strberrie" , & self . strberrie ()) . field ("incerrie" , & self . incerrie ()) . field ("operrie" , & self . operrie ()) . field ("rdperrie" , & self . rdperrie ()) . field ("rdserrie" , & self . rdserrie ()) . field ("sneccerrie" , & self . sneccerrie ()) . field ("dbeccerrie" , & self . dbeccerrie ()) . field ("crcendie" , & self . crcendie ()) . field ("crcrderrie" , & self . crcrderrie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ lock: {=bool:?}, pg: {=bool:?}, ser: {=bool:?}, ber: {=bool:?}, psize: {=u8:?}, fw: {=bool:?}, start: {=bool:?}, snb: {=u8:?}, crc_en: {=bool:?}, eopie: {=bool:?}, wrperrie: {=bool:?}, pgserrie: {=bool:?}, strberrie: {=bool:?}, incerrie: {=bool:?}, operrie: {=bool:?}, rdperrie: {=bool:?}, rdserrie: {=bool:?}, sneccerrie: {=bool:?}, dbeccerrie: {=bool:?}, crcendie: {=bool:?}, crcrderrie: {=bool:?} }}" , self . lock () , self . pg () , self . ser () , self . ber () , self . psize () , self . fw () , self . start () , self . snb () , self . crc_en () , self . eopie () , self . wrperrie () , self . pgserrie () , self . strberrie () , self . incerrie () , self . operrie () , self . rdperrie () , self . rdserrie () , self . sneccerrie () , self . dbeccerrie () , self . crcendie () , self . crcrderrie ()) } } # [doc = "FLASH CRC control register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Crccr { Crccr (0) } } impl core :: fmt :: Debug for Crccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Crccr") . field ("crc_sect" , & self . crc_sect ()) . field ("all_bank" , & self . all_bank ()) . field ("crc_by_sect" , & self . crc_by_sect ()) . field ("add_sect" , & self . add_sect ()) . field ("clean_sect" , & self . clean_sect ()) . field ("start_crc" , & self . start_crc ()) . field ("clean_crc" , & self . clean_crc ()) . field ("crc_burst" , & self . crc_burst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Crccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Crccr {{ crc_sect: {=u8:?}, all_bank: {=bool:?}, crc_by_sect: {=bool:?}, add_sect: {=bool:?}, clean_sect: {=bool:?}, start_crc: {=bool:?}, clean_crc: {=bool:?}, crc_burst: {=u8:?} }}" , self . crc_sect () , self . all_bank () , self . crc_by_sect () , self . add_sect () , self . clean_sect () , self . start_crc () , self . clean_crc () , self . crc_burst ()) } } # [doc = "FLASH CRC data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Crcdatar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Crcdatar {{ crc_data: {=u32:?} }}" , self . crc_data ()) } } # [doc = "FLASH CRC end address register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Crceaddr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Crceaddr {{ crc_end_addr: {=u32:?} }}" , self . crc_end_addr ()) } } # [doc = "FLASH CRC start address register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Crcsaddr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Crcsaddr {{ crc_start_addr: {=u32:?} }}" , self . crc_start_addr ()) } } # [doc = "FLASH ECC fail address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Far { Far (0) } } impl core :: fmt :: Debug for Far { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Far") . field ("fail_ecc_addr" , & self . fail_ecc_addr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Far { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Far {{ fail_ecc_addr: {=u16:?} }}" , self . fail_ecc_addr ()) } } # [doc = "FLASH option clear control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Optccr { Optccr (0) } } impl core :: fmt :: Debug for Optccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Optccr") . field ("clr_optchangeerr" , & self . clr_optchangeerr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Optccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Optccr {{ clr_optchangeerr: {=bool:?} }}" , self . clr_optchangeerr ()) } } # [doc = "FLASH option control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Optcr { Optcr (0) } } impl core :: fmt :: Debug for Optcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Optcr") . field ("optlock" , & self . optlock ()) . field ("optstart" , & self . optstart ()) . field ("mer" , & self . mer ()) . field ("optchangeerrie" , & self . optchangeerrie ()) . field ("swap_bank" , & self . swap_bank ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Optcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Optcr {{ optlock: {=bool:?}, optstart: {=bool:?}, mer: {=bool:?}, optchangeerrie: {=bool:?}, swap_bank: {=bool:?} }}" , self . optlock () , self . optstart () , self . mer () , self . optchangeerrie () , self . swap_bank ()) } } # [doc = "FLASH option status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> OptsrCur { OptsrCur (0) } } impl core :: fmt :: Debug for OptsrCur { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("OptsrCur") . field ("opt_busy" , & self . opt_busy ()) . field ("bor_lev" , & self . bor_lev ()) . field ("iwdg1_hw" , & self . iwdg1_hw ()) . field ("n_rst_stop_d1" , & self . n_rst_stop_d1 ()) . field ("n_rst_stby_d1" , & self . n_rst_stby_d1 ()) . field ("rdp" , & self . rdp ()) . field ("fz_iwdg_stop" , & self . fz_iwdg_stop ()) . field ("fz_iwdg_sdby" , & self . fz_iwdg_sdby ()) . field ("st_ram_size" , & self . st_ram_size ()) . field ("security" , & self . security ()) . field ("rss1" , & self . rss1 ()) . field ("perso_ok" , & self . perso_ok ()) . field ("io_hslv" , & self . io_hslv ()) . field ("optchangeerr" , & self . optchangeerr ()) . field ("swap_bank_opt" , & self . swap_bank_opt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for OptsrCur { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "OptsrCur {{ opt_busy: {=bool:?}, bor_lev: {=u8:?}, iwdg1_hw: {=bool:?}, n_rst_stop_d1: {=bool:?}, n_rst_stby_d1: {=bool:?}, rdp: {=u8:?}, fz_iwdg_stop: {=bool:?}, fz_iwdg_sdby: {=bool:?}, st_ram_size: {=u8:?}, security: {=bool:?}, rss1: {=bool:?}, perso_ok: {=bool:?}, io_hslv: {=bool:?}, optchangeerr: {=bool:?}, swap_bank_opt: {=bool:?} }}" , self . opt_busy () , self . bor_lev () , self . iwdg1_hw () , self . n_rst_stop_d1 () , self . n_rst_stby_d1 () , self . rdp () , self . fz_iwdg_stop () , self . fz_iwdg_sdby () , self . st_ram_size () , self . security () , self . rss1 () , self . perso_ok () , self . io_hslv () , self . optchangeerr () , self . swap_bank_opt ()) } } # [doc = "FLASH option status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> OptsrPrg { OptsrPrg (0) } } impl core :: fmt :: Debug for OptsrPrg { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("OptsrPrg") . field ("bor_lev" , & self . bor_lev ()) . field ("iwdg1_hw" , & self . iwdg1_hw ()) . field ("n_rst_stop_d1" , & self . n_rst_stop_d1 ()) . field ("n_rst_stby_d1" , & self . n_rst_stby_d1 ()) . field ("rdp" , & self . rdp ()) . field ("fz_iwdg_stop" , & self . fz_iwdg_stop ()) . field ("fz_iwdg_sdby" , & self . fz_iwdg_sdby ()) . field ("st_ram_size" , & self . st_ram_size ()) . field ("security" , & self . security ()) . field ("rss1" , & self . rss1 ()) . field ("rss2" , & self . rss2 ()) . field ("io_hslv" , & self . io_hslv ()) . field ("swap_bank_opt" , & self . swap_bank_opt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for OptsrPrg { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "OptsrPrg {{ bor_lev: {=u8:?}, iwdg1_hw: {=bool:?}, n_rst_stop_d1: {=bool:?}, n_rst_stby_d1: {=bool:?}, rdp: {=u8:?}, fz_iwdg_stop: {=bool:?}, fz_iwdg_sdby: {=bool:?}, st_ram_size: {=u8:?}, security: {=bool:?}, rss1: {=bool:?}, rss2: {=bool:?}, io_hslv: {=bool:?}, swap_bank_opt: {=bool:?} }}" , self . bor_lev () , self . iwdg1_hw () , self . n_rst_stop_d1 () , self . n_rst_stby_d1 () , self . rdp () , self . fz_iwdg_stop () , self . fz_iwdg_sdby () , self . st_ram_size () , self . security () , self . rss1 () , self . rss2 () , self . io_hslv () , self . swap_bank_opt ()) } } # [doc = "FLASH protection address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> PrarCur { PrarCur (0) } } impl core :: fmt :: Debug for PrarCur { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("PrarCur") . field ("prot_area_start" , & self . prot_area_start ()) . field ("prot_area_end" , & self . prot_area_end ()) . field ("dmep" , & self . dmep ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for PrarCur { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "PrarCur {{ prot_area_start: {=u16:?}, prot_area_end: {=u16:?}, dmep: {=bool:?} }}" , self . prot_area_start () , self . prot_area_end () , self . dmep ()) } } # [doc = "FLASH protection address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> PrarPrg { PrarPrg (0) } } impl core :: fmt :: Debug for PrarPrg { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("PrarPrg") . field ("prot_area_start" , & self . prot_area_start ()) . field ("prot_area_end" , & self . prot_area_end ()) . field ("dmep" , & self . dmep ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for PrarPrg { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "PrarPrg {{ prot_area_start: {=u16:?}, prot_area_end: {=u16:?}, dmep: {=bool:?} }}" , self . prot_area_start () , self . prot_area_end () , self . dmep ()) } } # [doc = "FLASH secure address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> ScarCur { ScarCur (0) } } impl core :: fmt :: Debug for ScarCur { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("ScarCur") . field ("sec_area_start" , & self . sec_area_start ()) . field ("sec_area_end" , & self . sec_area_end ()) . field ("dmes" , & self . dmes ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for ScarCur { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "ScarCur {{ sec_area_start: {=u16:?}, sec_area_end: {=u16:?}, dmes: {=bool:?} }}" , self . sec_area_start () , self . sec_area_end () , self . dmes ()) } } # [doc = "FLASH secure address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> ScarPrg { ScarPrg (0) } } impl core :: fmt :: Debug for ScarPrg { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("ScarPrg") . field ("sec_area_start" , & self . sec_area_start ()) . field ("sec_area_end" , & self . sec_area_end ()) . field ("dmes" , & self . dmes ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for ScarPrg { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "ScarPrg {{ sec_area_start: {=u16:?}, sec_area_end: {=u16:?}, dmes: {=bool:?} }}" , self . sec_area_start () , self . sec_area_end () , self . dmes ()) } } # [doc = "FLASH status register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("bsy" , & self . bsy ()) . field ("wbne" , & self . wbne ()) . field ("qw" , & self . qw ()) . field ("crc_busy" , & self . crc_busy ()) . field ("eop" , & self . eop ()) . field ("wrperr" , & self . wrperr ()) . field ("pgserr" , & self . pgserr ()) . field ("strberr" , & self . strberr ()) . field ("incerr" , & self . incerr ()) . field ("operr" , & self . operr ()) . field ("rdperr" , & self . rdperr ()) . field ("rdserr" , & self . rdserr ()) . field ("sneccerr1" , & self . sneccerr1 ()) . field ("dbeccerr" , & self . dbeccerr ()) . field ("crcend" , & self . crcend ()) . field ("crcrderr" , & self . crcrderr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ bsy: {=bool:?}, wbne: {=bool:?}, qw: {=bool:?}, crc_busy: {=bool:?}, eop: {=bool:?}, wrperr: {=bool:?}, pgserr: {=bool:?}, strberr: {=bool:?}, incerr: {=bool:?}, operr: {=bool:?}, rdperr: {=bool:?}, rdserr: {=bool:?}, sneccerr1: {=bool:?}, dbeccerr: {=bool:?}, crcend: {=bool:?}, crcrderr: {=bool:?} }}" , self . bsy () , self . wbne () , self . qw () , self . crc_busy () , self . eop () , self . wrperr () , self . pgserr () , self . strberr () , self . incerr () , self . operr () , self . rdperr () , self . rdserr () , self . sneccerr1 () , self . dbeccerr () , self . crcend () , self . crcrderr ()) } } # [doc = "FLASH write sector protection for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> WpsnCurr { WpsnCurr (0) } } impl core :: fmt :: Debug for WpsnCurr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("WpsnCurr") . field ("wrpsn" , & self . wrpsn ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for WpsnCurr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "WpsnCurr {{ wrpsn: {=u8:?} }}" , self . wrpsn ()) } } # [doc = "FLASH write sector protection for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> WpsnPrgr { WpsnPrgr (0) } } impl core :: fmt :: Debug for WpsnPrgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("WpsnPrgr") . field ("wrpsn" , & self . wrpsn ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for WpsnPrgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "WpsnPrgr {{ wrpsn: {=u8:?} }}" , self . wrpsn ()) } } }
...
fn default () -> Ahbenr { Ahbenr (0) } } impl core :: fmt :: Debug for Ahbenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahbenr") . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("sramen" , & self . sramen ()) . field ("flashen" , & self . flashen ()) . field ("crcen" , & self . crcen ()) . field ("usb_otg_fsen" , & self . usb_otg_fsen ()) . field ("ethen" , & self . ethen ()) . field ("ethtxen" , & self . ethtxen ()) . field ("ethrxen" , & self . ethrxen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahbenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahbenr {{ dma1en: {=bool:?}, dma2en: {=bool:?}, sramen: {=bool:?}, flashen: {=bool:?}, crcen: {=bool:?}, usb_otg_fsen: {=bool:?}, ethen: {=bool:?}, ethtxen: {=bool:?}, ethrxen: {=bool:?} }}" , self . dma1en () , self . dma2en () , self . sramen () , self . flashen () , self . crcen () , self . usb_otg_fsen () , self . ethen () , self . ethtxen () , self . ethrxen ()) } } # [doc = "AHB peripheral clock reset register (RCC_AHBRSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahbrstr { Ahbrstr (0) } } impl core :: fmt :: Debug for Ahbrstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahbrstr") . field ("usb_otg_fsrst" , & self . usb_otg_fsrst ()) . field ("ethrst" , & self . ethrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahbrstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahbrstr {{ usb_otg_fsrst: {=bool:?}, ethrst: {=bool:?} }}" , self . usb_otg_fsrst () , self . ethrst ()) } } # [doc = "APB1 peripheral clock enable register (RCC_APB1ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr { Apb1enr (0) } } impl core :: fmt :: Debug for Apb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr") . field ("tim2en" , & self . tim2en ()) . field ("tim3en" , & self . tim3en ()) . field ("tim4en" , & self . tim4en ()) . field ("tim5en" , & self . tim5en ()) . field ("tim6en" , & self . tim6en ()) . field ("tim7en" , & self . tim7en ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("spi3en" , & self . spi3en ()) . field ("usart2en" , & self . usart2en ()) . field ("usart3en" , & self . usart3en ()) . field ("uart4en" , & self . uart4en ()) . field ("uart5en" , & self . uart5en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("can1en" , & self . can1en ()) . field ("can2en" , & self . can2en ()) . field ("bkpen" , & self . bkpen ()) . field ("pwren" , & self . pwren ()) . field ("dacen" , & self . dacen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr {{ tim2en: {=bool:?}, tim3en: {=bool:?}, tim4en: {=bool:?}, tim5en: {=bool:?}, tim6en: {=bool:?}, tim7en: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, spi3en: {=bool:?}, usart2en: {=bool:?}, usart3en: {=bool:?}, uart4en: {=bool:?}, uart5en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, can1en: {=bool:?}, can2en: {=bool:?}, bkpen: {=bool:?}, pwren: {=bool:?}, dacen: {=bool:?} }}" , self . tim2en () , self . tim3en () , self . tim4en () , self . tim5en () , self . tim6en () , self . tim7en () , self . wwdgen () , self . spi2en () , self . spi3en () , self . usart2en () , self . usart3en () , self . uart4en () , self . uart5en () , self . i2c1en () , self . i2c2en () , self . can1en () , self . can2en () , self . bkpen () , self . pwren () , self . dacen ()) } } # [doc = "APB1 peripheral reset register (RCC_APB1RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr { Apb1rstr (0) } } impl core :: fmt :: Debug for Apb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr") . field ("tim2rst" , & self . tim2rst ()) . field ("tim3rst" , & self . tim3rst ()) . field ("tim4rst" , & self . tim4rst ()) . field ("tim5rst" , & self . tim5rst ()) . field ("tim6rst" , & self . tim6rst ()) . field ("tim7rst" , & self . tim7rst ()) . field ("wwdgrst" , & self . wwdgrst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("spi3rst" , & self . spi3rst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("usart3rst" , & self . usart3rst ()) . field ("uart4rst" , & self . uart4rst ()) . field ("uart5rst" , & self . uart5rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("can1rst" , & self . can1rst ()) . field ("can2rst" , & self . can2rst ()) . field ("bkprst" , & self . bkprst ()) . field ("pwrrst" , & self . pwrrst ()) . field ("dacrst" , & self . dacrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim4rst: {=bool:?}, tim5rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, wwdgrst: {=bool:?}, spi2rst: {=bool:?}, spi3rst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, uart4rst: {=bool:?}, uart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, can1rst: {=bool:?}, can2rst: {=bool:?}, bkprst: {=bool:?}, pwrrst: {=bool:?}, dacrst: {=bool:?} }}" , self . tim2rst () , self . tim3rst () , self . tim4rst () , self . tim5rst () , self . tim6rst () , self . tim7rst () , self . wwdgrst () , self . spi2rst () , self . spi3rst () , self . usart2rst () , self . usart3rst () , self . uart4rst () , self . uart5rst () , self . i2c1rst () , self . i2c2rst () , self . can1rst () , self . can2rst () , self . bkprst () , self . pwrrst () , self . dacrst ()) } } # [doc = "APB2 peripheral clock enable register (RCC_APB2ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("afioen" , & self . afioen ()) . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpioden" , & self . gpioden ()) . field ("gpioeen" , & self . gpioeen ()) . field ("adc1en" , & self . adc1en ()) . field ("adc2en" , & self . adc2en ()) . field ("tim1en" , & self . tim1en ()) . field ("spi1en" , & self . spi1en ()) . field ("usart1en" , & self . usart1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ afioen: {=bool:?}, gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpioeen: {=bool:?}, adc1en: {=bool:?}, adc2en: {=bool:?}, tim1en: {=bool:?}, spi1en: {=bool:?}, usart1en: {=bool:?} }}" , self . afioen () , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpioden () , self . gpioeen () , self . adc1en () , self . adc2en () , self . tim1en () , self . spi1en () , self . usart1en ()) } } # [doc = "APB2 peripheral reset register (RCC_APB2RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("prediv1" , & self . prediv1 ()) . field ("prediv2" , & self . prediv2 ()) . field ("pll2mul" , & self . pll2mul ()) . field ("pll3mul" , & self . pll3mul ()) . field ("prediv1src" , & self . prediv1src ()) . field ("i2s2src" , & self . i2s2src ()) . field ("i2s3src" , & self . i2s3src ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ prediv1: {:?}, prediv2: {:?}, pll2mul: {:?}, pll3mul: {:?}, prediv1src: {:?}, i2s2src: {:?}, i2s3src: {:?} }}" , self . prediv1 () , self . prediv2 () , self . pll2mul () , self . pll3mul () , self . prediv1src () , self . i2s2src () , self . i2s3src ()) } } # [doc = "Clock interrupt register (RCC_CIR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
fn default () -> Ahb3enr { Ahb3enr (0) } } impl core :: fmt :: Debug for Ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3enr") . field ("mdmaen" , & self . mdmaen ()) . field ("dma2den" , & self . dma2den ()) . field ("jpgdecen" , & self . jpgdecen ()) . field ("fmcen" , & self . fmcen ()) . field ("quadspien" , & self . quadspien ()) . field ("sdmmc1en" , & self . sdmmc1en ()) . field ("octospi2en" , & self . octospi2en ()) . field ("iomngren" , & self . iomngren ()) . field ("otfd1en" , & self . otfd1en ()) . field ("otfd2en" , & self . otfd2en ()) . field ("dtcm1en" , & self . dtcm1en ()) . field ("dtcm2en" , & self . dtcm2en ()) . field ("itcm1en" , & self . itcm1en ()) . field ("axisramen" , & self . axisramen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3enr {{ mdmaen: {=bool:?}, dma2den: {=bool:?}, jpgdecen: {=bool:?}, fmcen: {=bool:?}, quadspien: {=bool:?}, sdmmc1en: {=bool:?}, octospi2en: {=bool:?}, iomngren: {=bool:?}, otfd1en: {=bool:?}, otfd2en: {=bool:?}, dtcm1en: {=bool:?}, dtcm2en: {=bool:?}, itcm1en: {=bool:?}, axisramen: {=bool:?} }}" , self . mdmaen () , self . dma2den () , self . jpgdecen () , self . fmcen () , self . quadspien () , self . sdmmc1en () , self . octospi2en () , self . iomngren () , self . otfd1en () , self . otfd2en () , self . dtcm1en () , self . dtcm2en () , self . itcm1en () , self . axisramen ()) } } # [doc = "RCC AHB3 Sleep Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3rstr { Ahb3rstr (0) } } impl core :: fmt :: Debug for Ahb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3rstr") . field ("mdmarst" , & self . mdmarst ()) . field ("dma2drst" , & self . dma2drst ()) . field ("jpgdecrst" , & self . jpgdecrst ()) . field ("fmcrst" , & self . fmcrst ()) . field ("quadspirst" , & self . quadspirst ()) . field ("sdmmc1rst" , & self . sdmmc1rst ()) . field ("octospi2rst" , & self . octospi2rst ()) . field ("iomngrrst" , & self . iomngrrst ()) . field ("otfd1rst" , & self . otfd1rst ()) . field ("otfd2rst" , & self . otfd2rst ()) . field ("cpurst" , & self . cpurst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3rstr {{ mdmarst: {=bool:?}, dma2drst: {=bool:?}, jpgdecrst: {=bool:?}, fmcrst: {=bool:?}, quadspirst: {=bool:?}, sdmmc1rst: {=bool:?}, octospi2rst: {=bool:?}, iomngrrst: {=bool:?}, otfd1rst: {=bool:?}, otfd2rst: {=bool:?}, cpurst: {=bool:?} }}" , self . mdmarst () , self . dma2drst () , self . jpgdecrst () , self . fmcrst () , self . quadspirst () , self . sdmmc1rst () , self . octospi2rst () , self . iomngrrst () , self . otfd1rst () , self . otfd2rst () , self . cpurst ()) } } # [doc = "RCC AHB4 Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> D1ccipr { D1ccipr (0) } } impl core :: fmt :: Debug for D1ccipr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("D1ccipr") . field ("fmcsel" , & self . fmcsel ()) . field ("quadspisel" , & self . quadspisel ()) . field ("sdmmcsel" , & self . sdmmcsel ()) . field ("persel" , & self . persel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for D1ccipr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "D1ccipr {{ fmcsel: {:?}, quadspisel: {:?}, sdmmcsel: {:?}, persel: {:?} }}" , self . fmcsel () , self . quadspisel () , self . sdmmcsel () , self . persel ()) } } # [doc = "RCC Domain 1 Clock Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
MEDIUM_HIGH = 0x01 , # [doc = "Medium low driving capability"]
MEDIUM_LOW = 0x02 , # [doc = "High driving capability"]

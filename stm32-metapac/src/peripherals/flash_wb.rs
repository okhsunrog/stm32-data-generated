...
fn default () -> Acr { Acr (0) } } impl core :: fmt :: Debug for Acr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Acr") . field ("latency" , & self . latency ()) . field ("prften" , & self . prften ()) . field ("icen" , & self . icen ()) . field ("dcen" , & self . dcen ()) . field ("icrst" , & self . icrst ()) . field ("dcrst" , & self . dcrst ()) . field ("pes" , & self . pes ()) . field ("empty" , & self . empty ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Acr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Acr {{ latency: {=u8:?}, prften: {=bool:?}, icen: {=bool:?}, dcen: {=bool:?}, icrst: {=bool:?}, dcrst: {=bool:?}, pes: {=bool:?}, empty: {=bool:?} }}" , self . latency () , self . prften () , self . icen () , self . dcen () , self . icrst () , self . dcrst () , self . pes () , self . empty ()) } } # [doc = "CPU2 cortex M0 access control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2acr { C2acr (0) } } impl core :: fmt :: Debug for C2acr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2acr") . field ("prften" , & self . prften ()) . field ("icen" , & self . icen ()) . field ("icrst" , & self . icrst ()) . field ("pes" , & self . pes ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2acr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2acr {{ prften: {=bool:?}, icen: {=bool:?}, icrst: {=bool:?}, pes: {=bool:?} }}" , self . prften () , self . icen () , self . icrst () , self . pes ()) } } # [doc = "CPU2 cortex M0 control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2cr { C2cr (0) } } impl core :: fmt :: Debug for C2cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2cr") . field ("pg" , & self . pg ()) . field ("per" , & self . per ()) . field ("mer" , & self . mer ()) . field ("pnb" , & self . pnb ()) . field ("strt" , & self . strt ()) . field ("fstpg" , & self . fstpg ()) . field ("eopie" , & self . eopie ()) . field ("errie" , & self . errie ()) . field ("rderrie" , & self . rderrie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2cr {{ pg: {=bool:?}, per: {=bool:?}, mer: {=bool:?}, pnb: {=u8:?}, strt: {=bool:?}, fstpg: {=bool:?}, eopie: {=bool:?}, errie: {=bool:?}, rderrie: {=bool:?} }}" , self . pg () , self . per () , self . mer () , self . pnb () , self . strt () , self . fstpg () , self . eopie () , self . errie () , self . rderrie ()) } } # [doc = "CPU2 cortex M0 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2sr { C2sr (0) } } impl core :: fmt :: Debug for C2sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2sr") . field ("eop" , & self . eop ()) . field ("operr" , & self . operr ()) . field ("progerr" , & self . progerr ()) . field ("wrperr" , & self . wrperr ()) . field ("pgaerr" , & self . pgaerr ()) . field ("sizerr" , & self . sizerr ()) . field ("pgserr" , & self . pgserr ()) . field ("misserr" , & self . misserr ()) . field ("fasterr" , & self . fasterr ()) . field ("rderr" , & self . rderr ()) . field ("bsy" , & self . bsy ()) . field ("cfgbsy" , & self . cfgbsy ()) . field ("pesd" , & self . pesd ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2sr {{ eop: {=bool:?}, operr: {=bool:?}, progerr: {=bool:?}, wrperr: {=bool:?}, pgaerr: {=bool:?}, sizerr: {=bool:?}, pgserr: {=bool:?}, misserr: {=bool:?}, fasterr: {=bool:?}, rderr: {=bool:?}, bsy: {=bool:?}, cfgbsy: {=bool:?}, pesd: {=bool:?} }}" , self . eop () , self . operr () , self . progerr () , self . wrperr () , self . pgaerr () , self . sizerr () , self . pgserr () , self . misserr () , self . fasterr () , self . rderr () , self . bsy () , self . cfgbsy () , self . pesd ()) } } # [doc = "Flash control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("pg" , & self . pg ()) . field ("per" , & self . per ()) . field ("mer" , & self . mer ()) . field ("pnb" , & self . pnb ()) . field ("strt" , & self . strt ()) . field ("optstrt" , & self . optstrt ()) . field ("fstpg" , & self . fstpg ()) . field ("eopie" , & self . eopie ()) . field ("errie" , & self . errie ()) . field ("rderrie" , & self . rderrie ()) . field ("obl_launch" , & self . obl_launch ()) . field ("optlock" , & self . optlock ()) . field ("lock" , & self . lock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ pg: {=bool:?}, per: {=bool:?}, mer: {=bool:?}, pnb: {=u8:?}, strt: {=bool:?}, optstrt: {=bool:?}, fstpg: {=bool:?}, eopie: {=bool:?}, errie: {=bool:?}, rderrie: {=bool:?}, obl_launch: {=bool:?}, optlock: {=bool:?}, lock: {=bool:?} }}" , self . pg () , self . per () , self . mer () , self . pnb () , self . strt () , self . optstrt () , self . fstpg () , self . eopie () , self . errie () , self . rderrie () , self . obl_launch () , self . optlock () , self . lock ()) } } # [doc = "Flash ECC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Eccr { Eccr (0) } } impl core :: fmt :: Debug for Eccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Eccr") . field ("addr_ecc" , & self . addr_ecc ()) . field ("sysf_ecc" , & self . sysf_ecc ()) . field ("ecccie" , & self . ecccie ()) . field ("cpuid" , & self . cpuid ()) . field ("eccc" , & self . eccc ()) . field ("eccd" , & self . eccd ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Eccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Eccr {{ addr_ecc: {=u32:?}, sysf_ecc: {=bool:?}, ecccie: {=bool:?}, cpuid: {=u8:?}, eccc: {=bool:?}, eccd: {=bool:?} }}" , self . addr_ecc () , self . sysf_ecc () , self . ecccie () , self . cpuid () , self . eccc () , self . eccd ()) } } # [doc = "IPCC mailbox data buffer address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ipccbr { Ipccbr (0) } } impl core :: fmt :: Debug for Ipccbr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ipccbr") . field ("ipccdba" , & self . ipccdba ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ipccbr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ipccbr {{ ipccdba: {=u16:?} }}" , self . ipccdba ()) } } # [doc = "Flash option register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Optr { Optr (0) } } impl core :: fmt :: Debug for Optr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Optr") . field ("rdp" , & self . rdp ()) . field ("ese" , & self . ese ()) . field ("bor_lev" , & self . bor_lev ()) . field ("n_rst_stop" , & self . n_rst_stop ()) . field ("n_rst_stdby" , & self . n_rst_stdby ()) . field ("n_rst_shdw" , & self . n_rst_shdw ()) . field ("idwg_sw" , & self . idwg_sw ()) . field ("iwdg_stop" , & self . iwdg_stop ()) . field ("iwdg_stdby" , & self . iwdg_stdby ()) . field ("wwdg_sw" , & self . wwdg_sw ()) . field ("n_boot1" , & self . n_boot1 ()) . field ("sram2_pe" , & self . sram2_pe ()) . field ("sram2_rst" , & self . sram2_rst ()) . field ("n_swboot0" , & self . n_swboot0 ()) . field ("n_boot0" , & self . n_boot0 ()) . field ("agc_trim" , & self . agc_trim ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Optr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Optr {{ rdp: {=u8:?}, ese: {=bool:?}, bor_lev: {=u8:?}, n_rst_stop: {=bool:?}, n_rst_stdby: {=bool:?}, n_rst_shdw: {=bool:?}, idwg_sw: {=bool:?}, iwdg_stop: {=bool:?}, iwdg_stdby: {=bool:?}, wwdg_sw: {=bool:?}, n_boot1: {=bool:?}, sram2_pe: {=bool:?}, sram2_rst: {=bool:?}, n_swboot0: {=bool:?}, n_boot0: {=bool:?}, agc_trim: {=u8:?} }}" , self . rdp () , self . ese () , self . bor_lev () , self . n_rst_stop () , self . n_rst_stdby () , self . n_rst_shdw () , self . idwg_sw () , self . iwdg_stop () , self . iwdg_stdby () , self . wwdg_sw () , self . n_boot1 () , self . sram2_pe () , self . sram2_rst () , self . n_swboot0 () , self . n_boot0 () , self . agc_trim ()) } } # [doc = "Flash Bank 1 PCROP End address zone A register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pcrop1aer { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pcrop1aer {{ pcrop1a_end: {=u16:?}, pcrop_rdp: {=bool:?} }}" , self . pcrop1a_end () , self . pcrop_rdp ()) } } # [doc = "Flash Bank 1 PCROP Start address zone A register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pcrop1asr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pcrop1asr {{ pcrop1a_strt: {=u16:?} }}" , self . pcrop1a_strt ()) } } # [doc = "Flash Bank 1 PCROP End address area B register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pcrop1ber { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pcrop1ber {{ pcrop1b_end: {=u16:?} }}" , self . pcrop1b_end ()) } } # [doc = "Flash Bank 1 PCROP Start address area B register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pcrop1bsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pcrop1bsr {{ pcrop1b_strt: {=u16:?} }}" , self . pcrop1b_strt ()) } } # [doc = "Secure flash start address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sfr { Sfr (0) } } impl core :: fmt :: Debug for Sfr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sfr") . field ("sfsa" , & self . sfsa ()) . field ("fsd" , & self . fsd ()) . field ("dds" , & self . dds ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sfr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sfr {{ sfsa: {=u8:?}, fsd: {=bool:?}, dds: {=bool:?} }}" , self . sfsa () , self . fsd () , self . dds ()) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Srrvr { Srrvr (0) } } impl core :: fmt :: Debug for Srrvr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Srrvr") . field ("sbrv" , & self . sbrv ()) . field ("sbrsa" , & self . sbrsa ()) . field ("brsd" , & self . brsd ()) . field ("snbrsa" , & self . snbrsa ()) . field ("nbrsd" , & self . nbrsd ()) . field ("c2opt" , & self . c2opt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Srrvr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Srrvr {{ sbrv: {=u32:?}, sbrsa: {=u8:?}, brsd: {=bool:?}, snbrsa: {=u8:?}, nbrsd: {=bool:?}, c2opt: {=bool:?} }}" , self . sbrv () , self . sbrsa () , self . brsd () , self . snbrsa () , self . nbrsd () , self . c2opt ()) } } # [doc = "Flash Bank 1 WRP area A address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Wrp1ar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Wrp1ar {{ wrp1a_strt: {=u8:?}, wrp1a_end: {=u8:?} }}" , self . wrp1a_strt () , self . wrp1a_end ()) } } # [doc = "Flash Bank 1 WRP area B address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Wrp1br { Wrp1br (0) } } impl core :: fmt :: Debug for Wrp1br { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Wrp1br") . field ("wrp1b_end" , & self . wrp1b_end ()) . field ("wrp1b_strt" , & self . wrp1b_strt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Wrp1br { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Wrp1br {{ wrp1b_end: {=u8:?}, wrp1b_strt: {=u8:?} }}" , self . wrp1b_end () , self . wrp1b_strt ()) } } }
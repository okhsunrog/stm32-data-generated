...
fn default () -> Cr1 { Cr1 (0) } } impl core :: fmt :: Debug for Cr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr1") . field ("cpha" , & self . cpha ()) . field ("cpol" , & self . cpol ()) . field ("mstr" , & self . mstr ()) . field ("br" , & self . br ()) . field ("spe" , & self . spe ()) . field ("lsbfirst" , & self . lsbfirst ()) . field ("ssi" , & self . ssi ()) . field ("ssm" , & self . ssm ()) . field ("rxonly" , & self . rxonly ()) . field ("crcl" , & self . crcl ()) . field ("crcnext" , & self . crcnext ()) . field ("crcen" , & self . crcen ()) . field ("bidioe" , & self . bidioe ()) . field ("bidimode" , & self . bidimode ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr1 {{ cpha: {:?}, cpol: {:?}, mstr: {:?}, br: {:?}, spe: {=bool:?}, lsbfirst: {:?}, ssi: {=bool:?}, ssm: {=bool:?}, rxonly: {:?}, crcl: {:?}, crcnext: {:?}, crcen: {=bool:?}, bidioe: {:?}, bidimode: {:?} }}" , self . cpha () , self . cpol () , self . mstr () , self . br () , self . spe () , self . lsbfirst () , self . ssi () , self . ssm () , self . rxonly () , self . crcl () , self . crcnext () , self . crcen () , self . bidioe () , self . bidimode ()) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr2 { Cr2 (0) } } impl core :: fmt :: Debug for Cr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2") . field ("rxdmaen" , & self . rxdmaen ()) . field ("txdmaen" , & self . txdmaen ()) . field ("ssoe" , & self . ssoe ()) . field ("nssp" , & self . nssp ()) . field ("frf" , & self . frf ()) . field ("errie" , & self . errie ()) . field ("rxneie" , & self . rxneie ()) . field ("txeie" , & self . txeie ()) . field ("ds" , & self . ds ()) . field ("frxth" , & self . frxth ()) . field ("ldma_rx" , & self . ldma_rx ()) . field ("ldma_tx" , & self . ldma_tx ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2 {{ rxdmaen: {=bool:?}, txdmaen: {=bool:?}, ssoe: {=bool:?}, nssp: {=bool:?}, frf: {:?}, errie: {=bool:?}, rxneie: {=bool:?}, txeie: {=bool:?}, ds: {:?}, frxth: {:?}, ldma_rx: {:?}, ldma_tx: {:?} }}" , self . rxdmaen () , self . txdmaen () , self . ssoe () , self . nssp () , self . frf () , self . errie () , self . rxneie () , self . txeie () , self . ds () , self . frxth () , self . ldma_rx () , self . ldma_tx ()) } } # [doc = "CRC polynomial register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Crcpr { Crcpr (0) } } impl core :: fmt :: Debug for Crcpr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Crcpr") . field ("crcpoly" , & self . crcpoly ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Crcpr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Crcpr {{ crcpoly: {=u16:?} }}" , self . crcpoly ()) } } # [doc = "I2S configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> I2scfgr { I2scfgr (0) } } impl core :: fmt :: Debug for I2scfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("I2scfgr") . field ("chlen" , & self . chlen ()) . field ("datlen" , & self . datlen ()) . field ("ckpol" , & self . ckpol ()) . field ("i2sstd" , & self . i2sstd ()) . field ("pcmsync" , & self . pcmsync ()) . field ("i2scfg" , & self . i2scfg ()) . field ("i2se" , & self . i2se ()) . field ("i2smod" , & self . i2smod ()) . field ("astrten" , & self . astrten ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for I2scfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "I2scfgr {{ chlen: {:?}, datlen: {:?}, ckpol: {:?}, i2sstd: {:?}, pcmsync: {:?}, i2scfg: {:?}, i2se: {=bool:?}, i2smod: {:?}, astrten: {=bool:?} }}" , self . chlen () , self . datlen () , self . ckpol () , self . i2sstd () , self . pcmsync () , self . i2scfg () , self . i2se () , self . i2smod () , self . astrten ()) } } # [doc = "I2S prescaler register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> I2spr { I2spr (0) } } impl core :: fmt :: Debug for I2spr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("I2spr") . field ("i2sdiv" , & self . i2sdiv ()) . field ("odd" , & self . odd ()) . field ("mckoe" , & self . mckoe ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for I2spr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "I2spr {{ i2sdiv: {=u8:?}, odd: {:?}, mckoe: {=bool:?} }}" , self . i2sdiv () , self . odd () , self . mckoe ()) } } # [doc = "RX CRC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Rxcrcr { Rxcrcr (0) } } impl core :: fmt :: Debug for Rxcrcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Rxcrcr") . field ("rx_crc" , & self . rx_crc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Rxcrcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Rxcrcr {{ rx_crc: {=u16:?} }}" , self . rx_crc ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("rxne" , & self . rxne ()) . field ("txe" , & self . txe ()) . field ("chside" , & self . chside ()) . field ("udr" , & self . udr ()) . field ("crcerr" , & self . crcerr ()) . field ("modf" , & self . modf ()) . field ("ovr" , & self . ovr ()) . field ("bsy" , & self . bsy ()) . field ("fre" , & self . fre ()) . field ("frlvl" , & self . frlvl ()) . field ("ftlvl" , & self . ftlvl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ rxne: {=bool:?}, txe: {=bool:?}, chside: {:?}, udr: {=bool:?}, crcerr: {=bool:?}, modf: {=bool:?}, ovr: {=bool:?}, bsy: {=bool:?}, fre: {=bool:?}, frlvl: {:?}, ftlvl: {:?} }}" , self . rxne () , self . txe () , self . chside () , self . udr () , self . crcerr () , self . modf () , self . ovr () , self . bsy () , self . fre () , self . frlvl () , self . ftlvl ()) } } # [doc = "TX CRC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Txcrcr { Txcrcr (0) } } impl core :: fmt :: Debug for Txcrcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Txcrcr") . field ("tx_crc" , & self . tx_crc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Txcrcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Txcrcr {{ tx_crc: {=u16:?} }}" , self . tx_crc ()) } } } pub mod vals { # [repr (u8)]
...
IDLE_LOW = 0x0 , # [doc = "I2S clock inactive state is high level"]
...
TX_BUFFER = 0x0 , # [doc = "Next transmit value is from Tx CRC register"]
...
MASTER_RX = 0x03 , } impl Iscfg { # [inline (always)]
...
FULL_DUPLEX = 0x0 , # [doc = "Output disabled (Receive-only mode)"]
OUTPUT_DISABLED = 0x01 , } impl Rxonly { # [inline (always)]

...
fn default () -> Ahb1enr { Ahb1enr (0) } } impl core :: fmt :: Debug for Ahb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1enr") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpiohen" , & self . gpiohen ()) . field ("crcen" , & self . crcen ()) . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("rngen" , & self . rngen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1enr {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpiohen: {=bool:?}, crcen: {=bool:?}, dma1en: {=bool:?}, dma2en: {=bool:?}, rngen: {=bool:?} }}" , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpiohen () , self . crcen () , self . dma1en () , self . dma2en () , self . rngen ()) } } # [doc = "AHB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb1lpenr { Ahb1lpenr (0) } } impl core :: fmt :: Debug for Ahb1lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1lpenr") . field ("gpioalpen" , & self . gpioalpen ()) . field ("gpioblpen" , & self . gpioblpen ()) . field ("gpioclpen" , & self . gpioclpen ()) . field ("gpiohlpen" , & self . gpiohlpen ()) . field ("crclpen" , & self . crclpen ()) . field ("flashlpen" , & self . flashlpen ()) . field ("sram1lpen" , & self . sram1lpen ()) . field ("dma1lpen" , & self . dma1lpen ()) . field ("dma2lpen" , & self . dma2lpen ()) . field ("rnglpen" , & self . rnglpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1lpenr {{ gpioalpen: {=bool:?}, gpioblpen: {=bool:?}, gpioclpen: {=bool:?}, gpiohlpen: {=bool:?}, crclpen: {=bool:?}, flashlpen: {=bool:?}, sram1lpen: {=bool:?}, dma1lpen: {=bool:?}, dma2lpen: {=bool:?}, rnglpen: {=bool:?} }}" , self . gpioalpen () , self . gpioblpen () , self . gpioclpen () , self . gpiohlpen () , self . crclpen () , self . flashlpen () , self . sram1lpen () , self . dma1lpen () , self . dma2lpen () , self . rnglpen ()) } } # [doc = "AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr { Apb1enr (0) } } impl core :: fmt :: Debug for Apb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr") . field ("tim5en" , & self . tim5en ()) . field ("tim6en" , & self . tim6en ()) . field ("lptim1en" , & self . lptim1en ()) . field ("rtcapben" , & self . rtcapben ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("usart2en" , & self . usart2en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("fmpi2c1en" , & self . fmpi2c1en ()) . field ("pwren" , & self . pwren ()) . field ("dacen" , & self . dacen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr {{ tim5en: {=bool:?}, tim6en: {=bool:?}, lptim1en: {=bool:?}, rtcapben: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, usart2en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, fmpi2c1en: {=bool:?}, pwren: {=bool:?}, dacen: {=bool:?} }}" , self . tim5en () , self . tim6en () , self . lptim1en () , self . rtcapben () , self . wwdgen () , self . spi2en () , self . usart2en () , self . i2c1en () , self . i2c2en () , self . fmpi2c1en () , self . pwren () , self . dacen ()) } } # [doc = "APB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1lpenr { Apb1lpenr (0) } } impl core :: fmt :: Debug for Apb1lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1lpenr") . field ("tim5lpen" , & self . tim5lpen ()) . field ("tim6lpen" , & self . tim6lpen ()) . field ("lptim1lpen" , & self . lptim1lpen ()) . field ("rtcapblpen" , & self . rtcapblpen ()) . field ("wwdglpen" , & self . wwdglpen ()) . field ("spi2lpen" , & self . spi2lpen ()) . field ("usart2lpen" , & self . usart2lpen ()) . field ("i2c1lpen" , & self . i2c1lpen ()) . field ("i2c2lpen" , & self . i2c2lpen ()) . field ("fmpi2c1lpen" , & self . fmpi2c1lpen ()) . field ("pwrlpen" , & self . pwrlpen ()) . field ("daclpen" , & self . daclpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1lpenr {{ tim5lpen: {=bool:?}, tim6lpen: {=bool:?}, lptim1lpen: {=bool:?}, rtcapblpen: {=bool:?}, wwdglpen: {=bool:?}, spi2lpen: {=bool:?}, usart2lpen: {=bool:?}, i2c1lpen: {=bool:?}, i2c2lpen: {=bool:?}, fmpi2c1lpen: {=bool:?}, pwrlpen: {=bool:?}, daclpen: {=bool:?} }}" , self . tim5lpen () , self . tim6lpen () , self . lptim1lpen () , self . rtcapblpen () , self . wwdglpen () , self . spi2lpen () , self . usart2lpen () , self . i2c1lpen () , self . i2c2lpen () , self . fmpi2c1lpen () , self . pwrlpen () , self . daclpen ()) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr { Apb1rstr (0) } } impl core :: fmt :: Debug for Apb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr") . field ("tim5rst" , & self . tim5rst ()) . field ("tim6rst" , & self . tim6rst ()) . field ("lptim1rst" , & self . lptim1rst ()) . field ("wwdgrst" , & self . wwdgrst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("fmpi2c1rst" , & self . fmpi2c1rst ()) . field ("pwrrst" , & self . pwrrst ()) . field ("dacrst" , & self . dacrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr {{ tim5rst: {=bool:?}, tim6rst: {=bool:?}, lptim1rst: {=bool:?}, wwdgrst: {=bool:?}, spi2rst: {=bool:?}, usart2rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, fmpi2c1rst: {=bool:?}, pwrrst: {=bool:?}, dacrst: {=bool:?} }}" , self . tim5rst () , self . tim6rst () , self . lptim1rst () , self . wwdgrst () , self . spi2rst () , self . usart2rst () , self . i2c1rst () , self . i2c2rst () , self . fmpi2c1rst () , self . pwrrst () , self . dacrst ()) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("tim1en" , & self . tim1en ()) . field ("usart1en" , & self . usart1en ()) . field ("usart6en" , & self . usart6en ()) . field ("adc1en" , & self . adc1en ()) . field ("spi1en" , & self . spi1en ()) . field ("syscfgen" , & self . syscfgen ()) . field ("extiten" , & self . extiten ()) . field ("tim9en" , & self . tim9en ()) . field ("tim11en" , & self . tim11en ()) . field ("spi5en" , & self . spi5en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ tim1en: {=bool:?}, usart1en: {=bool:?}, usart6en: {=bool:?}, adc1en: {=bool:?}, spi1en: {=bool:?}, syscfgen: {=bool:?}, extiten: {=bool:?}, tim9en: {=bool:?}, tim11en: {=bool:?}, spi5en: {=bool:?} }}" , self . tim1en () , self . usart1en () , self . usart6en () , self . adc1en () , self . spi1en () , self . syscfgen () , self . extiten () , self . tim9en () , self . tim11en () , self . spi5en ()) } } # [doc = "APB2 peripheral clock enabled in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2lpenr { Apb2lpenr (0) } } impl core :: fmt :: Debug for Apb2lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2lpenr") . field ("tim1lpen" , & self . tim1lpen ()) . field ("usart1lpen" , & self . usart1lpen ()) . field ("usart6lpen" , & self . usart6lpen ()) . field ("adc1lpen" , & self . adc1lpen ()) . field ("sdiolpen" , & self . sdiolpen ()) . field ("spi1lpen" , & self . spi1lpen ()) . field ("syscfglpen" , & self . syscfglpen ()) . field ("extitlpen" , & self . extitlpen ()) . field ("tim9lpen" , & self . tim9lpen ()) . field ("tim11lpen" , & self . tim11lpen ()) . field ("spi5lpen" , & self . spi5lpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2lpenr {{ tim1lpen: {=bool:?}, usart1lpen: {=bool:?}, usart6lpen: {=bool:?}, adc1lpen: {=bool:?}, sdiolpen: {=bool:?}, spi1lpen: {=bool:?}, syscfglpen: {=bool:?}, extitlpen: {=bool:?}, tim9lpen: {=bool:?}, tim11lpen: {=bool:?}, spi5lpen: {=bool:?} }}" , self . tim1lpen () , self . usart1lpen () , self . usart6lpen () , self . adc1lpen () , self . sdiolpen () , self . spi1lpen () , self . syscfglpen () , self . extitlpen () , self . tim9lpen () , self . tim11lpen () , self . spi5lpen ()) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("tim1rst" , & self . tim1rst ()) . field ("usart1rst" , & self . usart1rst ()) . field ("usart6rst" , & self . usart6rst ()) . field ("adcrst" , & self . adcrst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("syscfgrst" , & self . syscfgrst ()) . field ("tim9rst" , & self . tim9rst ()) . field ("tim11rst" , & self . tim11rst ()) . field ("spi5rst" , & self . spi5rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ tim1rst: {=bool:?}, usart1rst: {=bool:?}, usart6rst: {=bool:?}, adcrst: {=bool:?}, spi1rst: {=bool:?}, syscfgrst: {=bool:?}, tim9rst: {=bool:?}, tim11rst: {=bool:?}, spi5rst: {=bool:?} }}" , self . tim1rst () , self . usart1rst () , self . usart6rst () , self . adcrst () , self . spi1rst () , self . syscfgrst () , self . tim9rst () , self . tim11rst () , self . spi5rst ()) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr {{ sw: {:?}, sws: {:?}, hpre: {:?}, mco1en: {=bool:?}, mco2en: {=bool:?}, ppre1: {:?}, ppre2: {:?}, rtcpre: {=u8:?}, mco1sel: {:?}, mco1pre: {:?}, mco2pre: {:?}, mco2sel: {:?} }}" , self . sw () , self . sws () , self . hpre () , self . mco1en () , self . mco2en () , self . ppre1 () , self . ppre2 () , self . rtcpre () , self . mco1sel () , self . mco1pre () , self . mco2pre () , self . mco2sel ()) } } # [doc = "clock interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ hsion: {=bool:?}, hsirdy: {=bool:?}, hsitrim: {=u8:?}, hsical: {=u8:?}, hseon: {=bool:?}, hserdy: {=bool:?}, hsebyp: {=bool:?}, csson: {=bool:?}, pllon: {=bool:?}, pllrdy: {=bool:?} }}" , self . hsion () , self . hsirdy () , self . hsitrim () , self . hsical () , self . hseon () , self . hserdy () , self . hsebyp () , self . csson () , self . pllon () , self . pllrdy ()) } } # [doc = "clock control & status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dckcfgr { Dckcfgr (0) } } impl core :: fmt :: Debug for Dckcfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dckcfgr") . field ("timpre" , & self . timpre ()) . field ("i2ssrc" , & self . i2ssrc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dckcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dckcfgr {{ timpre: {:?}, i2ssrc: {:?} }}" , self . timpre () , self . i2ssrc ()) } } # [doc = "DCKCFGR2 register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dckcfgr2 { Dckcfgr2 (0) } } impl core :: fmt :: Debug for Dckcfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dckcfgr2") . field ("fmpi2c1sel" , & self . fmpi2c1sel ()) . field ("lptim1sel" , & self . lptim1sel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dckcfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dckcfgr2 {{ fmpi2c1sel: {:?}, lptim1sel: {:?} }}" , self . fmpi2c1sel () , self . lptim1sel ()) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pllcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pllcfgr {{ pllm: {:?}, plln: {:?}, pllp: {:?}, pllsrc: {:?}, pllq: {:?}, pllr: {:?} }}" , self . pllm () , self . plln () , self . pllp () , self . pllsrc () , self . pllq () , self . pllr ()) } } # [doc = "spread spectrum clock generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

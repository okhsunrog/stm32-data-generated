...
fn default () -> Ahb1rstr { Ahb1rstr (0) } } impl core :: fmt :: Debug for Ahb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1rstr") . field ("gpdma1rst" , & self . gpdma1rst ()) . field ("cordicrst" , & self . cordicrst ()) . field ("fmacrst" , & self . fmacrst ()) . field ("mdf1rst" , & self . mdf1rst ()) . field ("crcrst" , & self . crcrst ()) . field ("jpegrst" , & self . jpegrst ()) . field ("tscrst" , & self . tscrst ()) . field ("ramcfgrst" , & self . ramcfgrst ()) . field ("dma2drst" , & self . dma2drst ()) . field ("gfxmmurst" , & self . gfxmmurst ()) . field ("gpu2drst" , & self . gpu2drst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1rstr {{ gpdma1rst: {=bool:?}, cordicrst: {=bool:?}, fmacrst: {=bool:?}, mdf1rst: {=bool:?}, crcrst: {=bool:?}, jpegrst: {=bool:?}, tscrst: {=bool:?}, ramcfgrst: {=bool:?}, dma2drst: {=bool:?}, gfxmmurst: {=bool:?}, gpu2drst: {=bool:?} }}" , self . gpdma1rst () , self . cordicrst () , self . fmacrst () , self . mdf1rst () , self . crcrst () , self . jpegrst () , self . tscrst () , self . ramcfgrst () , self . dma2drst () , self . gfxmmurst () , self . gpu2drst ()) } } # [doc = "RCC AHB1 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb1smenr { Ahb1smenr (0) } } impl core :: fmt :: Debug for Ahb1smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1smenr") . field ("gpdma1smen" , & self . gpdma1smen ()) . field ("cordicsmen" , & self . cordicsmen ()) . field ("fmacsmen" , & self . fmacsmen ()) . field ("mdf1smen" , & self . mdf1smen ()) . field ("flashsmen" , & self . flashsmen ()) . field ("crcsmen" , & self . crcsmen ()) . field ("jpegsmen" , & self . jpegsmen ()) . field ("tscsmen" , & self . tscsmen ()) . field ("ramcfgsmen" , & self . ramcfgsmen ()) . field ("dma2dsmen" , & self . dma2dsmen ()) . field ("gfxmmusmen" , & self . gfxmmusmen ()) . field ("gpu2dsmen" , & self . gpu2dsmen ()) . field ("dcache2smen" , & self . dcache2smen ()) . field ("gtzc1smen" , & self . gtzc1smen ()) . field ("bkpsramsmen" , & self . bkpsramsmen ()) . field ("icachesmen" , & self . icachesmen ()) . field ("dcache1smen" , & self . dcache1smen ()) . field ("sram1smen" , & self . sram1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1smenr {{ gpdma1smen: {=bool:?}, cordicsmen: {=bool:?}, fmacsmen: {=bool:?}, mdf1smen: {=bool:?}, flashsmen: {=bool:?}, crcsmen: {=bool:?}, jpegsmen: {=bool:?}, tscsmen: {=bool:?}, ramcfgsmen: {=bool:?}, dma2dsmen: {=bool:?}, gfxmmusmen: {=bool:?}, gpu2dsmen: {=bool:?}, dcache2smen: {=bool:?}, gtzc1smen: {=bool:?}, bkpsramsmen: {=bool:?}, icachesmen: {=bool:?}, dcache1smen: {=bool:?}, sram1smen: {=bool:?} }}" , self . gpdma1smen () , self . cordicsmen () , self . fmacsmen () , self . mdf1smen () , self . flashsmen () , self . crcsmen () , self . jpegsmen () , self . tscsmen () , self . ramcfgsmen () , self . dma2dsmen () , self . gfxmmusmen () , self . gpu2dsmen () , self . dcache2smen () , self . gtzc1smen () , self . bkpsramsmen () , self . icachesmen () , self . dcache1smen () , self . sram1smen ()) } } # [doc = "RCC AHB2 peripheral clock enable register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2enr1 { Ahb2enr1 (0) } } impl core :: fmt :: Debug for Ahb2enr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2enr1") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpioden" , & self . gpioden ()) . field ("gpioeen" , & self . gpioeen ()) . field ("gpiofen" , & self . gpiofen ()) . field ("gpiogen" , & self . gpiogen ()) . field ("gpiohen" , & self . gpiohen ()) . field ("gpioien" , & self . gpioien ()) . field ("gpiojen" , & self . gpiojen ()) . field ("adc12en" , & self . adc12en ()) . field ("dcmien" , & self . dcmien ()) . field ("usb_otg_fsen" , & self . usb_otg_fsen ()) . field ("usb_otg_hsen" , & self . usb_otg_hsen ()) . field ("usb_otg_hs_phyen" , & self . usb_otg_hs_phyen ()) . field ("aesen" , & self . aesen ()) . field ("hashen" , & self . hashen ()) . field ("rngen" , & self . rngen ()) . field ("pkaen" , & self . pkaen ()) . field ("saesen" , & self . saesen ()) . field ("octospimen" , & self . octospimen ()) . field ("otfdec1en" , & self . otfdec1en ()) . field ("otfdec2en" , & self . otfdec2en ()) . field ("sdmmc1en" , & self . sdmmc1en ()) . field ("sdmmc2en" , & self . sdmmc2en ()) . field ("sram2en" , & self . sram2en ()) . field ("sram3en" , & self . sram3en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2enr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2enr1 {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpioeen: {=bool:?}, gpiofen: {=bool:?}, gpiogen: {=bool:?}, gpiohen: {=bool:?}, gpioien: {=bool:?}, gpiojen: {=bool:?}, adc12en: {=bool:?}, dcmien: {=bool:?}, usb_otg_fsen: {=bool:?}, usb_otg_hsen: {=bool:?}, usb_otg_hs_phyen: {=bool:?}, aesen: {=bool:?}, hashen: {=bool:?}, rngen: {=bool:?}, pkaen: {=bool:?}, saesen: {=bool:?}, octospimen: {=bool:?}, otfdec1en: {=bool:?}, otfdec2en: {=bool:?}, sdmmc1en: {=bool:?}, sdmmc2en: {=bool:?}, sram2en: {=bool:?}, sram3en: {=bool:?} }}" , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpioden () , self . gpioeen () , self . gpiofen () , self . gpiogen () , self . gpiohen () , self . gpioien () , self . gpiojen () , self . adc12en () , self . dcmien () , self . usb_otg_fsen () , self . usb_otg_hsen () , self . usb_otg_hs_phyen () , self . aesen () , self . hashen () , self . rngen () , self . pkaen () , self . saesen () , self . octospimen () , self . otfdec1en () , self . otfdec2en () , self . sdmmc1en () , self . sdmmc2en () , self . sram2en () , self . sram3en ()) } } # [doc = "RCC AHB2 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2enr2 { Ahb2enr2 (0) } } impl core :: fmt :: Debug for Ahb2enr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2enr2") . field ("fsmcen" , & self . fsmcen ()) . field ("octospi1en" , & self . octospi1en ()) . field ("octospi2en" , & self . octospi2en ()) . field ("hspi1en" , & self . hspi1en ()) . field ("sram6en" , & self . sram6en ()) . field ("sram5en" , & self . sram5en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2enr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2enr2 {{ fsmcen: {=bool:?}, octospi1en: {=bool:?}, octospi2en: {=bool:?}, hspi1en: {=bool:?}, sram6en: {=bool:?}, sram5en: {=bool:?} }}" , self . fsmcen () , self . octospi1en () , self . octospi2en () , self . hspi1en () , self . sram6en () , self . sram5en ()) } } # [doc = "RCC AHB2 peripheral reset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2rstr1 { Ahb2rstr1 (0) } } impl core :: fmt :: Debug for Ahb2rstr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2rstr1") . field ("gpioarst" , & self . gpioarst ()) . field ("gpiobrst" , & self . gpiobrst ()) . field ("gpiocrst" , & self . gpiocrst ()) . field ("gpiodrst" , & self . gpiodrst ()) . field ("gpioerst" , & self . gpioerst ()) . field ("gpiofrst" , & self . gpiofrst ()) . field ("gpiogrst" , & self . gpiogrst ()) . field ("gpiohrst" , & self . gpiohrst ()) . field ("gpioirst" , & self . gpioirst ()) . field ("gpiojrst" , & self . gpiojrst ()) . field ("adc12rst" , & self . adc12rst ()) . field ("dcmirst" , & self . dcmirst ()) . field ("usb_otg_fsrst" , & self . usb_otg_fsrst ()) . field ("usb_otg_hsrst" , & self . usb_otg_hsrst ()) . field ("aesrst" , & self . aesrst ()) . field ("hashrst" , & self . hashrst ()) . field ("rngrst" , & self . rngrst ()) . field ("pkarst" , & self . pkarst ()) . field ("saesrst" , & self . saesrst ()) . field ("octospimrst" , & self . octospimrst ()) . field ("otfdec1rst" , & self . otfdec1rst ()) . field ("otfdec2rst" , & self . otfdec2rst ()) . field ("sdmmc1rst" , & self . sdmmc1rst ()) . field ("sdmmc2rst" , & self . sdmmc2rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2rstr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2rstr1 {{ gpioarst: {=bool:?}, gpiobrst: {=bool:?}, gpiocrst: {=bool:?}, gpiodrst: {=bool:?}, gpioerst: {=bool:?}, gpiofrst: {=bool:?}, gpiogrst: {=bool:?}, gpiohrst: {=bool:?}, gpioirst: {=bool:?}, gpiojrst: {=bool:?}, adc12rst: {=bool:?}, dcmirst: {=bool:?}, usb_otg_fsrst: {=bool:?}, usb_otg_hsrst: {=bool:?}, aesrst: {=bool:?}, hashrst: {=bool:?}, rngrst: {=bool:?}, pkarst: {=bool:?}, saesrst: {=bool:?}, octospimrst: {=bool:?}, otfdec1rst: {=bool:?}, otfdec2rst: {=bool:?}, sdmmc1rst: {=bool:?}, sdmmc2rst: {=bool:?} }}" , self . gpioarst () , self . gpiobrst () , self . gpiocrst () , self . gpiodrst () , self . gpioerst () , self . gpiofrst () , self . gpiogrst () , self . gpiohrst () , self . gpioirst () , self . gpiojrst () , self . adc12rst () , self . dcmirst () , self . usb_otg_fsrst () , self . usb_otg_hsrst () , self . aesrst () , self . hashrst () , self . rngrst () , self . pkarst () , self . saesrst () , self . octospimrst () , self . otfdec1rst () , self . otfdec2rst () , self . sdmmc1rst () , self . sdmmc2rst ()) } } # [doc = "RCC AHB2 peripheral reset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2rstr2 { Ahb2rstr2 (0) } } impl core :: fmt :: Debug for Ahb2rstr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2rstr2") . field ("fsmcrst" , & self . fsmcrst ()) . field ("octospi1rst" , & self . octospi1rst ()) . field ("octospi2rst" , & self . octospi2rst ()) . field ("hspi1rst" , & self . hspi1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2rstr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2rstr2 {{ fsmcrst: {=bool:?}, octospi1rst: {=bool:?}, octospi2rst: {=bool:?}, hspi1rst: {=bool:?} }}" , self . fsmcrst () , self . octospi1rst () , self . octospi2rst () , self . hspi1rst ()) } } # [doc = "RCC AHB2 peripheral clocks enable in Sleep and Stop modes register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2smenr1 { Ahb2smenr1 (0) } } impl core :: fmt :: Debug for Ahb2smenr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2smenr1") . field ("gpioasmen" , & self . gpioasmen ()) . field ("gpiobsmen" , & self . gpiobsmen ()) . field ("gpiocsmen" , & self . gpiocsmen ()) . field ("gpiodsmen" , & self . gpiodsmen ()) . field ("gpioesmen" , & self . gpioesmen ()) . field ("gpiofsmen" , & self . gpiofsmen ()) . field ("gpiogsmen" , & self . gpiogsmen ()) . field ("gpiohsmen" , & self . gpiohsmen ()) . field ("gpioismen" , & self . gpioismen ()) . field ("gpiojsmen" , & self . gpiojsmen ()) . field ("adc12smen" , & self . adc12smen ()) . field ("dcmismen" , & self . dcmismen ()) . field ("usb_otg_fssmen" , & self . usb_otg_fssmen ()) . field ("usb_otg_hssmen" , & self . usb_otg_hssmen ()) . field ("usb_otg_hs_physmen" , & self . usb_otg_hs_physmen ()) . field ("aessmen" , & self . aessmen ()) . field ("hashsmen" , & self . hashsmen ()) . field ("rngsmen" , & self . rngsmen ()) . field ("pkasmen" , & self . pkasmen ()) . field ("saessmen" , & self . saessmen ()) . field ("octospimsmen" , & self . octospimsmen ()) . field ("otfdec1smen" , & self . otfdec1smen ()) . field ("otfdec2smen" , & self . otfdec2smen ()) . field ("sdmmc1smen" , & self . sdmmc1smen ()) . field ("sdmmc2smen" , & self . sdmmc2smen ()) . field ("sram2smen" , & self . sram2smen ()) . field ("sram3smen" , & self . sram3smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2smenr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2smenr1 {{ gpioasmen: {=bool:?}, gpiobsmen: {=bool:?}, gpiocsmen: {=bool:?}, gpiodsmen: {=bool:?}, gpioesmen: {=bool:?}, gpiofsmen: {=bool:?}, gpiogsmen: {=bool:?}, gpiohsmen: {=bool:?}, gpioismen: {=bool:?}, gpiojsmen: {=bool:?}, adc12smen: {=bool:?}, dcmismen: {=bool:?}, usb_otg_fssmen: {=bool:?}, usb_otg_hssmen: {=bool:?}, usb_otg_hs_physmen: {=bool:?}, aessmen: {=bool:?}, hashsmen: {=bool:?}, rngsmen: {=bool:?}, pkasmen: {=bool:?}, saessmen: {=bool:?}, octospimsmen: {=bool:?}, otfdec1smen: {=bool:?}, otfdec2smen: {=bool:?}, sdmmc1smen: {=bool:?}, sdmmc2smen: {=bool:?}, sram2smen: {=bool:?}, sram3smen: {=bool:?} }}" , self . gpioasmen () , self . gpiobsmen () , self . gpiocsmen () , self . gpiodsmen () , self . gpioesmen () , self . gpiofsmen () , self . gpiogsmen () , self . gpiohsmen () , self . gpioismen () , self . gpiojsmen () , self . adc12smen () , self . dcmismen () , self . usb_otg_fssmen () , self . usb_otg_hssmen () , self . usb_otg_hs_physmen () , self . aessmen () , self . hashsmen () , self . rngsmen () , self . pkasmen () , self . saessmen () , self . octospimsmen () , self . otfdec1smen () , self . otfdec2smen () , self . sdmmc1smen () , self . sdmmc2smen () , self . sram2smen () , self . sram3smen ()) } } # [doc = "RCC AHB2 peripheral clocks enable in Sleep and Stop modes register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2smenr2 { Ahb2smenr2 (0) } } impl core :: fmt :: Debug for Ahb2smenr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2smenr2") . field ("fsmcsmen" , & self . fsmcsmen ()) . field ("octospi1smen" , & self . octospi1smen ()) . field ("octospi2smen" , & self . octospi2smen ()) . field ("hspi1smen" , & self . hspi1smen ()) . field ("sram6smen" , & self . sram6smen ()) . field ("sram5smen" , & self . sram5smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2smenr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2smenr2 {{ fsmcsmen: {=bool:?}, octospi1smen: {=bool:?}, octospi2smen: {=bool:?}, hspi1smen: {=bool:?}, sram6smen: {=bool:?}, sram5smen: {=bool:?} }}" , self . fsmcsmen () , self . octospi1smen () , self . octospi2smen () , self . hspi1smen () , self . sram6smen () , self . sram5smen ()) } } # [doc = "RCC AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3enr { Ahb3enr (0) } } impl core :: fmt :: Debug for Ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3enr") . field ("lpgpio1en" , & self . lpgpio1en ()) . field ("pwren" , & self . pwren ()) . field ("adc4en" , & self . adc4en ()) . field ("dac1en" , & self . dac1en ()) . field ("lpdma1en" , & self . lpdma1en ()) . field ("adf1en" , & self . adf1en ()) . field ("gtzc2en" , & self . gtzc2en ()) . field ("sram4en" , & self . sram4en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3enr {{ lpgpio1en: {=bool:?}, pwren: {=bool:?}, adc4en: {=bool:?}, dac1en: {=bool:?}, lpdma1en: {=bool:?}, adf1en: {=bool:?}, gtzc2en: {=bool:?}, sram4en: {=bool:?} }}" , self . lpgpio1en () , self . pwren () , self . adc4en () , self . dac1en () , self . lpdma1en () , self . adf1en () , self . gtzc2en () , self . sram4en ()) } } # [doc = "RCC AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3rstr { Ahb3rstr (0) } } impl core :: fmt :: Debug for Ahb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3rstr") . field ("lpgpio1rst" , & self . lpgpio1rst ()) . field ("adc4rst" , & self . adc4rst ()) . field ("dac1rst" , & self . dac1rst ()) . field ("lpdma1rst" , & self . lpdma1rst ()) . field ("adf1rst" , & self . adf1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3rstr {{ lpgpio1rst: {=bool:?}, adc4rst: {=bool:?}, dac1rst: {=bool:?}, lpdma1rst: {=bool:?}, adf1rst: {=bool:?} }}" , self . lpgpio1rst () , self . adc4rst () , self . dac1rst () , self . lpdma1rst () , self . adf1rst ()) } } # [doc = "RCC AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3smenr { Ahb3smenr (0) } } impl core :: fmt :: Debug for Ahb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3smenr") . field ("lpgpio1smen" , & self . lpgpio1smen ()) . field ("pwrsmen" , & self . pwrsmen ()) . field ("adc4smen" , & self . adc4smen ()) . field ("dac1smen" , & self . dac1smen ()) . field ("lpdma1smen" , & self . lpdma1smen ()) . field ("adf1smen" , & self . adf1smen ()) . field ("gtzc2smen" , & self . gtzc2smen ()) . field ("sram4smen" , & self . sram4smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3smenr {{ lpgpio1smen: {=bool:?}, pwrsmen: {=bool:?}, adc4smen: {=bool:?}, dac1smen: {=bool:?}, lpdma1smen: {=bool:?}, adf1smen: {=bool:?}, gtzc2smen: {=bool:?}, sram4smen: {=bool:?} }}" , self . lpgpio1smen () , self . pwrsmen () , self . adc4smen () , self . dac1smen () , self . lpdma1smen () , self . adf1smen () , self . gtzc2smen () , self . sram4smen ()) } } # [doc = "RCC APB1 peripheral clock enable register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr1 { Apb1enr1 (0) } } impl core :: fmt :: Debug for Apb1enr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr1") . field ("tim2en" , & self . tim2en ()) . field ("tim3en" , & self . tim3en ()) . field ("tim4en" , & self . tim4en ()) . field ("tim5en" , & self . tim5en ()) . field ("tim6en" , & self . tim6en ()) . field ("tim7en" , & self . tim7en ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("usart2en" , & self . usart2en ()) . field ("usart3en" , & self . usart3en ()) . field ("uart4en" , & self . uart4en ()) . field ("uart5en" , & self . uart5en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("crsen" , & self . crsen ()) . field ("usart6en" , & self . usart6en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr1 {{ tim2en: {=bool:?}, tim3en: {=bool:?}, tim4en: {=bool:?}, tim5en: {=bool:?}, tim6en: {=bool:?}, tim7en: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, usart2en: {=bool:?}, usart3en: {=bool:?}, uart4en: {=bool:?}, uart5en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, crsen: {=bool:?}, usart6en: {=bool:?} }}" , self . tim2en () , self . tim3en () , self . tim4en () , self . tim5en () , self . tim6en () , self . tim7en () , self . wwdgen () , self . spi2en () , self . usart2en () , self . usart3en () , self . uart4en () , self . uart5en () , self . i2c1en () , self . i2c2en () , self . crsen () , self . usart6en ()) } } # [doc = "RCC APB1 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr2 { Apb1enr2 (0) } } impl core :: fmt :: Debug for Apb1enr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr2") . field ("i2c4en" , & self . i2c4en ()) . field ("lptim2en" , & self . lptim2en ()) . field ("i2c5en" , & self . i2c5en ()) . field ("i2c6en" , & self . i2c6en ()) . field ("fdcan1en" , & self . fdcan1en ()) . field ("ucpd1en" , & self . ucpd1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr2 {{ i2c4en: {=bool:?}, lptim2en: {=bool:?}, i2c5en: {=bool:?}, i2c6en: {=bool:?}, fdcan1en: {=bool:?}, ucpd1en: {=bool:?} }}" , self . i2c4en () , self . lptim2en () , self . i2c5en () , self . i2c6en () , self . fdcan1en () , self . ucpd1en ()) } } # [doc = "RCC APB1 peripheral reset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr1 { Apb1rstr1 (0) } } impl core :: fmt :: Debug for Apb1rstr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr1") . field ("tim2rst" , & self . tim2rst ()) . field ("tim3rst" , & self . tim3rst ()) . field ("tim4rst" , & self . tim4rst ()) . field ("tim5rst" , & self . tim5rst ()) . field ("tim6rst" , & self . tim6rst ()) . field ("tim7rst" , & self . tim7rst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("usart3rst" , & self . usart3rst ()) . field ("uart4rst" , & self . uart4rst ()) . field ("uart5rst" , & self . uart5rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("crsrst" , & self . crsrst ()) . field ("usart6rst" , & self . usart6rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr1 {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim4rst: {=bool:?}, tim5rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, spi2rst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, uart4rst: {=bool:?}, uart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, crsrst: {=bool:?}, usart6rst: {=bool:?} }}" , self . tim2rst () , self . tim3rst () , self . tim4rst () , self . tim5rst () , self . tim6rst () , self . tim7rst () , self . spi2rst () , self . usart2rst () , self . usart3rst () , self . uart4rst () , self . uart5rst () , self . i2c1rst () , self . i2c2rst () , self . crsrst () , self . usart6rst ()) } } # [doc = "RCC APB1 peripheral reset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr2 { Apb1rstr2 (0) } } impl core :: fmt :: Debug for Apb1rstr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr2") . field ("i2c4rst" , & self . i2c4rst ()) . field ("lptim2rst" , & self . lptim2rst ()) . field ("i2c5rst" , & self . i2c5rst ()) . field ("i2c6rst" , & self . i2c6rst ()) . field ("fdcan1rst" , & self . fdcan1rst ()) . field ("ucpd1rst" , & self . ucpd1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr2 {{ i2c4rst: {=bool:?}, lptim2rst: {=bool:?}, i2c5rst: {=bool:?}, i2c6rst: {=bool:?}, fdcan1rst: {=bool:?}, ucpd1rst: {=bool:?} }}" , self . i2c4rst () , self . lptim2rst () , self . i2c5rst () , self . i2c6rst () , self . fdcan1rst () , self . ucpd1rst ()) } } # [doc = "RCC APB1 peripheral clocks enable in Sleep and Stop modes register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1smenr1 { Apb1smenr1 (0) } } impl core :: fmt :: Debug for Apb1smenr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1smenr1") . field ("tim2smen" , & self . tim2smen ()) . field ("tim3smen" , & self . tim3smen ()) . field ("tim4smen" , & self . tim4smen ()) . field ("tim5smen" , & self . tim5smen ()) . field ("tim6smen" , & self . tim6smen ()) . field ("tim7smen" , & self . tim7smen ()) . field ("wwdgsmen" , & self . wwdgsmen ()) . field ("spi2smen" , & self . spi2smen ()) . field ("usart2smen" , & self . usart2smen ()) . field ("usart3smen" , & self . usart3smen ()) . field ("uart4smen" , & self . uart4smen ()) . field ("uart5smen" , & self . uart5smen ()) . field ("i2c1smen" , & self . i2c1smen ()) . field ("i2c2smen" , & self . i2c2smen ()) . field ("crssmen" , & self . crssmen ()) . field ("usart6smen" , & self . usart6smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1smenr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1smenr1 {{ tim2smen: {=bool:?}, tim3smen: {=bool:?}, tim4smen: {=bool:?}, tim5smen: {=bool:?}, tim6smen: {=bool:?}, tim7smen: {=bool:?}, wwdgsmen: {=bool:?}, spi2smen: {=bool:?}, usart2smen: {=bool:?}, usart3smen: {=bool:?}, uart4smen: {=bool:?}, uart5smen: {=bool:?}, i2c1smen: {=bool:?}, i2c2smen: {=bool:?}, crssmen: {=bool:?}, usart6smen: {=bool:?} }}" , self . tim2smen () , self . tim3smen () , self . tim4smen () , self . tim5smen () , self . tim6smen () , self . tim7smen () , self . wwdgsmen () , self . spi2smen () , self . usart2smen () , self . usart3smen () , self . uart4smen () , self . uart5smen () , self . i2c1smen () , self . i2c2smen () , self . crssmen () , self . usart6smen ()) } } # [doc = "RCC APB1 peripheral clocks enable in Sleep and Stop modes register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1smenr2 { Apb1smenr2 (0) } } impl core :: fmt :: Debug for Apb1smenr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1smenr2") . field ("i2c4smen" , & self . i2c4smen ()) . field ("lptim2smen" , & self . lptim2smen ()) . field ("i2c5smen" , & self . i2c5smen ()) . field ("i2c6smen" , & self . i2c6smen ()) . field ("fdcan1smen" , & self . fdcan1smen ()) . field ("ucpd1smen" , & self . ucpd1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1smenr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1smenr2 {{ i2c4smen: {=bool:?}, lptim2smen: {=bool:?}, i2c5smen: {=bool:?}, i2c6smen: {=bool:?}, fdcan1smen: {=bool:?}, ucpd1smen: {=bool:?} }}" , self . i2c4smen () , self . lptim2smen () , self . i2c5smen () , self . i2c6smen () , self . fdcan1smen () , self . ucpd1smen ()) } } # [doc = "RCC APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("tim1en" , & self . tim1en ()) . field ("spi1en" , & self . spi1en ()) . field ("tim8en" , & self . tim8en ()) . field ("usart1en" , & self . usart1en ()) . field ("tim15en" , & self . tim15en ()) . field ("tim16en" , & self . tim16en ()) . field ("tim17en" , & self . tim17en ()) . field ("sai1en" , & self . sai1en ()) . field ("sai2en" , & self . sai2en ()) . field ("usben" , & self . usben ()) . field ("gfxtimen" , & self . gfxtimen ()) . field ("ltdcen" , & self . ltdcen ()) . field ("dsien" , & self . dsien ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ tim1en: {=bool:?}, spi1en: {=bool:?}, tim8en: {=bool:?}, usart1en: {=bool:?}, tim15en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?}, sai1en: {=bool:?}, sai2en: {=bool:?}, usben: {=bool:?}, gfxtimen: {=bool:?}, ltdcen: {=bool:?}, dsien: {=bool:?} }}" , self . tim1en () , self . spi1en () , self . tim8en () , self . usart1en () , self . tim15en () , self . tim16en () , self . tim17en () , self . sai1en () , self . sai2en () , self . usben () , self . gfxtimen () , self . ltdcen () , self . dsien ()) } } # [doc = "RCC APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("tim1rst" , & self . tim1rst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("tim8rst" , & self . tim8rst ()) . field ("usart1rst" , & self . usart1rst ()) . field ("tim15rst" , & self . tim15rst ()) . field ("tim16rst" , & self . tim16rst ()) . field ("tim17rst" , & self . tim17rst ()) . field ("sai1rst" , & self . sai1rst ()) . field ("sai2rst" , & self . sai2rst ()) . field ("usbrst" , & self . usbrst ()) . field ("gfxtimrst" , & self . gfxtimrst ()) . field ("ltdcrst" , & self . ltdcrst ()) . field ("dsirst" , & self . dsirst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ tim1rst: {=bool:?}, spi1rst: {=bool:?}, tim8rst: {=bool:?}, usart1rst: {=bool:?}, tim15rst: {=bool:?}, tim16rst: {=bool:?}, tim17rst: {=bool:?}, sai1rst: {=bool:?}, sai2rst: {=bool:?}, usbrst: {=bool:?}, gfxtimrst: {=bool:?}, ltdcrst: {=bool:?}, dsirst: {=bool:?} }}" , self . tim1rst () , self . spi1rst () , self . tim8rst () , self . usart1rst () , self . tim15rst () , self . tim16rst () , self . tim17rst () , self . sai1rst () , self . sai2rst () , self . usbrst () , self . gfxtimrst () , self . ltdcrst () , self . dsirst ()) } } # [doc = "RCC APB2 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2smenr { Apb2smenr (0) } } impl core :: fmt :: Debug for Apb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2smenr") . field ("tim1smen" , & self . tim1smen ()) . field ("spi1smen" , & self . spi1smen ()) . field ("tim8smen" , & self . tim8smen ()) . field ("usart1smen" , & self . usart1smen ()) . field ("tim15smen" , & self . tim15smen ()) . field ("tim16smen" , & self . tim16smen ()) . field ("tim17smen" , & self . tim17smen ()) . field ("sai1smen" , & self . sai1smen ()) . field ("sai2smen" , & self . sai2smen ()) . field ("usbsmen" , & self . usbsmen ()) . field ("gfxtimsmen" , & self . gfxtimsmen ()) . field ("ltdcsmen" , & self . ltdcsmen ()) . field ("dsismen" , & self . dsismen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2smenr {{ tim1smen: {=bool:?}, spi1smen: {=bool:?}, tim8smen: {=bool:?}, usart1smen: {=bool:?}, tim15smen: {=bool:?}, tim16smen: {=bool:?}, tim17smen: {=bool:?}, sai1smen: {=bool:?}, sai2smen: {=bool:?}, usbsmen: {=bool:?}, gfxtimsmen: {=bool:?}, ltdcsmen: {=bool:?}, dsismen: {=bool:?} }}" , self . tim1smen () , self . spi1smen () , self . tim8smen () , self . usart1smen () , self . tim15smen () , self . tim16smen () , self . tim17smen () , self . sai1smen () , self . sai2smen () , self . usbsmen () , self . gfxtimsmen () , self . ltdcsmen () , self . dsismen ()) } } # [doc = "RCC APB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb3enr { Apb3enr (0) } } impl core :: fmt :: Debug for Apb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb3enr") . field ("syscfgen" , & self . syscfgen ()) . field ("spi3en" , & self . spi3en ()) . field ("lpuart1en" , & self . lpuart1en ()) . field ("i2c3en" , & self . i2c3en ()) . field ("lptim1en" , & self . lptim1en ()) . field ("lptim3en" , & self . lptim3en ()) . field ("lptim4en" , & self . lptim4en ()) . field ("opampen" , & self . opampen ()) . field ("compen" , & self . compen ()) . field ("vrefen" , & self . vrefen ()) . field ("rtcapben" , & self . rtcapben ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb3enr {{ syscfgen: {=bool:?}, spi3en: {=bool:?}, lpuart1en: {=bool:?}, i2c3en: {=bool:?}, lptim1en: {=bool:?}, lptim3en: {=bool:?}, lptim4en: {=bool:?}, opampen: {=bool:?}, compen: {=bool:?}, vrefen: {=bool:?}, rtcapben: {=bool:?} }}" , self . syscfgen () , self . spi3en () , self . lpuart1en () , self . i2c3en () , self . lptim1en () , self . lptim3en () , self . lptim4en () , self . opampen () , self . compen () , self . vrefen () , self . rtcapben ()) } } # [doc = "RCC APB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb3rstr { Apb3rstr (0) } } impl core :: fmt :: Debug for Apb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb3rstr") . field ("syscfgrst" , & self . syscfgrst ()) . field ("spi3rst" , & self . spi3rst ()) . field ("lpuart1rst" , & self . lpuart1rst ()) . field ("i2c3rst" , & self . i2c3rst ()) . field ("lptim1rst" , & self . lptim1rst ()) . field ("lptim3rst" , & self . lptim3rst ()) . field ("lptim4rst" , & self . lptim4rst ()) . field ("opamprst" , & self . opamprst ()) . field ("comprst" , & self . comprst ()) . field ("vrefrst" , & self . vrefrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb3rstr {{ syscfgrst: {=bool:?}, spi3rst: {=bool:?}, lpuart1rst: {=bool:?}, i2c3rst: {=bool:?}, lptim1rst: {=bool:?}, lptim3rst: {=bool:?}, lptim4rst: {=bool:?}, opamprst: {=bool:?}, comprst: {=bool:?}, vrefrst: {=bool:?} }}" , self . syscfgrst () , self . spi3rst () , self . lpuart1rst () , self . i2c3rst () , self . lptim1rst () , self . lptim3rst () , self . lptim4rst () , self . opamprst () , self . comprst () , self . vrefrst ()) } } # [doc = "RCC APB3 peripheral clock enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb3smenr { Apb3smenr (0) } } impl core :: fmt :: Debug for Apb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb3smenr") . field ("syscfgsmen" , & self . syscfgsmen ()) . field ("spi3smen" , & self . spi3smen ()) . field ("lpuart1smen" , & self . lpuart1smen ()) . field ("i2c3smen" , & self . i2c3smen ()) . field ("lptim1smen" , & self . lptim1smen ()) . field ("lptim3smen" , & self . lptim3smen ()) . field ("lptim4smen" , & self . lptim4smen ()) . field ("opampsmen" , & self . opampsmen ()) . field ("compsmen" , & self . compsmen ()) . field ("vrefsmen" , & self . vrefsmen ()) . field ("rtcapbsmen" , & self . rtcapbsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb3smenr {{ syscfgsmen: {=bool:?}, spi3smen: {=bool:?}, lpuart1smen: {=bool:?}, i2c3smen: {=bool:?}, lptim1smen: {=bool:?}, lptim3smen: {=bool:?}, lptim4smen: {=bool:?}, opampsmen: {=bool:?}, compsmen: {=bool:?}, vrefsmen: {=bool:?}, rtcapbsmen: {=bool:?} }}" , self . syscfgsmen () , self . spi3smen () , self . lpuart1smen () , self . i2c3smen () , self . lptim1smen () , self . lptim3smen () , self . lptim4smen () , self . opampsmen () , self . compsmen () , self . vrefsmen () , self . rtcapbsmen ()) } } # [doc = "RCC Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bdcr { Bdcr (0) } } impl core :: fmt :: Debug for Bdcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bdcr") . field ("lseon" , & self . lseon ()) . field ("lserdy" , & self . lserdy ()) . field ("lsebyp" , & self . lsebyp ()) . field ("lsedrv" , & self . lsedrv ()) . field ("lsecsson" , & self . lsecsson ()) . field ("lsecssd" , & self . lsecssd ()) . field ("lsesysen" , & self . lsesysen ()) . field ("rtcsel" , & self . rtcsel ()) . field ("lsesysrdy" , & self . lsesysrdy ()) . field ("lsegfon" , & self . lsegfon ()) . field ("rtcen" , & self . rtcen ()) . field ("bdrst" , & self . bdrst ()) . field ("lscoen" , & self . lscoen ()) . field ("lscosel" , & self . lscosel ()) . field ("lsion" , & self . lsion ()) . field ("lsirdy" , & self . lsirdy ()) . field ("lsiprediv" , & self . lsiprediv ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bdcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bdcr {{ lseon: {=bool:?}, lserdy: {=bool:?}, lsebyp: {=bool:?}, lsedrv: {:?}, lsecsson: {=bool:?}, lsecssd: {=bool:?}, lsesysen: {=bool:?}, rtcsel: {:?}, lsesysrdy: {=bool:?}, lsegfon: {=bool:?}, rtcen: {=bool:?}, bdrst: {=bool:?}, lscoen: {=bool:?}, lscosel: {:?}, lsion: {=bool:?}, lsirdy: {=bool:?}, lsiprediv: {:?} }}" , self . lseon () , self . lserdy () , self . lsebyp () , self . lsedrv () , self . lsecsson () , self . lsecssd () , self . lsesysen () , self . rtcsel () , self . lsesysrdy () , self . lsegfon () , self . rtcen () , self . bdrst () , self . lscoen () , self . lscosel () , self . lsion () , self . lsirdy () , self . lsiprediv ()) } } # [doc = "RCC peripherals independent clock configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccipr1 { Ccipr1 (0) } } impl core :: fmt :: Debug for Ccipr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccipr1") . field ("usart1sel" , & self . usart1sel ()) . field ("usart2sel" , & self . usart2sel ()) . field ("usart3sel" , & self . usart3sel ()) . field ("uart4sel" , & self . uart4sel ()) . field ("uart5sel" , & self . uart5sel ()) . field ("i2c1sel" , & self . i2c1sel ()) . field ("i2c2sel" , & self . i2c2sel ()) . field ("i2c4sel" , & self . i2c4sel ()) . field ("spi2sel" , & self . spi2sel ()) . field ("lptim2sel" , & self . lptim2sel ()) . field ("spi1sel" , & self . spi1sel ()) . field ("systicksel" , & self . systicksel ()) . field ("fdcan1sel" , & self . fdcan1sel ()) . field ("iclksel" , & self . iclksel ()) . field ("timicsel" , & self . timicsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccipr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccipr1 {{ usart1sel: {:?}, usart2sel: {:?}, usart3sel: {:?}, uart4sel: {:?}, uart5sel: {:?}, i2c1sel: {:?}, i2c2sel: {:?}, i2c4sel: {:?}, spi2sel: {:?}, lptim2sel: {:?}, spi1sel: {:?}, systicksel: {:?}, fdcan1sel: {:?}, iclksel: {:?}, timicsel: {:?} }}" , self . usart1sel () , self . usart2sel () , self . usart3sel () , self . uart4sel () , self . uart5sel () , self . i2c1sel () , self . i2c2sel () , self . i2c4sel () , self . spi2sel () , self . lptim2sel () , self . spi1sel () , self . systicksel () , self . fdcan1sel () , self . iclksel () , self . timicsel ()) } } # [doc = "RCC peripherals independent clock configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccipr2 { Ccipr2 (0) } } impl core :: fmt :: Debug for Ccipr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccipr2") . field ("mdf1sel" , & self . mdf1sel ()) . field ("sai1sel" , & self . sai1sel ()) . field ("sai2sel" , & self . sai2sel ()) . field ("saessel" , & self . saessel ()) . field ("rngsel" , & self . rngsel ()) . field ("sdmmcsel" , & self . sdmmcsel ()) . field ("dsisel" , & self . dsisel ()) . field ("usart6sel" , & self . usart6sel ()) . field ("ltdcsel" , & self . ltdcsel ()) . field ("octospisel" , & self . octospisel ()) . field ("hspi1sel" , & self . hspi1sel ()) . field ("i2c5sel" , & self . i2c5sel ()) . field ("i2c6sel" , & self . i2c6sel ()) . field ("otghssel" , & self . otghssel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccipr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccipr2 {{ mdf1sel: {:?}, sai1sel: {:?}, sai2sel: {:?}, saessel: {:?}, rngsel: {:?}, sdmmcsel: {:?}, dsisel: {:?}, usart6sel: {:?}, ltdcsel: {:?}, octospisel: {:?}, hspi1sel: {:?}, i2c5sel: {:?}, i2c6sel: {:?}, otghssel: {:?} }}" , self . mdf1sel () , self . sai1sel () , self . sai2sel () , self . saessel () , self . rngsel () , self . sdmmcsel () , self . dsisel () , self . usart6sel () , self . ltdcsel () , self . octospisel () , self . hspi1sel () , self . i2c5sel () , self . i2c6sel () , self . otghssel ()) } } # [doc = "RCC peripherals independent clock configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccipr3 { Ccipr3 (0) } } impl core :: fmt :: Debug for Ccipr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccipr3") . field ("lpuart1sel" , & self . lpuart1sel ()) . field ("spi3sel" , & self . spi3sel ()) . field ("i2c3sel" , & self . i2c3sel ()) . field ("lptim34sel" , & self . lptim34sel ()) . field ("lptim1sel" , & self . lptim1sel ()) . field ("adcdacsel" , & self . adcdacsel ()) . field ("dac1sel" , & self . dac1sel ()) . field ("adf1sel" , & self . adf1sel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccipr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccipr3 {{ lpuart1sel: {:?}, spi3sel: {:?}, i2c3sel: {:?}, lptim34sel: {:?}, lptim1sel: {:?}, adcdacsel: {:?}, dac1sel: {:?}, adf1sel: {:?} }}" , self . lpuart1sel () , self . spi3sel () , self . i2c3sel () , self . lptim34sel () , self . lptim1sel () , self . adcdacsel () , self . dac1sel () , self . adf1sel ()) } } # [doc = "RCC clock configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr1 { Cfgr1 (0) } } impl core :: fmt :: Debug for Cfgr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr1") . field ("sw" , & self . sw ()) . field ("sws" , & self . sws ()) . field ("stopwuck" , & self . stopwuck ()) . field ("stopkerwuck" , & self . stopkerwuck ()) . field ("mcosel" , & self . mcosel ()) . field ("mcopre" , & self . mcopre ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr1 {{ sw: {:?}, sws: {:?}, stopwuck: {:?}, stopkerwuck: {:?}, mcosel: {:?}, mcopre: {:?} }}" , self . sw () , self . sws () , self . stopwuck () , self . stopkerwuck () , self . mcosel () , self . mcopre ()) } } # [doc = "RCC clock configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("hpre" , & self . hpre ()) . field ("ppre1" , & self . ppre1 ()) . field ("ppre2" , & self . ppre2 ()) . field ("dpre" , & self . dpre ()) . field ("ahb1dis" , & self . ahb1dis ()) . field ("ahb2dis1" , & self . ahb2dis1 ()) . field ("ahb2dis2" , & self . ahb2dis2 ()) . field ("apb1dis" , & self . apb1dis ()) . field ("apb2dis" , & self . apb2dis ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ hpre: {:?}, ppre1: {:?}, ppre2: {:?}, dpre: {:?}, ahb1dis: {=bool:?}, ahb2dis1: {=bool:?}, ahb2dis2: {=bool:?}, apb1dis: {=bool:?}, apb2dis: {=bool:?} }}" , self . hpre () , self . ppre1 () , self . ppre2 () , self . dpre () , self . ahb1dis () , self . ahb2dis1 () , self . ahb2dis2 () , self . apb1dis () , self . apb2dis ()) } } # [doc = "RCC clock configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr3 { Cfgr3 (0) } } impl core :: fmt :: Debug for Cfgr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr3") . field ("ppre3" , & self . ppre3 ()) . field ("ahb3dis" , & self . ahb3dis ()) . field ("apb3dis" , & self . apb3dis ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr3 {{ ppre3: {:?}, ahb3dis: {=bool:?}, apb3dis: {=bool:?} }}" , self . ppre3 () , self . ahb3dis () , self . apb3dis ()) } } # [doc = "RCC clock interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cicr { Cicr (0) } } impl core :: fmt :: Debug for Cicr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cicr") . field ("lsirdyc" , & self . lsirdyc ()) . field ("lserdyc" , & self . lserdyc ()) . field ("msisrdyc" , & self . msisrdyc ()) . field ("hsirdyc" , & self . hsirdyc ()) . field ("hserdyc" , & self . hserdyc ()) . field ("hsi48rdyc" , & self . hsi48rdyc ()) . field ("pllrdyc[0]" , & self . pllrdyc (0usize)) . field ("pllrdyc[1]" , & self . pllrdyc (1usize)) . field ("pllrdyc[2]" , & self . pllrdyc (2usize)) . field ("cssc" , & self . cssc ()) . field ("msikrdyc" , & self . msikrdyc ()) . field ("shsirdyc" , & self . shsirdyc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cicr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cicr {{ lsirdyc: {=bool:?}, lserdyc: {=bool:?}, msisrdyc: {=bool:?}, hsirdyc: {=bool:?}, hserdyc: {=bool:?}, hsi48rdyc: {=bool:?}, pllrdyc[0]: {=bool:?}, pllrdyc[1]: {=bool:?}, pllrdyc[2]: {=bool:?}, cssc: {=bool:?}, msikrdyc: {=bool:?}, shsirdyc: {=bool:?} }}" , self . lsirdyc () , self . lserdyc () , self . msisrdyc () , self . hsirdyc () , self . hserdyc () , self . hsi48rdyc () , self . pllrdyc (0usize) , self . pllrdyc (1usize) , self . pllrdyc (2usize) , self . cssc () , self . msikrdyc () , self . shsirdyc ()) } } # [doc = "RCC clock interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cier { Cier (0) } } impl core :: fmt :: Debug for Cier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cier") . field ("lsirdyie" , & self . lsirdyie ()) . field ("lserdyie" , & self . lserdyie ()) . field ("msisrdyie" , & self . msisrdyie ()) . field ("hsirdyie" , & self . hsirdyie ()) . field ("hserdyie" , & self . hserdyie ()) . field ("hsi48rdyie" , & self . hsi48rdyie ()) . field ("pllrdyie[0]" , & self . pllrdyie (0usize)) . field ("pllrdyie[1]" , & self . pllrdyie (1usize)) . field ("pllrdyie[2]" , & self . pllrdyie (2usize)) . field ("msikrdyie" , & self . msikrdyie ()) . field ("shsirdyie" , & self . shsirdyie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cier {{ lsirdyie: {=bool:?}, lserdyie: {=bool:?}, msisrdyie: {=bool:?}, hsirdyie: {=bool:?}, hserdyie: {=bool:?}, hsi48rdyie: {=bool:?}, pllrdyie[0]: {=bool:?}, pllrdyie[1]: {=bool:?}, pllrdyie[2]: {=bool:?}, msikrdyie: {=bool:?}, shsirdyie: {=bool:?} }}" , self . lsirdyie () , self . lserdyie () , self . msisrdyie () , self . hsirdyie () , self . hserdyie () , self . hsi48rdyie () , self . pllrdyie (0usize) , self . pllrdyie (1usize) , self . pllrdyie (2usize) , self . msikrdyie () , self . shsirdyie ()) } } # [doc = "RCC clock interrupt flag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cifr { Cifr (0) } } impl core :: fmt :: Debug for Cifr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cifr") . field ("lsirdyf" , & self . lsirdyf ()) . field ("lserdyf" , & self . lserdyf ()) . field ("msisrdyf" , & self . msisrdyf ()) . field ("hsirdyf" , & self . hsirdyf ()) . field ("hserdyf" , & self . hserdyf ()) . field ("hsi48rdyf" , & self . hsi48rdyf ()) . field ("pllrdyf[0]" , & self . pllrdyf (0usize)) . field ("pllrdyf[1]" , & self . pllrdyf (1usize)) . field ("pllrdyf[2]" , & self . pllrdyf (2usize)) . field ("cssf" , & self . cssf ()) . field ("msikrdyf" , & self . msikrdyf ()) . field ("shsirdyf" , & self . shsirdyf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cifr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cifr {{ lsirdyf: {=bool:?}, lserdyf: {=bool:?}, msisrdyf: {=bool:?}, hsirdyf: {=bool:?}, hserdyf: {=bool:?}, hsi48rdyf: {=bool:?}, pllrdyf[0]: {=bool:?}, pllrdyf[1]: {=bool:?}, pllrdyf[2]: {=bool:?}, cssf: {=bool:?}, msikrdyf: {=bool:?}, shsirdyf: {=bool:?} }}" , self . lsirdyf () , self . lserdyf () , self . msisrdyf () , self . hsirdyf () , self . hserdyf () , self . hsi48rdyf () , self . pllrdyf (0usize) , self . pllrdyf (1usize) , self . pllrdyf (2usize) , self . cssf () , self . msikrdyf () , self . shsirdyf ()) } } # [doc = "RCC clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("msison" , & self . msison ()) . field ("msikeron" , & self . msikeron ()) . field ("msisrdy" , & self . msisrdy ()) . field ("msipllen" , & self . msipllen ()) . field ("msikon" , & self . msikon ()) . field ("msikrdy" , & self . msikrdy ()) . field ("msipllsel" , & self . msipllsel ()) . field ("msipllfast" , & self . msipllfast ()) . field ("hsion" , & self . hsion ()) . field ("hsikeron" , & self . hsikeron ()) . field ("hsirdy" , & self . hsirdy ()) . field ("hsi48on" , & self . hsi48on ()) . field ("hsi48rdy" , & self . hsi48rdy ()) . field ("shsion" , & self . shsion ()) . field ("shsirdy" , & self . shsirdy ()) . field ("hseon" , & self . hseon ()) . field ("hserdy" , & self . hserdy ()) . field ("hsebyp" , & self . hsebyp ()) . field ("csson" , & self . csson ()) . field ("hseext" , & self . hseext ()) . field ("pllon[0]" , & self . pllon (0usize)) . field ("pllon[1]" , & self . pllon (1usize)) . field ("pllon[2]" , & self . pllon (2usize)) . field ("pllrdy[0]" , & self . pllrdy (0usize)) . field ("pllrdy[1]" , & self . pllrdy (1usize)) . field ("pllrdy[2]" , & self . pllrdy (2usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ msison: {=bool:?}, msikeron: {=bool:?}, msisrdy: {=bool:?}, msipllen: {=bool:?}, msikon: {=bool:?}, msikrdy: {=bool:?}, msipllsel: {:?}, msipllfast: {:?}, hsion: {=bool:?}, hsikeron: {=bool:?}, hsirdy: {=bool:?}, hsi48on: {=bool:?}, hsi48rdy: {=bool:?}, shsion: {=bool:?}, shsirdy: {=bool:?}, hseon: {=bool:?}, hserdy: {=bool:?}, hsebyp: {=bool:?}, csson: {=bool:?}, hseext: {:?}, pllon[0]: {=bool:?}, pllon[1]: {=bool:?}, pllon[2]: {=bool:?}, pllrdy[0]: {=bool:?}, pllrdy[1]: {=bool:?}, pllrdy[2]: {=bool:?} }}" , self . msison () , self . msikeron () , self . msisrdy () , self . msipllen () , self . msikon () , self . msikrdy () , self . msipllsel () , self . msipllfast () , self . hsion () , self . hsikeron () , self . hsirdy () , self . hsi48on () , self . hsi48rdy () , self . shsion () , self . shsirdy () , self . hseon () , self . hserdy () , self . hsebyp () , self . csson () , self . hseext () , self . pllon (0usize) , self . pllon (1usize) , self . pllon (2usize) , self . pllrdy (0usize) , self . pllrdy (1usize) , self . pllrdy (2usize)) } } # [doc = "RCC clock recovery RC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Crrcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Crrcr {{ hsi48cal: {=u16:?} }}" , self . hsi48cal ()) } } # [doc = "RCC control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("msiksrange" , & self . msiksrange ()) . field ("msissrange" , & self . msissrange ()) . field ("rmvf" , & self . rmvf ()) . field ("oblrstf" , & self . oblrstf ()) . field ("pinrstf" , & self . pinrstf ()) . field ("borrstf" , & self . borrstf ()) . field ("sftrstf" , & self . sftrstf ()) . field ("iwdgrstf" , & self . iwdgrstf ()) . field ("wwdgrstf" , & self . wwdgrstf ()) . field ("lpwrrstf" , & self . lpwrrstf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ msiksrange: {:?}, msissrange: {:?}, rmvf: {=bool:?}, oblrstf: {=bool:?}, pinrstf: {=bool:?}, borrstf: {=bool:?}, sftrstf: {=bool:?}, iwdgrstf: {=bool:?}, wwdgrstf: {=bool:?}, lpwrrstf: {=bool:?} }}" , self . msiksrange () , self . msissrange () , self . rmvf () , self . oblrstf () , self . pinrstf () , self . borrstf () , self . sftrstf () , self . iwdgrstf () , self . wwdgrstf () , self . lpwrrstf ()) } } # [doc = "RCC internal clock sources calibration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icscr1 { Icscr1 (0) } } impl core :: fmt :: Debug for Icscr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icscr1") . field ("msical3" , & self . msical3 ()) . field ("msical2" , & self . msical2 ()) . field ("msical1" , & self . msical1 ()) . field ("msical0" , & self . msical0 ()) . field ("msibias" , & self . msibias ()) . field ("msirgsel" , & self . msirgsel ()) . field ("msikrange" , & self . msikrange ()) . field ("msisrange" , & self . msisrange ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icscr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icscr1 {{ msical3: {=u8:?}, msical2: {=u8:?}, msical1: {=u8:?}, msical0: {=u8:?}, msibias: {:?}, msirgsel: {:?}, msikrange: {:?}, msisrange: {:?} }}" , self . msical3 () , self . msical2 () , self . msical1 () , self . msical0 () , self . msibias () , self . msirgsel () , self . msikrange () , self . msisrange ()) } } # [doc = "RCC internal clock sources calibration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icscr2 { Icscr2 (0) } } impl core :: fmt :: Debug for Icscr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icscr2") . field ("msitrim3" , & self . msitrim3 ()) . field ("msitrim2" , & self . msitrim2 ()) . field ("msitrim1" , & self . msitrim1 ()) . field ("msitrim0" , & self . msitrim0 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icscr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icscr2 {{ msitrim3: {=u8:?}, msitrim2: {=u8:?}, msitrim1: {=u8:?}, msitrim0: {=u8:?} }}" , self . msitrim3 () , self . msitrim2 () , self . msitrim1 () , self . msitrim0 ()) } } # [doc = "RCC internal clock sources calibration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icscr3 { Icscr3 (0) } } impl core :: fmt :: Debug for Icscr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icscr3") . field ("hsical" , & self . hsical ()) . field ("hsitrim" , & self . hsitrim ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icscr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icscr3 {{ hsical: {=u16:?}, hsitrim: {=u8:?} }}" , self . hsical () , self . hsitrim ()) } } # [doc = "RCC PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pll1cfgr { Pll1cfgr (0) } } impl core :: fmt :: Debug for Pll1cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pll1cfgr") . field ("pllsrc" , & self . pllsrc ()) . field ("pllrge" , & self . pllrge ()) . field ("pllfracen" , & self . pllfracen ()) . field ("pllm" , & self . pllm ()) . field ("pllmboost" , & self . pllmboost ()) . field ("pllpen" , & self . pllpen ()) . field ("pllqen" , & self . pllqen ()) . field ("pllren" , & self . pllren ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pll1cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pll1cfgr {{ pllsrc: {:?}, pllrge: {:?}, pllfracen: {=bool:?}, pllm: {:?}, pllmboost: {:?}, pllpen: {=bool:?}, pllqen: {=bool:?}, pllren: {=bool:?} }}" , self . pllsrc () , self . pllrge () , self . pllfracen () , self . pllm () , self . pllmboost () , self . pllpen () , self . pllqen () , self . pllren ()) } } # [doc = "RCC PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pll23cfgr { Pll23cfgr (0) } } impl core :: fmt :: Debug for Pll23cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pll23cfgr") . field ("pllsrc" , & self . pllsrc ()) . field ("pllrge" , & self . pllrge ()) . field ("pllfracen" , & self . pllfracen ()) . field ("pllm" , & self . pllm ()) . field ("pllpen" , & self . pllpen ()) . field ("pllqen" , & self . pllqen ()) . field ("pllren" , & self . pllren ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pll23cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pll23cfgr {{ pllsrc: {:?}, pllrge: {:?}, pllfracen: {=bool:?}, pllm: {:?}, pllpen: {=bool:?}, pllqen: {=bool:?}, pllren: {=bool:?} }}" , self . pllsrc () , self . pllrge () , self . pllfracen () , self . pllm () , self . pllpen () , self . pllqen () , self . pllren ()) } } # [doc = "RCC PLL1 dividers register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Privcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Privcfgr {{ spriv: {=bool:?}, nspriv: {=bool:?} }}" , self . spriv () , self . nspriv ()) } } # [doc = "RCC secure configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Seccfgr { Seccfgr (0) } } impl core :: fmt :: Debug for Seccfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Seccfgr") . field ("hsisec" , & self . hsisec ()) . field ("hsesec" , & self . hsesec ()) . field ("msisec" , & self . msisec ()) . field ("lsisec" , & self . lsisec ()) . field ("lsesec" , & self . lsesec ()) . field ("sysclksec" , & self . sysclksec ()) . field ("prescsec" , & self . prescsec ()) . field ("pllsec[0]" , & self . pllsec (0usize)) . field ("pllsec[1]" , & self . pllsec (1usize)) . field ("pllsec[2]" , & self . pllsec (2usize)) . field ("iclksec" , & self . iclksec ()) . field ("hsi48sec" , & self . hsi48sec ()) . field ("rmvfsec" , & self . rmvfsec ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Seccfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Seccfgr {{ hsisec: {:?}, hsesec: {:?}, msisec: {:?}, lsisec: {:?}, lsesec: {:?}, sysclksec: {:?}, prescsec: {:?}, pllsec[0]: {:?}, pllsec[1]: {:?}, pllsec[2]: {:?}, iclksec: {:?}, hsi48sec: {:?}, rmvfsec: {:?} }}" , self . hsisec () , self . hsesec () , self . msisec () , self . lsisec () , self . lsesec () , self . sysclksec () , self . prescsec () , self . pllsec (0usize) , self . pllsec (1usize) , self . pllsec (2usize) , self . iclksec () , self . hsi48sec () , self . rmvfsec ()) } } # [doc = "RCC SmartRun domain peripheral autonomous mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Srdamr { Srdamr (0) } } impl core :: fmt :: Debug for Srdamr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Srdamr") . field ("spi3amen" , & self . spi3amen ()) . field ("lpuart1amen" , & self . lpuart1amen ()) . field ("i2c3amen" , & self . i2c3amen ()) . field ("lptim1amen" , & self . lptim1amen ()) . field ("lptim3amen" , & self . lptim3amen ()) . field ("lptim4amen" , & self . lptim4amen ()) . field ("opampamen" , & self . opampamen ()) . field ("compamen" , & self . compamen ()) . field ("vrefamen" , & self . vrefamen ()) . field ("rtcapbamen" , & self . rtcapbamen ()) . field ("adc4amen" , & self . adc4amen ()) . field ("lpgpio1amen" , & self . lpgpio1amen ()) . field ("dac1amen" , & self . dac1amen ()) . field ("lpdma1amen" , & self . lpdma1amen ()) . field ("adf1amen" , & self . adf1amen ()) . field ("sram4amen" , & self . sram4amen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Srdamr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Srdamr {{ spi3amen: {=bool:?}, lpuart1amen: {=bool:?}, i2c3amen: {=bool:?}, lptim1amen: {=bool:?}, lptim3amen: {=bool:?}, lptim4amen: {=bool:?}, opampamen: {=bool:?}, compamen: {=bool:?}, vrefamen: {=bool:?}, rtcapbamen: {=bool:?}, adc4amen: {=bool:?}, lpgpio1amen: {=bool:?}, dac1amen: {=bool:?}, lpdma1amen: {=bool:?}, adf1amen: {=bool:?}, sram4amen: {=bool:?} }}" , self . spi3amen () , self . lpuart1amen () , self . i2c3amen () , self . lptim1amen () , self . lptim3amen () , self . lptim4amen () , self . opampamen () , self . compamen () , self . vrefamen () , self . rtcapbamen () , self . adc4amen () , self . lpgpio1amen () , self . dac1amen () , self . lpdma1amen () , self . adf1amen () , self . sram4amen ()) } } } pub mod vals { # [repr (u8)]
...
fn from (val : Pllmboost) -> u8 { Pllmboost :: to_bits (val) } } # [repr (u16)]
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]

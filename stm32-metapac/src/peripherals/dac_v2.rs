...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("en[0]" , & self . en (0usize)) . field ("en[1]" , & self . en (1usize)) . field ("boff[0]" , & self . boff (0usize)) . field ("boff[1]" , & self . boff (1usize)) . field ("ten[0]" , & self . ten (0usize)) . field ("ten[1]" , & self . ten (1usize)) . field ("tsel[0]" , & self . tsel (0usize)) . field ("tsel[1]" , & self . tsel (1usize)) . field ("wave[0]" , & self . wave (0usize)) . field ("wave[1]" , & self . wave (1usize)) . field ("mamp[0]" , & self . mamp (0usize)) . field ("mamp[1]" , & self . mamp (1usize)) . field ("dmaen[0]" , & self . dmaen (0usize)) . field ("dmaen[1]" , & self . dmaen (1usize)) . field ("dmaudrie[0]" , & self . dmaudrie (0usize)) . field ("dmaudrie[1]" , & self . dmaudrie (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ en[0]: {=bool:?}, en[1]: {=bool:?}, boff[0]: {=bool:?}, boff[1]: {=bool:?}, ten[0]: {=bool:?}, ten[1]: {=bool:?}, tsel[0]: {=u8:?}, tsel[1]: {=u8:?}, wave[0]: {:?}, wave[1]: {:?}, mamp[0]: {=u8:?}, mamp[1]: {=u8:?}, dmaen[0]: {=bool:?}, dmaen[1]: {=bool:?}, dmaudrie[0]: {=bool:?}, dmaudrie[1]: {=bool:?} }}" , self . en (0usize) , self . en (1usize) , self . boff (0usize) , self . boff (1usize) , self . ten (0usize) , self . ten (1usize) , self . tsel (0usize) , self . tsel (1usize) , self . wave (0usize) , self . wave (1usize) , self . mamp (0usize) , self . mamp (1usize) , self . dmaen (0usize) , self . dmaen (1usize) , self . dmaudrie (0usize) , self . dmaudrie (1usize)) } } # [doc = "channel 12-bit left-aligned data holding register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dor { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dor {{ dor: {=u16:?} }}" , self . dor ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("dmaudr[0]" , & self . dmaudr (0usize)) . field ("dmaudr[1]" , & self . dmaudr (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ dmaudr[0]: {=bool:?}, dmaudr[1]: {=bool:?} }}" , self . dmaudr (0usize) , self . dmaudr (1usize)) } } # [doc = "software trigger register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

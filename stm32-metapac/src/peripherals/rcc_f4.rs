...
fn default () -> Ahb1enr { Ahb1enr (0) } } impl core :: fmt :: Debug for Ahb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1enr") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpioden" , & self . gpioden ()) . field ("gpioeen" , & self . gpioeen ()) . field ("gpiofen" , & self . gpiofen ()) . field ("gpiogen" , & self . gpiogen ()) . field ("gpiohen" , & self . gpiohen ()) . field ("gpioien" , & self . gpioien ()) . field ("gpiojen" , & self . gpiojen ()) . field ("gpioken" , & self . gpioken ()) . field ("crcen" , & self . crcen ()) . field ("bkpsramen" , & self . bkpsramen ()) . field ("ccmdataramen" , & self . ccmdataramen ()) . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("dma2den" , & self . dma2den ()) . field ("ethen" , & self . ethen ()) . field ("ethtxen" , & self . ethtxen ()) . field ("ethrxen" , & self . ethrxen ()) . field ("ethptpen" , & self . ethptpen ()) . field ("usb_otg_hsen" , & self . usb_otg_hsen ()) . field ("usb_otg_hsulpien" , & self . usb_otg_hsulpien ()) . finish () } } # [cfg (feature = "defmt")]
...
fn default () -> Ahb2lpenr { Ahb2lpenr (0) } } impl core :: fmt :: Debug for Ahb2lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2lpenr") . field ("dcmilpen" , & self . dcmilpen ()) . field ("fsmclpen" , & self . fsmclpen ()) . field ("quadspilpen" , & self . quadspilpen ()) . field ("cryplpen" , & self . cryplpen ()) . field ("hashlpen" , & self . hashlpen ()) . field ("rnglpen" , & self . rnglpen ()) . field ("usb_otg_fslpen" , & self . usb_otg_fslpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2lpenr {{ dcmilpen: {=bool:?}, fsmclpen: {=bool:?}, quadspilpen: {=bool:?}, cryplpen: {=bool:?}, hashlpen: {=bool:?}, rnglpen: {=bool:?}, usb_otg_fslpen: {=bool:?} }}" , self . dcmilpen () , self . fsmclpen () , self . quadspilpen () , self . cryplpen () , self . hashlpen () , self . rnglpen () , self . usb_otg_fslpen ()) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3enr { Ahb3enr (0) } } impl core :: fmt :: Debug for Ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3enr") . field ("fmcen" , & self . fmcen ()) . field ("fsmcen" , & self . fsmcen ()) . field ("quadspien" , & self . quadspien ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3enr {{ fmcen: {=bool:?}, fsmcen: {=bool:?}, quadspien: {=bool:?} }}" , self . fmcen () , self . fsmcen () , self . quadspien ()) } } # [doc = "AHB3 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3lpenr { Ahb3lpenr (0) } } impl core :: fmt :: Debug for Ahb3lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3lpenr") . field ("fmclpen" , & self . fmclpen ()) . field ("fsmclpen" , & self . fsmclpen ()) . field ("quadspilpen" , & self . quadspilpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3lpenr {{ fmclpen: {=bool:?}, fsmclpen: {=bool:?}, quadspilpen: {=bool:?} }}" , self . fmclpen () , self . fsmclpen () , self . quadspilpen ()) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3rstr { Ahb3rstr (0) } } impl core :: fmt :: Debug for Ahb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3rstr") . field ("fmcrst" , & self . fmcrst ()) . field ("fsmcrst" , & self . fsmcrst ()) . field ("quadspirst" , & self . quadspirst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3rstr {{ fmcrst: {=bool:?}, fsmcrst: {=bool:?}, quadspirst: {=bool:?} }}" , self . fmcrst () , self . fsmcrst () , self . quadspirst ()) } } # [doc = "APB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr { Apb1enr (0) } } impl core :: fmt :: Debug for Apb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr") . field ("tim2en" , & self . tim2en ()) . field ("tim3en" , & self . tim3en ()) . field ("tim4en" , & self . tim4en ()) . field ("tim5en" , & self . tim5en ()) . field ("tim6en" , & self . tim6en ()) . field ("tim7en" , & self . tim7en ()) . field ("tim12en" , & self . tim12en ()) . field ("tim13en" , & self . tim13en ()) . field ("tim14en" , & self . tim14en ()) . field ("lptim1en" , & self . lptim1en ()) . field ("rtcapben" , & self . rtcapben ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("spi3en" , & self . spi3en ()) . field ("spdifrxen" , & self . spdifrxen ()) . field ("usart2en" , & self . usart2en ()) . field ("usart3en" , & self . usart3en ()) . field ("uart4en" , & self . uart4en ()) . field ("uart5en" , & self . uart5en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("i2c3en" , & self . i2c3en ()) . field ("fmpi2c1en" , & self . fmpi2c1en ()) . field ("can1en" , & self . can1en ()) . field ("can2en" , & self . can2en ()) . field ("can3en" , & self . can3en ()) . field ("cecen" , & self . cecen ()) . field ("pwren" , & self . pwren ()) . field ("dacen" , & self . dacen ()) . field ("uart7en" , & self . uart7en ()) . field ("uart8en" , & self . uart8en ()) . finish () } } # [cfg (feature = "defmt")]
...
fn default () -> Apb1lpenr { Apb1lpenr (0) } } impl core :: fmt :: Debug for Apb1lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1lpenr") . field ("tim2lpen" , & self . tim2lpen ()) . field ("tim3lpen" , & self . tim3lpen ()) . field ("tim4lpen" , & self . tim4lpen ()) . field ("tim5lpen" , & self . tim5lpen ()) . field ("tim6lpen" , & self . tim6lpen ()) . field ("tim7lpen" , & self . tim7lpen ()) . field ("tim12lpen" , & self . tim12lpen ()) . field ("tim13lpen" , & self . tim13lpen ()) . field ("tim14lpen" , & self . tim14lpen ()) . field ("lptim1lpen" , & self . lptim1lpen ()) . field ("rtcapblpen" , & self . rtcapblpen ()) . field ("wwdglpen" , & self . wwdglpen ()) . field ("spi2lpen" , & self . spi2lpen ()) . field ("spi3lpen" , & self . spi3lpen ()) . field ("spdiflpen" , & self . spdiflpen ()) . field ("usart2lpen" , & self . usart2lpen ()) . field ("usart3lpen" , & self . usart3lpen ()) . field ("uart4lpen" , & self . uart4lpen ()) . field ("uart5lpen" , & self . uart5lpen ()) . field ("i2c1lpen" , & self . i2c1lpen ()) . field ("i2c2lpen" , & self . i2c2lpen ()) . field ("i2c3lpen" , & self . i2c3lpen ()) . field ("fmpi2c1lpen" , & self . fmpi2c1lpen ()) . field ("can1lpen" , & self . can1lpen ()) . field ("can2lpen" , & self . can2lpen ()) . field ("can3lpen" , & self . can3lpen ()) . field ("ceclpen" , & self . ceclpen ()) . field ("pwrlpen" , & self . pwrlpen ()) . field ("daclpen" , & self . daclpen ()) . field ("uart7lpen" , & self . uart7lpen ()) . field ("uart8lpen" , & self . uart8lpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1lpenr {{ tim2lpen: {=bool:?}, tim3lpen: {=bool:?}, tim4lpen: {=bool:?}, tim5lpen: {=bool:?}, tim6lpen: {=bool:?}, tim7lpen: {=bool:?}, tim12lpen: {=bool:?}, tim13lpen: {=bool:?}, tim14lpen: {=bool:?}, lptim1lpen: {=bool:?}, rtcapblpen: {=bool:?}, wwdglpen: {=bool:?}, spi2lpen: {=bool:?}, spi3lpen: {=bool:?}, spdiflpen: {=bool:?}, usart2lpen: {=bool:?}, usart3lpen: {=bool:?}, uart4lpen: {=bool:?}, uart5lpen: {=bool:?}, i2c1lpen: {=bool:?}, i2c2lpen: {=bool:?}, i2c3lpen: {=bool:?}, fmpi2c1lpen: {=bool:?}, can1lpen: {=bool:?}, can2lpen: {=bool:?}, can3lpen: {=bool:?}, ceclpen: {=bool:?}, pwrlpen: {=bool:?}, daclpen: {=bool:?}, uart7lpen: {=bool:?}, uart8lpen: {=bool:?} }}" , self . tim2lpen () , self . tim3lpen () , self . tim4lpen () , self . tim5lpen () , self . tim6lpen () , self . tim7lpen () , self . tim12lpen () , self . tim13lpen () , self . tim14lpen () , self . lptim1lpen () , self . rtcapblpen () , self . wwdglpen () , self . spi2lpen () , self . spi3lpen () , self . spdiflpen () , self . usart2lpen () , self . usart3lpen () , self . uart4lpen () , self . uart5lpen () , self . i2c1lpen () , self . i2c2lpen () , self . i2c3lpen () , self . fmpi2c1lpen () , self . can1lpen () , self . can2lpen () , self . can3lpen () , self . ceclpen () , self . pwrlpen () , self . daclpen () , self . uart7lpen () , self . uart8lpen ()) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr { Apb1rstr (0) } } impl core :: fmt :: Debug for Apb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr") . field ("tim2rst" , & self . tim2rst ()) . field ("tim3rst" , & self . tim3rst ()) . field ("tim4rst" , & self . tim4rst ()) . field ("tim5rst" , & self . tim5rst ()) . field ("tim6rst" , & self . tim6rst ()) . field ("tim7rst" , & self . tim7rst ()) . field ("tim12rst" , & self . tim12rst ()) . field ("tim13rst" , & self . tim13rst ()) . field ("tim14rst" , & self . tim14rst ()) . field ("lptim1rst" , & self . lptim1rst ()) . field ("wwdgrst" , & self . wwdgrst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("spi3rst" , & self . spi3rst ()) . field ("spdifrxrst" , & self . spdifrxrst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("usart3rst" , & self . usart3rst ()) . field ("uart4rst" , & self . uart4rst ()) . field ("uart5rst" , & self . uart5rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("i2c3rst" , & self . i2c3rst ()) . field ("fmpi2c1rst" , & self . fmpi2c1rst ()) . field ("can1rst" , & self . can1rst ()) . field ("can2rst" , & self . can2rst ()) . field ("can3rst" , & self . can3rst ()) . field ("pwrrst" , & self . pwrrst ()) . field ("dacrst" , & self . dacrst ()) . field ("uart7rst" , & self . uart7rst ()) . field ("uart8rst" , & self . uart8rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim4rst: {=bool:?}, tim5rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, tim12rst: {=bool:?}, tim13rst: {=bool:?}, tim14rst: {=bool:?}, lptim1rst: {=bool:?}, wwdgrst: {=bool:?}, spi2rst: {=bool:?}, spi3rst: {=bool:?}, spdifrxrst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, uart4rst: {=bool:?}, uart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, i2c3rst: {=bool:?}, fmpi2c1rst: {=bool:?}, can1rst: {=bool:?}, can2rst: {=bool:?}, can3rst: {=bool:?}, pwrrst: {=bool:?}, dacrst: {=bool:?}, uart7rst: {=bool:?}, uart8rst: {=bool:?} }}" , self . tim2rst () , self . tim3rst () , self . tim4rst () , self . tim5rst () , self . tim6rst () , self . tim7rst () , self . tim12rst () , self . tim13rst () , self . tim14rst () , self . lptim1rst () , self . wwdgrst () , self . spi2rst () , self . spi3rst () , self . spdifrxrst () , self . usart2rst () , self . usart3rst () , self . uart4rst () , self . uart5rst () , self . i2c1rst () , self . i2c2rst () , self . i2c3rst () , self . fmpi2c1rst () , self . can1rst () , self . can2rst () , self . can3rst () , self . pwrrst () , self . dacrst () , self . uart7rst () , self . uart8rst ()) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2lpenr { Apb2lpenr (0) } } impl core :: fmt :: Debug for Apb2lpenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2lpenr") . field ("tim1lpen" , & self . tim1lpen ()) . field ("tim8lpen" , & self . tim8lpen ()) . field ("usart1lpen" , & self . usart1lpen ()) . field ("usart6lpen" , & self . usart6lpen ()) . field ("uart9lpen" , & self . uart9lpen ()) . field ("uart10lpen" , & self . uart10lpen ()) . field ("adc1lpen" , & self . adc1lpen ()) . field ("adc2lpen" , & self . adc2lpen ()) . field ("adc3lpen" , & self . adc3lpen ()) . field ("sdiolpen" , & self . sdiolpen ()) . field ("spi1lpen" , & self . spi1lpen ()) . field ("spi4lpen" , & self . spi4lpen ()) . field ("syscfglpen" , & self . syscfglpen ()) . field ("extitlpen" , & self . extitlpen ()) . field ("tim9lpen" , & self . tim9lpen ()) . field ("tim10lpen" , & self . tim10lpen ()) . field ("tim11lpen" , & self . tim11lpen ()) . field ("spi5lpen" , & self . spi5lpen ()) . field ("spi6lpen" , & self . spi6lpen ()) . field ("sai1lpen" , & self . sai1lpen ()) . field ("sai2lpen" , & self . sai2lpen ()) . field ("dfsdmlpen" , & self . dfsdmlpen ()) . field ("dfsdm2lpen" , & self . dfsdm2lpen ()) . field ("ltdclpen" , & self . ltdclpen ()) . field ("dsilpen" , & self . dsilpen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2lpenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2lpenr {{ tim1lpen: {=bool:?}, tim8lpen: {=bool:?}, usart1lpen: {=bool:?}, usart6lpen: {=bool:?}, uart9lpen: {=bool:?}, uart10lpen: {=bool:?}, adc1lpen: {=bool:?}, adc2lpen: {=bool:?}, adc3lpen: {=bool:?}, sdiolpen: {=bool:?}, spi1lpen: {=bool:?}, spi4lpen: {=bool:?}, syscfglpen: {=bool:?}, extitlpen: {=bool:?}, tim9lpen: {=bool:?}, tim10lpen: {=bool:?}, tim11lpen: {=bool:?}, spi5lpen: {=bool:?}, spi6lpen: {=bool:?}, sai1lpen: {=bool:?}, sai2lpen: {=bool:?}, dfsdmlpen: {=bool:?}, dfsdm2lpen: {=bool:?}, ltdclpen: {=bool:?}, dsilpen: {=bool:?} }}" , self . tim1lpen () , self . tim8lpen () , self . usart1lpen () , self . usart6lpen () , self . uart9lpen () , self . uart10lpen () , self . adc1lpen () , self . adc2lpen () , self . adc3lpen () , self . sdiolpen () , self . spi1lpen () , self . spi4lpen () , self . syscfglpen () , self . extitlpen () , self . tim9lpen () , self . tim10lpen () , self . tim11lpen () , self . spi5lpen () , self . spi6lpen () , self . sai1lpen () , self . sai2lpen () , self . dfsdmlpen () , self . dfsdm2lpen () , self . ltdclpen () , self . dsilpen ()) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("tim1rst" , & self . tim1rst ()) . field ("tim8rst" , & self . tim8rst ()) . field ("usart1rst" , & self . usart1rst ()) . field ("usart6rst" , & self . usart6rst ()) . field ("uart9rst" , & self . uart9rst ()) . field ("uart10rst" , & self . uart10rst ()) . field ("adcrst" , & self . adcrst ()) . field ("sdiorst" , & self . sdiorst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("spi4rst" , & self . spi4rst ()) . field ("syscfgrst" , & self . syscfgrst ()) . field ("tim9rst" , & self . tim9rst ()) . field ("tim10rst" , & self . tim10rst ()) . field ("tim11rst" , & self . tim11rst ()) . field ("spi5rst" , & self . spi5rst ()) . field ("spi6rst" , & self . spi6rst ()) . field ("sai1rst" , & self . sai1rst ()) . field ("sai2rst" , & self . sai2rst ()) . field ("dfsdmrst" , & self . dfsdmrst ()) . field ("dfsdm2rst" , & self . dfsdm2rst ()) . field ("ltdcrst" , & self . ltdcrst ()) . field ("dsirst" , & self . dsirst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ tim1rst: {=bool:?}, tim8rst: {=bool:?}, usart1rst: {=bool:?}, usart6rst: {=bool:?}, uart9rst: {=bool:?}, uart10rst: {=bool:?}, adcrst: {=bool:?}, sdiorst: {=bool:?}, spi1rst: {=bool:?}, spi4rst: {=bool:?}, syscfgrst: {=bool:?}, tim9rst: {=bool:?}, tim10rst: {=bool:?}, tim11rst: {=bool:?}, spi5rst: {=bool:?}, spi6rst: {=bool:?}, sai1rst: {=bool:?}, sai2rst: {=bool:?}, dfsdmrst: {=bool:?}, dfsdm2rst: {=bool:?}, ltdcrst: {=bool:?}, dsirst: {=bool:?} }}" , self . tim1rst () , self . tim8rst () , self . usart1rst () , self . usart6rst () , self . uart9rst () , self . uart10rst () , self . adcrst () , self . sdiorst () , self . spi1rst () , self . spi4rst () , self . syscfgrst () , self . tim9rst () , self . tim10rst () , self . tim11rst () , self . spi5rst () , self . spi6rst () , self . sai1rst () , self . sai2rst () , self . dfsdmrst () , self . dfsdm2rst () , self . ltdcrst () , self . dsirst ()) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bdcr { Bdcr (0) } } impl core :: fmt :: Debug for Bdcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bdcr") . field ("lseon" , & self . lseon ()) . field ("lserdy" , & self . lserdy ()) . field ("lsebyp" , & self . lsebyp ()) . field ("lsemod" , & self . lsemod ()) . field ("rtcsel" , & self . rtcsel ()) . field ("rtcen" , & self . rtcen ()) . field ("bdrst" , & self . bdrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bdcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bdcr {{ lseon: {=bool:?}, lserdy: {=bool:?}, lsebyp: {=bool:?}, lsemod: {:?}, rtcsel: {:?}, rtcen: {=bool:?}, bdrst: {=bool:?} }}" , self . lseon () , self . lserdy () , self . lsebyp () , self . lsemod () , self . rtcsel () , self . rtcen () , self . bdrst ()) } } # [doc = "clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr { Cfgr (0) } } impl core :: fmt :: Debug for Cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr") . field ("sw" , & self . sw ()) . field ("sws" , & self . sws ()) . field ("hpre" , & self . hpre ()) . field ("mco1en" , & self . mco1en ()) . field ("mco2en" , & self . mco2en ()) . field ("ppre1" , & self . ppre1 ()) . field ("ppre2" , & self . ppre2 ()) . field ("rtcpre" , & self . rtcpre ()) . field ("mco1sel" , & self . mco1sel ()) . field ("i2ssrc" , & self . i2ssrc ()) . field ("mco1pre" , & self . mco1pre ()) . field ("mco2pre" , & self . mco2pre ()) . field ("mco2sel" , & self . mco2sel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr {{ sw: {:?}, sws: {:?}, hpre: {:?}, mco1en: {=bool:?}, mco2en: {=bool:?}, ppre1: {:?}, ppre2: {:?}, rtcpre: {=u8:?}, mco1sel: {:?}, i2ssrc: {:?}, mco1pre: {:?}, mco2pre: {:?}, mco2sel: {:?} }}" , self . sw () , self . sws () , self . hpre () , self . mco1en () , self . mco2en () , self . ppre1 () , self . ppre2 () , self . rtcpre () , self . mco1sel () , self . i2ssrc () , self . mco1pre () , self . mco2pre () , self . mco2sel ()) } } # [doc = "clock interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ckgatenr { Ckgatenr (0) } } impl core :: fmt :: Debug for Ckgatenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ckgatenr") . field ("ahb2apb1_cken" , & self . ahb2apb1_cken ()) . field ("ahb2apb2_cken" , & self . ahb2apb2_cken ()) . field ("cm4dbg_cken" , & self . cm4dbg_cken ()) . field ("spare_cken" , & self . spare_cken ()) . field ("sram_cken" , & self . sram_cken ()) . field ("flash_cken" , & self . flash_cken ()) . field ("rcc_cken" , & self . rcc_cken ()) . field ("evtcl_cken" , & self . evtcl_cken ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ckgatenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ckgatenr {{ ahb2apb1_cken: {=bool:?}, ahb2apb2_cken: {=bool:?}, cm4dbg_cken: {=bool:?}, spare_cken: {=bool:?}, sram_cken: {=bool:?}, flash_cken: {=bool:?}, rcc_cken: {=bool:?}, evtcl_cken: {=bool:?} }}" , self . ahb2apb1_cken () , self . ahb2apb2_cken () , self . cm4dbg_cken () , self . spare_cken () , self . sram_cken () , self . flash_cken () , self . rcc_cken () , self . evtcl_cken ()) } } # [doc = "clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dckcfgr { Dckcfgr (0) } } impl core :: fmt :: Debug for Dckcfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dckcfgr") . field ("plli2sdivq" , & self . plli2sdivq ()) . field ("plli2sdivr" , & self . plli2sdivr ()) . field ("plldivr" , & self . plldivr ()) . field ("pllsaidivq" , & self . pllsaidivq ()) . field ("ckdfsdm2asel" , & self . ckdfsdm2asel ()) . field ("ckdfsdm1asel" , & self . ckdfsdm1asel ()) . field ("pllsaidivr" , & self . pllsaidivr ()) . field ("sai1asrc" , & self . sai1asrc ()) . field ("sai1src" , & self . sai1src ()) . field ("sai1bsrc" , & self . sai1bsrc ()) . field ("sai2src" , & self . sai2src ()) . field ("timpre" , & self . timpre ()) . field ("i2s1src" , & self . i2s1src ()) . field ("i2ssrc" , & self . i2ssrc ()) . field ("clk48sel" , & self . clk48sel ()) . field ("i2s2src" , & self . i2s2src ()) . field ("sdiosel" , & self . sdiosel ()) . field ("dsisel" , & self . dsisel ()) . field ("ckdfsdm1sel" , & self . ckdfsdm1sel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dckcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dckcfgr {{ plli2sdivq: {:?}, plli2sdivr: {:?}, plldivr: {:?}, pllsaidivq: {:?}, ckdfsdm2asel: {:?}, ckdfsdm1asel: {:?}, pllsaidivr: {:?}, sai1asrc: {:?}, sai1src: {:?}, sai1bsrc: {:?}, sai2src: {:?}, timpre: {:?}, i2s1src: {:?}, i2ssrc: {:?}, clk48sel: {:?}, i2s2src: {:?}, sdiosel: {:?}, dsisel: {:?}, ckdfsdm1sel: {:?} }}" , self . plli2sdivq () , self . plli2sdivr () , self . plldivr () , self . pllsaidivq () , self . ckdfsdm2asel () , self . ckdfsdm1asel () , self . pllsaidivr () , self . sai1asrc () , self . sai1src () , self . sai1bsrc () , self . sai2src () , self . timpre () , self . i2s1src () , self . i2ssrc () , self . clk48sel () , self . i2s2src () , self . sdiosel () , self . dsisel () , self . ckdfsdm1sel ()) } } # [doc = "dedicated clocks configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dckcfgr2 { Dckcfgr2 (0) } } impl core :: fmt :: Debug for Dckcfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dckcfgr2") . field ("fmpi2c1sel" , & self . fmpi2c1sel ()) . field ("cecsel" , & self . cecsel ()) . field ("clk48sel" , & self . clk48sel ()) . field ("sdiosel" , & self . sdiosel ()) . field ("spdifrxsel" , & self . spdifrxsel ()) . field ("lptim1sel" , & self . lptim1sel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dckcfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dckcfgr2 {{ fmpi2c1sel: {:?}, cecsel: {:?}, clk48sel: {:?}, sdiosel: {:?}, spdifrxsel: {:?}, lptim1sel: {:?} }}" , self . fmpi2c1sel () , self . cecsel () , self . clk48sel () , self . sdiosel () , self . spdifrxsel () , self . lptim1sel ()) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pllcfgr { Pllcfgr (0) } } impl core :: fmt :: Debug for Pllcfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pllcfgr") . field ("pllm" , & self . pllm ()) . field ("plln" , & self . plln ()) . field ("pllp" , & self . pllp ()) . field ("pllsrc" , & self . pllsrc ()) . field ("pllq" , & self . pllq ()) . field ("pllr" , & self . pllr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pllcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pllcfgr {{ pllm: {:?}, plln: {:?}, pllp: {:?}, pllsrc: {:?}, pllq: {:?}, pllr: {:?} }}" , self . pllm () , self . plln () , self . pllp () , self . pllsrc () , self . pllq () , self . pllr ()) } } # [doc = "PLLI2S configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Plli2scfgr { Plli2scfgr (0) } } impl core :: fmt :: Debug for Plli2scfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Plli2scfgr") . field ("pllm" , & self . pllm ()) . field ("plln" , & self . plln ()) . field ("pllp" , & self . pllp ()) . field ("plli2ssrc" , & self . plli2ssrc ()) . field ("pllsrc" , & self . pllsrc ()) . field ("pllq" , & self . pllq ()) . field ("pllr" , & self . pllr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Plli2scfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Plli2scfgr {{ pllm: {:?}, plln: {:?}, pllp: {:?}, plli2ssrc: {:?}, pllsrc: {:?}, pllq: {:?}, pllr: {:?} }}" , self . pllm () , self . plln () , self . pllp () , self . plli2ssrc () , self . pllsrc () , self . pllq () , self . pllr ()) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pllsaicfgr { Pllsaicfgr (0) } } impl core :: fmt :: Debug for Pllsaicfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pllsaicfgr") . field ("pllm" , & self . pllm ()) . field ("plln" , & self . plln ()) . field ("pllp" , & self . pllp ()) . field ("pllsrc" , & self . pllsrc ()) . field ("pllq" , & self . pllq ()) . field ("pllr" , & self . pllr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pllsaicfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pllsaicfgr {{ pllm: {:?}, plln: {:?}, pllp: {:?}, pllsrc: {:?}, pllq: {:?}, pllr: {:?} }}" , self . pllm () , self . plln () , self . pllp () , self . pllsrc () , self . pllq () , self . pllr ()) } } # [doc = "spread spectrum clock generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
HSI_DIV_488 = 0x01 , } impl Cecsel { # [inline (always)]

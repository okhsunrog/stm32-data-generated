...
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]
pub enum Vrs { # [doc = "Voltage reference set to around 2.5 V."]
VREF0 = 0x0 , # [doc = "Voltage reference set to around 2.048 V."]
VREF1 = 0x01 , # [doc = "Voltage reference set to around 1.8 V."]
VREF2 = 0x02 , # [doc = "Voltage reference set to around 1.5 V (ADC, DAC are not compatible with this setting)."]

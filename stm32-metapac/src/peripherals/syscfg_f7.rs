...
fn default () -> Cmpcr { Cmpcr (0) } } impl core :: fmt :: Debug for Cmpcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cmpcr") . field ("cmp_pd" , & self . cmp_pd ()) . field ("ready" , & self . ready ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cmpcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cmpcr {{ cmp_pd: {=bool:?}, ready: {=bool:?} }}" , self . cmp_pd () , self . ready ()) } } # [doc = "external interrupt configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Memrmp { Memrmp (0) } } impl core :: fmt :: Debug for Memrmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Memrmp") . field ("mem_boot" , & self . mem_boot ()) . field ("fb_mode" , & self . fb_mode ()) . field ("swp_fmc" , & self . swp_fmc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Memrmp { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Memrmp {{ mem_boot: {=bool:?}, fb_mode: {=bool:?}, swp_fmc: {=u8:?} }}" , self . mem_boot () , self . fb_mode () , self . swp_fmc ()) } } # [doc = "peripheral mode configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pmc { Pmc (0) } } impl core :: fmt :: Debug for Pmc { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pmc") . field ("i2c1_fmp" , & self . i2c1_fmp ()) . field ("i2c2_fmp" , & self . i2c2_fmp ()) . field ("i2c3_fmp" , & self . i2c3_fmp ()) . field ("i2c4_fmp" , & self . i2c4_fmp ()) . field ("pb6_fmp" , & self . pb6_fmp ()) . field ("pb7_fmp" , & self . pb7_fmp ()) . field ("pb8_fmp" , & self . pb8_fmp ()) . field ("pb9_fmp" , & self . pb9_fmp ()) . field ("adc1dc2" , & self . adc1dc2 ()) . field ("adc2dc2" , & self . adc2dc2 ()) . field ("adc3dc2" , & self . adc3dc2 ()) . field ("mii_rmii_sel" , & self . mii_rmii_sel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pmc { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pmc {{ i2c1_fmp: {=bool:?}, i2c2_fmp: {=bool:?}, i2c3_fmp: {=bool:?}, i2c4_fmp: {=bool:?}, pb6_fmp: {=bool:?}, pb7_fmp: {=bool:?}, pb8_fmp: {=bool:?}, pb9_fmp: {=bool:?}, adc1dc2: {=bool:?}, adc2dc2: {=bool:?}, adc3dc2: {=bool:?}, mii_rmii_sel: {=bool:?} }}" , self . i2c1_fmp () , self . i2c2_fmp () , self . i2c3_fmp () , self . i2c4_fmp () , self . pb6_fmp () , self . pb7_fmp () , self . pb8_fmp () , self . pb9_fmp () , self . adc1dc2 () , self . adc2dc2 () , self . adc3dc2 () , self . mii_rmii_sel ()) } } }
...
fn default () -> Ahb1enr { Ahb1enr (0) } } impl core :: fmt :: Debug for Ahb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1enr") . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("dmamux1en" , & self . dmamux1en ()) . field ("crcen" , & self . crcen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1enr {{ dma1en: {=bool:?}, dma2en: {=bool:?}, dmamux1en: {=bool:?}, crcen: {=bool:?} }}" , self . dma1en () , self . dma2en () , self . dmamux1en () , self . crcen ()) } } # [doc = "AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb1rstr { Ahb1rstr (0) } } impl core :: fmt :: Debug for Ahb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1rstr") . field ("dma1rst" , & self . dma1rst ()) . field ("dma2rst" , & self . dma2rst ()) . field ("dmamux1rst" , & self . dmamux1rst ()) . field ("crcrst" , & self . crcrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1rstr {{ dma1rst: {=bool:?}, dma2rst: {=bool:?}, dmamux1rst: {=bool:?}, crcrst: {=bool:?} }}" , self . dma1rst () , self . dma2rst () , self . dmamux1rst () , self . crcrst ()) } } # [doc = "AHB1 peripheral clocks enable in Sleep modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb1smenr { Ahb1smenr (0) } } impl core :: fmt :: Debug for Ahb1smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb1smenr") . field ("dma1smen" , & self . dma1smen ()) . field ("dma2smen" , & self . dma2smen ()) . field ("dmamux1smen" , & self . dmamux1smen ()) . field ("crcsmen" , & self . crcsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb1smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb1smenr {{ dma1smen: {=bool:?}, dma2smen: {=bool:?}, dmamux1smen: {=bool:?}, crcsmen: {=bool:?} }}" , self . dma1smen () , self . dma2smen () , self . dmamux1smen () , self . crcsmen ()) } } # [doc = "AHB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2enr { Ahb2enr (0) } } impl core :: fmt :: Debug for Ahb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2enr") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpiohen" , & self . gpiohen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2enr {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpiohen: {=bool:?} }}" , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpiohen ()) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2rstr { Ahb2rstr (0) } } impl core :: fmt :: Debug for Ahb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2rstr") . field ("gpioarst" , & self . gpioarst ()) . field ("gpiobrst" , & self . gpiobrst ()) . field ("gpiocrst" , & self . gpiocrst ()) . field ("gpiohrst" , & self . gpiohrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2rstr {{ gpioarst: {=bool:?}, gpiobrst: {=bool:?}, gpiocrst: {=bool:?}, gpiohrst: {=bool:?} }}" , self . gpioarst () , self . gpiobrst () , self . gpiocrst () , self . gpiohrst ()) } } # [doc = "AHB2 peripheral clocks enable in Sleep modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb2smenr { Ahb2smenr (0) } } impl core :: fmt :: Debug for Ahb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb2smenr") . field ("gpioasmen" , & self . gpioasmen ()) . field ("gpiobsmen" , & self . gpiobsmen ()) . field ("gpiocsmen" , & self . gpiocsmen ()) . field ("gpiohsmen" , & self . gpiohsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb2smenr {{ gpioasmen: {=bool:?}, gpiobsmen: {=bool:?}, gpiocsmen: {=bool:?}, gpiohsmen: {=bool:?} }}" , self . gpioasmen () , self . gpiobsmen () , self . gpiocsmen () , self . gpiohsmen ()) } } # [doc = "AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3enr { Ahb3enr (0) } } impl core :: fmt :: Debug for Ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3enr") . field ("pkaen" , & self . pkaen ()) . field ("aesen" , & self . aesen ()) . field ("rngen" , & self . rngen ()) . field ("hsemen" , & self . hsemen ()) . field ("ipccen" , & self . ipccen ()) . field ("flashen" , & self . flashen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3enr {{ pkaen: {=bool:?}, aesen: {=bool:?}, rngen: {=bool:?}, hsemen: {=bool:?}, ipccen: {=bool:?}, flashen: {=bool:?} }}" , self . pkaen () , self . aesen () , self . rngen () , self . hsemen () , self . ipccen () , self . flashen ()) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3rstr { Ahb3rstr (0) } } impl core :: fmt :: Debug for Ahb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3rstr") . field ("pkarst" , & self . pkarst ()) . field ("aesrst" , & self . aesrst ()) . field ("rngrst" , & self . rngrst ()) . field ("hsemrst" , & self . hsemrst ()) . field ("ipccrst" , & self . ipccrst ()) . field ("flashrst" , & self . flashrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3rstr {{ pkarst: {=bool:?}, aesrst: {=bool:?}, rngrst: {=bool:?}, hsemrst: {=bool:?}, ipccrst: {=bool:?}, flashrst: {=bool:?} }}" , self . pkarst () , self . aesrst () , self . rngrst () , self . hsemrst () , self . ipccrst () , self . flashrst ()) } } # [doc = "AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahb3smenr { Ahb3smenr (0) } } impl core :: fmt :: Debug for Ahb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahb3smenr") . field ("pkasmen" , & self . pkasmen ()) . field ("aessmen" , & self . aessmen ()) . field ("rngsmen" , & self . rngsmen ()) . field ("sram1smen" , & self . sram1smen ()) . field ("sram2smen" , & self . sram2smen ()) . field ("flashsmen" , & self . flashsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahb3smenr {{ pkasmen: {=bool:?}, aessmen: {=bool:?}, rngsmen: {=bool:?}, sram1smen: {=bool:?}, sram2smen: {=bool:?}, flashsmen: {=bool:?} }}" , self . pkasmen () , self . aessmen () , self . rngsmen () , self . sram1smen () , self . sram2smen () , self . flashsmen ()) } } # [doc = "APB1 peripheral clock enable register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr1 { Apb1enr1 (0) } } impl core :: fmt :: Debug for Apb1enr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr1") . field ("tim2en" , & self . tim2en ()) . field ("rtcapben" , & self . rtcapben ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("usart2en" , & self . usart2en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("i2c3en" , & self . i2c3en ()) . field ("dacen" , & self . dacen ()) . field ("lptim1en" , & self . lptim1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr1 {{ tim2en: {=bool:?}, rtcapben: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, usart2en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, i2c3en: {=bool:?}, dacen: {=bool:?}, lptim1en: {=bool:?} }}" , self . tim2en () , self . rtcapben () , self . wwdgen () , self . spi2en () , self . usart2en () , self . i2c1en () , self . i2c2en () , self . i2c3en () , self . dacen () , self . lptim1en ()) } } # [doc = "APB1 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr2 { Apb1enr2 (0) } } impl core :: fmt :: Debug for Apb1enr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr2") . field ("lpuart1en" , & self . lpuart1en ()) . field ("lptim2en" , & self . lptim2en ()) . field ("lptim3en" , & self . lptim3en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr2 {{ lpuart1en: {=bool:?}, lptim2en: {=bool:?}, lptim3en: {=bool:?} }}" , self . lpuart1en () , self . lptim2en () , self . lptim3en ()) } } # [doc = "APB1 peripheral reset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr1 { Apb1rstr1 (0) } } impl core :: fmt :: Debug for Apb1rstr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr1") . field ("tim2rst" , & self . tim2rst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("i2c3rst" , & self . i2c3rst ()) . field ("dacrst" , & self . dacrst ()) . field ("lptim1rst" , & self . lptim1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr1 {{ tim2rst: {=bool:?}, spi2rst: {=bool:?}, usart2rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, i2c3rst: {=bool:?}, dacrst: {=bool:?}, lptim1rst: {=bool:?} }}" , self . tim2rst () , self . spi2rst () , self . usart2rst () , self . i2c1rst () , self . i2c2rst () , self . i2c3rst () , self . dacrst () , self . lptim1rst ()) } } # [doc = "APB1 peripheral reset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr2 { Apb1rstr2 (0) } } impl core :: fmt :: Debug for Apb1rstr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr2") . field ("lpuart1rst" , & self . lpuart1rst ()) . field ("lptim2rst" , & self . lptim2rst ()) . field ("lptim3rst" , & self . lptim3rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr2 {{ lpuart1rst: {=bool:?}, lptim2rst: {=bool:?}, lptim3rst: {=bool:?} }}" , self . lpuart1rst () , self . lptim2rst () , self . lptim3rst ()) } } # [doc = "APB1 peripheral clocks enable in Sleep mode register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1smenr1 { Apb1smenr1 (0) } } impl core :: fmt :: Debug for Apb1smenr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1smenr1") . field ("tim2smen" , & self . tim2smen ()) . field ("rtcapbsmen" , & self . rtcapbsmen ()) . field ("wwdgsmen" , & self . wwdgsmen ()) . field ("spi2smen" , & self . spi2smen ()) . field ("usart2smen" , & self . usart2smen ()) . field ("i2c1smen" , & self . i2c1smen ()) . field ("i2c2smen" , & self . i2c2smen ()) . field ("i2c3smen" , & self . i2c3smen ()) . field ("dacsmen" , & self . dacsmen ()) . field ("lptim1smen" , & self . lptim1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1smenr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1smenr1 {{ tim2smen: {=bool:?}, rtcapbsmen: {=bool:?}, wwdgsmen: {=bool:?}, spi2smen: {=bool:?}, usart2smen: {=bool:?}, i2c1smen: {=bool:?}, i2c2smen: {=bool:?}, i2c3smen: {=bool:?}, dacsmen: {=bool:?}, lptim1smen: {=bool:?} }}" , self . tim2smen () , self . rtcapbsmen () , self . wwdgsmen () , self . spi2smen () , self . usart2smen () , self . i2c1smen () , self . i2c2smen () , self . i2c3smen () , self . dacsmen () , self . lptim1smen ()) } } # [doc = "APB1 peripheral clocks enable in Sleep mode register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1smenr2 { Apb1smenr2 (0) } } impl core :: fmt :: Debug for Apb1smenr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1smenr2") . field ("lpuart1smen" , & self . lpuart1smen ()) . field ("lptim2smen" , & self . lptim2smen ()) . field ("lptim3smen" , & self . lptim3smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1smenr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1smenr2 {{ lpuart1smen: {=bool:?}, lptim2smen: {=bool:?}, lptim3smen: {=bool:?} }}" , self . lpuart1smen () , self . lptim2smen () , self . lptim3smen ()) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("adcen" , & self . adcen ()) . field ("tim1en" , & self . tim1en ()) . field ("spi1en" , & self . spi1en ()) . field ("usart1en" , & self . usart1en ()) . field ("tim16en" , & self . tim16en ()) . field ("tim17en" , & self . tim17en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ adcen: {=bool:?}, tim1en: {=bool:?}, spi1en: {=bool:?}, usart1en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?} }}" , self . adcen () , self . tim1en () , self . spi1en () , self . usart1en () , self . tim16en () , self . tim17en ()) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("adcrst" , & self . adcrst ()) . field ("tim1rst" , & self . tim1rst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("usart1rst" , & self . usart1rst ()) . field ("tim16rst" , & self . tim16rst ()) . field ("tim17rst" , & self . tim17rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ adcrst: {=bool:?}, tim1rst: {=bool:?}, spi1rst: {=bool:?}, usart1rst: {=bool:?}, tim16rst: {=bool:?}, tim17rst: {=bool:?} }}" , self . adcrst () , self . tim1rst () , self . spi1rst () , self . usart1rst () , self . tim16rst () , self . tim17rst ()) } } # [doc = "APB2 peripheral clocks enable in Sleep mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2smenr { Apb2smenr (0) } } impl core :: fmt :: Debug for Apb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2smenr") . field ("adcsmen" , & self . adcsmen ()) . field ("tim1smen" , & self . tim1smen ()) . field ("spi1smen" , & self . spi1smen ()) . field ("usart1smen" , & self . usart1smen ()) . field ("tim16smen" , & self . tim16smen ()) . field ("tim17smen" , & self . tim17smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2smenr {{ adcsmen: {=bool:?}, tim1smen: {=bool:?}, spi1smen: {=bool:?}, usart1smen: {=bool:?}, tim16smen: {=bool:?}, tim17smen: {=bool:?} }}" , self . adcsmen () , self . tim1smen () , self . spi1smen () , self . usart1smen () , self . tim16smen () , self . tim17smen ()) } } # [doc = "APB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb3enr { Apb3enr (0) } } impl core :: fmt :: Debug for Apb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb3enr") . field ("subghzspien" , & self . subghzspien ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb3enr {{ subghzspien: {=bool:?} }}" , self . subghzspien ()) } } # [doc = "APB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb3rstr { Apb3rstr (0) } } impl core :: fmt :: Debug for Apb3rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb3rstr") . field ("subghzspirst" , & self . subghzspirst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb3rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb3rstr {{ subghzspirst: {=bool:?} }}" , self . subghzspirst ()) } } # [doc = "APB3 peripheral clock enable in Sleep mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb3smenr { Apb3smenr (0) } } impl core :: fmt :: Debug for Apb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb3smenr") . field ("subghzspismen" , & self . subghzspismen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb3smenr {{ subghzspismen: {=bool:?} }}" , self . subghzspismen ()) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bdcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bdcr {{ lseon: {=bool:?}, lserdy: {=bool:?}, lsebyp: {=bool:?}, lsedrv: {:?}, lsecsson: {=bool:?}, lsecssd: {=bool:?}, lsesysen: {=bool:?}, rtcsel: {:?}, lsesysrdy: {=bool:?}, rtcen: {=bool:?}, bdrst: {=bool:?}, lscoen: {=bool:?}, lscosel: {=bool:?} }}" , self . lseon () , self . lserdy () , self . lsebyp () , self . lsedrv () , self . lsecsson () , self . lsecssd () , self . lsesysen () , self . rtcsel () , self . lsesysrdy () , self . rtcen () , self . bdrst () , self . lscoen () , self . lscosel ()) } } # [doc = "CPU2 AHB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb1enr { C2ahb1enr (0) } } impl core :: fmt :: Debug for C2ahb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb1enr") . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("dmamux1en" , & self . dmamux1en ()) . field ("crcen" , & self . crcen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb1enr {{ dma1en: {=bool:?}, dma2en: {=bool:?}, dmamux1en: {=bool:?}, crcen: {=bool:?} }}" , self . dma1en () , self . dma2en () , self . dmamux1en () , self . crcen ()) } } # [doc = "CPU2 AHB1 peripheral clocks enable in Sleep modes register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb1smenr { C2ahb1smenr (0) } } impl core :: fmt :: Debug for C2ahb1smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb1smenr") . field ("dma1smen" , & self . dma1smen ()) . field ("dma2smen" , & self . dma2smen ()) . field ("dmamux1smen" , & self . dmamux1smen ()) . field ("crcsmen" , & self . crcsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb1smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb1smenr {{ dma1smen: {=bool:?}, dma2smen: {=bool:?}, dmamux1smen: {=bool:?}, crcsmen: {=bool:?} }}" , self . dma1smen () , self . dma2smen () , self . dmamux1smen () , self . crcsmen ()) } } # [doc = "CPU2 AHB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb2enr { C2ahb2enr (0) } } impl core :: fmt :: Debug for C2ahb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb2enr") . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpiohen" , & self . gpiohen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb2enr {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpiohen: {=bool:?} }}" , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpiohen ()) } } # [doc = "CPU2 AHB2 peripheral clocks enable in Sleep modes register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb2smenr { C2ahb2smenr (0) } } impl core :: fmt :: Debug for C2ahb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb2smenr") . field ("gpioasmen" , & self . gpioasmen ()) . field ("gpiobsmen" , & self . gpiobsmen ()) . field ("gpiocsmen" , & self . gpiocsmen ()) . field ("gpiohsmen" , & self . gpiohsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb2smenr {{ gpioasmen: {=bool:?}, gpiobsmen: {=bool:?}, gpiocsmen: {=bool:?}, gpiohsmen: {=bool:?} }}" , self . gpioasmen () , self . gpiobsmen () , self . gpiocsmen () , self . gpiohsmen ()) } } # [doc = "CPU2 AHB3 peripheral clock enable register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb3enr { C2ahb3enr (0) } } impl core :: fmt :: Debug for C2ahb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb3enr") . field ("pkaen" , & self . pkaen ()) . field ("aesen" , & self . aesen ()) . field ("rngen" , & self . rngen ()) . field ("hsemen" , & self . hsemen ()) . field ("ipccen" , & self . ipccen ()) . field ("flashen" , & self . flashen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb3enr {{ pkaen: {=bool:?}, aesen: {=bool:?}, rngen: {=bool:?}, hsemen: {=bool:?}, ipccen: {=bool:?}, flashen: {=bool:?} }}" , self . pkaen () , self . aesen () , self . rngen () , self . hsemen () , self . ipccen () , self . flashen ()) } } # [doc = "CPU2 AHB3 peripheral clocks enable in Sleep mode register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2ahb3smenr { C2ahb3smenr (0) } } impl core :: fmt :: Debug for C2ahb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2ahb3smenr") . field ("pkasmen" , & self . pkasmen ()) . field ("aessmen" , & self . aessmen ()) . field ("rngsmen" , & self . rngsmen ()) . field ("sram1smen" , & self . sram1smen ()) . field ("sram2smen" , & self . sram2smen ()) . field ("flashsmen" , & self . flashsmen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2ahb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2ahb3smenr {{ pkasmen: {=bool:?}, aessmen: {=bool:?}, rngsmen: {=bool:?}, sram1smen: {=bool:?}, sram2smen: {=bool:?}, flashsmen: {=bool:?} }}" , self . pkasmen () , self . aessmen () , self . rngsmen () , self . sram1smen () , self . sram2smen () , self . flashsmen ()) } } # [doc = "CPU2 APB1 peripheral clock enable register 1 \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb1enr1 { C2apb1enr1 (0) } } impl core :: fmt :: Debug for C2apb1enr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb1enr1") . field ("tim2en" , & self . tim2en ()) . field ("rtcapben" , & self . rtcapben ()) . field ("spi2en" , & self . spi2en ()) . field ("usart2en" , & self . usart2en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("i2c3en" , & self . i2c3en ()) . field ("dacen" , & self . dacen ()) . field ("lptim1en" , & self . lptim1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb1enr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb1enr1 {{ tim2en: {=bool:?}, rtcapben: {=bool:?}, spi2en: {=bool:?}, usart2en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, i2c3en: {=bool:?}, dacen: {=bool:?}, lptim1en: {=bool:?} }}" , self . tim2en () , self . rtcapben () , self . spi2en () , self . usart2en () , self . i2c1en () , self . i2c2en () , self . i2c3en () , self . dacen () , self . lptim1en ()) } } # [doc = "CPU2 APB1 peripheral clock enable register 2 \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb1enr2 { C2apb1enr2 (0) } } impl core :: fmt :: Debug for C2apb1enr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb1enr2") . field ("lpuart1en" , & self . lpuart1en ()) . field ("lptim2en" , & self . lptim2en ()) . field ("lptim3en" , & self . lptim3en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb1enr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb1enr2 {{ lpuart1en: {=bool:?}, lptim2en: {=bool:?}, lptim3en: {=bool:?} }}" , self . lpuart1en () , self . lptim2en () , self . lptim3en ()) } } # [doc = "CPU2 APB1 peripheral clocks enable in Sleep mode register 1 \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb1smenr1 { C2apb1smenr1 (0) } } impl core :: fmt :: Debug for C2apb1smenr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb1smenr1") . field ("tim2smen" , & self . tim2smen ()) . field ("rtcapbsmen" , & self . rtcapbsmen ()) . field ("spi2smen" , & self . spi2smen ()) . field ("usart2smen" , & self . usart2smen ()) . field ("i2c1smen" , & self . i2c1smen ()) . field ("i2c2smen" , & self . i2c2smen ()) . field ("i2c3smen" , & self . i2c3smen ()) . field ("dacsmen" , & self . dacsmen ()) . field ("lptim1smen" , & self . lptim1smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb1smenr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb1smenr1 {{ tim2smen: {=bool:?}, rtcapbsmen: {=bool:?}, spi2smen: {=bool:?}, usart2smen: {=bool:?}, i2c1smen: {=bool:?}, i2c2smen: {=bool:?}, i2c3smen: {=bool:?}, dacsmen: {=bool:?}, lptim1smen: {=bool:?} }}" , self . tim2smen () , self . rtcapbsmen () , self . spi2smen () , self . usart2smen () , self . i2c1smen () , self . i2c2smen () , self . i2c3smen () , self . dacsmen () , self . lptim1smen ()) } } # [doc = "CPU2 APB1 peripheral clocks enable in Sleep mode register 2 \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb1smenr2 { C2apb1smenr2 (0) } } impl core :: fmt :: Debug for C2apb1smenr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb1smenr2") . field ("lpuart1smen" , & self . lpuart1smen ()) . field ("lptim2smen" , & self . lptim2smen ()) . field ("lptim3smen" , & self . lptim3smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb1smenr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb1smenr2 {{ lpuart1smen: {=bool:?}, lptim2smen: {=bool:?}, lptim3smen: {=bool:?} }}" , self . lpuart1smen () , self . lptim2smen () , self . lptim3smen ()) } } # [doc = "CPU2 APB2 peripheral clock enable register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb2enr { C2apb2enr (0) } } impl core :: fmt :: Debug for C2apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb2enr") . field ("adcen" , & self . adcen ()) . field ("tim1en" , & self . tim1en ()) . field ("spi1en" , & self . spi1en ()) . field ("usart1en" , & self . usart1en ()) . field ("tim16en" , & self . tim16en ()) . field ("tim17en" , & self . tim17en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb2enr {{ adcen: {=bool:?}, tim1en: {=bool:?}, spi1en: {=bool:?}, usart1en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?} }}" , self . adcen () , self . tim1en () , self . spi1en () , self . usart1en () , self . tim16en () , self . tim17en ()) } } # [doc = "CPU2 APB2 peripheral clocks enable in Sleep mode register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb2smenr { C2apb2smenr (0) } } impl core :: fmt :: Debug for C2apb2smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb2smenr") . field ("adcsmen" , & self . adcsmen ()) . field ("tim1smen" , & self . tim1smen ()) . field ("spi1smen" , & self . spi1smen ()) . field ("usart1smen" , & self . usart1smen ()) . field ("tim16smen" , & self . tim16smen ()) . field ("tim17smen" , & self . tim17smen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb2smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb2smenr {{ adcsmen: {=bool:?}, tim1smen: {=bool:?}, spi1smen: {=bool:?}, usart1smen: {=bool:?}, tim16smen: {=bool:?}, tim17smen: {=bool:?} }}" , self . adcsmen () , self . tim1smen () , self . spi1smen () , self . usart1smen () , self . tim16smen () , self . tim17smen ()) } } # [doc = "CPU2 APB3 peripheral clock enable register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb3enr { C2apb3enr (0) } } impl core :: fmt :: Debug for C2apb3enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb3enr") . field ("subghzspien" , & self . subghzspien ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb3enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb3enr {{ subghzspien: {=bool:?} }}" , self . subghzspien ()) } } # [doc = "CPU2 APB3 peripheral clock enable in Sleep mode register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> C2apb3smenr { C2apb3smenr (0) } } impl core :: fmt :: Debug for C2apb3smenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("C2apb3smenr") . field ("subghzspismen" , & self . subghzspismen ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for C2apb3smenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "C2apb3smenr {{ subghzspismen: {=bool:?} }}" , self . subghzspismen ()) } } # [doc = "Peripherals independent clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccipr { Ccipr (0) } } impl core :: fmt :: Debug for Ccipr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccipr") . field ("usart1sel" , & self . usart1sel ()) . field ("usart2sel" , & self . usart2sel ()) . field ("spi2sel" , & self . spi2sel ()) . field ("lpuart1sel" , & self . lpuart1sel ()) . field ("i2c1sel" , & self . i2c1sel ()) . field ("i2c2sel" , & self . i2c2sel ()) . field ("i2c3sel" , & self . i2c3sel ()) . field ("lptim1sel" , & self . lptim1sel ()) . field ("lptim2sel" , & self . lptim2sel ()) . field ("lptim3sel" , & self . lptim3sel ()) . field ("adcsel" , & self . adcsel ()) . field ("rngsel" , & self . rngsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccipr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccipr {{ usart1sel: {=u8:?}, usart2sel: {=u8:?}, spi2sel: {=u8:?}, lpuart1sel: {=u8:?}, i2c1sel: {=u8:?}, i2c2sel: {=u8:?}, i2c3sel: {=u8:?}, lptim1sel: {=u8:?}, lptim2sel: {=u8:?}, lptim3sel: {=u8:?}, adcsel: {:?}, rngsel: {:?} }}" , self . usart1sel () , self . usart2sel () , self . spi2sel () , self . lpuart1sel () , self . i2c1sel () , self . i2c2sel () , self . i2c3sel () , self . lptim1sel () , self . lptim2sel () , self . lptim3sel () , self . adcsel () , self . rngsel ()) } } # [doc = "Clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cicr { Cicr (0) } } impl core :: fmt :: Debug for Cicr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cicr") . field ("lsirdyc" , & self . lsirdyc ()) . field ("lserdyc" , & self . lserdyc ()) . field ("msirdyc" , & self . msirdyc ()) . field ("hsirdyc" , & self . hsirdyc ()) . field ("hserdyc" , & self . hserdyc ()) . field ("pllrdyc" , & self . pllrdyc ()) . field ("cssc" , & self . cssc ()) . field ("lsecssc" , & self . lsecssc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cicr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cicr {{ lsirdyc: {=bool:?}, lserdyc: {=bool:?}, msirdyc: {=bool:?}, hsirdyc: {=bool:?}, hserdyc: {=bool:?}, pllrdyc: {=bool:?}, cssc: {=bool:?}, lsecssc: {=bool:?} }}" , self . lsirdyc () , self . lserdyc () , self . msirdyc () , self . hsirdyc () , self . hserdyc () , self . pllrdyc () , self . cssc () , self . lsecssc ()) } } # [doc = "Clock interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cier { Cier (0) } } impl core :: fmt :: Debug for Cier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cier") . field ("lsirdyie" , & self . lsirdyie ()) . field ("lserdyie" , & self . lserdyie ()) . field ("msirdyie" , & self . msirdyie ()) . field ("hsirdyie" , & self . hsirdyie ()) . field ("hserdyie" , & self . hserdyie ()) . field ("pllrdyie" , & self . pllrdyie ()) . field ("lsecssie" , & self . lsecssie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cier {{ lsirdyie: {=bool:?}, lserdyie: {=bool:?}, msirdyie: {=bool:?}, hsirdyie: {=bool:?}, hserdyie: {=bool:?}, pllrdyie: {=bool:?}, lsecssie: {=bool:?} }}" , self . lsirdyie () , self . lserdyie () , self . msirdyie () , self . hsirdyie () , self . hserdyie () , self . pllrdyie () , self . lsecssie ()) } } # [doc = "Clock interrupt flag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("msion" , & self . msion ()) . field ("msirdy" , & self . msirdy ()) . field ("msipllen" , & self . msipllen ()) . field ("msirgsel" , & self . msirgsel ()) . field ("msirange" , & self . msirange ()) . field ("hsion" , & self . hsion ()) . field ("hsikeron" , & self . hsikeron ()) . field ("hsirdy" , & self . hsirdy ()) . field ("hsiasfs" , & self . hsiasfs ()) . field ("hsikerdy" , & self . hsikerdy ()) . field ("hseon" , & self . hseon ()) . field ("hserdy" , & self . hserdy ()) . field ("csson" , & self . csson ()) . field ("hsepre" , & self . hsepre ()) . field ("hsebyppwr" , & self . hsebyppwr ()) . field ("pllon" , & self . pllon ()) . field ("pllrdy" , & self . pllrdy ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ msion: {=bool:?}, msirdy: {=bool:?}, msipllen: {=bool:?}, msirgsel: {:?}, msirange: {:?}, hsion: {=bool:?}, hsikeron: {=bool:?}, hsirdy: {=bool:?}, hsiasfs: {=bool:?}, hsikerdy: {=bool:?}, hseon: {=bool:?}, hserdy: {=bool:?}, csson: {=bool:?}, hsepre: {:?}, hsebyppwr: {=bool:?}, pllon: {=bool:?}, pllrdy: {=bool:?} }}" , self . msion () , self . msirdy () , self . msipllen () , self . msirgsel () , self . msirange () , self . hsion () , self . hsikeron () , self . hsirdy () , self . hsiasfs () , self . hsikerdy () , self . hseon () , self . hserdy () , self . csson () , self . hsepre () , self . hsebyppwr () , self . pllon () , self . pllrdy ()) } } # [doc = "Control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("lsion" , & self . lsion ()) . field ("lsirdy" , & self . lsirdy ()) . field ("lsipre" , & self . lsipre ()) . field ("msisrange" , & self . msisrange ()) . field ("rfrstf" , & self . rfrstf ()) . field ("rfrst" , & self . rfrst ()) . field ("rmvf" , & self . rmvf ()) . field ("rfilarstf" , & self . rfilarstf ()) . field ("oblrstf" , & self . oblrstf ()) . field ("pinrstf" , & self . pinrstf ()) . field ("borrstf" , & self . borrstf ()) . field ("sftrstf" , & self . sftrstf ()) . field ("iwdgrstf" , & self . iwdgrstf ()) . field ("wwdgrstf" , & self . wwdgrstf ()) . field ("lpwrrstf" , & self . lpwrrstf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ lsion: {=bool:?}, lsirdy: {=bool:?}, lsipre: {=bool:?}, msisrange: {=u8:?}, rfrstf: {=bool:?}, rfrst: {=bool:?}, rmvf: {=bool:?}, rfilarstf: {=bool:?}, oblrstf: {=bool:?}, pinrstf: {=bool:?}, borrstf: {=bool:?}, sftrstf: {=bool:?}, iwdgrstf: {=bool:?}, wwdgrstf: {=bool:?}, lpwrrstf: {=bool:?} }}" , self . lsion () , self . lsirdy () , self . lsipre () , self . msisrange () , self . rfrstf () , self . rfrst () , self . rmvf () , self . rfilarstf () , self . oblrstf () , self . pinrstf () , self . borrstf () , self . sftrstf () , self . iwdgrstf () , self . wwdgrstf () , self . lpwrrstf ()) } } # [doc = "Extended clock recovery register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Extcfgr { Extcfgr (0) } } impl core :: fmt :: Debug for Extcfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Extcfgr") . field ("shdhpre" , & self . shdhpre ()) . field ("c2hpre" , & self . c2hpre ()) . field ("shdhpref" , & self . shdhpref ()) . field ("c2hpref" , & self . c2hpref ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Extcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Extcfgr {{ shdhpre: {:?}, c2hpre: {:?}, shdhpref: {=bool:?}, c2hpref: {=bool:?} }}" , self . shdhpre () , self . c2hpre () , self . shdhpref () , self . c2hpref ()) } } # [doc = "Internal clock sources calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pllcfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pllcfgr {{ pllsrc: {:?}, pllm: {:?}, plln: {:?}, pllpen: {=bool:?}, pllp: {:?}, pllqen: {=bool:?}, pllq: {:?}, pllren: {=bool:?}, pllr: {:?} }}" , self . pllsrc () , self . pllm () , self . plln () , self . pllpen () , self . pllp () , self . pllqen () , self . pllq () , self . pllren () , self . pllr ()) } } } pub mod vals { # [repr (u8)]

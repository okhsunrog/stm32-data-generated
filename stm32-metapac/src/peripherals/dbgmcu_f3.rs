...
fn default () -> Apb1fzr { Apb1fzr (0) } } impl core :: fmt :: Debug for Apb1fzr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1fzr") . field ("tim2" , & self . tim2 ()) . field ("tim3" , & self . tim3 ()) . field ("tim4" , & self . tim4 ()) . field ("tim5" , & self . tim5 ()) . field ("tim6" , & self . tim6 ()) . field ("tim7" , & self . tim7 ()) . field ("tim12" , & self . tim12 ()) . field ("tim13" , & self . tim13 ()) . field ("tim14" , & self . tim14 ()) . field ("tim18" , & self . tim18 ()) . field ("rtc" , & self . rtc ()) . field ("wwdg" , & self . wwdg ()) . field ("iwdg" , & self . iwdg ()) . field ("i2c1_smbus_timeout" , & self . i2c1_smbus_timeout ()) . field ("i2c2_smbus_timeout" , & self . i2c2_smbus_timeout ()) . field ("can" , & self . can ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1fzr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1fzr {{ tim2: {=bool:?}, tim3: {=bool:?}, tim4: {=bool:?}, tim5: {=bool:?}, tim6: {=bool:?}, tim7: {=bool:?}, tim12: {=bool:?}, tim13: {=bool:?}, tim14: {=bool:?}, tim18: {=bool:?}, rtc: {=bool:?}, wwdg: {=bool:?}, iwdg: {=bool:?}, i2c1_smbus_timeout: {=bool:?}, i2c2_smbus_timeout: {=bool:?}, can: {=bool:?} }}" , self . tim2 () , self . tim3 () , self . tim4 () , self . tim5 () , self . tim6 () , self . tim7 () , self . tim12 () , self . tim13 () , self . tim14 () , self . tim18 () , self . rtc () , self . wwdg () , self . iwdg () , self . i2c1_smbus_timeout () , self . i2c2_smbus_timeout () , self . can ()) } } # [doc = "APB High Freeze Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2fzr { Apb2fzr (0) } } impl core :: fmt :: Debug for Apb2fzr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2fzr") . field ("tim15" , & self . tim15 ()) . field ("tim16" , & self . tim16 ()) . field ("tim17" , & self . tim17 ()) . field ("tim19" , & self . tim19 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2fzr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2fzr {{ tim15: {=bool:?}, tim16: {=bool:?}, tim17: {=bool:?}, tim19: {=bool:?} }}" , self . tim15 () , self . tim16 () , self . tim17 () , self . tim19 ()) } } # [doc = "Debug MCU Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

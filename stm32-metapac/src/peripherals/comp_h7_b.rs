...
# [inline (always)]
pub const fn inmsel (& self) -> super :: vals :: Inmsel { let val = (self . 0 >> 16usize) & 0x07 ; super :: vals :: Inmsel :: from_bits (val as u8) } # [doc = "COMP channel 1 inverting input selection field."]
# [inline (always)]
pub fn set_inmsel (& mut self , val : super :: vals :: Inmsel) { self . 0 = (self . 0 & ! (0x07 << 16usize)) | (((val . to_bits () as u32) & 0x07) << 16usize) ; } # [doc = "COMP channel 1 non-inverting input selection bit."]
# [inline (always)]
...
fn default () -> Cfgr1 { Cfgr1 (0) } } impl core :: fmt :: Debug for Cfgr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr1") . field ("en" , & self . en ()) . field ("brgen" , & self . brgen ()) . field ("scalen" , & self . scalen ()) . field ("polarity" , & self . polarity ()) . field ("iten" , & self . iten ()) . field ("hyst" , & self . hyst ()) . field ("pwrmode" , & self . pwrmode ()) . field ("inmsel" , & self . inmsel ()) . field ("inpsel" , & self . inpsel ()) . field ("blanking" , & self . blanking ()) . field ("lock" , & self . lock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr1 {{ en: {=bool:?}, brgen: {=bool:?}, scalen: {=bool:?}, polarity: {=bool:?}, iten: {=bool:?}, hyst: {:?}, pwrmode: {:?}, inmsel: {:?}, inpsel: {:?}, blanking: {:?}, lock: {=bool:?} }}" , self . en () , self . brgen () , self . scalen () , self . polarity () , self . iten () , self . hyst () , self . pwrmode () , self . inmsel () , self . inpsel () , self . blanking () , self . lock ()) } } # [doc = "Comparator configuration register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("en" , & self . en ()) . field ("brgen" , & self . brgen ()) . field ("scalen" , & self . scalen ()) . field ("polarity" , & self . polarity ()) . field ("winmode" , & self . winmode ()) . field ("iten" , & self . iten ()) . field ("hyst" , & self . hyst ()) . field ("pwrmode" , & self . pwrmode ()) . field ("inmsel" , & self . inmsel ()) . field ("inpsel" , & self . inpsel ()) . field ("blanking" , & self . blanking ()) . field ("lock" , & self . lock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ en: {=bool:?}, brgen: {=bool:?}, scalen: {=bool:?}, polarity: {=bool:?}, winmode: {=bool:?}, iten: {=bool:?}, hyst: {:?}, pwrmode: {:?}, inmsel: {:?}, inpsel: {:?}, blanking: {:?}, lock: {=bool:?} }}" , self . en () , self . brgen () , self . scalen () , self . polarity () , self . winmode () , self . iten () , self . hyst () , self . pwrmode () , self . inmsel () , self . inpsel () , self . blanking () , self . lock ()) } } # [doc = "Comparator interrupt clear flag register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icfr { Icfr (0) } } impl core :: fmt :: Debug for Icfr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icfr") . field ("ccif[0]" , & self . ccif (0usize)) . field ("ccif[1]" , & self . ccif (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icfr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icfr {{ ccif[0]: {=bool:?}, ccif[1]: {=bool:?} }}" , self . ccif (0usize) , self . ccif (1usize)) } } # [doc = "Comparator option register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Or { Or (0) } } impl core :: fmt :: Debug for Or { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Or") . field ("afop" , & self . afop ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Or { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Or {{ afop: {=u16:?} }}" , self . afop ()) } } # [doc = "Comparator status register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("cval[0]" , & self . cval (0usize)) . field ("cval[1]" , & self . cval (1usize)) . field ("cif[0]" , & self . cif (0usize)) . field ("cif[1]" , & self . cif (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ cval[0]: {=bool:?}, cval[1]: {=bool:?}, cif[0]: {=bool:?}, cif[1]: {=bool:?} }}" , self . cval (0usize) , self . cval (1usize) , self . cif (0usize) , self . cif (1usize)) } } } pub mod vals { # [repr (u8)]
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]
pub enum Blanking { NO_BLANKING = 0x0 , TIM1OC5 = 0x01 , TIM2OC3 = 0x02 , TIM3OC3 = 0x03 , TIM3OC4 = 0x04 , TIM8OC5 = 0x05 , TIM15OC1 = 0x06 , _RESERVED_7 = 0x07 , _RESERVED_8 = 0x08 , _RESERVED_9 = 0x09 , _RESERVED_a = 0x0a , _RESERVED_b = 0x0b , _RESERVED_c = 0x0c , _RESERVED_d = 0x0d , _RESERVED_e = 0x0e , _RESERVED_f = 0x0f , } impl Blanking { # [inline (always)]
...
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]
pub enum Inmsel { VREF_1OVER4 = 0x0 , VREF_1OVER2 = 0x01 , VREF_3OVER4 = 0x02 , VREF = 0x03 , INM1 = 0x04 , INM2 = 0x05 , COMPX_INM1 = 0x06 , COMPX_INM2 = 0x07 , } impl Inmsel { # [inline (always)]
pub const fn from_bits (val : u8) -> Inmsel { unsafe { core :: mem :: transmute (val & 0x07) } } # [inline (always)]
...
MEDIUM_EITHER = 0x02 , # [doc = "Ultra low power / ultra-low-power"]

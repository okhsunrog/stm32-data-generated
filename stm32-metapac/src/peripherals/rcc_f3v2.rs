...
fn default () -> Ahbenr { Ahbenr (0) } } impl core :: fmt :: Debug for Ahbenr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahbenr") . field ("dma1en" , & self . dma1en ()) . field ("dma2en" , & self . dma2en ()) . field ("sramen" , & self . sramen ()) . field ("flashen" , & self . flashen ()) . field ("fmcen" , & self . fmcen ()) . field ("crcen" , & self . crcen ()) . field ("gpiohen" , & self . gpiohen ()) . field ("gpioaen" , & self . gpioaen ()) . field ("gpioben" , & self . gpioben ()) . field ("gpiocen" , & self . gpiocen ()) . field ("gpioden" , & self . gpioden ()) . field ("gpioeen" , & self . gpioeen ()) . field ("gpiofen" , & self . gpiofen ()) . field ("gpiogen" , & self . gpiogen ()) . field ("tscen" , & self . tscen ()) . field ("adc12en" , & self . adc12en ()) . field ("adc34en" , & self . adc34en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahbenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahbenr {{ dma1en: {=bool:?}, dma2en: {=bool:?}, sramen: {=bool:?}, flashen: {=bool:?}, fmcen: {=bool:?}, crcen: {=bool:?}, gpiohen: {=bool:?}, gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpioeen: {=bool:?}, gpiofen: {=bool:?}, gpiogen: {=bool:?}, tscen: {=bool:?}, adc12en: {=bool:?}, adc34en: {=bool:?} }}" , self . dma1en () , self . dma2en () , self . sramen () , self . flashen () , self . fmcen () , self . crcen () , self . gpiohen () , self . gpioaen () , self . gpioben () , self . gpiocen () , self . gpioden () , self . gpioeen () , self . gpiofen () , self . gpiogen () , self . tscen () , self . adc12en () , self . adc34en ()) } } # [doc = "AHB peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ahbrstr { Ahbrstr (0) } } impl core :: fmt :: Debug for Ahbrstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ahbrstr") . field ("fmcrst" , & self . fmcrst ()) . field ("gpiohrst" , & self . gpiohrst ()) . field ("gpioarst" , & self . gpioarst ()) . field ("gpiobrst" , & self . gpiobrst ()) . field ("gpiocrst" , & self . gpiocrst ()) . field ("gpiodrst" , & self . gpiodrst ()) . field ("gpioerst" , & self . gpioerst ()) . field ("gpiofrst" , & self . gpiofrst ()) . field ("gpiogrst" , & self . gpiogrst ()) . field ("tscrst" , & self . tscrst ()) . field ("adc12rst" , & self . adc12rst ()) . field ("adc34rst" , & self . adc34rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ahbrstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ahbrstr {{ fmcrst: {=bool:?}, gpiohrst: {=bool:?}, gpioarst: {=bool:?}, gpiobrst: {=bool:?}, gpiocrst: {=bool:?}, gpiodrst: {=bool:?}, gpioerst: {=bool:?}, gpiofrst: {=bool:?}, gpiogrst: {=bool:?}, tscrst: {=bool:?}, adc12rst: {=bool:?}, adc34rst: {=bool:?} }}" , self . fmcrst () , self . gpiohrst () , self . gpioarst () , self . gpiobrst () , self . gpiocrst () , self . gpiodrst () , self . gpioerst () , self . gpiofrst () , self . gpiogrst () , self . tscrst () , self . adc12rst () , self . adc34rst ()) } } # [doc = "APB1 peripheral clock enable register (RCC_APB1ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1enr { Apb1enr (0) } } impl core :: fmt :: Debug for Apb1enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1enr") . field ("tim2en" , & self . tim2en ()) . field ("tim3en" , & self . tim3en ()) . field ("tim4en" , & self . tim4en ()) . field ("tim6en" , & self . tim6en ()) . field ("tim7en" , & self . tim7en ()) . field ("wwdgen" , & self . wwdgen ()) . field ("spi2en" , & self . spi2en ()) . field ("spi3en" , & self . spi3en ()) . field ("usart2en" , & self . usart2en ()) . field ("usart3en" , & self . usart3en ()) . field ("uart4en" , & self . uart4en ()) . field ("uart5en" , & self . uart5en ()) . field ("i2c1en" , & self . i2c1en ()) . field ("i2c2en" , & self . i2c2en ()) . field ("usben" , & self . usben ()) . field ("canen" , & self . canen ()) . field ("dac2en" , & self . dac2en ()) . field ("pwren" , & self . pwren ()) . field ("dacen" , & self . dacen ()) . field ("i2c3en" , & self . i2c3en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1enr {{ tim2en: {=bool:?}, tim3en: {=bool:?}, tim4en: {=bool:?}, tim6en: {=bool:?}, tim7en: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, spi3en: {=bool:?}, usart2en: {=bool:?}, usart3en: {=bool:?}, uart4en: {=bool:?}, uart5en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, usben: {=bool:?}, canen: {=bool:?}, dac2en: {=bool:?}, pwren: {=bool:?}, dacen: {=bool:?}, i2c3en: {=bool:?} }}" , self . tim2en () , self . tim3en () , self . tim4en () , self . tim6en () , self . tim7en () , self . wwdgen () , self . spi2en () , self . spi3en () , self . usart2en () , self . usart3en () , self . uart4en () , self . uart5en () , self . i2c1en () , self . i2c2en () , self . usben () , self . canen () , self . dac2en () , self . pwren () , self . dacen () , self . i2c3en ()) } } # [doc = "APB1 peripheral reset register (RCC_APB1RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb1rstr { Apb1rstr (0) } } impl core :: fmt :: Debug for Apb1rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb1rstr") . field ("tim2rst" , & self . tim2rst ()) . field ("tim3rst" , & self . tim3rst ()) . field ("tim4rst" , & self . tim4rst ()) . field ("tim6rst" , & self . tim6rst ()) . field ("tim7rst" , & self . tim7rst ()) . field ("wwdgrst" , & self . wwdgrst ()) . field ("spi2rst" , & self . spi2rst ()) . field ("spi3rst" , & self . spi3rst ()) . field ("usart2rst" , & self . usart2rst ()) . field ("usart3rst" , & self . usart3rst ()) . field ("uart4rst" , & self . uart4rst ()) . field ("uart5rst" , & self . uart5rst ()) . field ("i2c1rst" , & self . i2c1rst ()) . field ("i2c2rst" , & self . i2c2rst ()) . field ("usbrst" , & self . usbrst ()) . field ("canrst" , & self . canrst ()) . field ("dac2rst" , & self . dac2rst ()) . field ("pwrrst" , & self . pwrrst ()) . field ("dacrst" , & self . dacrst ()) . field ("i2c3rst" , & self . i2c3rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb1rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb1rstr {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim4rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, wwdgrst: {=bool:?}, spi2rst: {=bool:?}, spi3rst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, uart4rst: {=bool:?}, uart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, usbrst: {=bool:?}, canrst: {=bool:?}, dac2rst: {=bool:?}, pwrrst: {=bool:?}, dacrst: {=bool:?}, i2c3rst: {=bool:?} }}" , self . tim2rst () , self . tim3rst () , self . tim4rst () , self . tim6rst () , self . tim7rst () , self . wwdgrst () , self . spi2rst () , self . spi3rst () , self . usart2rst () , self . usart3rst () , self . uart4rst () , self . uart5rst () , self . i2c1rst () , self . i2c2rst () , self . usbrst () , self . canrst () , self . dac2rst () , self . pwrrst () , self . dacrst () , self . i2c3rst ()) } } # [doc = "APB2 peripheral clock enable register (RCC_APB2ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2enr { Apb2enr (0) } } impl core :: fmt :: Debug for Apb2enr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2enr") . field ("syscfgen" , & self . syscfgen ()) . field ("tim1en" , & self . tim1en ()) . field ("spi1en" , & self . spi1en ()) . field ("tim8en" , & self . tim8en ()) . field ("usart1en" , & self . usart1en ()) . field ("spi4en" , & self . spi4en ()) . field ("tim15en" , & self . tim15en ()) . field ("tim16en" , & self . tim16en ()) . field ("tim17en" , & self . tim17en ()) . field ("tim19en" , & self . tim19en ()) . field ("tim20en" , & self . tim20en ()) . field ("dbgmcuen" , & self . dbgmcuen ()) . field ("hrtim1en" , & self . hrtim1en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2enr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2enr {{ syscfgen: {=bool:?}, tim1en: {=bool:?}, spi1en: {=bool:?}, tim8en: {=bool:?}, usart1en: {=bool:?}, spi4en: {=bool:?}, tim15en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?}, tim19en: {=bool:?}, tim20en: {=bool:?}, dbgmcuen: {=bool:?}, hrtim1en: {=bool:?} }}" , self . syscfgen () , self . tim1en () , self . spi1en () , self . tim8en () , self . usart1en () , self . spi4en () , self . tim15en () , self . tim16en () , self . tim17en () , self . tim19en () , self . tim20en () , self . dbgmcuen () , self . hrtim1en ()) } } # [doc = "APB2 peripheral reset register (RCC_APB2RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Apb2rstr { Apb2rstr (0) } } impl core :: fmt :: Debug for Apb2rstr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Apb2rstr") . field ("syscfgrst" , & self . syscfgrst ()) . field ("tim1rst" , & self . tim1rst ()) . field ("spi1rst" , & self . spi1rst ()) . field ("tim8rst" , & self . tim8rst ()) . field ("usart1rst" , & self . usart1rst ()) . field ("spi4rst" , & self . spi4rst ()) . field ("tim15rst" , & self . tim15rst ()) . field ("tim16rst" , & self . tim16rst ()) . field ("tim17rst" , & self . tim17rst ()) . field ("tim19rst" , & self . tim19rst ()) . field ("tim20rst" , & self . tim20rst ()) . field ("dbgmcurst" , & self . dbgmcurst ()) . field ("hrtim1rst" , & self . hrtim1rst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Apb2rstr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Apb2rstr {{ syscfgrst: {=bool:?}, tim1rst: {=bool:?}, spi1rst: {=bool:?}, tim8rst: {=bool:?}, usart1rst: {=bool:?}, spi4rst: {=bool:?}, tim15rst: {=bool:?}, tim16rst: {=bool:?}, tim17rst: {=bool:?}, tim19rst: {=bool:?}, tim20rst: {=bool:?}, dbgmcurst: {=bool:?}, hrtim1rst: {=bool:?} }}" , self . syscfgrst () , self . tim1rst () , self . spi1rst () , self . tim8rst () , self . usart1rst () , self . spi4rst () , self . tim15rst () , self . tim16rst () , self . tim17rst () , self . tim19rst () , self . tim20rst () , self . dbgmcurst () , self . hrtim1rst ()) } } # [doc = "Backup domain control register (RCC_BDCR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bdcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bdcr {{ lseon: {=bool:?}, lserdy: {=bool:?}, lsebyp: {=bool:?}, lsedrv: {:?}, rtcsel: {:?}, rtcen: {=bool:?}, bdrst: {=bool:?} }}" , self . lseon () , self . lserdy () , self . lsebyp () , self . lsedrv () , self . rtcsel () , self . rtcen () , self . bdrst ()) } } # [doc = "Clock configuration register (RCC_CFGR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr { Cfgr (0) } } impl core :: fmt :: Debug for Cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr") . field ("sw" , & self . sw ()) . field ("sws" , & self . sws ()) . field ("hpre" , & self . hpre ()) . field ("ppre1" , & self . ppre1 ()) . field ("ppre2" , & self . ppre2 ()) . field ("adcpre" , & self . adcpre ()) . field ("pllsrc" , & self . pllsrc ()) . field ("pllxtpre" , & self . pllxtpre ()) . field ("pllmul" , & self . pllmul ()) . field ("usbpre" , & self . usbpre ()) . field ("i2ssrc" , & self . i2ssrc ()) . field ("mcosel" , & self . mcosel ()) . field ("mcopre" , & self . mcopre ()) . field ("pllmcodiv" , & self . pllmcodiv ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr {{ sw: {:?}, sws: {:?}, hpre: {:?}, ppre1: {:?}, ppre2: {:?}, adcpre: {:?}, pllsrc: {:?}, pllxtpre: {:?}, pllmul: {:?}, usbpre: {:?}, i2ssrc: {:?}, mcosel: {:?}, mcopre: {:?}, pllmcodiv: {:?} }}" , self . sw () , self . sws () , self . hpre () , self . ppre1 () , self . ppre2 () , self . adcpre () , self . pllsrc () , self . pllxtpre () , self . pllmul () , self . usbpre () , self . i2ssrc () , self . mcosel () , self . mcopre () , self . pllmcodiv ()) } } # [doc = "Clock configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("prediv" , & self . prediv ()) . field ("adc12pres" , & self . adc12pres ()) . field ("adc1pres" , & self . adc1pres ()) . field ("adc34pres" , & self . adc34pres ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ prediv: {:?}, adc12pres: {:?}, adc1pres: {:?}, adc34pres: {:?} }}" , self . prediv () , self . adc12pres () , self . adc1pres () , self . adc34pres ()) } } # [doc = "Clock configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr3 { Cfgr3 (0) } } impl core :: fmt :: Debug for Cfgr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr3") . field ("usart1sw" , & self . usart1sw ()) . field ("i2c1sw" , & self . i2c1sw ()) . field ("i2c2sw" , & self . i2c2sw ()) . field ("cecsw" , & self . cecsw ()) . field ("i2c3sw" , & self . i2c3sw ()) . field ("tim1sw" , & self . tim1sw ()) . field ("tim8sw" , & self . tim8sw ()) . field ("tim15sw" , & self . tim15sw ()) . field ("tim16sw" , & self . tim16sw ()) . field ("hrtim1sw" , & self . hrtim1sw ()) . field ("tim17sw" , & self . tim17sw ()) . field ("tim20sw" , & self . tim20sw ()) . field ("usart2sw" , & self . usart2sw ()) . field ("usart3sw" , & self . usart3sw ()) . field ("uart4sw" , & self . uart4sw ()) . field ("uart5sw" , & self . uart5sw ()) . field ("tim2sw" , & self . tim2sw ()) . field ("tim34sw" , & self . tim34sw ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr3 {{ usart1sw: {:?}, i2c1sw: {:?}, i2c2sw: {:?}, cecsw: {:?}, i2c3sw: {:?}, tim1sw: {:?}, tim8sw: {:?}, tim15sw: {:?}, tim16sw: {:?}, hrtim1sw: {:?}, tim17sw: {:?}, tim20sw: {:?}, usart2sw: {:?}, usart3sw: {:?}, uart4sw: {:?}, uart5sw: {:?}, tim2sw: {:?}, tim34sw: {:?} }}" , self . usart1sw () , self . i2c1sw () , self . i2c2sw () , self . cecsw () , self . i2c3sw () , self . tim1sw () , self . tim8sw () , self . tim15sw () , self . tim16sw () , self . hrtim1sw () , self . tim17sw () , self . tim20sw () , self . usart2sw () , self . usart3sw () , self . uart4sw () , self . uart5sw () , self . tim2sw () , self . tim34sw ()) } } # [doc = "Clock interrupt register (RCC_CIR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("lsion" , & self . lsion ()) . field ("lsirdy" , & self . lsirdy ()) . field ("v18pwrrstf" , & self . v18pwrrstf ()) . field ("rmvf" , & self . rmvf ()) . field ("oblrstf" , & self . oblrstf ()) . field ("pinrstf" , & self . pinrstf ()) . field ("porrstf" , & self . porrstf ()) . field ("sftrstf" , & self . sftrstf ()) . field ("iwdgrstf" , & self . iwdgrstf ()) . field ("wwdgrstf" , & self . wwdgrstf ()) . field ("lpwrrstf" , & self . lpwrrstf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ lsion: {=bool:?}, lsirdy: {=bool:?}, v18pwrrstf: {=bool:?}, rmvf: {=bool:?}, oblrstf: {=bool:?}, pinrstf: {=bool:?}, porrstf: {=bool:?}, sftrstf: {=bool:?}, iwdgrstf: {=bool:?}, wwdgrstf: {=bool:?}, lpwrrstf: {=bool:?} }}" , self . lsion () , self . lsirdy () , self . v18pwrrstf () , self . rmvf () , self . oblrstf () , self . pinrstf () , self . porrstf () , self . sftrstf () , self . iwdgrstf () , self . wwdgrstf () , self . lpwrrstf ()) } } } pub mod vals { # [repr (u8)]

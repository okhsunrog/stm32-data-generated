...
fn default () -> Clrisr { Clrisr (0) } } impl core :: fmt :: Debug for Clrisr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Clrisr") . field ("clreocalf" , & self . clreocalf ()) . field ("clrjovrf" , & self . clrjovrf ()) . field ("clrrovrf" , & self . clrrovrf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Clrisr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Clrisr {{ clreocalf: {=bool:?}, clrjovrf: {=bool:?}, clrrovrf: {=bool:?} }}" , self . clreocalf () , self . clrjovrf () , self . clrrovrf ()) } } # [doc = "channel configuration register 1."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Confchr1 { Confchr1 (0) } } impl core :: fmt :: Debug for Confchr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Confchr1") . field ("confch[0]" , & self . confch (0usize)) . field ("confch[1]" , & self . confch (1usize)) . field ("confch[2]" , & self . confch (2usize)) . field ("confch[3]" , & self . confch (3usize)) . field ("confch[4]" , & self . confch (4usize)) . field ("confch[5]" , & self . confch (5usize)) . field ("confch[6]" , & self . confch (6usize)) . field ("confch[7]" , & self . confch (7usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Confchr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Confchr1 {{ confch[0]: {=u8:?}, confch[1]: {=u8:?}, confch[2]: {=u8:?}, confch[3]: {=u8:?}, confch[4]: {=u8:?}, confch[5]: {=u8:?}, confch[6]: {=u8:?}, confch[7]: {=u8:?} }}" , self . confch (0usize) , self . confch (1usize) , self . confch (2usize) , self . confch (3usize) , self . confch (4usize) , self . confch (5usize) , self . confch (6usize) , self . confch (7usize)) } } # [doc = "channel configuration register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Confchr2 { Confchr2 (0) } } impl core :: fmt :: Debug for Confchr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Confchr2") . field ("confch[0]" , & self . confch (0usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Confchr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Confchr2 {{ confch[0]: {=u8:?} }}" , self . confch (0usize)) } } # [doc = "configuration 0 register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Confr { Confr (0) } } impl core :: fmt :: Debug for Confr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Confr") . field ("offset" , & self . offset ()) . field ("gain" , & self . gain ()) . field ("se" , & self . se ()) . field ("common" , & self . common ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Confr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Confr {{ offset: {=u16:?}, gain: {=u8:?}, se: {=u8:?}, common: {=u8:?} }}" , self . offset () , self . gain () , self . se () , self . common ()) } } # [doc = "control register 1."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr1 { Cr1 (0) } } impl core :: fmt :: Debug for Cr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr1") . field ("eocalie" , & self . eocalie ()) . field ("jeocie" , & self . jeocie ()) . field ("jovrie" , & self . jovrie ()) . field ("reocie" , & self . reocie ()) . field ("rovrie" , & self . rovrie ()) . field ("refv" , & self . refv ()) . field ("slowck" , & self . slowck ()) . field ("sbi" , & self . sbi ()) . field ("pdi" , & self . pdi ()) . field ("jsync" , & self . jsync ()) . field ("rsync" , & self . rsync ()) . field ("jdmaen" , & self . jdmaen ()) . field ("rdmaen" , & self . rdmaen ()) . field ("init" , & self . init ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr1 {{ eocalie: {=bool:?}, jeocie: {=bool:?}, jovrie: {=bool:?}, reocie: {=bool:?}, rovrie: {=bool:?}, refv: {=u8:?}, slowck: {=bool:?}, sbi: {=bool:?}, pdi: {=bool:?}, jsync: {=bool:?}, rsync: {=bool:?}, jdmaen: {=bool:?}, rdmaen: {=bool:?}, init: {=bool:?} }}" , self . eocalie () , self . jeocie () , self . jovrie () , self . reocie () , self . rovrie () , self . refv () , self . slowck () , self . sbi () , self . pdi () , self . jsync () , self . rsync () , self . jdmaen () , self . rdmaen () , self . init ()) } } # [doc = "control register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr2 { Cr2 (0) } } impl core :: fmt :: Debug for Cr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2") . field ("adon" , & self . adon ()) . field ("calibcnt" , & self . calibcnt ()) . field ("startcalib" , & self . startcalib ()) . field ("jcont" , & self . jcont ()) . field ("jds" , & self . jds ()) . field ("jextsel" , & self . jextsel ()) . field ("jexten" , & self . jexten ()) . field ("jswstart" , & self . jswstart ()) . field ("rch" , & self . rch ()) . field ("rcont" , & self . rcont ()) . field ("rswstart" , & self . rswstart ()) . field ("fast" , & self . fast ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2 {{ adon: {=bool:?}, calibcnt: {=u8:?}, startcalib: {=bool:?}, jcont: {=bool:?}, jds: {=bool:?}, jextsel: {=u8:?}, jexten: {=u8:?}, jswstart: {=bool:?}, rch: {=u8:?}, rcont: {=bool:?}, rswstart: {=bool:?}, fast: {=bool:?} }}" , self . adon () , self . calibcnt () , self . startcalib () , self . jcont () , self . jds () , self . jextsel () , self . jexten () , self . jswstart () , self . rch () , self . rcont () , self . rswstart () , self . fast ()) } } # [doc = "interrupt and status register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Isr { Isr (0) } } impl core :: fmt :: Debug for Isr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Isr") . field ("eocalf" , & self . eocalf ()) . field ("jeocf" , & self . jeocf ()) . field ("jovrf" , & self . jovrf ()) . field ("reocf" , & self . reocf ()) . field ("rovrf" , & self . rovrf ()) . field ("calibip" , & self . calibip ()) . field ("jcip" , & self . jcip ()) . field ("rcip" , & self . rcip ()) . field ("stabip" , & self . stabip ()) . field ("initrdy" , & self . initrdy ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Isr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Isr {{ eocalf: {=bool:?}, jeocf: {=bool:?}, jovrf: {=bool:?}, reocf: {=bool:?}, rovrf: {=bool:?}, calibip: {=bool:?}, jcip: {=bool:?}, rcip: {=bool:?}, stabip: {=bool:?}, initrdy: {=bool:?} }}" , self . eocalf () , self . jeocf () , self . jovrf () , self . reocf () , self . rovrf () , self . calibip () , self . jcip () , self . rcip () , self . stabip () , self . initrdy ()) } } # [doc = "injected channel group selection register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Jchgr { Jchgr (0) } } impl core :: fmt :: Debug for Jchgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Jchgr") . field ("jchg" , & self . jchg ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Jchgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jchgr {{ jchg: {=u16:?} }}" , self . jchg ()) } } # [doc = "data register for injected group."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Jdatar { Jdatar (0) } } impl core :: fmt :: Debug for Jdatar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Jdatar") . field ("jdata" , & self . jdata ()) . field ("jdatach" , & self . jdatach ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Jdatar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jdatar {{ jdata: {=u16:?}, jdatach: {=u8:?} }}" , self . jdata () , self . jdatach ()) } } # [doc = "data register for the regular channel."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Rdatar { Rdatar (0) } } impl core :: fmt :: Debug for Rdatar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Rdatar") . field ("rdata" , & self . rdata ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Rdatar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Rdatar {{ rdata: {=u16:?} }}" , self . rdata ()) } } }
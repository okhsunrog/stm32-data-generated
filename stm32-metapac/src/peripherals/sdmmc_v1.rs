...
impl defmt :: Format for Argr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Argr {{ cmdarg: {=u32:?} }}" , self . cmdarg ()) } } # [doc = "SDI clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Clkcr { Clkcr (0) } } impl core :: fmt :: Debug for Clkcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Clkcr") . field ("clkdiv" , & self . clkdiv ()) . field ("clken" , & self . clken ()) . field ("pwrsav" , & self . pwrsav ()) . field ("bypass" , & self . bypass ()) . field ("widbus" , & self . widbus ()) . field ("negedge" , & self . negedge ()) . field ("hwfc_en" , & self . hwfc_en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Clkcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Clkcr {{ clkdiv: {=u8:?}, clken: {=bool:?}, pwrsav: {=bool:?}, bypass: {=bool:?}, widbus: {=u8:?}, negedge: {=bool:?}, hwfc_en: {=bool:?} }}" , self . clkdiv () , self . clken () , self . pwrsav () , self . bypass () , self . widbus () , self . negedge () , self . hwfc_en ()) } } # [doc = "command register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cmdr { Cmdr (0) } } impl core :: fmt :: Debug for Cmdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cmdr") . field ("cmdindex" , & self . cmdindex ()) . field ("waitresp" , & self . waitresp ()) . field ("waitint" , & self . waitint ()) . field ("waitpend" , & self . waitpend ()) . field ("cpsmen" , & self . cpsmen ()) . field ("sdiosuspend" , & self . sdiosuspend ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cmdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cmdr {{ cmdindex: {=u8:?}, waitresp: {=u8:?}, waitint: {=bool:?}, waitpend: {=bool:?}, cpsmen: {=bool:?}, sdiosuspend: {=bool:?} }}" , self . cmdindex () , self . waitresp () , self . waitint () , self . waitpend () , self . cpsmen () , self . sdiosuspend ()) } } # [doc = "data counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dcntr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dcntr {{ datacount: {=u32:?} }}" , self . datacount ()) } } # [doc = "data control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dlenr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dlenr {{ datalength: {=u32:?} }}" , self . datalength ()) } } # [doc = "data timer register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dtimer { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dtimer {{ datatime: {=u32:?} }}" , self . datatime ()) } } # [doc = "FIFO counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fifocnt { Fifocnt (0) } } impl core :: fmt :: Debug for Fifocnt { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fifocnt") . field ("fifocount" , & self . fifocount ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fifocnt { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fifocnt {{ fifocount: {=u32:?} }}" , self . fifocount ()) } } # [doc = "data FIFO register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fifor { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fifor {{ fifodata: {=u32:?} }}" , self . fifodata ()) } } # [doc = "interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icr { Icr (0) } } impl core :: fmt :: Debug for Icr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icr") . field ("ccrcfailc" , & self . ccrcfailc ()) . field ("dcrcfailc" , & self . dcrcfailc ()) . field ("ctimeoutc" , & self . ctimeoutc ()) . field ("dtimeoutc" , & self . dtimeoutc ()) . field ("txunderrc" , & self . txunderrc ()) . field ("rxoverrc" , & self . rxoverrc ()) . field ("cmdrendc" , & self . cmdrendc ()) . field ("cmdsentc" , & self . cmdsentc ()) . field ("dataendc" , & self . dataendc ()) . field ("stbiterrc" , & self . stbiterrc ()) . field ("dbckendc" , & self . dbckendc ()) . field ("sdioitc" , & self . sdioitc ()) . finish () } } # [cfg (feature = "defmt")]
...
fn default () -> Power { Power (0) } } impl core :: fmt :: Debug for Power { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Power") . field ("pwrctrl" , & self . pwrctrl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Power { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Power {{ pwrctrl: {=u8:?} }}" , self . pwrctrl ()) } } # [doc = "command response register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Respcmdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Respcmdr {{ respcmd: {=u8:?} }}" , self . respcmd ()) } } # [doc = "response 1..4 register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for RespxR { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "RespxR {{ cardstatus: {=u32:?} }}" , self . cardstatus ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

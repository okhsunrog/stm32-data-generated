...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("capture" , & self . capture ()) . field ("cm" , & self . cm ()) . field ("crop" , & self . crop ()) . field ("jpeg" , & self . jpeg ()) . field ("ess" , & self . ess ()) . field ("pckpol" , & self . pckpol ()) . field ("hspol" , & self . hspol ()) . field ("vspol" , & self . vspol ()) . field ("fcrc" , & self . fcrc ()) . field ("edm" , & self . edm ()) . field ("enable" , & self . enable ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ capture: {=bool:?}, cm: {=bool:?}, crop: {=bool:?}, jpeg: {=bool:?}, ess: {=bool:?}, pckpol: {=bool:?}, hspol: {=bool:?}, vspol: {=bool:?}, fcrc: {=u8:?}, edm: {=u8:?}, enable: {=bool:?} }}" , self . capture () , self . cm () , self . crop () , self . jpeg () , self . ess () , self . pckpol () , self . hspol () , self . vspol () , self . fcrc () , self . edm () , self . enable ()) } } # [doc = "crop window size"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cwsize { Cwsize (0) } } impl core :: fmt :: Debug for Cwsize { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cwsize") . field ("capcnt" , & self . capcnt ()) . field ("vline" , & self . vline ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cwsize { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cwsize {{ capcnt: {=u16:?}, vline: {=u16:?} }}" , self . capcnt () , self . vline ()) } } # [doc = "crop window start"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cwstrt { Cwstrt (0) } } impl core :: fmt :: Debug for Cwstrt { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cwstrt") . field ("hoffcnt" , & self . hoffcnt ()) . field ("vst" , & self . vst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cwstrt { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cwstrt {{ hoffcnt: {=u16:?}, vst: {=u16:?} }}" , self . hoffcnt () , self . vst ()) } } # [doc = "data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dr { Dr (0) } } impl core :: fmt :: Debug for Dr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dr") . field ("byte0" , & self . byte0 ()) . field ("byte1" , & self . byte1 ()) . field ("byte2" , & self . byte2 ()) . field ("byte3" , & self . byte3 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ byte0: {=u8:?}, byte1: {=u8:?}, byte2: {=u8:?}, byte3: {=u8:?} }}" , self . byte0 () , self . byte1 () , self . byte2 () , self . byte3 ()) } } # [doc = "embedded synchronization code register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Escr { Escr (0) } } impl core :: fmt :: Debug for Escr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Escr") . field ("fsc" , & self . fsc ()) . field ("lsc" , & self . lsc ()) . field ("lec" , & self . lec ()) . field ("fec" , & self . fec ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Escr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Escr {{ fsc: {=u8:?}, lsc: {=u8:?}, lec: {=u8:?}, fec: {=u8:?} }}" , self . fsc () , self . lsc () , self . lec () , self . fec ()) } } # [doc = "embedded synchronization unmask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Esur { Esur (0) } } impl core :: fmt :: Debug for Esur { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Esur") . field ("fsu" , & self . fsu ()) . field ("lsu" , & self . lsu ()) . field ("leu" , & self . leu ()) . field ("feu" , & self . feu ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Esur { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Esur {{ fsu: {=u8:?}, lsu: {=u8:?}, leu: {=u8:?}, feu: {=u8:?} }}" , self . fsu () , self . lsu () , self . leu () , self . feu ()) } } # [doc = "interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icr { Icr (0) } } impl core :: fmt :: Debug for Icr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icr") . field ("frame_isc" , & self . frame_isc ()) . field ("ovr_isc" , & self . ovr_isc ()) . field ("err_isc" , & self . err_isc ()) . field ("vsync_isc" , & self . vsync_isc ()) . field ("line_isc" , & self . line_isc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icr {{ frame_isc: {=bool:?}, ovr_isc: {=bool:?}, err_isc: {=bool:?}, vsync_isc: {=bool:?}, line_isc: {=bool:?} }}" , self . frame_isc () , self . ovr_isc () , self . err_isc () , self . vsync_isc () , self . line_isc ()) } } # [doc = "interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ier { Ier (0) } } impl core :: fmt :: Debug for Ier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ier") . field ("frame_ie" , & self . frame_ie ()) . field ("ovr_ie" , & self . ovr_ie ()) . field ("err_ie" , & self . err_ie ()) . field ("vsync_ie" , & self . vsync_ie ()) . field ("line_ie" , & self . line_ie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ier {{ frame_ie: {=bool:?}, ovr_ie: {=bool:?}, err_ie: {=bool:?}, vsync_ie: {=bool:?}, line_ie: {=bool:?} }}" , self . frame_ie () , self . ovr_ie () , self . err_ie () , self . vsync_ie () , self . line_ie ()) } } # [doc = "masked interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mis { Mis (0) } } impl core :: fmt :: Debug for Mis { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mis") . field ("frame_mis" , & self . frame_mis ()) . field ("ovr_mis" , & self . ovr_mis ()) . field ("err_mis" , & self . err_mis ()) . field ("vsync_mis" , & self . vsync_mis ()) . field ("line_mis" , & self . line_mis ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mis { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mis {{ frame_mis: {=bool:?}, ovr_mis: {=bool:?}, err_mis: {=bool:?}, vsync_mis: {=bool:?}, line_mis: {=bool:?} }}" , self . frame_mis () , self . ovr_mis () , self . err_mis () , self . vsync_mis () , self . line_mis ()) } } # [doc = "raw interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ris { Ris (0) } } impl core :: fmt :: Debug for Ris { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ris") . field ("frame_ris" , & self . frame_ris ()) . field ("ovr_ris" , & self . ovr_ris ()) . field ("err_ris" , & self . err_ris ()) . field ("vsync_ris" , & self . vsync_ris ()) . field ("line_ris" , & self . line_ris ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ris { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ris {{ frame_ris: {=bool:?}, ovr_ris: {=bool:?}, err_ris: {=bool:?}, vsync_ris: {=bool:?}, line_ris: {=bool:?} }}" , self . frame_ris () , self . ovr_ris () , self . err_ris () , self . vsync_ris () , self . line_ris ()) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("hsync" , & self . hsync ()) . field ("vsync" , & self . vsync ()) . field ("fne" , & self . fne ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ hsync: {=bool:?}, vsync: {=bool:?}, fne: {=bool:?} }}" , self . hsync () , self . vsync () , self . fne ()) } } }
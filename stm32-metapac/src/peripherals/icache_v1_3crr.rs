...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("en" , & self . en ()) . field ("cacheinv" , & self . cacheinv ()) . field ("waysel" , & self . waysel ()) . field ("hitmen" , & self . hitmen ()) . field ("missmen" , & self . missmen ()) . field ("hitmrst" , & self . hitmrst ()) . field ("missmrst" , & self . missmrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ en: {=bool:?}, cacheinv: {=bool:?}, waysel: {:?}, hitmen: {=bool:?}, missmen: {=bool:?}, hitmrst: {=bool:?}, missmrst: {=bool:?} }}" , self . en () , self . cacheinv () , self . waysel () , self . hitmen () , self . missmen () , self . hitmrst () , self . missmrst ()) } } # [doc = "ICACHE region configuration register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Crr { Crr (0) } } impl core :: fmt :: Debug for Crr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Crr") . field ("baseaddr" , & self . baseaddr ()) . field ("rsize" , & self . rsize ()) . field ("ren" , & self . ren ()) . field ("remapaddr" , & self . remapaddr ()) . field ("mstsel" , & self . mstsel ()) . field ("hburst" , & self . hburst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Crr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Crr {{ baseaddr: {=u8:?}, rsize: {:?}, ren: {=bool:?}, remapaddr: {=u16:?}, mstsel: {:?}, hburst: {:?} }}" , self . baseaddr () , self . rsize () , self . ren () , self . remapaddr () , self . mstsel () , self . hburst ()) } } # [doc = "ICACHE flag clear register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fcr { Fcr (0) } } impl core :: fmt :: Debug for Fcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fcr") . field ("cbsyendf" , & self . cbsyendf ()) . field ("cerrf" , & self . cerrf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fcr {{ cbsyendf: {=bool:?}, cerrf: {=bool:?} }}" , self . cbsyendf () , self . cerrf ()) } } # [doc = "ICACHE interrupt enable register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ier { Ier (0) } } impl core :: fmt :: Debug for Ier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ier") . field ("bsyendie" , & self . bsyendie ()) . field ("errie" , & self . errie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ier {{ bsyendie: {=bool:?}, errie: {=bool:?} }}" , self . bsyendie () , self . errie ()) } } # [doc = "ICACHE miss monitor register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mmonr { Mmonr (0) } } impl core :: fmt :: Debug for Mmonr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mmonr") . field ("missmon" , & self . missmon ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mmonr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Mmonr {{ missmon: {=u16:?} }}" , self . missmon ()) } } # [doc = "ICACHE status register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("busyf" , & self . busyf ()) . field ("bsyendf" , & self . bsyendf ()) . field ("errf" , & self . errf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ busyf: {=bool:?}, bsyendf: {=bool:?}, errf: {=bool:?} }}" , self . busyf () , self . bsyendf () , self . errf ()) } } } pub mod vals { # [repr (u8)]
...
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]
pub enum Rsize { _RESERVED_0 = 0x0 , MEGA_BYTES2 = 0x01 , MEGA_BYTES4 = 0x02 , MEGA_BYTES8 = 0x03 , MEGA_BYTES16 = 0x04 , MEGA_BYTES32 = 0x05 , MEGA_BYTES64 = 0x06 , MEGA_BYTES128 = 0x07 , } impl Rsize { # [inline (always)]
...
DIRECT_MAPPED = 0x0 , # [doc = "n-way set associative cache (reset value)"]
NWAY_SET_ASSOCIATIVE = 0x01 , } impl Waysel { # [inline (always)]

...
impl defmt :: Format for ArrCore { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "ArrCore {{ arr: {=u16:?} }}" , self . arr ()) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ccr1ch { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr1ch {{ ccr: {=u16:?} }}" , self . ccr ()) } } # [doc = "counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DcrGp16 { DcrGp16 (0) } } impl core :: fmt :: Debug for DcrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DcrGp16") . field ("dba" , & self . dba ()) . field ("dbl" , & self . dbl ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for DcrGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "DcrGp16 {{ dba: {=u8:?}, dbl: {=u8:?} }}" , self . dba () , self . dbl ()) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for EgrGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "EgrGp16 {{ ug: {=bool:?}, ccg[0]: {=bool:?}, ccg[1]: {=bool:?}, ccg[2]: {=bool:?}, ccg[3]: {=bool:?}, tg: {=bool:?} }}" , self . ug () , self . ccg (0usize) , self . ccg (1usize) , self . ccg (2usize) , self . ccg (3usize) , self . tg ()) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for SrGp16 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "SrGp16 {{ uif: {=bool:?}, ccif[0]: {=bool:?}, ccif[1]: {=bool:?}, ccif[2]: {=bool:?}, ccif[3]: {=bool:?}, tif: {=bool:?}, ccof[0]: {=bool:?}, ccof[1]: {=bool:?}, ccof[2]: {=bool:?}, ccof[3]: {=bool:?} }}" , self . uif () , self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) , self . tif () , self . ccof (0usize) , self . ccof (1usize) , self . ccof (2usize) , self . ccof (3usize)) } } } pub mod vals { # [repr (u8)]

...
fn default () -> Cr2 { Cr2 (0) } } impl core :: fmt :: Debug for Cr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2") . field ("adon" , & self . adon ()) . field ("cont" , & self . cont ()) . field ("dma" , & self . dma ()) . field ("dds" , & self . dds ()) . field ("eocs" , & self . eocs ()) . field ("align" , & self . align ()) . field ("jextsel" , & self . jextsel ()) . field ("jexten" , & self . jexten ()) . field ("jswstart" , & self . jswstart ()) . field ("extsel" , & self . extsel ()) . field ("exten" , & self . exten ()) . field ("swstart" , & self . swstart ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2 {{ adon: {=bool:?}, cont: {=bool:?}, dma: {=bool:?}, dds: {:?}, eocs: {:?}, align: {:?}, jextsel: {=u8:?}, jexten: {:?}, jswstart: {=bool:?}, extsel: {=u8:?}, exten: {:?}, swstart: {=bool:?} }}" , self . adon () , self . cont () , self . dma () , self . dds () , self . eocs () , self . align () , self . jextsel () , self . jexten () , self . jswstart () , self . extsel () , self . exten () , self . swstart ()) } } # [doc = "regular data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Jdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jdr {{ jdata: {=u16:?} }}" , self . jdata ()) } } # [doc = "injected channel data offset register x"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Jofr { Jofr (0) } } impl core :: fmt :: Debug for Jofr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Jofr") . field ("joffset" , & self . joffset ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Jofr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jofr {{ joffset: {=u16:?} }}" , self . joffset ()) } } # [doc = "injected sequence register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr1 { Smpr1 (0) } } impl core :: fmt :: Debug for Smpr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr1") . field ("smp[0]" , & self . smp (0usize)) . field ("smp[1]" , & self . smp (1usize)) . field ("smp[2]" , & self . smp (2usize)) . field ("smp[3]" , & self . smp (3usize)) . field ("smp[4]" , & self . smp (4usize)) . field ("smp[5]" , & self . smp (5usize)) . field ("smp[6]" , & self . smp (6usize)) . field ("smp[7]" , & self . smp (7usize)) . field ("smp[8]" , & self . smp (8usize)) . field ("smpx_x" , & self . smpx_x ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smpr1 {{ smp[0]: {:?}, smp[1]: {:?}, smp[2]: {:?}, smp[3]: {:?}, smp[4]: {:?}, smp[5]: {:?}, smp[6]: {:?}, smp[7]: {:?}, smp[8]: {:?}, smpx_x: {:?} }}" , self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) , self . smpx_x ()) } } # [doc = "sample time register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr2 { Smpr2 (0) } } impl core :: fmt :: Debug for Smpr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr2") . field ("smp[0]" , & self . smp (0usize)) . field ("smp[1]" , & self . smp (1usize)) . field ("smp[2]" , & self . smp (2usize)) . field ("smp[3]" , & self . smp (3usize)) . field ("smp[4]" , & self . smp (4usize)) . field ("smp[5]" , & self . smp (5usize)) . field ("smp[6]" , & self . smp (6usize)) . field ("smp[7]" , & self . smp (7usize)) . field ("smp[8]" , & self . smp (8usize)) . field ("smp[9]" , & self . smp (9usize)) . field ("smpx_x" , & self . smpx_x ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Smpr2 {{ smp[0]: {:?}, smp[1]: {:?}, smp[2]: {:?}, smp[3]: {:?}, smp[4]: {:?}, smp[5]: {:?}, smp[6]: {:?}, smp[7]: {:?}, smp[8]: {:?}, smp[9]: {:?}, smpx_x: {:?} }}" , self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) , self . smp (9usize) , self . smpx_x ()) } } # [doc = "regular sequence register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Sqr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sqr3 {{ sq[0]: {=u8:?}, sq[1]: {=u8:?}, sq[2]: {=u8:?}, sq[3]: {=u8:?}, sq[4]: {=u8:?}, sq[5]: {=u8:?} }}" , self . sq (0usize) , self . sq (1usize) , self . sq (2usize) , self . sq (3usize) , self . sq (4usize) , self . sq (5usize)) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
ALL_CHANNELS = 0x0 , # [doc = "Analog watchdog enabled on a single channel"]
SINGLE_CHANNEL = 0x01 , } impl Awdsgl { # [inline (always)]
...
EACH_SEQUENCE = 0x0 , # [doc = "The EOC bit is set at the end of each regular conversion"]
EACH_CONVERSION = 0x01 , } impl Eocs { # [inline (always)]
...
pub struct SmprSmpxX (u32) ; impl SmprSmpxX { # [doc = "3 cycles"]
...
pub const CYCLES480 : Self = Self (0x07) ; } impl SmprSmpxX { pub const fn from_bits (val : u32) -> SmprSmpxX { Self (val & 0xffff_ffff) } pub const fn to_bits (self) -> u32 { self . 0 } } impl core :: fmt :: Debug for SmprSmpxX { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { match self . 0 { 0x0 => f . write_str ("CYCLES3") , 0x01 => f . write_str ("CYCLES15") , 0x02 => f . write_str ("CYCLES28") , 0x03 => f . write_str ("CYCLES56") , 0x04 => f . write_str ("CYCLES84") , 0x05 => f . write_str ("CYCLES112") , 0x06 => f . write_str ("CYCLES144") , 0x07 => f . write_str ("CYCLES480") , other => core :: write ! (f , "0x{:02X}" , other) , } } } # [cfg (feature = "defmt")]
impl defmt :: Format for SmprSmpxX { fn format (& self , f : defmt :: Formatter) { match self . 0 { 0x0 => defmt :: write ! (f , "CYCLES3") , 0x01 => defmt :: write ! (f , "CYCLES15") , 0x02 => defmt :: write ! (f , "CYCLES28") , 0x03 => defmt :: write ! (f , "CYCLES56") , 0x04 => defmt :: write ! (f , "CYCLES84") , 0x05 => defmt :: write ! (f , "CYCLES112") , 0x06 => defmt :: write ! (f , "CYCLES144") , 0x07 => defmt :: write ! (f , "CYCLES480") , other => defmt :: write ! (f , "0x{:02X}" , other) , } } } impl From < u32 > for SmprSmpxX { # [inline (always)]

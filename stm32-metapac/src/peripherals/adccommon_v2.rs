...
fn default () -> Ccr { Ccr (0) } } impl core :: fmt :: Debug for Ccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr") . field ("multi" , & self . multi ()) . field ("delay" , & self . delay ()) . field ("dds" , & self . dds ()) . field ("dma" , & self . dma ()) . field ("adcpre" , & self . adcpre ()) . field ("vbate" , & self . vbate ()) . field ("tsvrefe" , & self . tsvrefe ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr {{ multi: {:?}, delay: {=u8:?}, dds: {:?}, dma: {:?}, adcpre: {:?}, vbate: {=bool:?}, tsvrefe: {=bool:?} }}" , self . multi () , self . delay () , self . dds () , self . dma () , self . adcpre () , self . vbate () , self . tsvrefe ()) } } # [doc = "ADC common regular data register for dual and triple modes"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cdr { Cdr (0) } } impl core :: fmt :: Debug for Cdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cdr") . field ("data[0]" , & self . data (0usize)) . field ("data[1]" , & self . data (1usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cdr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cdr {{ data[0]: {=u16:?}, data[1]: {=u16:?} }}" , self . data (0usize) , self . data (1usize)) } } # [doc = "ADC common status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("awd[0]" , & self . awd (0usize)) . field ("awd[1]" , & self . awd (1usize)) . field ("awd[2]" , & self . awd (2usize)) . field ("eoc[0]" , & self . eoc (0usize)) . field ("eoc[1]" , & self . eoc (1usize)) . field ("eoc[2]" , & self . eoc (2usize)) . field ("jeoc[0]" , & self . jeoc (0usize)) . field ("jeoc[1]" , & self . jeoc (1usize)) . field ("jeoc[2]" , & self . jeoc (2usize)) . field ("jstrt[0]" , & self . jstrt (0usize)) . field ("jstrt[1]" , & self . jstrt (1usize)) . field ("jstrt[2]" , & self . jstrt (2usize)) . field ("strt[0]" , & self . strt (0usize)) . field ("strt[1]" , & self . strt (1usize)) . field ("strt[2]" , & self . strt (2usize)) . field ("ovr[0]" , & self . ovr (0usize)) . field ("ovr[1]" , & self . ovr (1usize)) . field ("ovr[2]" , & self . ovr (2usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Csr {{ awd[0]: {=bool:?}, awd[1]: {=bool:?}, awd[2]: {=bool:?}, eoc[0]: {=bool:?}, eoc[1]: {=bool:?}, eoc[2]: {=bool:?}, jeoc[0]: {=bool:?}, jeoc[1]: {=bool:?}, jeoc[2]: {=bool:?}, jstrt[0]: {=bool:?}, jstrt[1]: {=bool:?}, jstrt[2]: {=bool:?}, strt[0]: {=bool:?}, strt[1]: {=bool:?}, strt[2]: {=bool:?}, ovr[0]: {=bool:?}, ovr[1]: {=bool:?}, ovr[2]: {=bool:?} }}" , self . awd (0usize) , self . awd (1usize) , self . awd (2usize) , self . eoc (0usize) , self . eoc (1usize) , self . eoc (2usize) , self . jeoc (0usize) , self . jeoc (1usize) , self . jeoc (2usize) , self . jstrt (0usize) , self . jstrt (1usize) , self . jstrt (2usize) , self . strt (0usize) , self . strt (1usize) , self . strt (2usize) , self . ovr (0usize) , self . ovr (1usize) , self . ovr (2usize)) } } } pub mod vals { # [repr (u8)]
...
DUAL_RJ = 0x01 , # [doc = "Dual ADC1 and ADC2, combined regular and alternate trigger mode"]
DUAL_RA = 0x02 , _RESERVED_3 = 0x03 , _RESERVED_4 = 0x04 , # [doc = "Dual ADC1 and ADC2, injected simultaneous mode only"]
DUAL_J = 0x05 , # [doc = "Dual ADC1 and ADC2, regular simultaneous mode only"]
DUAL_R = 0x06 , # [doc = "Dual ADC1 and ADC2, interleaved mode only"]
DUAL_I = 0x07 , _RESERVED_8 = 0x08 , # [doc = "Dual ADC1 and ADC2, alternate trigger mode only"]
DUAL_A = 0x09 , _RESERVED_a = 0x0a , _RESERVED_b = 0x0b , _RESERVED_c = 0x0c , _RESERVED_d = 0x0d , _RESERVED_e = 0x0e , _RESERVED_f = 0x0f , _RESERVED_10 = 0x10 , # [doc = "Triple ADC, regular and injected simultaneous mode"]
TRIPLE_RJ = 0x11 , # [doc = "Triple ADC, regular and alternate trigger mode"]
TRIPLE_RA = 0x12 , _RESERVED_13 = 0x13 , _RESERVED_14 = 0x14 , # [doc = "Triple ADC, injected simultaneous mode only"]
TRIPLE_J = 0x15 , # [doc = "Triple ADC, regular simultaneous mode only"]
TRIPLE_R = 0x16 , # [doc = "Triple ADC, interleaved mode only"]
TRIPLE_I = 0x17 , # [doc = "Triple ADC, alternate trigger mode only"]
TRIPLE_A = 0x18 , _RESERVED_19 = 0x19 , _RESERVED_1a = 0x1a , _RESERVED_1b = 0x1b , _RESERVED_1c = 0x1c , _RESERVED_1d = 0x1d , _RESERVED_1e = 0x1e , _RESERVED_1f = 0x1f , } impl Multi { # [inline (always)]

...
# [inline (always)]
pub fn set_extevnt (& mut self , n : usize , val : bool) { assert ! (n < 10usize) ; let offs = 9usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Timer X compare 1 event"]
# [inline (always)]
pub const fn tcmp1 (& self , n : usize) -> bool { assert ! (n < 4usize) ; let offs = 19usize + ([0usize , 3usize , 6usize , 9usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Timer X compare 1 event"]
# [inline (always)]
pub fn set_tcmp1 (& mut self , n : usize , val : bool) { assert ! (n < 4usize) ; let offs = 19usize + ([0usize , 3usize , 6usize , 9usize]
[n]
as usize) ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Timer X compare 2 event"]
# [inline (always)]
pub const fn tcmp2 (& self , n : usize) -> bool { assert ! (n < 4usize) ; let offs = 20usize + ([0usize , 3usize , 6usize , 9usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Timer X compare 2 event"]
# [inline (always)]
pub fn set_tcmp2 (& mut self , n : usize , val : bool) { assert ! (n < 4usize) ; let offs = 20usize + ([0usize , 3usize , 6usize , 9usize]
[n]
...
fn default () -> Timxrst { Timxrst (0) } } impl core :: fmt :: Debug for Timxrst { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Timxrst") . field ("updt" , & self . updt ()) . field ("cmp[0]" , & self . cmp (0usize)) . field ("cmp[1]" , & self . cmp (1usize)) . field ("mstper" , & self . mstper ()) . field ("mstcmp[0]" , & self . mstcmp (0usize)) . field ("mstcmp[1]" , & self . mstcmp (1usize)) . field ("mstcmp[2]" , & self . mstcmp (2usize)) . field ("mstcmp[3]" , & self . mstcmp (3usize)) . field ("extevnt[0]" , & self . extevnt (0usize)) . field ("extevnt[1]" , & self . extevnt (1usize)) . field ("extevnt[2]" , & self . extevnt (2usize)) . field ("extevnt[3]" , & self . extevnt (3usize)) . field ("extevnt[4]" , & self . extevnt (4usize)) . field ("extevnt[5]" , & self . extevnt (5usize)) . field ("extevnt[6]" , & self . extevnt (6usize)) . field ("extevnt[7]" , & self . extevnt (7usize)) . field ("extevnt[8]" , & self . extevnt (8usize)) . field ("extevnt[9]" , & self . extevnt (9usize)) . field ("tcmp1[0]" , & self . tcmp1 (0usize)) . field ("tcmp1[1]" , & self . tcmp1 (1usize)) . field ("tcmp1[2]" , & self . tcmp1 (2usize)) . field ("tcmp1[3]" , & self . tcmp1 (3usize)) . field ("tcmp2[0]" , & self . tcmp2 (0usize)) . field ("tcmp2[1]" , & self . tcmp2 (1usize)) . field ("tcmp2[2]" , & self . tcmp2 (2usize)) . field ("tcmp2[3]" , & self . tcmp2 (3usize)) . field ("tcmp4[0]" , & self . tcmp4 (0usize)) . field ("tcmp4[1]" , & self . tcmp4 (1usize)) . field ("tcmp4[2]" , & self . tcmp4 (2usize)) . field ("tcmp4[3]" , & self . tcmp4 (3usize)) . finish () } } # [cfg (feature = "defmt")]

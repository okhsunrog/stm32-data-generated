...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("en" , & self . en ()) . field ("dmeie" , & self . dmeie ()) . field ("teie" , & self . teie ()) . field ("htie" , & self . htie ()) . field ("tcie" , & self . tcie ()) . field ("pfctrl" , & self . pfctrl ()) . field ("dir" , & self . dir ()) . field ("circ" , & self . circ ()) . field ("pinc" , & self . pinc ()) . field ("minc" , & self . minc ()) . field ("psize" , & self . psize ()) . field ("msize" , & self . msize ()) . field ("pincos" , & self . pincos ()) . field ("pl" , & self . pl ()) . field ("dbm" , & self . dbm ()) . field ("ct" , & self . ct ()) . field ("trbuff" , & self . trbuff ()) . field ("pburst" , & self . pburst ()) . field ("mburst" , & self . mburst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ en: {=bool:?}, dmeie: {=bool:?}, teie: {=bool:?}, htie: {=bool:?}, tcie: {=bool:?}, pfctrl: {:?}, dir: {:?}, circ: {=bool:?}, pinc: {=bool:?}, minc: {=bool:?}, psize: {:?}, msize: {:?}, pincos: {:?}, pl: {:?}, dbm: {=bool:?}, ct: {:?}, trbuff: {=bool:?}, pburst: {:?}, mburst: {:?} }}" , self . en () , self . dmeie () , self . teie () , self . htie () , self . tcie () , self . pfctrl () , self . dir () , self . circ () , self . pinc () , self . minc () , self . psize () , self . msize () , self . pincos () , self . pl () , self . dbm () , self . ct () , self . trbuff () , self . pburst () , self . mburst ()) } } # [doc = "stream x FIFO control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fcr { Fcr (0) } } impl core :: fmt :: Debug for Fcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fcr") . field ("fth" , & self . fth ()) . field ("dmdis" , & self . dmdis ()) . field ("fs" , & self . fs ()) . field ("feie" , & self . feie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fcr {{ fth: {:?}, dmdis: {:?}, fs: {:?}, feie: {=bool:?} }}" , self . fth () , self . dmdis () , self . fs () , self . feie ()) } } # [doc = "interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ixr { Ixr (0) } } impl core :: fmt :: Debug for Ixr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ixr") . field ("feif[0]" , & self . feif (0usize)) . field ("feif[1]" , & self . feif (1usize)) . field ("feif[2]" , & self . feif (2usize)) . field ("feif[3]" , & self . feif (3usize)) . field ("dmeif[0]" , & self . dmeif (0usize)) . field ("dmeif[1]" , & self . dmeif (1usize)) . field ("dmeif[2]" , & self . dmeif (2usize)) . field ("dmeif[3]" , & self . dmeif (3usize)) . field ("teif[0]" , & self . teif (0usize)) . field ("teif[1]" , & self . teif (1usize)) . field ("teif[2]" , & self . teif (2usize)) . field ("teif[3]" , & self . teif (3usize)) . field ("htif[0]" , & self . htif (0usize)) . field ("htif[1]" , & self . htif (1usize)) . field ("htif[2]" , & self . htif (2usize)) . field ("htif[3]" , & self . htif (3usize)) . field ("tcif[0]" , & self . tcif (0usize)) . field ("tcif[1]" , & self . tcif (1usize)) . field ("tcif[2]" , & self . tcif (2usize)) . field ("tcif[3]" , & self . tcif (3usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ixr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ixr {{ feif[0]: {=bool:?}, feif[1]: {=bool:?}, feif[2]: {=bool:?}, feif[3]: {=bool:?}, dmeif[0]: {=bool:?}, dmeif[1]: {=bool:?}, dmeif[2]: {=bool:?}, dmeif[3]: {=bool:?}, teif[0]: {=bool:?}, teif[1]: {=bool:?}, teif[2]: {=bool:?}, teif[3]: {=bool:?}, htif[0]: {=bool:?}, htif[1]: {=bool:?}, htif[2]: {=bool:?}, htif[3]: {=bool:?}, tcif[0]: {=bool:?}, tcif[1]: {=bool:?}, tcif[2]: {=bool:?}, tcif[3]: {=bool:?} }}" , self . feif (0usize) , self . feif (1usize) , self . feif (2usize) , self . feif (3usize) , self . dmeif (0usize) , self . dmeif (1usize) , self . dmeif (2usize) , self . dmeif (3usize) , self . teif (0usize) , self . teif (1usize) , self . teif (2usize) , self . teif (3usize) , self . htif (0usize) , self . htif (1usize) , self . htif (2usize) , self . htif (3usize) , self . tcif (0usize) , self . tcif (1usize) , self . tcif (2usize) , self . tcif (3usize)) } } # [doc = "stream x number of data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ndtr { Ndtr (0) } } impl core :: fmt :: Debug for Ndtr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ndtr") . field ("ndt" , & self . ndt ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ndtr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ndtr {{ ndt: {=u16:?} }}" , self . ndt ()) } } } pub mod vals { # [repr (u8)]
...
PERIPHERAL_TO_MEMORY = 0x0 , # [doc = "Memory-to-peripheral"]
MEMORY_TO_PERIPHERAL = 0x01 , # [doc = "Memory-to-memory"]
MEMORY_TO_MEMORY = 0x02 , _RESERVED_3 = 0x03 , } impl Dir { # [inline (always)]
...
THREE_QUARTERS = 0x02 , # [doc = "Full FIFO"]
...
VERY_HIGH = 0x03 , } impl Pl { # [inline (always)]

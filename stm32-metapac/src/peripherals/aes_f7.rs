...
# [inline (always)]
pub fn set_keysize (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize) ; } } impl Default for Cr { # [inline (always)]
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("en" , & self . en ()) . field ("datatype" , & self . datatype ()) . field ("mode" , & self . mode ()) . field ("chmod10" , & self . chmod10 ()) . field ("ccfc" , & self . ccfc ()) . field ("errc" , & self . errc ()) . field ("ccfie" , & self . ccfie ()) . field ("errie" , & self . errie ()) . field ("dmainen" , & self . dmainen ()) . field ("dmaouten" , & self . dmaouten ()) . field ("gcmph" , & self . gcmph ()) . field ("chmod2" , & self . chmod2 ()) . field ("keysize" , & self . keysize ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ en: {=bool:?}, datatype: {:?}, mode: {:?}, chmod10: {=u8:?}, ccfc: {=bool:?}, errc: {=bool:?}, ccfie: {=bool:?}, errie: {=bool:?}, dmainen: {=bool:?}, dmaouten: {=bool:?}, gcmph: {:?}, chmod2: {=bool:?}, keysize: {=bool:?} }}" , self . en () , self . datatype () , self . mode () , self . chmod10 () , self . ccfc () , self . errc () , self . ccfie () , self . errie () , self . dmainen () , self . dmaouten () , self . gcmph () , self . chmod2 () , self . keysize ()) } } # [doc = "Data input register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dinr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dinr {{ din: {=u32:?} }}" , self . din ()) } } # [doc = "Data output register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Doutr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Doutr {{ dout: {=u32:?} }}" , self . dout ()) } } # [doc = "Initialization vector register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ivr { Ivr (0) } } impl core :: fmt :: Debug for Ivr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ivr") . field ("ivi" , & self . ivi ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ivr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ivr {{ ivi: {=u32:?} }}" , self . ivi ()) } } # [doc = "Key register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Keyr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Keyr {{ key: {=u32:?} }}" , self . key ()) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("ccf" , & self . ccf ()) . field ("rderr" , & self . rderr ()) . field ("wrerr" , & self . wrerr ()) . field ("busy" , & self . busy ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr {{ ccf: {=bool:?}, rderr: {=bool:?}, wrerr: {=bool:?}, busy: {=bool:?} }}" , self . ccf () , self . rderr () , self . wrerr () , self . busy ()) } } # [doc = "Suspend register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Suspr { Suspr (0) } } impl core :: fmt :: Debug for Suspr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Suspr") . field ("susp" , & self . susp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Suspr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Suspr {{ susp: {=u32:?} }}" , self . susp ()) } } } pub mod vals { # [repr (u8)]
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]
pub enum Datatype { # [doc = "Word"]
NONE = 0x0 , # [doc = "Half-word (16-bit)"]
HALF_WORD = 0x01 , # [doc = "Byte (8-bit)"]
BYTE = 0x02 , # [doc = "Bit"]

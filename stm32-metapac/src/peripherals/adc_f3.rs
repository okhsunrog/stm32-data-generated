...
fn default () -> Awdcr { Awdcr (0) } } impl core :: fmt :: Debug for Awdcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Awdcr") . field ("awd2ch0[0]" , & self . awd2ch0 (0usize)) . field ("awd2ch0[1]" , & self . awd2ch0 (1usize)) . field ("awd2ch0[2]" , & self . awd2ch0 (2usize)) . field ("awd2ch0[3]" , & self . awd2ch0 (3usize)) . field ("awd2ch0[4]" , & self . awd2ch0 (4usize)) . field ("awd2ch0[5]" , & self . awd2ch0 (5usize)) . field ("awd2ch0[6]" , & self . awd2ch0 (6usize)) . field ("awd2ch0[7]" , & self . awd2ch0 (7usize)) . field ("awd2ch0[8]" , & self . awd2ch0 (8usize)) . field ("awd2ch0[9]" , & self . awd2ch0 (9usize)) . field ("awd2ch0[10]" , & self . awd2ch0 (10usize)) . field ("awd2ch0[11]" , & self . awd2ch0 (11usize)) . field ("awd2ch0[12]" , & self . awd2ch0 (12usize)) . field ("awd2ch0[13]" , & self . awd2ch0 (13usize)) . field ("awd2ch0[14]" , & self . awd2ch0 (14usize)) . field ("awd2ch0[15]" , & self . awd2ch0 (15usize)) . field ("awd2ch0[16]" , & self . awd2ch0 (16usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Awdcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Awdcr {{ awd2ch0[0]: {=bool:?}, awd2ch0[1]: {=bool:?}, awd2ch0[2]: {=bool:?}, awd2ch0[3]: {=bool:?}, awd2ch0[4]: {=bool:?}, awd2ch0[5]: {=bool:?}, awd2ch0[6]: {=bool:?}, awd2ch0[7]: {=bool:?}, awd2ch0[8]: {=bool:?}, awd2ch0[9]: {=bool:?}, awd2ch0[10]: {=bool:?}, awd2ch0[11]: {=bool:?}, awd2ch0[12]: {=bool:?}, awd2ch0[13]: {=bool:?}, awd2ch0[14]: {=bool:?}, awd2ch0[15]: {=bool:?}, awd2ch0[16]: {=bool:?} }}" , self . awd2ch0 (0usize) , self . awd2ch0 (1usize) , self . awd2ch0 (2usize) , self . awd2ch0 (3usize) , self . awd2ch0 (4usize) , self . awd2ch0 (5usize) , self . awd2ch0 (6usize) , self . awd2ch0 (7usize) , self . awd2ch0 (8usize) , self . awd2ch0 (9usize) , self . awd2ch0 (10usize) , self . awd2ch0 (11usize) , self . awd2ch0 (12usize) , self . awd2ch0 (13usize) , self . awd2ch0 (14usize) , self . awd2ch0 (15usize) , self . awd2ch0 (16usize)) } } # [doc = "Calibration Factors"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr { Cfgr (0) } } impl core :: fmt :: Debug for Cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr") . field ("dmaen" , & self . dmaen ()) . field ("dmacfg" , & self . dmacfg ()) . field ("res" , & self . res ()) . field ("align" , & self . align ()) . field ("extsel" , & self . extsel ()) . field ("exten" , & self . exten ()) . field ("ovrmod" , & self . ovrmod ()) . field ("cont" , & self . cont ()) . field ("autdly" , & self . autdly ()) . field ("discen" , & self . discen ()) . field ("discnum" , & self . discnum ()) . field ("jdiscen" , & self . jdiscen ()) . field ("jqm" , & self . jqm ()) . field ("awd1sgl" , & self . awd1sgl ()) . field ("awd1en" , & self . awd1en ()) . field ("jawd1en" , & self . jawd1en ()) . field ("jauto" , & self . jauto ()) . field ("awd1ch" , & self . awd1ch ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr {{ dmaen: {=bool:?}, dmacfg: {:?}, res: {:?}, align: {:?}, extsel: {=u8:?}, exten: {:?}, ovrmod: {=bool:?}, cont: {=bool:?}, autdly: {=bool:?}, discen: {=bool:?}, discnum: {=u8:?}, jdiscen: {=bool:?}, jqm: {:?}, awd1sgl: {:?}, awd1en: {=bool:?}, jawd1en: {=bool:?}, jauto: {=bool:?}, awd1ch: {=u8:?} }}" , self . dmaen () , self . dmacfg () , self . res () , self . align () , self . extsel () , self . exten () , self . ovrmod () , self . cont () , self . autdly () , self . discen () , self . discnum () , self . jdiscen () , self . jqm () , self . awd1sgl () , self . awd1en () , self . jawd1en () , self . jauto () , self . awd1ch ()) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("aden" , & self . aden ()) . field ("addis" , & self . addis ()) . field ("adstart" , & self . adstart ()) . field ("jadstart" , & self . jadstart ()) . field ("adstp" , & self . adstp ()) . field ("jadstp" , & self . jadstp ()) . field ("advregen" , & self . advregen ()) . field ("adcaldif" , & self . adcaldif ()) . field ("adcal" , & self . adcal ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ aden: {=bool:?}, addis: {=bool:?}, adstart: {=bool:?}, jadstart: {=bool:?}, adstp: {=bool:?}, jadstp: {=bool:?}, advregen: {:?}, adcaldif: {=bool:?}, adcal: {=bool:?} }}" , self . aden () , self . addis () , self . adstart () , self . jadstart () , self . adstp () , self . jadstp () , self . advregen () , self . adcaldif () , self . adcal ()) } } # [doc = "Differential Mode Selection Register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Difsel { Difsel (0) } } impl core :: fmt :: Debug for Difsel { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Difsel") . field ("difsel_10" , & self . difsel_10 ()) . field ("difsel_11" , & self . difsel_11 ()) . field ("difsel_12" , & self . difsel_12 ()) . field ("difsel_13" , & self . difsel_13 ()) . field ("difsel_14" , & self . difsel_14 ()) . field ("difsel_15" , & self . difsel_15 ()) . field ("difsel_16" , & self . difsel_16 ()) . field ("difsel_17" , & self . difsel_17 ()) . field ("difsel_18" , & self . difsel_18 ()) . field ("difsel_19" , & self . difsel_19 ()) . field ("difsel_110" , & self . difsel_110 ()) . field ("difsel_111" , & self . difsel_111 ()) . field ("difsel_112" , & self . difsel_112 ()) . field ("difsel_113" , & self . difsel_113 ()) . field ("difsel_114" , & self . difsel_114 ()) . field ("difsel_115" , & self . difsel_115 ()) . field ("difsel_116" , & self . difsel_116 ()) . field ("difsel_117" , & self . difsel_117 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Difsel { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Difsel {{ difsel_10: {:?}, difsel_11: {:?}, difsel_12: {:?}, difsel_13: {:?}, difsel_14: {:?}, difsel_15: {:?}, difsel_16: {:?}, difsel_17: {:?}, difsel_18: {:?}, difsel_19: {:?}, difsel_110: {:?}, difsel_111: {:?}, difsel_112: {:?}, difsel_113: {:?}, difsel_114: {:?}, difsel_115: {:?}, difsel_116: {:?}, difsel_117: {:?} }}" , self . difsel_10 () , self . difsel_11 () , self . difsel_12 () , self . difsel_13 () , self . difsel_14 () , self . difsel_15 () , self . difsel_16 () , self . difsel_17 () , self . difsel_18 () , self . difsel_19 () , self . difsel_110 () , self . difsel_111 () , self . difsel_112 () , self . difsel_113 () , self . difsel_114 () , self . difsel_115 () , self . difsel_116 () , self . difsel_117 ()) } } # [doc = "regular Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn jexten (& self) -> super :: vals :: Exten { let val = (self . 0 >> 6usize) & 0x03 ; super :: vals :: Exten :: from_bits (val as u8) } # [doc = "External Trigger Enable and Polarity Selection for injected channels"]
# [inline (always)]
pub fn set_jexten (& mut self , val : super :: vals :: Exten) { self . 0 = (self . 0 & ! (0x03 << 6usize)) | (((val . to_bits () as u32) & 0x03) << 6usize) ; } # [doc = "X conversion in the injected sequence"]
# [inline (always)]
...
impl defmt :: Format for Jsqr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Jsqr {{ jl: {=u8:?}, jextsel: {=u8:?}, jexten: {:?}, jsq[0]: {=u8:?}, jsq[1]: {=u8:?}, jsq[2]: {=u8:?}, jsq[3]: {=u8:?} }}" , self . jl () , self . jextsel () , self . jexten () , self . jsq (0usize) , self . jsq (1usize) , self . jsq (2usize) , self . jsq (3usize)) } } # [doc = "offset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ofr { Ofr (0) } } impl core :: fmt :: Debug for Ofr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ofr") . field ("offset" , & self . offset ()) . field ("ch" , & self . ch ()) . field ("en" , & self . en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ofr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ofr {{ offset: {=u16:?}, ch: {=u8:?}, en: {=bool:?} }}" , self . offset () , self . ch () , self . en ()) } } # [doc = "sample time register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tr1 { Tr1 (0) } } impl core :: fmt :: Debug for Tr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tr1") . field ("lt1" , & self . lt1 ()) . field ("ht1" , & self . ht1 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Tr1 {{ lt1: {=u16:?}, ht1: {=u16:?} }}" , self . lt1 () , self . ht1 ()) } } # [doc = "watchdog threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

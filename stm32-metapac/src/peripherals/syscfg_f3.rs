...
fn default () -> Cfgr1 { Cfgr1 (0) } } impl core :: fmt :: Debug for Cfgr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr1") . field ("mem_mode" , & self . mem_mode ()) . field ("usb_it_rmp" , & self . usb_it_rmp ()) . field ("tim1_itr3_rmp" , & self . tim1_itr3_rmp ()) . field ("dac1_trig_rmp" , & self . dac1_trig_rmp ()) . field ("dac_trig_rmp" , & self . dac_trig_rmp ()) . field ("adc2_dma_rmp" , & self . adc2_dma_rmp ()) . field ("tim16_dma_rmp" , & self . tim16_dma_rmp ()) . field ("tim17_dma_rmp" , & self . tim17_dma_rmp ()) . field ("tim6_dac1_ch1_dma_rmp" , & self . tim6_dac1_ch1_dma_rmp ()) . field ("tim6_dac1_dma_rmp" , & self . tim6_dac1_dma_rmp ()) . field ("tim6_dac1_out1_dma_rmp" , & self . tim6_dac1_out1_dma_rmp ()) . field ("tim7_dac1_ch2_dma_rmp" , & self . tim7_dac1_ch2_dma_rmp ()) . field ("tim7_dac1_out2_dma_rmp" , & self . tim7_dac1_out2_dma_rmp ()) . field ("dac2_ch1_dma_rmp" , & self . dac2_ch1_dma_rmp ()) . field ("tim18_dac2_out1_dma_rmp" , & self . tim18_dac2_out1_dma_rmp ()) . field ("i2c_pb6_fmp" , & self . i2c_pb6_fmp ()) . field ("i2c_pb7_fmp" , & self . i2c_pb7_fmp ()) . field ("i2c_pb8_fmp" , & self . i2c_pb8_fmp ()) . field ("i2c_pb9_fmp" , & self . i2c_pb9_fmp ()) . field ("i2c1_fmp" , & self . i2c1_fmp ()) . field ("i2c2_fmp" , & self . i2c2_fmp ()) . field ("encoder_mode" , & self . encoder_mode ()) . field ("i2c3_fmp" , & self . i2c3_fmp ()) . field ("vbat_mon" , & self . vbat_mon ()) . field ("fpu_ie[0]" , & self . fpu_ie (0usize)) . field ("fpu_ie[1]" , & self . fpu_ie (1usize)) . field ("fpu_ie[2]" , & self . fpu_ie (2usize)) . field ("fpu_ie[3]" , & self . fpu_ie (3usize)) . field ("fpu_ie[4]" , & self . fpu_ie (4usize)) . field ("fpu_ie[5]" , & self . fpu_ie (5usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr1 {{ mem_mode: {:?}, usb_it_rmp: {=bool:?}, tim1_itr3_rmp: {=bool:?}, dac1_trig_rmp: {=bool:?}, dac_trig_rmp: {=bool:?}, adc2_dma_rmp: {=bool:?}, tim16_dma_rmp: {=bool:?}, tim17_dma_rmp: {=bool:?}, tim6_dac1_ch1_dma_rmp: {=bool:?}, tim6_dac1_dma_rmp: {=bool:?}, tim6_dac1_out1_dma_rmp: {=bool:?}, tim7_dac1_ch2_dma_rmp: {=bool:?}, tim7_dac1_out2_dma_rmp: {=bool:?}, dac2_ch1_dma_rmp: {=bool:?}, tim18_dac2_out1_dma_rmp: {=bool:?}, i2c_pb6_fmp: {:?}, i2c_pb7_fmp: {:?}, i2c_pb8_fmp: {:?}, i2c_pb9_fmp: {:?}, i2c1_fmp: {:?}, i2c2_fmp: {:?}, encoder_mode: {:?}, i2c3_fmp: {:?}, vbat_mon: {=bool:?}, fpu_ie[0]: {=bool:?}, fpu_ie[1]: {=bool:?}, fpu_ie[2]: {=bool:?}, fpu_ie[3]: {=bool:?}, fpu_ie[4]: {=bool:?}, fpu_ie[5]: {=bool:?} }}" , self . mem_mode () , self . usb_it_rmp () , self . tim1_itr3_rmp () , self . dac1_trig_rmp () , self . dac_trig_rmp () , self . adc2_dma_rmp () , self . tim16_dma_rmp () , self . tim17_dma_rmp () , self . tim6_dac1_ch1_dma_rmp () , self . tim6_dac1_dma_rmp () , self . tim6_dac1_out1_dma_rmp () , self . tim7_dac1_ch2_dma_rmp () , self . tim7_dac1_out2_dma_rmp () , self . dac2_ch1_dma_rmp () , self . tim18_dac2_out1_dma_rmp () , self . i2c_pb6_fmp () , self . i2c_pb7_fmp () , self . i2c_pb8_fmp () , self . i2c_pb9_fmp () , self . i2c1_fmp () , self . i2c2_fmp () , self . encoder_mode () , self . i2c3_fmp () , self . vbat_mon () , self . fpu_ie (0usize) , self . fpu_ie (1usize) , self . fpu_ie (2usize) , self . fpu_ie (3usize) , self . fpu_ie (4usize) , self . fpu_ie (5usize)) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr2 { Cfgr2 (0) } } impl core :: fmt :: Debug for Cfgr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr2") . field ("lockup_lock" , & self . lockup_lock ()) . field ("sram_parity_lock" , & self . sram_parity_lock ()) . field ("pvd_lock" , & self . pvd_lock ()) . field ("byp_addr_par" , & self . byp_addr_par ()) . field ("sram_pef" , & self . sram_pef ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr2 {{ lockup_lock: {=bool:?}, sram_parity_lock: {=bool:?}, pvd_lock: {=bool:?}, byp_addr_par: {=bool:?}, sram_pef: {=bool:?} }}" , self . lockup_lock () , self . sram_parity_lock () , self . pvd_lock () , self . byp_addr_par () , self . sram_pef ()) } } # [doc = "configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr3 { Cfgr3 (0) } } impl core :: fmt :: Debug for Cfgr3 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr3") . field ("spi1_rx_dma_rmp" , & self . spi1_rx_dma_rmp ()) . field ("spi1_tx_dma_rmp" , & self . spi1_tx_dma_rmp ()) . field ("i2c1_rx_dma_rmp" , & self . i2c1_rx_dma_rmp ()) . field ("i2c1_tx_dma_rmp" , & self . i2c1_tx_dma_rmp ()) . field ("adc2_dma_rmp" , & self . adc2_dma_rmp ()) . field ("dac1_trig3_rmp" , & self . dac1_trig3_rmp ()) . field ("dac1_trig5_rmp" , & self . dac1_trig5_rmp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr3 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr3 {{ spi1_rx_dma_rmp: {:?}, spi1_tx_dma_rmp: {:?}, i2c1_rx_dma_rmp: {:?}, i2c1_tx_dma_rmp: {:?}, adc2_dma_rmp: {:?}, dac1_trig3_rmp: {:?}, dac1_trig5_rmp: {=bool:?} }}" , self . spi1_rx_dma_rmp () , self . spi1_tx_dma_rmp () , self . i2c1_rx_dma_rmp () , self . i2c1_tx_dma_rmp () , self . adc2_dma_rmp () , self . dac1_trig3_rmp () , self . dac1_trig5_rmp ()) } } # [doc = "configuration register 4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr4 { Cfgr4 (0) } } impl core :: fmt :: Debug for Cfgr4 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr4") . field ("adc12_ext2_rmp" , & self . adc12_ext2_rmp ()) . field ("adc12_ext3_rmp" , & self . adc12_ext3_rmp ()) . field ("adc12_ext5_rmp" , & self . adc12_ext5_rmp ()) . field ("adc12_ext13_rmp" , & self . adc12_ext13_rmp ()) . field ("adc12_ext15_rmp" , & self . adc12_ext15_rmp ()) . field ("adc12_jext3_rmp" , & self . adc12_jext3_rmp ()) . field ("adc12_jext6_rmp" , & self . adc12_jext6_rmp ()) . field ("adc12_jext13_rmp" , & self . adc12_jext13_rmp ()) . field ("adc34_ext5_rmp" , & self . adc34_ext5_rmp ()) . field ("adc34_ext6_rmp" , & self . adc34_ext6_rmp ()) . field ("adc34_ext15_rmp" , & self . adc34_ext15_rmp ()) . field ("adc34_jext5_rmp" , & self . adc34_jext5_rmp ()) . field ("adc34_jext11_rmp" , & self . adc34_jext11_rmp ()) . field ("adc34_jext14_rmp" , & self . adc34_jext14_rmp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr4 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfgr4 {{ adc12_ext2_rmp: {:?}, adc12_ext3_rmp: {:?}, adc12_ext5_rmp: {:?}, adc12_ext13_rmp: {:?}, adc12_ext15_rmp: {:?}, adc12_jext3_rmp: {:?}, adc12_jext6_rmp: {:?}, adc12_jext13_rmp: {:?}, adc34_ext5_rmp: {:?}, adc34_ext6_rmp: {:?}, adc34_ext15_rmp: {:?}, adc34_jext5_rmp: {:?}, adc34_jext11_rmp: {:?}, adc34_jext14_rmp: {:?} }}" , self . adc12_ext2_rmp () , self . adc12_ext3_rmp () , self . adc12_ext5_rmp () , self . adc12_ext13_rmp () , self . adc12_ext15_rmp () , self . adc12_jext3_rmp () , self . adc12_jext6_rmp () , self . adc12_jext13_rmp () , self . adc34_ext5_rmp () , self . adc34_ext6_rmp () , self . adc34_ext15_rmp () , self . adc34_jext5_rmp () , self . adc34_jext11_rmp () , self . adc34_jext14_rmp ()) } } # [doc = "external interrupt configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Exticr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Exticr {{ exti[0]: {=u8:?}, exti[1]: {=u8:?}, exti[2]: {=u8:?}, exti[3]: {=u8:?} }}" , self . exti (0usize) , self . exti (1usize) , self . exti (2usize) , self . exti (3usize)) } } # [doc = "CCM SRAM protection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Rcr { Rcr (0) } } impl core :: fmt :: Debug for Rcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Rcr") . field ("page_wp[0]" , & self . page_wp (0usize)) . field ("page_wp[1]" , & self . page_wp (1usize)) . field ("page_wp[2]" , & self . page_wp (2usize)) . field ("page_wp[3]" , & self . page_wp (3usize)) . field ("page_wp[4]" , & self . page_wp (4usize)) . field ("page_wp[5]" , & self . page_wp (5usize)) . field ("page_wp[6]" , & self . page_wp (6usize)) . field ("page_wp[7]" , & self . page_wp (7usize)) . field ("page_wp[8]" , & self . page_wp (8usize)) . field ("page_wp[9]" , & self . page_wp (9usize)) . field ("page_wp[10]" , & self . page_wp (10usize)) . field ("page_wp[11]" , & self . page_wp (11usize)) . field ("page_wp[12]" , & self . page_wp (12usize)) . field ("page_wp[13]" , & self . page_wp (13usize)) . field ("page_wp[14]" , & self . page_wp (14usize)) . field ("page_wp[15]" , & self . page_wp (15usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Rcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Rcr {{ page_wp[0]: {=bool:?}, page_wp[1]: {=bool:?}, page_wp[2]: {=bool:?}, page_wp[3]: {=bool:?}, page_wp[4]: {=bool:?}, page_wp[5]: {=bool:?}, page_wp[6]: {=bool:?}, page_wp[7]: {=bool:?}, page_wp[8]: {=bool:?}, page_wp[9]: {=bool:?}, page_wp[10]: {=bool:?}, page_wp[11]: {=bool:?}, page_wp[12]: {=bool:?}, page_wp[13]: {=bool:?}, page_wp[14]: {=bool:?}, page_wp[15]: {=bool:?} }}" , self . page_wp (0usize) , self . page_wp (1usize) , self . page_wp (2usize) , self . page_wp (3usize) , self . page_wp (4usize) , self . page_wp (5usize) , self . page_wp (6usize) , self . page_wp (7usize) , self . page_wp (8usize) , self . page_wp (9usize) , self . page_wp (10usize) , self . page_wp (11usize) , self . page_wp (12usize) , self . page_wp (13usize) , self . page_wp (14usize) , self . page_wp (15usize)) } } } pub mod vals { # [repr (u8)]
...
MAP_DMA1CH2 = 0x02 , # [doc = "ADC2 mapped on DMA1 channel 4"]
MAP_DMA1CH4 = 0x03 , } impl Adc2DmaRmpCfgr3 { # [inline (always)]
...
HR_TIM1 = 0x01 , } impl Dac1Trig3Rmp { # [inline (always)]
...
NO_REDIRECTION = 0x0 , # [doc = "TIM2 IC1 and TIM2 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively"]
MAP_TIM2TIM15 = 0x01 , # [doc = "TIM3 IC1 and TIM3 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively"]
MAP_TIM3TIM15 = 0x02 , _RESERVED_3 = 0x03 , } impl EncoderMode { # [inline (always)]
...
MAP_DMA1CH7 = 0x0 , # [doc = "I2C1_RX mapped on DMA1 CH3"]
MAP_DMA1CH3 = 0x01 , # [doc = "I2C1_RX mapped on DMA1 CH5"]
MAP_DMA1CH5 = 0x02 , _RESERVED_3 = 0x03 , } impl I2c1RxDmaRmp { # [inline (always)]
...
MAP_DMA1CH6 = 0x0 , # [doc = "I2C1_TX mapped on DMA1 CH2"]
MAP_DMA1CH2 = 0x01 , # [doc = "I2C1_TX mapped on DMA1 CH4"]
MAP_DMA1CH4 = 0x02 , _RESERVED_3 = 0x03 , } impl I2c1TxDmaRmp { # [inline (always)]
...
MAIN_FLASH = 0x0 , # [doc = "System Flash memory mapped at 0x0000_0000"]
SYSTEM_FLASH = 0x01 , # [doc = "Main Flash memory mapped at 0x0000_0000"]
MAIN_FLASH2 = 0x02 , # [doc = "Embedded SRAM mapped at 0x0000_0000"]
...
MAP_DMA1CH3 = 0x0 , # [doc = "SPI1_RX mapped on DMA1 CH4"]
MAP_DMA1CH5 = 0x01 , # [doc = "SPI1_RX mapped on DMA1 CH6"]
MAP_DMA1CH7 = 0x02 , _RESERVED_3 = 0x03 , } impl Spi1RxDmaRmp { # [inline (always)]
...
MAP_DMA1CH3 = 0x0 , # [doc = "SPI1_TX mapped on DMA1 CH5"]
MAP_DMA1CH5 = 0x01 , # [doc = "SPI1_TX mapped on DMA1 CH7"]
MAP_DMA1CH7 = 0x02 , _RESERVED_3 = 0x03 , } impl Spi1TxDmaRmp { # [inline (always)]

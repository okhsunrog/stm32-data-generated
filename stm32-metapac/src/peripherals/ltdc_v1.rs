...
fn default () -> Awcr { Awcr (0) } } impl core :: fmt :: Debug for Awcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Awcr") . field ("aah" , & self . aah ()) . field ("aaw" , & self . aaw ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Awcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Awcr {{ aah: {=u16:?}, aaw: {=u16:?} }}" , self . aah () , self . aaw ()) } } # [doc = "Background Color Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bccr { Bccr (0) } } impl core :: fmt :: Debug for Bccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bccr") . field ("bcblue" , & self . bcblue ()) . field ("bcgreen" , & self . bcgreen ()) . field ("bcred" , & self . bcred ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bccr {{ bcblue: {=u8:?}, bcgreen: {=u8:?}, bcred: {=u8:?} }}" , self . bcblue () , self . bcgreen () , self . bcred ()) } } # [doc = "Layerx Blending Factors Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bfcr { Bfcr (0) } } impl core :: fmt :: Debug for Bfcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bfcr") . field ("bf2" , & self . bf2 ()) . field ("bf1" , & self . bf1 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bfcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bfcr {{ bf2: {:?}, bf1: {:?} }}" , self . bf2 () , self . bf1 ()) } } # [doc = "Back Porch Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bpcr { Bpcr (0) } } impl core :: fmt :: Debug for Bpcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bpcr") . field ("avbp" , & self . avbp ()) . field ("ahbp" , & self . ahbp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bpcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Bpcr {{ avbp: {=u16:?}, ahbp: {=u16:?} }}" , self . avbp () , self . ahbp ()) } } # [doc = "Layerx Constant Alpha Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cacr { Cacr (0) } } impl core :: fmt :: Debug for Cacr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cacr") . field ("consta" , & self . consta ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cacr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cacr {{ consta: {=u8:?} }}" , self . consta ()) } } # [doc = "Current Display Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cdsr { Cdsr (0) } } impl core :: fmt :: Debug for Cdsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cdsr") . field ("vdes" , & self . vdes ()) . field ("hdes" , & self . hdes ()) . field ("vsyncs" , & self . vsyncs ()) . field ("hsyncs" , & self . hsyncs ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cdsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cdsr {{ vdes: {=bool:?}, hdes: {=bool:?}, vsyncs: {=bool:?}, hsyncs: {=bool:?} }}" , self . vdes () , self . hdes () , self . vsyncs () , self . hsyncs ()) } } # [doc = "Layerx Color Frame Buffer Address Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfbar { Cfbar (0) } } impl core :: fmt :: Debug for Cfbar { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfbar") . field ("cfbadd" , & self . cfbadd ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfbar { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfbar {{ cfbadd: {=u32:?} }}" , self . cfbadd ()) } } # [doc = "Layerx ColorFrame Buffer Line Number Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfblnr { Cfblnr (0) } } impl core :: fmt :: Debug for Cfblnr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfblnr") . field ("cfblnbr" , & self . cfblnbr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfblnr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfblnr {{ cfblnbr: {=u16:?} }}" , self . cfblnbr ()) } } # [doc = "Layerx Color Frame Buffer Length Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfblr { Cfblr (0) } } impl core :: fmt :: Debug for Cfblr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfblr") . field ("cfbll" , & self . cfbll ()) . field ("cfbp" , & self . cfbp ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfblr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cfblr {{ cfbll: {=u16:?}, cfbp: {=u16:?} }}" , self . cfbll () , self . cfbp ()) } } # [doc = "Layerx Color Keying Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ckcr { Ckcr (0) } } impl core :: fmt :: Debug for Ckcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ckcr") . field ("ckblue" , & self . ckblue ()) . field ("ckgreen" , & self . ckgreen ()) . field ("ckred" , & self . ckred ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ckcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ckcr {{ ckblue: {=u8:?}, ckgreen: {=u8:?}, ckred: {=u8:?} }}" , self . ckblue () , self . ckgreen () , self . ckred ()) } } # [doc = "Layerx CLUT Write Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Clutwr { Clutwr (0) } } impl core :: fmt :: Debug for Clutwr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Clutwr") . field ("blue" , & self . blue ()) . field ("green" , & self . green ()) . field ("red" , & self . red ()) . field ("clutadd" , & self . clutadd ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Clutwr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Clutwr {{ blue: {=u8:?}, green: {=u8:?}, red: {=u8:?}, clutadd: {=u8:?} }}" , self . blue () , self . green () , self . red () , self . clutadd ()) } } # [doc = "Current Position Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cpsr { Cpsr (0) } } impl core :: fmt :: Debug for Cpsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cpsr") . field ("cypos" , & self . cypos ()) . field ("cxpos" , & self . cxpos ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cpsr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cpsr {{ cypos: {=u16:?}, cxpos: {=u16:?} }}" , self . cypos () , self . cxpos ()) } } # [doc = "Layerx Control Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("len" , & self . len ()) . field ("colken" , & self . colken ()) . field ("cluten" , & self . cluten ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ len: {=bool:?}, colken: {=bool:?}, cluten: {=bool:?} }}" , self . len () , self . colken () , self . cluten ()) } } # [doc = "Layerx Default Color Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dccr { Dccr (0) } } impl core :: fmt :: Debug for Dccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dccr") . field ("dcblue" , & self . dcblue ()) . field ("dcgreen" , & self . dcgreen ()) . field ("dcred" , & self . dcred ()) . field ("dcalpha" , & self . dcalpha ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dccr {{ dcblue: {=u8:?}, dcgreen: {=u8:?}, dcred: {=u8:?}, dcalpha: {=u8:?} }}" , self . dcblue () , self . dcgreen () , self . dcred () , self . dcalpha ()) } } # [doc = "Global Control Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Gcr { Gcr (0) } } impl core :: fmt :: Debug for Gcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Gcr") . field ("ltdcen" , & self . ltdcen ()) . field ("dbw" , & self . dbw ()) . field ("dgw" , & self . dgw ()) . field ("drw" , & self . drw ()) . field ("den" , & self . den ()) . field ("pcpol" , & self . pcpol ()) . field ("depol" , & self . depol ()) . field ("vspol" , & self . vspol ()) . field ("hspol" , & self . hspol ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Gcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Gcr {{ ltdcen: {=bool:?}, dbw: {=u8:?}, dgw: {=u8:?}, drw: {=u8:?}, den: {=bool:?}, pcpol: {:?}, depol: {:?}, vspol: {:?}, hspol: {:?} }}" , self . ltdcen () , self . dbw () , self . dgw () , self . drw () , self . den () , self . pcpol () , self . depol () , self . vspol () , self . hspol ()) } } # [doc = "Interrupt Clear Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icr { Icr (0) } } impl core :: fmt :: Debug for Icr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icr") . field ("clif" , & self . clif ()) . field ("cfuif" , & self . cfuif ()) . field ("cterrif" , & self . cterrif ()) . field ("crrif" , & self . crrif ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Icr {{ clif: {:?}, cfuif: {:?}, cterrif: {:?}, crrif: {:?} }}" , self . clif () , self . cfuif () , self . cterrif () , self . crrif ()) } } # [doc = "Interrupt Enable Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ier { Ier (0) } } impl core :: fmt :: Debug for Ier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ier") . field ("lie" , & self . lie ()) . field ("fuie" , & self . fuie ()) . field ("terrie" , & self . terrie ()) . field ("rrie" , & self . rrie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ier { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ier {{ lie: {=bool:?}, fuie: {=bool:?}, terrie: {=bool:?}, rrie: {=bool:?} }}" , self . lie () , self . fuie () , self . terrie () , self . rrie ()) } } # [doc = "Interrupt Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Isr { Isr (0) } } impl core :: fmt :: Debug for Isr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Isr") . field ("lif" , & self . lif ()) . field ("fuif" , & self . fuif ()) . field ("terrif" , & self . terrif ()) . field ("rrif" , & self . rrif ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Isr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Isr {{ lif: {=bool:?}, fuif: {=bool:?}, terrif: {=bool:?}, rrif: {=bool:?} }}" , self . lif () , self . fuif () , self . terrif () , self . rrif ()) } } # [doc = "Line Interrupt Position Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Lipcr { Lipcr (0) } } impl core :: fmt :: Debug for Lipcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Lipcr") . field ("lipos" , & self . lipos ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Lipcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Lipcr {{ lipos: {=u16:?} }}" , self . lipos ()) } } # [doc = "Layerx Pixel Format Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Pfcr { Pfcr (0) } } impl core :: fmt :: Debug for Pfcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Pfcr") . field ("pf" , & self . pf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Pfcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Pfcr {{ pf: {:?} }}" , self . pf ()) } } # [doc = "Shadow Reload Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Srcr { Srcr (0) } } impl core :: fmt :: Debug for Srcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Srcr") . field ("imr" , & self . imr ()) . field ("vbr" , & self . vbr ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Srcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Srcr {{ imr: {:?}, vbr: {:?} }}" , self . imr () , self . vbr ()) } } # [doc = "Synchronization Size Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sscr { Sscr (0) } } impl core :: fmt :: Debug for Sscr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sscr") . field ("vsh" , & self . vsh ()) . field ("hsw" , & self . hsw ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sscr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sscr {{ vsh: {=u16:?}, hsw: {=u16:?} }}" , self . vsh () , self . hsw ()) } } # [doc = "Total Width Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Twcr { Twcr (0) } } impl core :: fmt :: Debug for Twcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Twcr") . field ("totalh" , & self . totalh ()) . field ("totalw" , & self . totalw ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Twcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Twcr {{ totalh: {=u16:?}, totalw: {=u16:?} }}" , self . totalh () , self . totalw ()) } } # [doc = "Layerx Window Horizontal Position Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Whpcr { Whpcr (0) } } impl core :: fmt :: Debug for Whpcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Whpcr") . field ("whstpos" , & self . whstpos ()) . field ("whsppos" , & self . whsppos ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Whpcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Whpcr {{ whstpos: {=u16:?}, whsppos: {=u16:?} }}" , self . whstpos () , self . whsppos ()) } } # [doc = "Layerx Window Vertical Position Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Wvpcr { Wvpcr (0) } } impl core :: fmt :: Debug for Wvpcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Wvpcr") . field ("wvstpos" , & self . wvstpos ()) . field ("wvsppos" , & self . wvsppos ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Wvpcr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Wvpcr {{ wvstpos: {=u16:?}, wvsppos: {=u16:?} }}" , self . wvstpos () , self . wvsppos ()) } } } pub mod vals { # [repr (u8)]
# [derive (Copy , Clone , Debug , Eq , PartialEq , Ord , PartialOrd)]
# [cfg_attr (feature = "defmt" , derive (defmt :: Format))]
pub enum Bf1 { _RESERVED_0 = 0x0 , _RESERVED_1 = 0x01 , _RESERVED_2 = 0x02 , _RESERVED_3 = 0x03 , # [doc = "BF1 = constant alpha"]
CONSTANT = 0x04 , _RESERVED_5 = 0x05 , # [doc = "BF1 = pixel alpha * constant alpha"]
PIXEL = 0x06 , _RESERVED_7 = 0x07 , } impl Bf1 { # [inline (always)]
...
ACTIVE_LOW = 0x0 , # [doc = "Data enable polarity is active high"]
ACTIVE_HIGH = 0x01 , } impl Depol { # [inline (always)]
...
ACTIVE_LOW = 0x0 , # [doc = "Horizontal synchronization polarity is active high"]
ACTIVE_HIGH = 0x01 , } impl Hspol { # [inline (always)]
...
NO_EFFECT = 0x0 , # [doc = "The shadow registers are reloaded immediately. This bit is set by software and cleared only by hardware after reload"]
...
RISING_EDGE = 0x0 , # [doc = "Pixel clock on falling edge"]
FALLING_EDGE = 0x01 , } impl Pcpol { # [inline (always)]
...
NO_EFFECT = 0x0 , # [doc = "The shadow registers are reloaded during the vertical blanking period (at the beginning of the first line after the active display area)."]
...
ACTIVE_LOW = 0x0 , # [doc = "Vertical synchronization polarity is active high"]
ACTIVE_HIGH = 0x01 , } impl Vspol { # [inline (always)]

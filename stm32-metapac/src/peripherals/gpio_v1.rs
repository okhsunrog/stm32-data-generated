...
fn default () -> Brr { Brr (0) } } impl core :: fmt :: Debug for Brr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Brr") . field ("br[0]" , & self . br (0usize)) . field ("br[1]" , & self . br (1usize)) . field ("br[2]" , & self . br (2usize)) . field ("br[3]" , & self . br (3usize)) . field ("br[4]" , & self . br (4usize)) . field ("br[5]" , & self . br (5usize)) . field ("br[6]" , & self . br (6usize)) . field ("br[7]" , & self . br (7usize)) . field ("br[8]" , & self . br (8usize)) . field ("br[9]" , & self . br (9usize)) . field ("br[10]" , & self . br (10usize)) . field ("br[11]" , & self . br (11usize)) . field ("br[12]" , & self . br (12usize)) . field ("br[13]" , & self . br (13usize)) . field ("br[14]" , & self . br (14usize)) . field ("br[15]" , & self . br (15usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Brr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Brr {{ br[0]: {=bool:?}, br[1]: {=bool:?}, br[2]: {=bool:?}, br[3]: {=bool:?}, br[4]: {=bool:?}, br[5]: {=bool:?}, br[6]: {=bool:?}, br[7]: {=bool:?}, br[8]: {=bool:?}, br[9]: {=bool:?}, br[10]: {=bool:?}, br[11]: {=bool:?}, br[12]: {=bool:?}, br[13]: {=bool:?}, br[14]: {=bool:?}, br[15]: {=bool:?} }}" , self . br (0usize) , self . br (1usize) , self . br (2usize) , self . br (3usize) , self . br (4usize) , self . br (5usize) , self . br (6usize) , self . br (7usize) , self . br (8usize) , self . br (9usize) , self . br (10usize) , self . br (11usize) , self . br (12usize) , self . br (13usize) , self . br (14usize) , self . br (15usize)) } } # [doc = "Port bit set/reset register (GPIOn_BSRR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("mode[0]" , & self . mode (0usize)) . field ("mode[1]" , & self . mode (1usize)) . field ("mode[2]" , & self . mode (2usize)) . field ("mode[3]" , & self . mode (3usize)) . field ("mode[4]" , & self . mode (4usize)) . field ("mode[5]" , & self . mode (5usize)) . field ("mode[6]" , & self . mode (6usize)) . field ("mode[7]" , & self . mode (7usize)) . field ("cnf_in[0]" , & self . cnf_in (0usize)) . field ("cnf_in[1]" , & self . cnf_in (1usize)) . field ("cnf_in[2]" , & self . cnf_in (2usize)) . field ("cnf_in[3]" , & self . cnf_in (3usize)) . field ("cnf_in[4]" , & self . cnf_in (4usize)) . field ("cnf_in[5]" , & self . cnf_in (5usize)) . field ("cnf_in[6]" , & self . cnf_in (6usize)) . field ("cnf_in[7]" , & self . cnf_in (7usize)) . field ("cnf_out[0]" , & self . cnf_out (0usize)) . field ("cnf_out[1]" , & self . cnf_out (1usize)) . field ("cnf_out[2]" , & self . cnf_out (2usize)) . field ("cnf_out[3]" , & self . cnf_out (3usize)) . field ("cnf_out[4]" , & self . cnf_out (4usize)) . field ("cnf_out[5]" , & self . cnf_out (5usize)) . field ("cnf_out[6]" , & self . cnf_out (6usize)) . field ("cnf_out[7]" , & self . cnf_out (7usize)) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr {{ mode[0]: {:?}, mode[1]: {:?}, mode[2]: {:?}, mode[3]: {:?}, mode[4]: {:?}, mode[5]: {:?}, mode[6]: {:?}, mode[7]: {:?}, cnf_in[0]: {:?}, cnf_in[1]: {:?}, cnf_in[2]: {:?}, cnf_in[3]: {:?}, cnf_in[4]: {:?}, cnf_in[5]: {:?}, cnf_in[6]: {:?}, cnf_in[7]: {:?}, cnf_out[0]: {:?}, cnf_out[1]: {:?}, cnf_out[2]: {:?}, cnf_out[3]: {:?}, cnf_out[4]: {:?}, cnf_out[5]: {:?}, cnf_out[6]: {:?}, cnf_out[7]: {:?} }}" , self . mode (0usize) , self . mode (1usize) , self . mode (2usize) , self . mode (3usize) , self . mode (4usize) , self . mode (5usize) , self . mode (6usize) , self . mode (7usize) , self . cnf_in (0usize) , self . cnf_in (1usize) , self . cnf_in (2usize) , self . cnf_in (3usize) , self . cnf_in (4usize) , self . cnf_in (5usize) , self . cnf_in (6usize) , self . cnf_in (7usize) , self . cnf_out (0usize) , self . cnf_out (1usize) , self . cnf_out (2usize) , self . cnf_out (3usize) , self . cnf_out (4usize) , self . cnf_out (5usize) , self . cnf_out (6usize) , self . cnf_out (7usize)) } } # [doc = "Port input data register (GPIOn_IDR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
PUSH_PULL = 0x0 , # [doc = "Open Drain-Mode"]
OPEN_DRAIN = 0x01 , # [doc = "Alternate Function Push-Pull Mode"]
ALT_PUSH_PULL = 0x02 , # [doc = "Alternate Function Open-Drain Mode"]
ALT_OPEN_DRAIN = 0x03 , } impl CnfOut { # [inline (always)]
